export declare type P_ALTER_TABLE_ACTION = 'addColumn' | 'addColumns' | 'addIndex' | 'addPrimaryKey' | 'addUniqueKey' | 'addFulltextIndex' | 'addSpatialIndex' | 'addForeignKey' | 'setDefaultColumnValue' | 'dropDefaultColumnValue' | 'changeColumn' | 'dropColumn' | 'dropIndex' | 'dropPrimaryKey' | 'dropForeignKey' | 'renameIndex' | 'rename';
...
export interface P_DDS {
    id: 'P_DDS';
    def: P_CREATE_DB | P_CREATE_TABLE | P_CREATE_INDEX | P_ALTER_DB | P_ALTER_TABLE | P_DROP_DB | P_DROP_TABLE | P_DROP_INDEX | P_RENAME_TABLE | P_SET | P_USE_DB;
}
...
export interface O_ALTER_TABLE_SPEC {
    ...
    def: O_ALTER_TABLE_SPEC_ADD_COLUMN | O_ALTER_TABLE_SPEC_ADD_COLUMNS | O_ALTER_TABLE_SPEC_ADD_INDEX | O_ALTER_TABLE_SPEC_ADD_PRIMARY_KEY | O_ALTER_TABLE_SPEC_ADD_UNIQUE_KEY | O_ALTER_TABLE_SPEC_ADD_FULLTEXT_INDEX | O_ALTER_TABLE_SPEC_ADD_SPATIAL_INDEX | O_ALTER_TABLE_SPEC_ADD_FOREIGN_KEY | O_ALTER_TABLE_SPEC_CHANGE_ALGORITHM | O_ALTER_TABLE_SPEC_SET_DEFAULT_COLUMN_VALUE | O_ALTER_TABLE_SPEC_DROP_DEFAULT_COLUMN_VALUE | O_ALTER_TABLE_SPEC_CHANGE_COLUMN | O_ALTER_TABLE_SPEC_CONVERT_TO_CHARACTER_SET | O_ALTER_TABLE_SPEC_ENABLE_KEYS | O_ALTER_TABLE_SPEC_DISABLE_KEYS | O_ALTER_TABLE_SPEC_DISCARD_TABLESPACE | O_ALTER_TABLE_SPEC_IMPORT_TABLESPACE | O_ALTER_TABLE_SPEC_DROP_COLUMN | O_ALTER_TABLE_SPEC_DROP_INDEX | O_ALTER_TABLE_SPEC_DROP_PRIMARY_KEY | O_ALTER_TABLE_SPEC_DROP_FOREIGN_KEY | O_ALTER_TABLE_SPEC_FORCE | O_ALTER_TABLE_SPEC_CHANGE_LOCK | O_ALTER_TABLE_SPEC_ORDER_BY | O_ALTER_TABLE_SPEC_RENAME_INDEX | O_ALTER_TABLE_SPEC_RENAME | O_ALTER_TABLE_SPEC_WITH_VALIDATION | O_ALTER_TABLE_SPEC_WITHOUT_VALIDATION | O_ALTER_TABLE_SPEC_ADD_PERIOD_FOR_SYSTEM_TIME;
}
export declare type O_POSITION = {
    after: string | null;
};
...
export interface O_DATATYPE {
    id: 'O_DATATYPE';
    def: O_INTEGER_DATATYPE | O_FIXED_POINT_DATATYPE | O_FLOATING_POINT_DATATYPE | O_BIT_DATATYPE | O_BOOLEAN_DATATYPE | O_DATETIME_DATATYPE | O_YEAR_DATATYPE | O_VARIABLE_STRING_DATATYPE | O_FIXED_STRING_DATATYPE | O_ENUM_DATATYPE | O_SET_DATATYPE | O_SPATIAL_DATATYPE | O_JSON_DATATYPE;
}
