...
\reponse{Prendre $A$ supérieur ou égal à la plus petite des valeurs propres
     de~$-M$.}
    \item \question{Montrer que $\phi \in GL(S_n(\R))$ et que $\phi (S_n^+(\R))=S_n^+(\R)$.}
\reponse{Surjectivité de~$\phi$~: $\Im\Phi$ est un sous-espace vectoriel de~$S_n(\R)$ contenant
...
\reponse{Soit $M\in S_2(\R)$ de valeurs propres $a,b$ avec $a\le b$,
