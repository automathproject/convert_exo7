...
\reponse{
Pour $n\geq1$, on a d'après la formule de \textsc{Leibniz}~:
...
\end{align*}
On sait dériver facilement des sommes ou plus généralement des combinaisons linéaires. Donc, on linéarise~:
