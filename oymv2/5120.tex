...
\reponse{$z^2+z+1=0\Leftrightarrow z=-\frac{1}{2}+i\frac{\sqrt{3}}{2}=j\;\mbox{ou}\;z=-\frac{1}{2}-i\frac{\sqrt{3}}{2}=j^2$.}
    \item \question{$2z^2+2z+1=0$}
\reponse{$\Delta'=1^2-2=-1=i^2$. L'équation a donc deux solutions non réelles et conjuguées, à savoir
$z_1=\frac{1}{2}(-1+i)$ et $z_2=\frac{1}{2}(-1-i)$.\rule[-5mm]{0mm}{0mm}}
    \item \question{$z^2-2z\cos\theta+1=0$, $\theta$ réel donné.}
\reponse{Soit $\theta\in\Rr$. Pour tout complexe $z$, on a
\begin{align*}
...
\reponse{Soit $(E)$ l'équation $z^2-(6+i)z+(11+3i)=0$.
...
\reponse{Soit (E) l'équation $2z^2-(7+3i)z+(2+4i)=0$.
