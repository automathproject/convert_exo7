...
\reponse{$x^y = y^x \Leftrightarrow \frac{p^{p'q}}{q^{p'q}} = \frac{p'^{pq'}}{q'^{pq'}}$
...
\reponse{$\Bigl( pq' = m^a n^b,\ p'q = m^b n^a,\ m\wedge n = 1,\ a<b \Bigr)
              \Rightarrow  d=m^a n^a$, $a=n^{b-a}$ et $b = m^{b-a}$.}
    \item \question{Montrer que $b-a \le 1$ et conclure.}
\reponse{$m\ge n+1$ donc si $b-a \ge 2$, on a :
