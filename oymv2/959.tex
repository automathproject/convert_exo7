...
$$}
\reponse{
Soit $P \in E$ et $\lambda \in \Rr$, alors la division euclidienne de $AP$ par $B$ s'\'ecrit $AP= Q\cdot B + R$, donc en multipliant par $\lambda$ on obtient :
...
Sens $\Rightarrow$. Supposons $f$ est bijective, donc en particulier $f$ est surjective,
...
Sens $\Leftarrow$. Supposons $A, B$ premiers entre eux. Montrons que $f$ est injective.
...
\indication{Résultats utiles d'arithmétique des polynômes : la division euclidienne, le théorème de Bézout,
le lemme de Gauss.}
\end{enumerate}
}
