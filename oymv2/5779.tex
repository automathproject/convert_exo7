...
\reponse{L'existence, la bilinéarité, la symétrie et la positivité sont immédiates. Soit $P\in\Rr[X]$. 
...
\reponse{L'orthonormalisée de la base canonique de $\Rr[X]$ répond à la question.}
    \item \question{Soit $(P_n)_{n\in\Nn}$ une telle base. Montrer que chaque polynôme $P_n$, $n\in\Nn^*$, a $n$ racines réelles simples.}
\reponse{Soit $n$ un entier naturel non nul. Le polynôme $P_n\in(P_0,...,P_{n-1})^\bot=(\Rr_{n-1}[X])^\bot$.
