...
\begin{enumerate}
    \item \question{Développement asymptotique à la précision $x^2$ en $0$ de $\frac{1}{x(e^x-1)}-\frac{1}{x^2}$.}
...
\end{center}}
    \item \question{Développement asymptotique à la précision $\frac{1}{x^3}$ en $+\infty$ de $x\ln(x+1)-(x+1)\ln x$.}
\reponse{\begin{align*}\ensuremath
