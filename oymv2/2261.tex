...
\reponse{Le polynôme $X$ n'est jamais inversible dans $A[X]$. Si $A$ n'est pas
...
\reponse{Soit $P=X+a$ un polynôme unitaire linéaire de $A[X]$. Supposons que 
...
de $\Rr[x]$.}
\reponse{Les polynômes irréductibles de $\Cc[X]$ sont les polynômes de degré 1
    (théorème de Gauss).
...
\reponse{Supposons que $K[X]$ ait un nombre fini de polynômes unitaires
