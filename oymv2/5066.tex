...
\reponse{Pour $x\in[-\pi,\pi]$, $\cos x\leq\frac{1}{2}\Leftrightarrow x\in\left[-\pi,-\frac{\pi}{3}\right]\cup\left[\frac{\pi}{3},\pi\right]$.}
    \item \question{$\sin x\geq-\frac{1}{\sqrt{2}},\;I=\Rr$,}
\reponse{Pour $x\in\Rr$, $\sin
...
\reponse{Pour $x\in[-\pi,\pi]$, $\cos^2x\geq\cos(2x)\Leftrightarrow\frac{1}{2}(1+\cos(2x))\geq\cos(2x)\Leftrightarrow\cos(2x)\leq1\Leftrightarrow
x\in[-\pi,\pi]$.}
    \item \question{$\cos^2x\leq\frac{1}{2},\;I=[0,2\pi]$,}
\reponse{Pour $x\in[0,2\pi]$, $\cos^2x\leq\frac{1}{2}\Leftrightarrow-\frac{1}{\sqrt{2}}\leq\cos x\leq\frac{1}{\sqrt{2}}\Leftrightarrow
