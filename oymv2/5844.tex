...
\reponse{Soit $A$ une partie de $E$. $\overline{A}$ est fermé et donc  $\overline{(\overline{A})}=\overline{A}$. $\overset{\circ}{A}$ est ouvert et donc $\overset{\circ}{\overset{\circ}{A}}=\overset{\circ}{A}$.}
...
\reponse{Soient $A$ et $B$ deux parties de $E$ telles que  $A\subset B$.
...
\reponse{Soient $A$ et $B$ deux parties de $E$.
...
\reponse{$\overline{A}\cap\overline{B}$ est un fermé contenant $A\cap B$ et donc  $\overline{A\cap B}\subset\overline{A}\cap\overline{B}$.
...
\reponse{Soient $A$ et $B$ deux parties de $E$. Soit $x\in E$.
