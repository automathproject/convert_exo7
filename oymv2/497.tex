...
\reponse{Calculons d'abord $f(0)$. Nous savons $f(1) = f(1+0) = f(1) +f(0)$, donc $f(0) = 0$.
...
\reponse{$0 = f(0) = f(-1 + 1) = f(-1) + f(1)$. Donc $f(-1) = - f(1)$. Puis comme ci-dessus $f(-n) = n f(-1)= -n f(1)$.}
    \item \question{$\forall q\in \Qq \qquad f(q) = q \cdot f(1)$.}
\reponse{Soit $q = \frac ab$. Alors $f(a) = f(\frac ab + \frac ab + \cdots +\frac ab) = f(\frac ab ) + \cdots + f(\frac ab)$
...
\reponse{Fixons $x \in \Rr$. Soit $(\alpha_i)$ une suite croissante de rationnels qui tend vers $x$. Soit
