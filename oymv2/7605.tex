...
\reponse{Soit $f$ et $g$ deux applications holomorphes sur un ouvert étoilé $D$ de $\Cc$.
...
\reponse{L'ouvert $\Cc$ est étoilé et contient le chemin $\partial\Delta_2$ dont l'intérieur est $\Delta_2$.
