...
\reponse{Fixons $n$ et montrons la r\'ecurrence sur $k \ge 1$.
...
\reponse{\'Ecrivons $m=n+k$, alors l'\'egalit\'e pr\'ec\'edente devient:
...
\reponse{Supposons qu'il y a un nombre fini de nombres premiers.
