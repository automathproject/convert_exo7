...
en \'el\'ements simples sur $\mathbb{R}$ et sur $\mathbb{C}$.}
\reponse{$\frac{X^3-2}{X^4(X^2+X+1)^2} = 
...
en \'el\'ements simples sur $\mathbb{R}$ et sur $\mathbb{C}$.}
\reponse{$\frac{X^2-3}{(X^2+1)(X^2+4)} = 
