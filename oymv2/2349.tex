...
\reponse{$\| f \|_1 = \int_0^1|f(t)|dt \le \int_0^1 \|f\|_\infty dt \le \|f\|_\infty$.
...
\reponse{Comme les métriques sont définies par des normes et que les normes ne sont pas équivalentes alors les métriques ne définissent pas la même topologie.}
\indication{\begin{itemize}
