...
\reponse{{\it Ecrivons la matrice $A$ de $f$ dans la base $\cal B$}.
...
\reponse{{\it Déterminons les sous-espaces $\ker f$ et $\Im f$.}
...
\reponse{Soient $\vec u_1=(1,0,-1)$, $\vec u_2=(1,2,0)$ et $\vec u_3=(0,1,1)$. {\it Démontrons que $(\vec u_1,\vec u_2,\vec u_3)$ est une base de $E$.}
...
\reponse{{\it Calculons $f(\vec u_1)$, $f(\vec u_2)$ et $f(\vec u_3)$ et déterminons la matrice $B$ de $f$ dans la base $(\vec u_1,\vec u_2,\vec u_3)$.}
...
\reponse{{\it Déterminons les valeurs propres de $f$ et, pour chacune, un vecteur propre.}
