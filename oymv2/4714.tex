...
\reponse{$x^3+y^3+z^3 - 3xyz = \frac 12 (x+y+z)\bigl((x-y)^2 + (y-z)^2 + (z-x)^2\bigr)$.}
...
\reponse{$3c_{n+1} - 3b_{n+1} = a_n + b_n + c_n - 3\sqrt[3]{a_nb_nc_n} \ge 0  \Rightarrow  b_{n+1} \le c_{n+1}$.\par
