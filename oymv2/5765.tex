...
\reponse{Soit $n\in\Nn^*$. Soient $a$ et $A$ deux réels tels que $0<a<A$. On considère $\begin{array}[t]{cccc}
...
\reponse{Pour $x>0$, on a $I_1(x)=\left[\frac{1}{x}\Arctan\left(\frac{t}{x}\right)\right]_0^{+\infty}=\frac{\pi}{2x}$. Ensuite, $I_2(x)=-\frac{1}{2x}I_1'(x)=\frac{\pi}{4x^3}$ puis $I_3(x)=-\frac{1}{4x}I_2'(x)=\frac{3\pi}{16x^5}$ et donc $I_3(1)=\frac{3\pi}{16}$.
