...
\reponse{$$\includegraphics{../images/img005443-10}$$
...
\reponse{$$\includegraphics{../images/img005443-11}$$


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%}
    \item \question{$f_{11}(x)=\Arcsin\sqrt{\frac{1}{2}-x}+\Arcsin\sqrt{\frac{1}{2}+x}$.}
\reponse{$$\includegraphics{../images/img005443-12}$$


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%}
    \item \question{$f_{12}(x)=\frac{\Arcsin x}{x}$.}
\reponse{$$\includegraphics{../images/img005443-13}$$
...
\reponse{$$\includegraphics{../images/img005443-14}$$}
\end{enumerate}
}
