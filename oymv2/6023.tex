...
\reponse{Lorsque l'on tire un bulletin au hasard, la probabilité que ce soit
un bulletin pour A est de $0.2.$}
    \item \question{Comment peut-on l'approcher?}
\reponse{Il y a suffisamment de bulletins de vote en tout pour que l'on puisse
...
\reponse{$P[X\geq 45]=1-P[X\leq 44]\simeq 1-F(\frac{44.5-40}{4\sqrt{2}})\simeq 21\%$,
...
\reponse{Reprenons le calcul pour le candidat B qui n'a obtenu que $2$\% des voix.
