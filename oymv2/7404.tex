...
\reponse{Le groupe $\mathbb{F}_{19}^\times$ est d'ordre 18, donc les ordres
...
\reponse{$D=2^7=14$. $C^d=8^7=2^{21}=2^3=8$. $mC^d=11\times8=12$.
Finalement, $(M_1,M_2)=(14,12)$.}
    \item \question{Comment Bernard retrouve-t-il le message $m$ ?}
\reponse{Il utilise la formule : $m=M_2(M_1^c)^{-1}$. On vérifie en effet
que $12\times 14^{-3}=12\times(-5)^{-3}=12\times (-7)=-8=11$.}
	...
	cette fois ?}
\reponse{Le message envoyé est $3\times8^{-3}=3\times 2^{-9}=-3=16$.
