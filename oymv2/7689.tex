...
\reponse{Le vecteur vitesse de la courbe $C'$ est $(1,2t,0)$ de norme $\sqrt{1+4t^2}$.
...
\reponse{En utilisant le changement de variables $2t=\sinh (u)$, on obtient le calcul de primitive
 \begin{eqnarray*}
