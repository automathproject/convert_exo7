...
associ\'ee \`a $(E.D.)$.}
\reponse{L'\'equation caract\'eristique $r^2-4r+4=0$ a une racine (double) $r=2$
...
\reponse{Pour $d(x) = e^{-2x}$ on peut chercher une solution particuli\`ere de la forme : $ y_1(x)
...
\reponse{On d\'eduit du principe de superposition que la
fonction $$
