...
Ainsi, une base de vecteurs propres est donnée par les vecteurs $(1,0,0), (0,0,1)$ et $(1,2,0)$.}
   ...
   \begin{enumerate}}
\reponse{{\it Soit $E$ l'espace vectoriel des solutions du système $x'=Ax$, où $x$ est une fonction de la variable réelle $t$ à valeur dans $\R^3$.}
   \begin{enumerate}}
...
\reponse{{\it Lorsque $A$ est diagonalisable, donnons une base de $E$ en fonction des vecteurs propres et des valeurs propres de $A$ et écrivons la solution générale du système.}
...
\reponse{{\it Lorsque $A$ n'est pas diagonalisable, intégrons directement le système $X'=AX$}.
