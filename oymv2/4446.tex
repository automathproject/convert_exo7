...
\reponse{Comparaison série-intégrale~: $u_n\sim\frac{\ln^2 n}2$.}
    \item \question{Montrer que la suite de terme général~: $v_n = u_n - \frac{\ln^2n}2$ est convergente.}
\reponse{Comparaison série-intégrale encore ($v_n$ est la somme des aires entre
...
\reponse{$v_n-\ell = -\sum_{k=n}^\infty\Bigl( \int_{t=k}^{k+1}\frac{\ln t}t\,d t - \frac{\ln(k+1)}{k+1}\Bigr) = -\sum_{k=n}^\infty w_k$
