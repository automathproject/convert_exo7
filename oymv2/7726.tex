...
\reponse{Si $q$ et $Q$ sont équivalents, il existe un isomorphisme linéaire $u$ de $E$ tel que $Q=q\circ u$. Par conséquent $Q$ prend toutes les valeurs que prend $q$.}
...
\reponse{On sait dans ce cas, que le vecteur isotrope est dans un plan hyperbolique, sur lequel $q$ est équivalente à la forme $Q(x,y)=xy$ qui prend toutes les valeurs de $k$.}
...
\reponse{On procède par récurrence comme dans le cours en utilisant le fait que l'orthogonal d'un espace non singulier dan un espace non-singulier est non-singulier et on s'arrête quand la forme n'a plus de vecteurs isotropes non nuls.}
