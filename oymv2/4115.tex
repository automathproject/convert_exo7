...
\reponse{$\gamma_1(t) = (-x(t),y(t))$ et $\gamma_2(t) = (x(-t),-y(-t))$
...
\reponse{$x'(t_0) = 0 \Leftrightarrow x(t_0) = 0$ ou $y(t_0) = 0$. Dans le premier cas on
...
\reponse{En supposant $\Phi$ de classe $\mathcal{C}^1$ on obtient l'équation
