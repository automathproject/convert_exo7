...
\reponse{Le vecteur normal du c\^one $C$
...
\reponse{L'intersection du c\^one $C$ avec 
...
\reponse{Le vecteur normal en un point quelconque 
...
\indication{Le vecteur normal de la surface d'\'equation 
