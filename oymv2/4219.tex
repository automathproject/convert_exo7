...
\reponse{Il existe $G$ telle que $\frac{\partial G}{\partial u} = g+u\frac{\partial g}{\partial u} = \frac{\partial (ug)}{\partial u}$ et
...
\reponse{$f(x,y) = x\Bigl(\varphi\Bigl(y-\frac1x\Bigr)
