...
\reponse{$F$ est d\'efinie sur $]0,1[\cup ]1,+\infty[$. $F$ est continue et d\'erivable sur $]0,1[$
...
\reponse{Notons $f(t) = \frac 1{\ln t}$ et $g(t) = \frac 1{t\ln t}$. On se place sur $]1,+\infty[$.
