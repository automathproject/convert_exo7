...
\reponse{Le point d'affixe $r\frac{1+it}{1-it}$ est de module $r$ et ses coordonnées $x=re(\xi(t))=r\frac{1-t^2}{1+t^2}$ et $y=Im(\xi(t))=r\frac{2t}{1+t^2}$ vérifient l'équation $y=t(x+r)$.
...
\reponse{Comme $t$ est réel, $t\mapsto r\frac{1+it}{1-it}$ est quotient de deux polynômes dont le dénominateur ne s'annule jamais. Elle est donc dérivable et 
...
\reponse{$$\int_{C_r} \frac{dz}{z}=\int_{C_r-\{-r\}} \frac{dz}{z}=\int_{-\infty}^{+\infty}\frac{\xi'(t)}{\xi(t)}dt=\int_{-\infty}^{+\infty}\frac{2i}{1+t^2}.$$}
    \item \question{En déduire la valeur de $\int_{-\infty}^{+\infty}\frac{dt}{1+t^2}$.}
\reponse{Par ailleurs, $\int_{C_r} \frac{dz}{z}=2i\pi Res_0(\frac{1}{z})=2i\pi.$
