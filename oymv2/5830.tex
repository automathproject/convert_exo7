...
\reponse{Ici $(\mathcal{S})$ est la sphère de centre $O$ et de rayon $3$ et  le point $S$ est extérieur à cette sphère. Donc
...
\reponse{Soit $M_0(x_0,y_0,z_0)$ un point de $(\mathcal{S})$ (c'est-à-dire tel que $x_0^2+x_0y_0+z_0-1 = 0$). $(\mathcal{S})$ est une surface du second degré. Une équation du plan tangent à $(\mathcal{S})$ en $M_0$ est fournie par la règle de dédoublement des termes : 
