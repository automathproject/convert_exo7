...
\reponse{
$D_f = {]0,1[}$. $f$ est convexe sur~$]0,1[$ par intégration de
...
En~$0$~: $\frac1{\strut t^x(1+t)} = \frac1{\strut t^{x+1}} - \frac1{\strut t^{x+1}(1+t)}$
...
$f(1/n) =_{(t=u^n)}  \int_{u=0}^{+\infty} \frac{nu^{n-1}\,d u}{u(1+u^n)}
