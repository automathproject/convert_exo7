...
nombre impair est $1$.}
\reponse{Soit $n$ un nombre impair, alors il s'\'ecrit $n=2p+1$ avec $p\in \Nn$.
...
$x^{2}=4 \pmod{8}.$}
\reponse{Si $n$ est pair alors il existe $p\in \Nn$ tel que $n=2p$. Et $n^2 = 4p^2$.
...
\reponse{Comme $a$ est impair alors d'apr\`es la premi\`ere question $a^2 \equiv 1 \pmod{8}$, et de m\^eme
...
$ab+bc+ca$ non plus.}
\reponse{Montrons par l'absurde que le nombre $a^2+b^2+c^2$ n'est pas le carr\'e d'un nombre entier.
