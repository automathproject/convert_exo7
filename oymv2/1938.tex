...
\reponse{Posons $S_n = \sum_{k=0}^{n} (k+1)3^{-k}$.
...
\reponse{Posons  $\displaystyle u_n = \frac{n}{n^4+n^2+1} $ et cherchons à la décomposer en éléments simples.
\begin{eqnarray*}
...
\reponse{Décomposons $\displaystyle v_n=\frac{2n-1}{n^3-4n}$ en éléments simples.
Comme 
\[
