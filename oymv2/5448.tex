...
\reponse{Puisque $f$ est de classe $C^1$ sur $[a,b]$, on peut effectuer une intégration par parties qui fournit pour $\lambda>0$~:
...
\reponse{Si $f$ est simplement supposée continue par morceaux, on ne peut donc plus effectuer une intégration par parties.
