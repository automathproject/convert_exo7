...
\reponse{$f$ est de classe $C^\infty$ car ses coordonn\'ees le sont
...
\reponse{La matrice jacobienne de $f$ est:
...
\reponse{Par continuit\'e de $Dg(x,y)$ \`a l'origine et en prenant
$\epsilon=1/2$ on a:
...
$\overline{B_\rho((0,0))}$.}
\reponse{D'apr\`es les accroissements finis, pour tous $X,Y \in
\mathbb{R}^2$, on a
