...
\reponse{Pour simplifier, on suppose $z=0$ (sinon, se placer dans la base $(1,X-z,\dots,(X-z)^d)$
...
\reponse{Voir r{\'e}ponse pr{\'e}c{\'e}dente. Y a-t-il une r{\'e}ponse plus simple pour~{1)}~?}
    \item \question{Que peut-on dire si les z{\'e}ros de~$P$ ne sont plus suppos{\'e}s simples~?}
\reponse{Si $z$ est z{\'e}ro d'ordre~$k$ de~$P$ alors il existe $\delta>0$ tel
