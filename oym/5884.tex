...
\contenu{
  \texte{}
  \question{Trouver toutes les fonctions $f$ dérivables sur $]0,+\infty[$ vérifiant $\forall x >0$, $f'(x) = f\left( \frac{3}{16x}\right)$.}
  \reponse{Soit $f$ une éventuelle solution. $f$ est dérivable sur $]0,+\infty[$ et pour tout réel $x>0$, $f'(x)=f\left( \frac{3}{16x}\right)$. On en déduit que $f'$ est dérivable sur $]0,+\infty[$ ou encore que $f$ est deux fois dérivable sur $]0,+\infty[$. En dérivant l'égalité initiale, on obtient pour tout réel $x$
