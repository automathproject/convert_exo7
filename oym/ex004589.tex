\exo7id{4589}
\titre{$\prod_{n=1}^\infty (1-q^nx)$}
\theme{}
\auteur{quercia}
\date{2010/03/14}
\organisation{exo7}
\contenu{
  \texte{Soit $q \in {]-1,1[}$ et $f(x) = \prod_{n=1}^\infty (1-q^nx)$.}
\begin{enumerate}
