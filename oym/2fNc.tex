...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Question de cours.}
  \item \reponse{L'application $\sin$ est holomorphe sur $\Cc$, donc $$I_1=\int_{\partial \Delta}\frac{\sin(z)}{z}dz=\int_{\partial \Delta}\frac{\sin(z)}{z-0}dz=(2i\pi)\sin(0)=0.$$}
  \item \reponse{L'application $\frac{\sin(z)}{z}$ se prolonge en $0$ par la somme de la série entière $\sum_{n\in\Nn}\frac{(-1)^n}{(2n+1)!}z^{2n}$ de rayon de convergence infini donc holomorphe sur $\Cc$.
  ...
  \item \reponse{L'application $\frac{\sin(z)-1}{z^2}$ se prolonge en $0$ par la somme de la série entière $\sum_{n\geq 1}\frac{(-1)^n}{(2n+1)!}z^{2n-1}$ holomorphe sur $\Cc$.
  ...
  \end{eqnarray*}}
  \item \reponse{L'application $\sin(z)$ admet $-\cos(z)$ comme primitive sur $\Cc^\times$ et même sur $\Cc$.
