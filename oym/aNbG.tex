...
\organisation{exo7}
\contenu{
  \texte{Soit $M$ la matrice r\'eelle $3\times3$ suivante :
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{{\it D\'eterminons les valeurs propres de $M$.}
...
La matrice $M$ admet donc trois valeurs propres distinctes qui sont : $1,2,$ et $-4$.}
  \item \reponse{{\it Montrons que $M$ est diagonalisable.}
...
cela prouve que $M$ est diagonalisable.}
  \item \reponse{{\it D\'eterminons une base de vecteurs propres et $P$ la matrice de passage.}
...
$$P=\begin{pmatrix}1&4&2 \\ 1&3&-3 \\ 1&-2&2\end{pmatrix}$$}
  \item \reponse{{\it Exprimons $M^k$ en fonction de $D^k$, puis calculons $M^k$.}
