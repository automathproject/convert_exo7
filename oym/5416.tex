...
\contenu{
  \texte{}
  \question{Soit $f$ une fonction dérivable sur $\Rr$ à valeurs dans $\Rr$ vérifiant $f(0)=f(a)=f'(0)=0$ pour un certain $a$ non nul. Montrer qu'il existe un point distinct de $O$ de la courbe représentative de $f$ en lequel la tangente passe par l'origine.}
  \reponse{$$\includegraphics{../images/img005416-1}$$
