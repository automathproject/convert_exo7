\uuid{4592}
\titre{Théorème de réalisation de Borel}
\theme{}
\auteur{quercia}
\date{2010/03/14}
\organisation{exo7}
\contenu{
  \texte{Soit $(a_n)$ une suite complexe donnée, on construit dans cet exercice
...
\begin{enumerate}
  ...
  \item \reponse{$\psi(x) = \exp\Bigl(\frac1{(1-x)(x-2)}\Bigr)$ sur $]1,2[$, $\psi(x) = 0$ ailleurs.}
\end{enumerate}
}