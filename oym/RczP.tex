...
\organisation{exo7}
\contenu{
  \texte{Soit $f(t)=\frac{t^2}{e^t-1}$ si $t\neq0$ et $0$ si $t=0$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$f$ est continue sur $\Rr^*$ en tant que quotient de fonctions continues sur $\Rr^*$ dont le dénominateur ne s'annule pas sur $\Rr^*$. D'autre part, quand $t$ tend vers $0$, $f(t)\sim\frac{t^2}{t}=t$ et $\lim_{t\rightarrow 0,\;t\neq0}f(t)=0=f(0)$. Ainsi, $f$ est continue en $0$ et donc sur $\Rr$.}
  \item \reponse{$f$ est continue sur $\Rr$ et donc $F$ est définie et de classe $C^1$ sur $\Rr$. De plus, $F'=f$ est positive sur $[0,+\infty[$, de sorte que $F$ est croissante sur $[0,+\infty[$. On en déduit que $F$ admet en $+\infty$ une limite dans $]-\infty,+\infty]$.
