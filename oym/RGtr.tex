...
\end{enumerate}
\begin{enumerate}
  \item \reponse{{\it On d\'etermine et on factorise le polyn\^ome caract\'eristique de $A$.}
...
\end{align*}}
  \item \reponse{{\it On d\'emontre que $A$ est diagonalisable et on d\'etermine une matrice $D$ diagonale et une matrice $P$ inversible telles  $A=PDP^{-1}$.}
...
on a la relation
$$A=PDP^{-1}.$$}
  \item \reponse{{\it On donne en le justifiant, mais sans calculs, le polyn\^ome minimal de $A$.}
...
$$Q_A(X)=(X-2)(X-4).$$}
  \item \reponse{{\it On calcule $A^n$ pour $n\in\N$.}
