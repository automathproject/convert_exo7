...
\organisation{exo7}
\contenu{
  \texte{Trouver les extrema locaux de}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$f$ est de classe $C^1$ sur $\Rr^2$ qui est un ouvert de $\Rr^2$. Donc si $f$ admet un extremum local en un point $(x_0,y_0)$ de $\Rr^2$, $(x_0,y_0)$ est un point critique de $f$. Or, pour $(x,y)\in\Rr^2$,
