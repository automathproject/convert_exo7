...
\contenu{
  \texte{}
  \question{Soit $P$ un polynôme de degré $3$ à coefficients réels. Montrer que la courbe d'équation $P(x) = P(y)$ dans un certain repère orthonormé, est en général la réunion d'une droite et d'une ellipse d'excentricité fixe.}
  \reponse{Posons $P = X^3+\alpha X^2+\beta X+\gamma$.
