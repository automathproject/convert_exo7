...
\organisation{exo7}
\contenu{
  \texte{Soit $l^\infty$ l'espace des suites r\'eelles muni avec la norme
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$A$ injective : Si $A(x_1,x_2,\ldots) = A(y_1,y_2,\ldots)$ alors
...
$A : l^\infty \rightarrow l^\infty$ n'est pas surjective.}
  \item \reponse{L'inverse \`a gauche de $A$ est $B$ définie par 
