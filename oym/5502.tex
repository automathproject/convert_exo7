...
\contenu{
  \texte{}
  \question{Dans $E_3$ rapporté à un repère $(O,i,j,k)$, on donne~:
...
Etudier $D\cap P$ et $P\cap P'$}
  \reponse{Les vecteurs $(2,-3,1)$ et $(1,2,0)$ ne sont pas colinéaires, de sorte que $(P)$ est bien un plan. Trouvons alors une équation cartésienne de $(P)$
