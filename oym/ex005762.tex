...
\contenu{
  \texte{}
  \question{Développer en série entière $F(x)=\int_{0}^{+\infty}e^{-t^2}\sin(tx)\;dt$ et en déduire que pour tout réel $x$, $F(x)=\frac{e^{-x^2/4}}{2}\int_{0}^{x}e^{t^2/4}\;dt$.}
  \reponse{Soit $x\in\Rr$. La fonction $t\mapsto e^{-t^2}\sin(tx)$ est continue sur $[0,+\infty[$, négligeable devant $\frac{1}{t^2}$ quand $t$ tend vers $+\infty$ et est donc intégrable sur $[0,+\infty[$. La fonction $F$ est donc définie sur $\Rr$ et impaire.
