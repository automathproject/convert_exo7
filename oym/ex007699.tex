...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Comme pour tout $t\in \Rr $, et tout $a_in\Rr $, $c(t+a)=t_{(0,0,a)}(c(t))$,
 ...
 Donc, l'image de $F$ est l'ensemble d'équation $y^2=x^2(1-x)$.}
  \item \reponse{Au voisinage du point $(0,0,0)$ de l'image de $S$,
