...
\contenu{
  \texte{}
  \question{\'Ecrire en coordonnée complexe  les deux similitudes (directe et indirecte) envoyant les points d'affixes $2$ et $3$ sur ceux d'affixes $i$ et $3i$ et trouver leurs éléments caractéristiques.}
  \reponse{Manifestement le rapport est $2$ car le segment donné est envoyé sur un segment deux fois plus long.
\begin{enumerate}
