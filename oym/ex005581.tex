...
\contenu{
  \texte{}
  \question{Soient $E$, $F$ et $G$, trois $\Kk$-espaces vectoriels puis $f\in\mathcal{L}(E,F)$ et $g\in\mathcal{L}(F,G)$.

Montrer que $\text{rg}f+\text{rg}g-\text{dim}F\leqslant\text{rg}(g\circ f)\leqslant\text{Min}\{\text{rg}f,\text{rg}g\}$.}
  \reponse{$\text{Im}(g\circ f)=g(f(E))\subset g(F)$ fournit $\text{rg}(gof)\leqslant\text{rg}g$.
