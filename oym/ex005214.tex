...
\contenu{
  \texte{}
  \question{Soit $u_n$ le chiffre des unités de $C_n^k$, $k$ entier naturel fixé non nul et $n$ entier naturel supèrieur ou égal à $k$. Montrer que le nombre $0,u_ku_{k+1}u_{k+2}...$ est rationnel.}
  \reponse{Soient $k$ un entier naturel non nul et $n$ un entier naturel supérieur ou égal à $k$.
