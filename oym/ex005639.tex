...
\contenu{
  \texte{}
  \question{Résoudre le système $MX = U$ où $M =(j^{i-1})_{1\leqslant i,j\leqslant n}\in M_n(\Rr)$, $U=(\delta_{i,1})_{1\leqslant i\leqslant n}\in M_{n,1}(\Rr)$ et $X$ est un vecteur colonne inconnu.}
  \reponse{Le déterminant du système est $\Delta=\text{Van}(1,\ldots,n)\neq0$. Le système proposé est donc un système de \textsc{Cramer}.
