\uuid{4122}
\titre{\'Etude qualitative : $x'=x^{2}-t$, ENS Cachan MP$^*$ 2005}
...
\contenu{
  \texte{}
  \question{On consid{\`e}re l'{\'e}quationn diff{\'e}rentielle $(E) : x'=x^{2}-t$ et l'ensemble $D_{0}=\{(t,x)\,|\, x^{2}-t<0\}$.
...
$[t_{0},+\infty[$ et la courbe int{\'e}grale reste dans $D_{0}$. En d{\'e}duire que $x(t)\mathop{\sim}\limits_{t\to +\infty} -\sqrt t$.}
  \reponse{Supposons $t>t_{0}$ tel que $x^{2}(t)-t\ge0$. On peut alors poser $t_{1}=\min \{ t>t_{0}\,|\,x^{2}(t)-t>0\}$. On a alors 
