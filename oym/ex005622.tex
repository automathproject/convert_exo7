...
\contenu{
  \texte{}
  \question{Soient $A\in\mathcal{M}_n(\Cc)$ et $B$ l'élément de $\mathcal{M}_{np}(\Cc)$ défini par blocs par $B=\left(
\begin{array}{cccc}
A&0&\ldots&0\\
0&\ddots&\ddots&\vdots\\
\vdots&\ddots&\ddots&0\\
...
\right)$. Déterminer le rang de $B$ en fonction du rang de $A$.}
  \reponse{On note $r$ le rang de $A$. Si $r=0$, $A$ est nulle et donc $B$ est nulle.
