...
\organisation{exo7}
\contenu{
  \texte{Pour tout $  n   $ entier sup\'erieur o\`u \'egal \`a $  2  $, on consid\`ere le polyn\^ome de
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Pour tout $  n \geq 2  $ on a : $  P_n(0)=-1  $ et $  P_n(1)=3  .$ Comme l'application
...
_n<1   .$}
  \item \reponse{Pour tout $  X\in   \rbrack 0, 1
...
ee (cf 1.) : elle est convergente.}
  \item \reponse{Pour tout $  n \geq 2  $ on a  :
