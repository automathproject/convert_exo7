...
\end{enumerate}
\begin{enumerate}
  \item \reponse{{\it Déterminons les valeurs propres de $A$.}
...
Les valeurs propres de $A$ sont $\lambda_1=1$, valeur propre simple et $\lambda_2=2$, valeur propre double.}
  \item \reponse{{\it Déterminons, sans calculs, des vecteurs $\vec u$ et $\vec v$ tels que $f(\vec u)=2\vec u$ et $f(\vec v)=2\vec v+\vec u$.}
...
Ainsi, les vecteurs $\vec u=\vec e_2$ et $\vec v=\vec e_3$ répondent-ils à la question.}
  \item \reponse{{\it Soit $\vec e$ tel que $f(\vec e)=\vec e$. Démontrons que $(\vec e,\vec u,\vec v)$ est une base de $\R^3$ et écrivons la matrice de $f$ dans cette base.}
