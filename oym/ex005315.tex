...
\contenu{
  \texte{}
  \question{Montrer que $\sum_{k=0}^{n-1}\cotan^2(\frac{\pi}{2n}+\frac{k\pi}{n})= n(n-1)$. (Indication. Poser $x_k=\cotan^2(\frac{\pi}{2n}+\frac{k\pi}{n})$ puis trouver un polynôme dont les $x_k$ sont les racines.)}
  \reponse{Il faut prendre garde au fait que les nombres $x_k=\cotan^2(\frac{\pi}{2n}+\frac{k\pi}{n})$ ne sont pas nécessairement deux à deux distincts.
