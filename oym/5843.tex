...
\contenu{
  \texte{}
  \question{Montrer qu'entre deux réels distincts, il existe un rationnel (ou encore montrer que $\Qq$ est dense dans $\Rr$).}
  \reponse{\textbf{1ère solution.} \textbullet~Montrons qu'entre deux réels distincts, il existe un rationnel.
