...
\contenu{
  \texte{}
  \question{Montrer que $\int_{0}^{1}x^{-x}\;dx =\sum_{n=1}^{+\infty}\frac{1}{n^n}$ et $\int_{0}^{1}x^{x}\;dx =\sum_{n=1}^{+\infty}\frac{(-1)^n}{n^n}$.}
  \reponse{Pour $x\in]0,1]$, $x^{-x}=e^{-x\ln(x)}$ et donc $\lim_{x \rightarrow 0^+}x^{-x}=1$. Donc si on pose $\forall x\in[0,1]$, $f(x)=\left\{
\begin{array}{l}
x^{-x}\;\text{si}\;x\in]0,1]\\
1\;\text{si}\;x=0
\end{array}
