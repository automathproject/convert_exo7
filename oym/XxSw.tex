...
\exo7id{2580}
\titre{Exercice 2580}
\theme{Sujets de l'année 2005-2006, Devoir à la maison}
\auteur{delaunay}
\date{2009/05/19}
\organisation{exo7}
\contenu{
  \texte{Soit $M$ la matrice de $\R^4$ suivante
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{D\'eterminons les valeurs propres de $M$ et ses sous-espaces propres.
...
ainsi, $E_{-3}$ est la droite vectorielle engendr\'ee par le vecteur $u_4=(1,-3,-7,7)$.}
  \item \reponse{Montrons que $M$ est diagonalisable. 
...
$Mu_3=3u_3$ et $Mu_4=-3u_4$.}
  \item \reponse{D\'eterminons une base de vecteurs propres et $P$ la matrice de passage.
...
$$P=\begin{pmatrix}1&1&1&1 \\  2&-2&3&-3 \\  -2&-2&-7&-7 \\  -3&3&-7&7\end{pmatrix}$$}
  \item \reponse{On a $D=P^{-1}MP$, pour $k\in\N$ exprimons $M^k$ en fonction de $D^k$, puis calculons $M^k$.
