...
\contenu{
  \texte{}
  \question{Soit $p$ un nombre premier. Montrer qu'un groupe ab\'elien fini, dont
tous les \'el\'ements diff\'erents de l'\'el\'ement neutre sont d'ordre $p$, est
isomorphe \`a $(\Z /p
\Z)^n $.}
  \reponse{Soit $G$ un groupe ab\'elien fini tel que $pG=\{0\}$. Pour tout entier $n\in \Z$ et pour tout
