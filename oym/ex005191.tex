...
\organisation{exo7}
\contenu{
  \texte{Soient $\Kk$ un sous-corps de $\Cc$ et $E$ un $\Kk$-espace vectoriel de dimension finie $n$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{\textbullet~\textbf{(1)$\Rightarrow$(2).} Si $\mbox{Ker }f=\mbox{Im }f$, alors pour tout élément $x$ de $E$, $f(x)$ est dans
...
$\mbox{Ker }f=\mbox{Im }f$.}
  \item \reponse{L'existence d'une base $(e_1,...,e_p,e_1',...,e_p')$ de $E$ vérifiant les conditions de l'énoncé a été établie
