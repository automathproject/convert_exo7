...
\contenu{
  \texte{}
  \question{Système d'équations cartésiennes de la droite $(\Delta)$ parallèle à la droite $(D)$~:~$2x=3y=6z$ et sécante aux droites $(D_1)$~:~$x=z-4=0$ et $(D_2)$~:~$y=z+4=0$.}
  \reponse{\textbullet~$(\Delta)$ est parallèle à $(D)$ si et seulement si $(\Delta)$ est dirigée par le vecteur $u(3,2,1)$ ou encore $(\Delta)$ admet un système d'équations paramétriques de la forme $\left\{
\begin{array}{l}
x=a+3\lambda\\
y=b+2\lambda\\
z=c+\lambda
