...
\contenu{
  \texte{}
  \question{Déterminer un équivalent simple de $\frac{n!}{(a+1)(a+2)\ldots(a+n)}$ quand $n$ tend vers l'infini ($a$ réel positif donné).}
  \reponse{(On applique la règle de \textsc{Raabe}-\textsc{Duhamel} qui n'est pas un résultat de cours.) Pour $n\in\Nn$, posons $u_n=\frac{n!}{(a+1)(a+2)\ldots(a+n)}$.
