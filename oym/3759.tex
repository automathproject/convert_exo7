...
\contenu{
  \texte{}
  \question{Soit $f : {\R^n} \to {\R^n}, {(x_1,\dots,x_n)} \mapsto {(x_1-x_n,x_2-x_1,\dots,x_n-x_{n-1}).}$
Avec la structure euclidienne canonique de~$\R^n$, calculer la norme de~$f$.}
  \reponse{$f = \mathrm{id}-r$ où $r(x_1,\dots,x_n) = (x_n,x_1,\dots,x_{n-1})$.
