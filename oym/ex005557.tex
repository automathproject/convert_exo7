...
\contenu{
  \texte{}
  \question{Le laplacien d'une application $g$ de $\Rr^2$ dans $\Rr$, de classe $C^2$ sur $\Rr^2$  est $\Delta g =\frac{\partial^2g}{\partial x^2}+\frac{\partial^2g}{\partial y^2}$.
...
soit non constante et ait un laplacien nul sur un sous-ensemble de $\Rr^2$ le plus grand possible (une fonction de Laplacien nul est dite harmonique).}
  \reponse{Pour $(x,y)\in\Rr^2$, $\frac{\cos(2x)}{\ch(2y)}\in[-1,1]$. Plus précisément, quand $x$ décrit $\Rr$, $\frac{\cos(2x)}{\ch(2\times0)}$ décrit $[-1,1]$ et donc quand $(x,y)$ décrit $\Rr^2$, $\frac{\cos(2x)}{\ch(2y)}$ décrit $[-1,1]$. 
