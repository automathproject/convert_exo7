...
\organisation{exo7}
\contenu{
  \texte{Soit $(x^3-x+2)$ l'id\'eal principal engendr\'e
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $P=x^{3}-x+2$. Sa réduction  $\bar{P}=x^{3}-x-1$ modulo $3$ est
    ...
    $\Qq[x]/(P)$ est un corps.}
  \item \reponse{Dans $\Qq[x]/(P)$, on a $y^{3}-y+2=0$, donc $y(y^{2}-1)=-2$ et
    finalement $y(\frac{1}{2}(1-y^{2}))=1$. Ainsi $y^{-1}=\frac{1}{2}(1-y^{2})$.}
  \item \reponse{$1+y+y^{2}=\pi(1+x+x^{2})$. On a $\pgcd(P,1+x+x^{2})=1$, et plus
