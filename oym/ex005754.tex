...
\contenu{
  \texte{}
  \question{Pour $n$ entier naturel, on pose $u_n=\frac{(-1)^n}{2n+1}\sum_{k=0}^{n}\frac{1}{4k+1}$. Convergence et somme de la série (numérique) de terme général $u_n$.}
  \reponse{Pour tout entier naturel $n$, $|a_n|\geqslant\frac{1}{2n+1}$ et donc la série proposée ne converge pas absolument.
