...
\contenu{
  \texte{}
  \question{Sur $E =\Rr_3[X]$, on pose pour tout $P\in E$, $\varphi_1(P)=P(0)$  et $\varphi_2(P) = P(1)$ puis $\psi_1(P) =P'(0)$ et $\psi_2(P) = P'(1)$. Montrer que $(\varphi_1,\varphi_2,\psi_1,\psi_2)$ est une base de $E^*$ et trouver la base dont elle est la duale.}
  \reponse{Les quatre applications $\varphi_1$, $\varphi_2$, $\psi_1$ et $\psi_2$ sont effectivement des formes linéaires sur $E$.
