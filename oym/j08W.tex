...
\organisation{exo7}
\contenu{
  \texte{Sur $E =\Rr^2$ ou $\Rr^3$ muni de sa structure euclidienne usuelle, réduire en base orthonormée les formes quadratiques suivantes :}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{(Quand $x^2$ et $y^2$ ont les mêmes coefficients, penser à faire une rotation d'angle $\frac{\pi}{4}$) En posant $x=\frac{1}{\sqrt{2}}(X+Y)$ et $y =\frac{1}{\sqrt{2}}(X-Y)$, on obtient
...
\end{center}}
  \item \reponse{La matrice de $Q$ dans la base canonique $(i,j)$ de $\Rr^2$ est $A=\left(
\begin{array}{cc}
6&2\\
2&9
\end{array}
...
Donc, si $e_1=\frac{1}{\sqrt{5}}(2,-1)$, $e_2=\frac{1}{\sqrt{5}}(1,2)$ et $u=xi+yj=Xe_1+Ye_2$, alors $q(u)=6x2+4xy+9y2= 5X^2 + 10Y^2$. De plus, $x=\frac{1}{\sqrt{5}}(2X+Y)$ et $y=\frac{1}{\sqrt{5}}(-X+2Y)$.}
  \item \reponse{La matrice de $Q$ dans la base canonique est $A=\left(
\begin{array}{ccc}
4&\sqrt{6}&5\sqrt{2}\\
\sqrt{6}&9&\sqrt{3}\\
5\sqrt{2}&\sqrt{3}&-1
