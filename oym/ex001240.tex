...
\organisation{exo7}
\contenu{
  \texte{Faire un d\'eveloppement limit\'e ou asymptotique
en $a$ \`a l'ordre $n$ de :}
\begin{enumerate}
...
o\left ({x}^{7}\right ) }$.}
  \item \reponse{$\displaystyle{{\frac {\arctan(x)-x}{\sin(x)-x}} =
2-{\frac {11}{10}}{x}^{2}+o\left ({x}^{3}\right ) }$.}
  \item \reponse{$\displaystyle{\ln (\tan(1/2\,x+1/4\,\pi )) = x+{\frac {1}{6}}{x}^{3}+o\left ({x}^{4}\right ) }$.}
  \item \reponse{$\displaystyle{\ln \sin x = \ln (1/2\,\sqrt {2})+x-\frac \pi 4 -\left (x-\frac \pi 4 \right )^{2}+{\frac {2}{3}}\left (x- \frac \pi 4\right )^{3}+o\left (\left (x-\frac \pi 4 \right )^{3}\right ) }$.}
  \item \reponse{$\displaystyle{\sqrt [3]{{x}^{3}+x}-\sqrt [3]{{x}^{3}-x}=
2/3\,\frac 1{x}+o(\frac 1 {x^4}) }$.}
  \item \reponse{$\displaystyle{(1+x)^{\frac 1 x}={e^{{\frac {\ln (1+x)}{x}}}}=
{e}}-1/2\,{e}x+{\frac {11}{24}}\,{e}{x}^{2}-{\frac {7}{16}
}\,{e}{x}^{3}+o\left ({x}^{3}\right ) $.}
  \item \reponse{$\displaystyle{x\left (\sqrt {{x}^{2}+\sqrt {{x}^{4}+1}}-
