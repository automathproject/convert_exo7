...
\contenu{
  \texte{}
  \question{Calculer la circulation du champ vectoriel
$\vec{V}(x,y)=(3x,x+y)$ le long du cercle $C$ de centre $O$ et de rayon $1$, 
parcouru dans le sens direct.}
  \reponse{Soit $\omega=3x dx + (x+y) dy$ la forme différentielle naturellement associée à $\vec{V}(x,y)$ et considérons $x=\cos t$ et $y=\sin t$ 
