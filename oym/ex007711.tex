...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Le plan $T_M\mathcal{S}$ tangent à $\mathcal{S}$ au point $M$ est engendré par les deux vecteurs
 ...
 \iff -2u_0X+Y+2(1+2u_0)v_0Z=0.$$}
  \item \reponse{Il suffit de dire que le plan tangent $T_M\Sigma$ est le noyau de la différentielle de la fonction 
 ...
 5(x_0^4X+y_0^4Y+z_0^4Z)=0\iff x_0^4X+y_0^4Y+z_0^4Z=0.$$}
  \item \reponse{Une équation du graphe $\mathcal{G}$ de $f$ est $z=f(x,y)$.
