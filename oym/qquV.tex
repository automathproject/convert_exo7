\uuid{qquV}
\exo7id{4174}
\titre{Fonctions convexes}
\theme{Exercices de Michel Quercia, Dérivées partielles}
\auteur{quercia}
\date{2010/03/11}
\organisation{exo7}
\contenu{
  \texte{Soit $U$ un ouvert convexe de~$\R^n$ et $f : U \to \R$. On dit que
...
\begin{enumerate}
  ...
  \item \reponse{thm des trois cordes pour $u \mapsto f(x+uh)$ sur $[-1,1]$.}
  \item \reponse{Soit $\overline{B}_\infty(x,r)\subset U$ et $y$ tel
