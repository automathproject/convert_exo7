...
\exo7id{151}
\titre{Exercice 151}
\theme{Logique, ensembles, raisonnements, Absurde et contraposée}
\auteur{bodin}
\date{1998/09/01}
\organisation{exo7}
\contenu{
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Montrons en fait la contrapos\'ee.
...
divisible par aucun des $p_i$}
  \item \reponse{Raisonnons par l'absurde : s'il n'existe qu'un nombre fini $r$ de nombres premiers $p_1,\ldots,p_r$
