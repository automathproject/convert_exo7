...
\contenu{
  \texte{}
  \question{Calculer la torsion de la courbe de $\Rr^3$ paramétrée par $c~:~t\mapsto (4\cos t,5-5\sin t, -3\cos t)$.
La courbe  est-elle plane ?}
  \reponse{Le vecteur vitesse est $\dot{c}(t)=(-4\sin t,-5\cos t,3\sin t)$.
