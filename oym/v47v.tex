\uuid{v47v}
\exo7id{3782}
\titre{$u$ autoadjoint et tr$(u) = 0$}
\theme{Exercices de Michel Quercia, Endomorphismes auto-adjoints}
\auteur{quercia}
\date{2010/03/11}
\organisation{exo7}
\contenu{
  \texte{Soit $u \in \mathcal{L}(E)$ auto-adjoint tel que $\mathrm{tr}(u) = 0$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $(\vec u_1,\dots,\vec u_n)$ une base propre pour $u$.
             On prend $\vec x = \vec u_1 + \dots + \vec u_n$.}
  \item \reponse{On norme $\vec x$ et on le complète en une base orthonormée.
