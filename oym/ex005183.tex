...
\contenu{
  \texte{}
  \question{$E$ désigne l'espace vectoriel $\Rr^4$ (muni des opérations usuelles). On considère les vecteurs $e_1=(1,2,3,4)$,
...
$G=\mbox{Vect}(e_4,e_5)$. Quelles sont les dimensions de $F$, $G$, $F\cap G$ et $F+G$~?}
  \reponse{\textbullet~$e_4$ et $e_5$ ne sont clairement pas colinéaires. Donc $(e_4,e_5)$ est une famille libre et
