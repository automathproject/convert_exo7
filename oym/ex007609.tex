...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $D$ un ouvert de $\Cc$ et $f : D\to \Cc$ une application holomorphe.
...
% 
%}
  \item \reponse{Soit $D$ un ouvert étoilé de $\Cc$. Soit $\Gamma$ un chemin fermé dans $D$. Soit $C$ un ensemble fini de points de $D-\Gamma$.
% Soit $f : D-C\to\Cc$ holomorphe.
% Alors,
% $$\sum_{c\in C\cap Int(\Gamma)} Ind_\Gamma(c) Res_c(f)=\frac{1}{2i\pi}\int_\Gamma f(z)dz.$$}
  \item \reponse{Soit $f$ une fonction holomorphe sur $\Delta$. On paramètre le cercle $\partial\Delta_{\frac{1}{2}}$ par $z=\frac{1}{2}e^{i\theta}$.
...
L'application $f$ prend donc une valeur réelle en $0$.}
  \item \reponse{Soit $f$ une fonction holomorphe sur $\Delta$ constante égale à $c$ sur le cercle $\partial\Delta_{\frac{1}{2}}$. 
