...
\organisation{exo7}
\contenu{
  \texte{Soit $P$ un polynôme à coefficients entiers relatifs de degré supérieur ou égal à $1$. Soit $n$ un entier relatif 
et $m=P(n)$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Posons $P=\sum_{i=0}^{l}a_iX_i$ où $l\geq1$ et où les $a_i$ sont des entiers relatifs avec $a_l\neq0$.
...
où $K$ est un entier relatif. $P(n+km)$ est donc un entier relatif multiple de $m=P(n)$.}
  \item \reponse{Soit $P\in\Zz[X]$ tel que $\forall n\in\Nn,\;P(n)$ est premier.
