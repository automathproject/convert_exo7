...
\contenu{
  \texte{}
  \question{Montrer que le produit de deux matrices symétriques réelles positives est à valeurs propres réelles positives.}
  \reponse{\textbf{Remarque.} Il faut prendre garde au fait que le produit de deux matrices symétriques n'est pas nécessairement symétrique. Plus précisément, si $A$ et $B$ sont deux matrices symétriques alors 
