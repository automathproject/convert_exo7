...
\contenu{
  \texte{}
  \question{Résoudre l'équation différentielle $(1-x^2)y'-2xy=x^2$ sur chacun des intervalles $I$
suivants~:~$I=]1,+\infty[$, $I=]-1,1[$, $I=]-1,+\infty[$, $I=\Rr$.}
  \reponse{L'équation différentielle à résoudre dans cet exercice est linéaire du premier ordre. On note $(E)$ l'équation
