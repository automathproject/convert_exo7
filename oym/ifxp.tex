...
\exo7id{5979}
\titre{Exercice 5979}
\theme{Compléments d'intégration, Continuité des translations, convolution, transformée de Fourier de $|x|^{\alpha - n}
\auteur{tumpach}
\date{2010/11/11}
\organisation{exo7}
\contenu{
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Si $f$ est continue \`a support compact dans la boule
...
o\`u $\mathcal{B}(0, M+1)$ est la boule centr\'ee en $0$ de rayon
$M+1$.}
  \item \reponse{Pour $f$ continue, on a $\lim_{h \rightarrow 0} |f(x- h) -
...
f(x)|^{p}\,dx = 0.
$$}
  \item \reponse{Soit $f$ une fonction quelconque dans $L^p(\mathbb{R}^n)$,
...
termes $\lim_{h \rightarrow 0}\|\tau_{h}f - f\|_{p}  = 0$.}
  \item \reponse{Pour $p = \infty$, les fonctions continues \`a support
