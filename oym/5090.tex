...
\contenu{
  \texte{}
  \question{Calculer $u_n=\Arctan\frac{2}{1^2}+\Arctan\frac{2}{2^2}+...+\Arctan\frac{2}{n^2}$ pour $n$ entier naturel non nul
donné puis déterminer $\lim_{n\rightarrow +\infty}u_n$. (Utiliser l'exercice \ref{exo:suprou2} 4))}
  \reponse{(On va retrouver le résultat de l'exercice \ref{exo:suprou2} dans un cas particulier)
