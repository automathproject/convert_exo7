\uuid{3768}
\titre{Décomposition en projections orthogonales}
\theme{}
\auteur{quercia}
\date{2010/03/11}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Soit $\varphi$ l'endomorphisme de matrice dans la base canonique de $\R^4$ :
...
$$\varphi = \lambda p + \mu q,\qquad p\circ q = 0,  \qquad p+q = \mathrm{id}_E.$$}
  \reponse{$M = 5\begin{pmatrix} \frac12 &0         &0         & \frac12 \cr
