...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Par l'exercice précédent, $\mathcal{P}$ a pour plan tangent au point $M(x,y,z)$
...
$$N(x,y,y)=\frac{1}{\sqrt{4x^2+4y^2+1}}\begin{pmatrix} 2x\\-2y\\1 \end{pmatrix}.$$}
  \item \reponse{L'endomorphisme de Weingarten est donné au point $A(0,0,0)$
...
\begin{pmatrix} 0\\1\\0\end{pmatrix}\mapsto\begin{pmatrix}0\\2\\0\end{pmatrix}
 \end{array}$$}
  \item \reponse{Ses valeurs propres sont donc $-2$ et $2$. La courbure de Gauss de $\mathcal{P}$ en $A$ est donc $-4$.
