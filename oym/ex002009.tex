...
\contenu{
  \texte{}
  \question{Soient $A, B, C, D$ quatre points distincts du plan tels que $\overrightarrow{AB}
...
et $B$ en $D$ est aussi le centre de celle transformant $A$ en $B$ et $C$ en $D$.}
  \reponse{Soit $z\mapsto \alpha z + \beta$ la représentation en coordonnée complexe de la similitude directe envoyant $A$ sur $C$ et $B$ sur $D$. On a donc
\[
