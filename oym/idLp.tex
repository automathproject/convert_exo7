...
\organisation{exo7}
\contenu{
  \texte{Dans chacun des cas suivants, déterminer $f(I)$ puis vérifier que $f$ réalise une bijection
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$f$ est dérivable sur $I=]-\infty,2]$, et pour $x\in]-\infty,2[$, $f'(x)=2x-4<0$. $f$ est donc continue
...
\end{center}}
  \item \reponse{On vérifie facilement que $f$ réalise une bijection de $]-2,+\infty[$ sur $]-\infty,2[$, notée $g$.
Soient
...
\end{center}}
  \item \reponse{$f$ est continue et strictement croissante sur $\left[-\frac{3}{2},+\infty\right[$.
...
\end{center}}
  \item \reponse{$f$ est définie sur $\Rr$, impaire.
