...
\contenu{
  \texte{}
  \question{$(\mathcal{C})$ est le cercle de diamètre $[A,B]$. $(D)$ est la tangente en $A$ à $(\mathcal{C})$. $P$ est
...
passant par $P$ coupe $(BS)$ en $M$. Ensemble des points $M$~?}
  \reponse{On choisit un repère orthonormé dans lequel $A$ a pour coordonnées $(R,0)$ et $(\mathcal{C})$ a pour représentation paramétrique $\left\{
\begin{array}{l}
x=R\cos t\\
y=R\sin t
\end{array}
