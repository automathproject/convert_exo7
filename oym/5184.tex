...
\contenu{
  \texte{}
  \question{Soit $\Kk$ un sous-corps de $\Cc$, $E$ un $\Kk$-espace vectoriel de dimension finie $n\geq2$. Soient $H_1$ et $H_2$ deux hyperplans de $E$.
Déterminer $\mbox{dim}_\Kk(H_1\cap H_2)$. Interprétez le résultat quand $n=2$ ou $n=3$.}
  \reponse{On a $H_1\subset H_1+H_2$ et donc $\mbox{dim }(H_1+H_2)\geq n-1$ ou encore $\mbox{dim }(H_1+H_2)\in\{n-1,n\}$. Donc
