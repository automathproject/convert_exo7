...
\organisation{exo7}
\contenu{
  \texte{Six couples sont réunis dans une soirée de réveillon. Une
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{L'univers des possibles est l'ensemble des couples possibles:
...
danse avec son épouse légitime est, si chacun choisit au hasard, $\frac{1}{6!}$.}
  \item \reponse{André danse avec son épouse, les autres choisissent au hasard: il y
a $5!$ permutations pour ces derniers:
$P(B)=\frac{5!}{6!}=\frac{1}{6}$.}
  \item \reponse{André et René dansent avec leur épouse, les $4$ autres
choisissent au hasard: il y a $4!$ permutations pour ces derniers:
$P(C)=\frac{4!}{6!}=\frac{1}{30}$.}
  \item \reponse{André ou René dansent avec leur épouse, les $4$ autres font ce
