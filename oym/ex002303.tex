...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$11,31,61$ sont premiers donc $2$ à $2$ premiers entre eux. Ainsi
  ...
  \begin{itemize}}
  \item \reponse{En utilisant le petit théorème de Fermat, on obtient que, modulo
    $11$~: $20^{15}\equiv 20^{5}\equiv -2^{5}\equiv 1[11]$.}
  \item \reponse{$(20^{15})^{2}=20^{30}\equiv 1[31]$. On en déduit que
  ...
  \item \reponse{$20^{15}\equiv(9^{2})^{15}\equiv3^{60}\equiv1[61]$
  \end{itemize}}
  \item \reponse{$1155=11\cdot7\cdot5\cdot3$. De plus (petit théorème de Fermat)
