...
\contenu{
  \texte{}
  \question{Soit $f$ une fonction réelle d'une variable réelle définie et continue sur un voisinage de $+\infty$. On suppose que la fonction $f(x+1)-f(x)$ admet dans $\Rr$ une limite $\ell$ quand $x$ tend vers $+\infty$. Etudier l'existence et la valeur eventuelle de $\lim_{x\rightarrow +\infty}\frac{f(x)}{x}$.}
  \reponse{Il existe $a>0$ tel que $f$ est définie et continue sur $[a,+\infty[$.
