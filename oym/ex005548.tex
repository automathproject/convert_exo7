...
\contenu{
  \texte{}
  \question{Soit, dans $\Rr^3$ rapporté à un repère orthonormé $(O,\overrightarrow{i},\overrightarrow{j},\overrightarrow{k})$, la courbe
...
directrice.}
  \reponse{On choisit un repère orthonormé $\mathcal{R}_1=\left(O',\overrightarrow{I},\overrightarrow{J},\overrightarrow{K}\right)$ tel que le plan d'équation $x+y+z=1$ dans $\mathcal{R}$ soit le plan d'équation $Z=0$ dans $\mathcal{R}_1$.
