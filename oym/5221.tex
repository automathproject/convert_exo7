...
\contenu{
  \texte{}
  \question{Soit $(u_n)_{n\in\Nn}$ une suite réelle. Montrer que si la suite $(u_n)_{n\in\Nn}$ converge au sens de \textsc{Césaro} et est monotone, alors la suite $(u_n)_{n\in\Nn}$ converge.}
  \reponse{Supposons sans perte de généralité $u$ croissante (quite à remplacer $u$ par $-u$).
