...
\organisation{exo7}
\contenu{
  \texte{D\'emontrer que si $J$ est un id\'eal premier
...
\begin{enumerate}
  ...
  \item \reponse{On suppose que $J\cap\Zz=(p)$. Soit $r_{p}$ la projection
  ...
  \item \reponse{Supposons $J$ maximal dans $\Zz[x]$. $J$ est en particulier premier,
