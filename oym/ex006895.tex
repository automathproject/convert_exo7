...
\organisation{exo7}
\contenu{
  \texte{On veut transmettre un message électronique composé des digits 0 et 1. Les 
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $X$ la variable aléatoire ``nombre d'erreurs commises lors de la transmission 
...
$}
  \item \reponse{Recevoir une majorité de 1 alors que 11111 a été émis correspond à l'événement $X\leq 2$, 
