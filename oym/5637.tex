\uuid{5637}
\titre{***I Déterminants de \textsc{Vandermonde}}
\theme{Déterminants}
\auteur{rouget}
\date{2010/10/16}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Soient $x_0$,..., $x_{n-1}$ $n$ nombres complexes. Calculer $\text{Van}(x_0,...,x_{n-1})= \text{det}(x_{j-1}^{i-1})_{1\leqslant i,j\leqslant n}$.}
  \reponse{Soit $n$ un entier naturel non nul. On note $L_0$, $L_1$,\ldots, $L_n$ les lignes  du déterminant $\text{Van}(x_0,\ldots,x_n)$
