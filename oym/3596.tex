...
\contenu{
  \texte{}
  \question{En se déplaçant uniquement sur les arêtes d'un cube de côté 1, combien y a-t-il
de chemins de longueur~$n$ pour aller d'un point à un autre~?}
  \reponse{Soit $d_n(i,j)$ le nombre de chemins de longueur~$n$ allant du sommet
