...
\contenu{
  \texte{}
  \question{Montrer que si les suites $(u_n^2)$ et $(u_n^3)$ convergent alors $(u_n)$ converge.}
  \reponse{Si $u_n^2\rightarrow0$, alors $|u_n|=\sqrt{|u_n^2|}\rightarrow0$ et donc $u_n\rightarrow0$.
