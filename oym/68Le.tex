...
\begin{enumerate}
  ...
  \item \reponse{$X^3-3=(X-3^{1/3})(X^2+3^{1/3}X+3^{2/3})$ où $X^2+3^{1/3}X+3^{2/3}$ 
...
$$X^3-3=(X-3^{1/3})(X+\frac{1}{2}3^{1/3}-\frac{i}{2}3^{5/6})(X+\frac{1}{2}3^{1/3}+\frac{i}{2}3^{5/6})$$}
  \item \reponse{Passons à $X^{12}-1$. $z=re^{i\theta}$ vérifie $z^{12}=1$ si et seulement 
...
\end{array}$$}
  \item \reponse{Pour $X^6+1$, $z=re^{i\theta}$ vérifie $z^{6}=-1$ si et seulement 
...
$$X^6+1=(X^2+1)(X^2-\sqrt{3}X+1)(X^2+\sqrt{3}X+1)$$}
  \item \reponse{$X^9+X^6+X^3+1=P(X^3)$ où $P(X)=X^3+X^2+X+1=\frac{X^4-1}{X-1}$ : 
