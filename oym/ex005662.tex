...
\contenu{
  \texte{}
  \question{Montrer que toute matrice de trace nulle est semblable à une matrice de diagonale nulle.}
  \reponse{On montre le résultat par récurrence sur $n\in\Nn^*$ le format de $A$.
