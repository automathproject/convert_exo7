...
\organisation{exo7}
\contenu{
  \texte{Soit $f  : \Rr \rightarrow \Rr$ d\'efinie par $f(x) = 2x/(1+x^2)$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$f$ n'est pas injective car $f(2) = \frac 45 = f(\frac12)$.
  ...
  \item \reponse{$f(x)=y$ est \'equivalent \`a l'\'equation 
  ...
  \item \reponse{Soit $y\in[-1,1]\setminus\{0\}$ alors les solutions $x$ possibles de l'\'equation $g(x)=y$ sont $x=\frac{1-\sqrt{1-y^2}}{y}$ ou
  ...
  \item \reponse{$f'(x) = \frac{2-2x^2}{1+x^2}$, donc $f'$ est strictement positive sur $]-1,1[$ donc $f$ est strictement croissante sur $[-1,1]$ avec $f(-1)=-1$ et $f(1)=1$. Donc la restriction
