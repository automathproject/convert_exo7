...
\organisation{exo7}
\contenu{
  \texte{Soient $E,F$ des espaces norm\'es et $A_n,A \in {\cal L}(E,F)$.
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{(1) $\Rightarrow$ (2). Supposons que $A_n$ converge vers $A$ dans 
...
Ce qui exactement la confergence uniforme de $A_n$ vers $A$ sur $M$.}
  \item \reponse{(2) $\Rightarrow$ (1). Par définition de la norme d'un opérateur nous avons $\| A_n - A\| = \sup_{\|x\|=1} \|A_n(x)-A(x)\|$.
