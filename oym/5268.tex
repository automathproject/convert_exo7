...
\contenu{
  \texte{}
  \question{Déterminer le centre de $\mathcal{M}_n(\Kk)$, c'est à dire l'ensemble des éléments de $\mathcal{M}_n(\Kk)$ qui commutent avec tous les éléments de $\mathcal{M}_n(\Kk)$ (utiliser les matrices élémentaires).}
  \reponse{Soit $A=(a_{k,l})_{1\leq k,l\leq n}\in\mathcal{M}_n(\Kk)$.
