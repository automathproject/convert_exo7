...
\exo7id{5930}
\titre{Exercice 5930}
\theme{Théorème de Carathéodory, calcul d'aire et de volume, Théorème de Carathéodory}
\auteur{tumpach}
\date{2010/11/11}
\organisation{exo7}
\contenu{
  \texte{On d\'efinit $m_{*}~:\mathcal{P}(\Omega) \rightarrow \mathbb{R}$
par
$$
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Il est clair que $m_{*}(\emptyset)=0$ et que $m_{*}$ est
monotone.
...
consequent $m_{*}$ est une mesure ext\'erieure.}
  \item \reponse{Les seuls ensembles mesurables sont
...
\end{array}
\right.$$}
  \item \reponse{Il est clair que l'ensemble des parties
