...
\contenu{
  \texte{}
  \question{Calculer $\underset{\alpha\in]0,\pi[}{\text{Inf}}\left\{\underset{n\in\Zz}{\text{Sup}}|\sin(n\alpha)|\right\}$.}
  \reponse{Pour $\alpha\in]0,\pi[$, posons $f(\alpha) =\underset{n\in\Zz}{\text{Sup}}|\sin(n\alpha)|=\underset{n\in\Nn}{\text{Sup}}|\sin(n\alpha)|$.
