...
\organisation{exo7}
\contenu{
  \texte{On munit $E =\mathcal{M}_3(\Rr)$ muni du produit scalaire usuel.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Déterminons l'orthogonal de $\mathcal{A}_3(\Rr)$ dans $\mathcal{M}_3(\Rr)$. Soit $(A,B)\in\mathcal{S}_(\Rr)\times\mathcal{A}_3(\Rr)$.
...
\end{center}}
  \item \reponse{Ainsi, la projection orthogonale de $M$ sur $\mathcal{A}_3(\Rr)$ est exactement la partie antisymétrique $p_a(M)$ de $M$ et la distance cherchée est la norme de $M-p_a(M)=p_s(M)$ avec 
