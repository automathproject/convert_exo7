\exo7id{7610}
\titre{Croissance à l'infini}
\theme{}
\auteur{mourougane}
\date{2021/08/10}
\organisation{exo7}
\contenu{
  \texte{On rappelle la formule de Gutzmer : soit $f$ la somme de la série entière $\sum_{n\geq 0} a_n z^n$ de rayon de convergence $R$.
Alors, pour tout $r<R$,
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $f:\Cc\to\Cc$ une application holomorphe bornée en module par $M$.
...
En particulier, tous les $a_n$ avec $n\not =0$ sont nuls et $f$ est constante}
  \item \reponse{Soit $f:\Cc\to\Cc$ une application holomorphe telle que $ M(r)\leq r$.
