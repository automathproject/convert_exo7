...
\contenu{
  \texte{}
  \question{Montrer que $\forall n\in\Nn^*,\;\sum_{k=1}^{n}|\cos k|\geq\frac{n}{4}$ (remarquer que si $x\in[0;1],\;x^2\leq x$).}
  \reponse{Soit $n\in\Nn^*$. Puisque, pour tout entier $k$, $|\cos k\;|\in[0,1]$, on a alors
