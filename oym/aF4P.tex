...
\organisation{exo7}
\contenu{
  \texte{Soit $I$ un intervalle ouvert de $\Rr$ et soit $f:I\to \Rr$
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$A$ est connexe car connexe par arcs.}
  \item \reponse{Si $z \in g(A)$ alors il existe $(x,y) \in A$ tel que $g(x,y)=z$.
...
Conclusion $z=f'(y)$ est dans $\overline {g(A)}$, et donc $f'(I) \subset \overline {g(A)}$.}
  \item \reponse{$A$ est connexe, $g$ est continue sur $A$ donc $g(A)$ est un connexe de $\Rr$. Par l'exercice \ref{exocon} comme on a 
