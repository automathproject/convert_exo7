...
\organisation{exo7}
\contenu{
  \texte{Soit $a>0$. On d\'efinit la suite $(u_n)_{n\geq 0}$ par
...
\begin{enumerate}
  ...
  \end{align*}}
  \item \reponse{Il est clair que pour $n\geqslant 0$ on a $u_n > 0$.
...
$(u_n)_{n\geqslant 1}$ est donc d\'ecroissante.}
  \item \reponse{La suite $(u_n)_{n\geqslant 1}$ est d\'ecroissante et minor\'ee par $\sqrt a$ donc elle converge vers une limite $\ell>0$.
...
\begin{align*}
  ...
  \end{align*}}
  \item \reponse{Par r\'ecurrence pour $n=1$, $u_1-\sqrt a \leqslant k$.
...
\end{align*}}
  \item \reponse{Soit $u_0=3$, alors $u_1 = \frac12(3+\frac{10}{3}) = 3,166\ldots$.
