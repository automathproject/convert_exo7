...
\organisation{exo7}
\contenu{
  \texte{Soient $A$ et $B$ deux parties born\'ees de $\Rr$.
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soient $A$ et $B$ deux parties born\'ees de $\R$.
...
un majorant de $A+B$.}
  \item \reponse{On veut montrer que, quel que soit
