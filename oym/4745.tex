\uuid{4745}
\titre{$x/\max(1,\|x\|)$, Centrale MP 2005}
...
\contenu{
  \texte{}
  \question{Soit $f$ d{\'e}finie par $f(x)=\frac{x}{\max(1,\|x\|)}$. Montrer que $f$ est $2$-lipschitzienne.}
  \reponse{Pour $\|x\| \le 1$ et $\|y\| \le 1$ on a $\|f(x)-f(y)\| = \|x-y\|$.
