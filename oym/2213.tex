...
\contenu{
  \texte{}
  \question{Montrer que si $\rho (A) <1$ alors
\begin{itemize}
\item $I-A$ est r\'eguli\`ere;
\item $(I-A)^{-1}=\lim_{k \rightarrow \infty} C_k$ avec $C_k=I+A+\cdots +A^k$.
\end{itemize}}
  \reponse{$\rho (A)<1 \Rightarrow 1$ n'est pas valeur propre de $A \Rightarrow 0$ n'est pas valeur propre de $I-A\Rightarrow I-A$ inversible
