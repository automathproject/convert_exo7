...
% $$\newfrac{\ln_\Rr(r)+i\theta}{\textrm{après avoir choisi l'écriture } z=re^{i\theta} \textrm{ avec } r\in[0,+\infty[ \textrm{ et } \theta\in]-\pi,\pi[}$$}
  \item \reponse{Une primitive d'une application continue $f$ sur $\Cc$ est une application holomorphe $F$ sur $\Cc$ dont la dérivée complexe $F'$ est l'application $f$.}
  \item \reponse{Comme la dérivée complexe d'une application holomorphe est holomorphe, il n'y a pas de tels exemples.}
  \item \reponse{$$\begin{array}{cccc}
 Id :& \Delta &\longrightarrow&\Cc\\
    &z         &\longmapsto& z
\end{array}$$
est holomorphe non-constante.}
  \item \reponse{Par le théorème de Liouville, toute application entière bornée est constante~: il n'y a donc pas de tels exemples.}
  \item \reponse{$$\begin{array}{cccc}
