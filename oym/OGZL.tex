...
\end{align*}}
  \item \reponse{La première méthode consiste à calculer $g'(x)=\frac{1}{2\sqrt x}\exp{\sqrt x}$, $g''(x)$, $g'''(x)$
...
Il reste alors à substituer $\sqrt{x}$ par son dl obtenu dans la première question.}
  \item \reponse{Posons $u=x-\frac\pi3$ (et donc $x=\frac\pi3+u$).
Alors 
