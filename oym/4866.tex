\uuid{4866}
\titre{\'Equation d'une droite variable}
...
\contenu{
  \texte{}
  \question{Soit $(O,\vec i,\vec j)$ un repère de ${\cal E}_2$, et
...
Montrer que la droite $(MM')$ passe par un point fixe (= indépendant de $m$).}
  \reponse{$\left(\begin{smallmatrix} 0 \cr 4/3 \cr\end{smallmatrix}\right)$.}
}