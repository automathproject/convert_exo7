...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soient $n\in\Nn$ et $x\in\Rr$. Posons $S_n=\sum_{k=0}^{n}\cos(kx)$ et $S_n'=\sum_{k=0}^{n}\sin(kx)$.
\begin{itemize}}
...
\begin{itemize}}
  \item \reponse{[\textbf{1er cas.}] Si $x\in2\pi\Zz$, on a immédiatement $S_n=n+1$ et $S_n'=0$.}
  \item \reponse{[\textbf{2ème cas.}] Si x$\notin2\pi\Zz$,
...
\end{itemize}}
  \item \reponse{[\textbf{2ème solution.}]
\begin{align*}
...
\end{itemize}}
  \item \reponse{Soient $n\in\Nn$ et $x\in\Rr$. Posons $S_n=\sum_{k=0}^{n}\cos^2(kx)$ et $S_n'=\sum_{k=0}^{n}\sin^2(kx)$. On
a~:
...
x}\right)\;\mbox{et}\;S_n'=\frac{1}{2}\left(n+1-\frac{\cos(nx)\sin(n+1)x}{\sin x}\right).$$}
  \item \reponse{Soient $n\in\Nn$ et $x\in\Rr$.
