...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Notons $\mathcal{R}$ le repère initial $(0,\vec i,\vec j,\vec k)$.
...
\end{array}
\right.$$}
  \item \reponse{Dans l'équation de la droite $(D)$ 
...
En particulier en faisant $(x',y',z')=(0,0,0)$ on remarque que cette droite passe par $A$.}
  \item \reponse{Nous avions obtenu l'égalité $(\mathcal{S})$ de changement de repère de $\mathcal{R}'$ 
