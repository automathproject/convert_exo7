...
\contenu{
  \texte{}
  \question{Trouver le polynôme $P$ de degré inférieur ou égal à $3$ tel que :
$$P(0)=1\quad\text{et}\quad P(1)=0\quad\text{et}\quad P(-1)=-2\quad\text{et}\quad P(2)=4.$$}
  \reponse{On cherche $P$ sous la forme $P(X)=aX^3+bX^2+cX+d$, ce qui donne le système linéaire suivant à résoudre:
