...
\contenu{
  \texte{}
  \question{Soit $P$ un polynôme à coefficients réels tel que $\forall x\in\Rr,\;P(x)\geq0$. Montrer qu'il existe deux polynômes $R$ et $S$ à coefficients réels tels que $P=R^2+S^2$.}
  \reponse{Soit $P$ un polynôme non nul à coefficients réels.
