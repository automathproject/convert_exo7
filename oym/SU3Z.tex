\uuid{SU3Z}
\exo7id{4143}
\titre{Laplacien en polaires}
\theme{Exercices de Michel Quercia, Dérivées partielles}
\auteur{quercia}
\date{2010/03/11}
\organisation{exo7}
\contenu{
  \texte{Soit $f : {\R^2} \to \R$ de classe $\mathcal{C}^2$, et
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$\Delta f = \frac{\partial^2 g}{\partial \rho^2} + \frac 1\rho \frac{\partial g}{\partial \rho} + \frac 1{\rho^2} \frac{\partial^2 g}{\partial \theta^2}$.}
\end{enumerate}
}