...
\contenu{
  \texte{}
  \question{Soit $(P_n)_{n\in\Nn}$ une suite de polynômes convergeant uniformément sur $\Rr$ vers une fonction $f$. Montrer que $f$ est un polynôme.}
  \reponse{Posons $f=\lim_{n \rightarrow +\infty}P_n$.
