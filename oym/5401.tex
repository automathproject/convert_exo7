...
\contenu{
  \texte{}
  \question{Soit $f$ périodique et continue sur $\Rr$. Montrer que $f$ est bornée et uniformément continue sur $\Rr$.}
  \reponse{Soit $T$ une pèriode strictement positive de $f$. $f$ est continue sur le segment $[0,T]$ et donc est bornée sur ce segment. $f$ est par suite bornée sur $\Rr$ par $T$-périodicité.
