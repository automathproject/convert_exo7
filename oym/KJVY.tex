...
\organisation{exo7}
\contenu{
  \texte{On rappelle qu'une fonction $f~:\Omega \rightarrow \mathbb{R}$ est
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Par d\'efinition, $ f\in \mathcal{L}^{1}(\Omega,
...
\end{equation*}}
  \item \reponse{Par monotonie de l'int\'egrale, on a
$$
\int_{\Omega} |f|\,d\mu ~\leq~\int_{\Omega} |g|\,d\mu < +\infty.
$$
D'apr\`es la question $(a)$, il en d\'ecoule que $f$ est
int\'egrable.}
  \item \reponse{D\'efinissons $z = \int_{\Omega} f\,d\mu$. Comme $z$
