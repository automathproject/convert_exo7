...
\end{enumerate}
\begin{enumerate}
  \item \reponse{La fonction $f$ \'etant d\'erivable, elle est continue.
...
(th\'eor\`eme de deug...).}
  \item \reponse{Le taux d'accroissement
...
donc $f$ est d\'erivable au point $0$ et $f'(0)=1 \neq0$.}
  \item \reponse{Par l'absurde, supposons que $f$ soit inversible au voisinage de
