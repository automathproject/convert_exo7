...
\right|=(225-256)-4(100-144)+9(64-81)=-31+176-153=-8$.}
  \item \reponse{$$\Delta_n=\mbox{det}(C_1,...,C_n)=\mbox{det}(C_1+...+C_n,C_2,...,C_n)=(a+(n-1)b)
\left|
\begin{array}{ccccc}
1&b&\ldots&\ldots&b\\
1&a&\ddots& &\vdots\\
...
\right|=(a+(n-1)b)(a-b)^{n-1}.$$}
  \item \reponse{Par $n$ linéarité, $D_n$ est somme de $2^n$ déterminants. Mais dans cette somme, un déterminant est nul dès qu'il contient au moins deux colonnes de $x$. Ainsi, en posant $\Delta_n=\mbox{det}(C_1+xC,...,C_n+xC)$ où $C_k=\left(
\begin{array}{c}
a_1\\
\vdots\\
a_{k-1}\\
...
\end{center}}
  \item \reponse{$\Delta_2=3$ et $\Delta_3=\left|
\begin{array}{ccc}
2&1&0\\
1&2&1\\
0&1&2
