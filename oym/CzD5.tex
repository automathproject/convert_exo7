...
\organisation{exo7}
\contenu{
  \texte{Montrer que les polyn\^omes suivantes sont irr\'eductibles dans
  $\Zz[x]$ :}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Le critère d'Eisenstein avec $2$ pour module donne directement le
résultat.}
  \item \reponse{La réduction modulo $2$ de $Q$ est $Q_{[2]}=x^{6}+x^{2}+1$, qui n'a pas
