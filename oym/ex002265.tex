...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $P$ un polynôme de degré $d=2$ ou $3$ de $K[X]$.
  ...
  \item \reponse{Irréductibles de degré $2$ de $\Zz/2\Zz$: Soit $P=aX^{2}+bX+c$ un
  ...
  \item \reponse{Soit $P=5X^{3}+8X^{2}+3X+15\in\Zz[X]$. Soient $A$ et $B$ deux
  ...
  \item \reponse{Un polynôme de degré $4$ est réductible ssi il a une racine ou est
