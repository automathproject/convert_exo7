\uuid{4210}
\titre{\'Equation d'ordre 2 à coefficients constants}
\theme{}
\auteur{quercia}
\date{2010/03/11}
\organisation{exo7}
\contenu{
  \texte{Soient $a,b,c \in \R$ non tous nuls. On considère l'équation aux dérivées
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$  (a + b\alpha + c\alpha^2)\frac{\partial^2 g}{\partial u^2}
