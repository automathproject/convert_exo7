...
\exo7id{671}
\titre{Exercice 671}
\theme{Fonctions continues, Pratique}
\auteur{vignal}
\date{2001/09/01}
\organisation{exo7}
\contenu{
  \texte{Soit $f$ la fonction r\'eelle \`a valeurs r\'eelles
d\'efinie par
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Le graphe est composé d'une portion de droite au dessus des $x \in ]-\infty,1[$ ;
...
On ``voit'' aussi que la fonction est bijective.}
  \item \reponse{La fonction est continue sur $]-\infty,1[$, $]1,4[$ et $]4,+\infty[$ car sur chacun des ces intervalles elle
...
Conclusion : $f$ est continue en tout point $x \in \Rr$ donc $f$ est continue sur $\Rr$.}
  \item \reponse{Le graphe devrait vous aider : tout d'abord il vous aide à se convaincre que $f$ est bien bijective
