...
\organisation{exo7}
\contenu{
  \texte{Soit $I$ un intervalle ouvert de $\Rr$, $f$ et $g$ deux fonctions d\'efinies sur $I$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{On a pour tout $x,y\in\R$ $|x-y|\geq \big| |x|-|y|\big|$
...
d\'efinition de l'assertion $\lim_{x\to a} f(x)=f(a). $}
  \item \reponse{Si $f,g$ sont continues
