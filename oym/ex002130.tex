...
\contenu{
  \texte{}
  \question{Soient $G$ un groupe et $H$ et $K$ deux sous-groupes de $G$.
...
(b) Montrer que si $H$ et $K$ sont finis alors $\displaystyle |HK| = \frac{|H|\cdot |K|}{|H\cap K|}$.}
  \reponse{(a) ($\Rightarrow$) Si $HK$ est un groupe, pour tous $h\in H$ et $k\in K$, on a $(hk)^{-1} =k^{-1} h^{-1} \in HK$ et donc $kh\in (HK)^{-1} = K^{-1} H^{-1} = KH$. D'o\`u $HK\subset KH$. L'autre inclusion s'obtient similairement.
