\exo7id{5322}
\titre{*** Polynômes $P$ vérifiant $P(\Zz)\subset\Zz$}
\theme{}
\auteur{rouget}
\date{2010/07/04}
\organisation{exo7}
\contenu{
  \texte{Soit $E$ la partie de $\Cc[X]$ formée des polynômes $P$ vérifiant $\forall a\in\Zz,\;P(a)\in\Zz$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Déjà, $P_0$ est dans $E$.
...
Ainsi, $\forall k\in\Zz,\;P_(k)\in\Zz$, ou encore $P_(\Zz)\subset\Zz$.}
  ...
  \item \reponse{Soit $P\in\Cc[X]\setminus\{0\}$ tel que $\forall k\in\Zz,\;P(k)\in\Zz$ (si $P$ est nul, $P$ est combinaison linéaire à coefficients entiers des $P_k$).
