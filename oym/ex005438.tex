...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Pour $x>0$, posons $f(x)=x+\ln x$. $f$ est continue sur $]0,+\infty[$, strictement croissante sur $]0,+\infty[$ en tant que somme de deux fonctions continues et strictement croissantes sur $]0,+\infty[$. $f$ réalise donc une bijection de $]0,+\infty[$ sur $f\left(]0,+\infty[\right)=\left]\lim_{x\rightarrow 0,\;x>0}f(x),\lim_{x\rightarrow +\infty}f(x)\right[=]-\infty,+\infty[=\Rr$. En particulier,
