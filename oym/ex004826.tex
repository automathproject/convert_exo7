\uuid{4826}
\titre{Compl{\'e}mentaire d'un hyperplan (Ens Ulm MP$^*$ 2005)}
\theme{}
\auteur{quercia}
\date{2010/03/16}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Soit $E$ un evn r{\'e}el et $H$ un hyperplan de~$E$.
Montrer que $E\setminus H$ est connexe par arcs si et seulement si
$H$ {\it n'est pas\/} ferm{\'e}.}
  \reponse{Le sens $H$ est ferm{\'e} $ \Rightarrow $ $E\setminus H$ n'est pas connexe (par arcs) est {\'e}vident.
