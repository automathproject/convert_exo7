...
\contenu{
  \texte{}
  \question{Soit $(u_n)$ une suite réelle non majorée. Montrer qu'il existe une suite extraite de $(u_n)$ tendant vers $+\infty$.}
  \reponse{La suite $u$ n'est pas majorée. Donc, $\forall M\in\Rr,\;\exists n\in\Nn/\;u_n> M$. En particulier, $\exists n_0\in\Nn/\;u_{n_0}\geq0$.
