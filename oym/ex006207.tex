...
\organisation{exo7}
\contenu{
  \texte{Soit $K$ un compact convexe d'un evn $E$. Soit $u$ une application linéaire
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Remarquons tout d'abord que si $0\in K$, l'application $u$ (linéaire) admet
...
combinaison convexe de ces $n$ points de $K$.}
  \item \reponse{Soit $x\in K$. Par 1., $S_{n_1}\circ\cdots\circ S_{n_k}(x)\in K$ et s'écrit
...
l'image de $K$ par $S_{n_1}\circ\cdots\circ S_{n_k}$ et ne peut être vide.}
  \item \reponse{Soit $a\in A$; pour tout $n$ il existe $x_n\in K$ tel que $a=S_n(x_n)$.
