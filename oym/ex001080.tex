...
\organisation{exo7}
\contenu{
  \texte{Soient $(x_n)_{n \in \N}$ et  $(y_n)_{n \in \N}$
...
\begin{enumerate}
  ...
  \begin{pmatrix}
    -9&-18\\6&12
  \end{pmatrix}$}
  \item \reponse{$U_n=A^nU_0$}
  \item \reponse{C'est la droite engendrée par $
  \begin{pmatrix}
    -2\\1
  ...
  \begin{pmatrix}
    -3\\2
  \end{pmatrix}$.}
  \item \reponse{Ce sont deux vecteurs non colinéaires. On a
$$P^{-1}AP=D=
\begin{pmatrix}
  3&0\\0&0
\end{pmatrix}$$}
  \item \reponse{On a $A=PDP^{-1}$ donc $A^n=PD^nP^{-1}=
  \begin{pmatrix}
   -3^{n+1} & -2\cdot 3^{n+1} \\
