\uuid{DVQP}
\exo7id{4756}
\titre{ENS Lyon MP 2002}
\theme{Exercices de Michel Quercia, Topologie dans les espaces vectoriels normés}
\auteur{quercia}
\date{2010/03/16}
\organisation{exo7}
\contenu{
  \texte{Soit $E$ un espace vectoriel norm{\'e} sur $\R$ ou $\C$ de dimension finie,
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $(e_1,\dots,e_p)$ une base de~$E$. On remplace la norme sur $E$
         par la norme infinie associ{\'e}e {\`a} $(e_1,\dots,e_p)$. Alors
         $\|\hskip-1pt|u^n\|\hskip-1pt| \le \sum_{i=1}^p\|u^n(e_i)\|$.}
  \item \reponse{Trigonaliser fortement $u$ (ou son prolongement au complexifi{\'e} de~$E$).
