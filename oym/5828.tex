...
\contenu{
  \texte{}
  \question{Former l'équation de la surface de révolution $(\mathcal{S})$ engendrée par la rotation de la droite $(\mathcal{D})$ $\left\{
\begin{array}{l}
x=z+2\\
y=2z+1
\end{array}
\right.$ autour de la droite $(\Delta)$ d'équations $x = y = z$. Quelle surface obtient-on ?}
  \reponse{Soit $A(a,b,c)$ un point quelconque de l'espace $E_3$.
