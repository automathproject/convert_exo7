\uuid{IgmA}
\exo7id{5092}
\titre{** Mines de DOUAI 1984}
\theme{Trigonométrie hyperbolique}
\auteur{rouget}
\date{2010/06/30}
\organisation{exo7}
\contenu{
  \texte{On considère la fonction numérique $f$ telle que~:
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$f$ est définie et dérivable sur $\mathcal{D}=\Rr\setminus\{\frac{1}{2}\}$.}
  \item \reponse{Pour $x$ élément de $\mathcal{D}$,
...
$g(x)=\Arctan\frac{1}{2x-1}-\frac{1}{2x}\frac{x^2-1}{2x^2-2x+1}$.}
  \item \reponse{Pour $x$ élément de $\mathcal{D}\setminus\{0\}$,
