...
\exo7id{2597}
\titre{Exercice 2597}
\theme{Sujets de l'année 2006-2007, Examen}
\auteur{delaunay}
\date{2009/05/19}
\organisation{exo7}
\contenu{
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{{\it Factorisons le polyn\^ome caract\'eristique de $A$}.
...
&=-X^3+3X^2-3X+1=(1-X)^3\end{align*}$$}
  \item \reponse{{\it D\'eterminons les sous-espaces propres et caract\'eristiques de $A$}.
...
$$\exp tB=e^t\begin{pmatrix}1&t&t^2/2 \\ 0&1&t \\ 0&0&1\end{pmatrix}.$$}
  \item \reponse{{\it Donnons les solutions des syst\`emes diff\'erentiels $Y'=BY$ et $X'=AX$.}
