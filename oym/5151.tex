...
\contenu{
  \texte{}
  \question{Soient $a$, $b$ et $c$ trois réels positifs. Montrer que l'un au moins des trois réels $a(1-b)$, $b(1-c)$, $c(1-a)$ est
inférieur ou égal à $\frac{1}{4}$.}
  \reponse{Si l'un des réels $a$, $b$ ou $c$ est strictement plus grand que $1$, alors l'un au moins des
