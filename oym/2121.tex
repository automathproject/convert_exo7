...
\contenu{
  \texte{}
  \question{Montrer que dans un groupe $G$, toute partie non vide finie stable par la
...
pr\'ec\'edente dans le cas d'une partie infinie.}
  \reponse{Soit $H$ une partie finie non vide de $G$ stable par la loi de composition. Pour montrer que
