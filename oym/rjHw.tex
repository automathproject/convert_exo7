...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $n\in\Nn^*$. Puisque $a$ est dans $]0,\pi[$ alors, pour tout entier naturel non nul $k$, $\frac{a}{2^k}$ est dans $]0,\pi[$ et donc
...
\end{center}}
  \item \reponse{$\forall k\in\Nn^*,\;\cos\left(\frac{a}{2^k}\right)>0$ car $\frac{a}{2^k}$ est dans $]0,\frac{\pi}{2}[$. Puis
