...
\organisation{exo7}
\contenu{
  \texte{Soit $\mathcal{S}$ la surface d'équation $x^4-x^3+xy-y^2-z=0$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Pour $(x,y)\in\Rr^2$, posons $f(x,y)=x^4-x^3+xy-y^2$ puis pour $(x,y,z)\in\Rr^3$, posons $g(x,y,z)=z-f(x,y)$. $\mathcal{S}$ est la surface d'équation $z=f(x,y)$ ou encore $g(x,y,z)=0$.
...
On obtient ainsi les trois points $O(0,0,0)$, $A\left( \frac{1}{2}, \frac{1}{4},0\right)$ et $B\left( \frac{1}{4}, \frac{1}{8}, \frac{1}{256}\right)$.}
  \item \reponse{La fonction $f$ est de classe $C^2$ sur $\Rr^2$ et
...
\textbullet~En $B$, le plan tangent est le plan d'équation $z= \frac{1}{256}$. De plus, $(rt-s^2)\left( \frac{1}{4}, \frac{1}{8}\right)= \frac{1}{2}>0$. Donc la surface $\mathcal{S}$ a une disposition en ballon au point $B$.}
  \item \reponse{Il s'agit maintenant d'étudier le signe de $z=f(x,y)=x^4-x^3+xy-y^2$ sur $\Rr^2$.
