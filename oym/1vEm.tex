...
\organisation{exo7}
\contenu{
  \texte{Soit $f:\R^2\rightarrow \R$ la fonction
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$f(x,y)=(x^2+y^2)^x= \mathrm e^{x \log (x^2+y^2)}=
...
car la fonction exponentielle est continue.}
  \item \reponse{Dans $\R^2 \setminus \{(0,0)\}$ les d\'eriv\'ees partielles
...
\end{align*}}
  \item \reponse{Pour que la d\'eriv\'ee partielle
