...
\contenu{
  \texte{}
  \question{On veut montrer de manière élémentaire (c'est-à-dire en se passant du logarithme népérien et en ne travaillant qu'avec
...
$\frac{1}{2}$.}
  \reponse{Pour $n\in\Nn^*$, $(1+\frac{1}{n})^n=\sum_{k=0}^{n}\frac{C_n^k}{n^k}$. Pour $k\in\{0,...,n\}$,
