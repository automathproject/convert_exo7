\uuid{U915}
\exo7id{7867}
\titre{Groupe non abélien d'ordre $8$}
\theme{Exercices de Christophe Mourougane, Algèbre}
\auteur{mourougane}
\date{2021/08/11}
\organisation{exo7}
\contenu{
  \texte{Soit $G$ un groupe d'ordre $8$.}
\begin{enumerate}
...
Déterminer un isomorphisme de $G$ avec un groupe connu.}
  \item \question{On suppose que $G$ admet un élément $a$ d'ordre $4$. Soit $b$ un élément hors du sous-groupe engendré par $a$. Montrer que $<a>$ est distingué et que $b^2$ appartient à $<a>$.
\begin{enumerate}}
