...
\organisation{exo7}
\contenu{
  \texte{$(E,||.||)$ un espace vectoriel norm\'e.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{On note $B= B(a,r)$, $B'=B'(a,r)$, $\bar B = \overline{B(a,r)}$.
...
D'autre part $y\in B = B(a,r)$ car $\| y-a \| = \| x-a-\frac{\epsilon}{2}\frac{x-a}{\|x-a\|}\| = \|x-a\| (1-\frac{\epsilon}{2\|x-a\|}) = r -\frac{\epsilon}{2} <r$. Donc $y\in B\cap B(x,\epsilon)$, ce qui prouve que $B'\cap \bar B$. Donc $B' = \bar B$.}
  \item \reponse{Pour le sens $\Leftarrow$. Soit $x \in \bar B(a,r)$ alors $\| x-b\|= 
