...
\contenu{
  \texte{}
  \question{Soit $P_n^k$ le nombre de partitions d'un ensemble à $n$ éléments en $k$ classes.
...
Calculer en fonction de $P_n^k$ le nombre de surjections d'un ensemble à $n$ éléments sur un ensemble à $p$ éléments.}
  \reponse{Soient $n$ et $k$ des entiers naturels tels que $2\leq k\leq n-1$.
