...
\contenu{
  \texte{}
  \question{On appelle idéal bilatère de l'anneau $(\mathcal{M}_n(\Kk),+,\times)$ tout sous-ensemble I de $\mathcal{M}_n(\Kk)$ tel que
...
Déterminer tous les idéaux bilatères de l'anneau $(\mathcal{M}_n(\Kk),+,\times)$.}
  \reponse{$\{0\}$ est un idéal bilatère de l'anneau $\mathcal{M}_n(\Kk),+,\times)$.
