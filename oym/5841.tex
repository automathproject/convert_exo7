...
\contenu{
  \texte{}
  \question{Soit $E = C^2([0,1],\Rr)$. Pour $f$ élément de $E$, on pose $N(f) =\int_{0}^{1}|f(t)|\;dt$, $N'(f) = |f(0)| +\int_{0}^{1}|f'(t)|\;dt$ et

$N''(f) =|f(0)|+|f'(0)|+\int_{0}^{1}|f''(t)|\;dt$. Montrer que $N$, $N'$ et $N''$ sont des normes et les comparer.}
  \reponse{\textbullet~Il est connu que $N$ est une norme sur $E$.
