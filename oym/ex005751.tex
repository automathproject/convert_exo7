...
\contenu{
  \texte{}
  \question{Pour $n\in\Nn$, on pose $W_n=\int_{0}^{\pi/2}\cos^nt\;dt$. Rayon de convergence et somme de la série entière associée à la suite $(W_n)_{n\in\Nn}$.}
  \reponse{On a déjà vu que $W_n\underset{n\rightarrow+\infty}{\sim}\sqrt{\frac{\pi}{2n}}$ et la règle de d'\textsc{Alembert} fournit $R = 1$. Soit $x\in]-1,1[$.
