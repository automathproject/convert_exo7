...
\organisation{exo7}
\contenu{
  \texte{Le plan est rapporté à un repère orthonormé $\mathcal{R}=\left(0,\overrightarrow{i},\overrightarrow{j}\right)$.
...
\begin{enumerate}
  ...
  \item \reponse{$y=x^2+x+1\Leftrightarrow y=\left(x+\frac{1}{2}\right)^2+\frac{3}{4}\Leftrightarrow\left(y-\frac{3}{4}\right)=\left(x+\frac{1}{2}\right)^2$.
...
$y=\frac{3}{4}-\frac{1}{4}=\frac{1}{2}$.}
  \item \reponse{$y^2+y-2x=0\Leftrightarrow\left(y+\frac{1}{2}\right)^2-\frac{1}{4}-2x=0\Leftrightarrow\left(y+\frac{1}{2}\right)^2=2\left(x+\frac{1}{8}\right)$.
...
$x=-\frac{1}{8}-\frac{1}{2}=-\frac{5}{8}$.}
  \item \reponse{$y=\sqrt{2x+3}\Leftrightarrow y^2=2\left(x+\frac{3}{2}\right)\;\mbox{et}\;y\geq0$. $\mathcal{C}$ est une demi-parabole de sommet
