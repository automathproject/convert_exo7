\uuid{680}
\titre{Exercice 680}
\theme{Fonctions continues, Etude de fonctions}
\auteur{ridde}
\date{1999/11/01}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Soit $f : \Rr \rightarrow \Rr$ continue en $0$ telle que pour chaque $x \in \Rr$,
$f(x) = f(2x)$. Montrer que $f$ est constante.}
  \reponse{Fixons $x\in \Rr$ et soit $y = x/2$, comme $f(y) = f(2y)$ nous obtenons $f(\frac 12 x) = f(x)$. Puis en prenant $y = \frac 14 x$, nous obtenons
