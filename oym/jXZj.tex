...
\organisation{exo7}
\contenu{
  \texte{Soit $F=\frac{P}{Q}$ une fraction rationnelle écrite sous forme irréductible. 
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Posons $G=\frac{A}{B}$ et $F = \frac{P}{Q}$ (avec $A,B,P,Q$ des polynômes).
...
donc $P$ divise $(a_0-b_0X)$.}
  \item \reponse{Supposons de plus qu'on a écrit $G=\frac{A}{B}$ sous forme irréductible, 
...
Notez que $a$ et $b$ ne sont pas tous les deux nuls en même temps (de même pour $b$ et $d$).}
  \item \reponse{Si $Y = \frac{aX+b}{cX+d}$ avec $(a,b) \neq (0,0)$,
