...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $a\in\Cc$. Soient $(\lambda,\mu)\in\Cc^2$ et $(P,Q)\in E^2$.
...
Donc, $\varphi_a$ est une forme linéaire sur $E$.}
  \item \reponse{On a déjà $\text{card}\left(\varphi_{a_j}\right)_{0\leqslant j\leqslant n}=n+1=\text{dim}(E)=\text{dim}(E^*)<+\infty$. Il suffit donc de vérifier que la famille $\left(\varphi_{a_j}\right)_{0\leqslant j\leqslant n}$ est libre.
