...
\organisation{exo7}
\contenu{
  \texte{La suite de Fibonacci $0,1,1,2,3,5,8,13,...$ est la suite $(F_n)_{n\geq 0}$ d\'efinie par la relation de r\'ecurrence $F_{n+1}=F_{n}+F_{n-1}$ pour $n\geq1$, avec $F_0=0$ et $F_1=1$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{{\it D\'eterminons une matrice $A\in M_2(\R)$ telle que, pour tout $n\geq1$,
$$\begin{pmatrix}F_{n+1} \\  F_n\end{pmatrix}=A^n\begin{pmatrix}F_{1} \\  F_0\end{pmatrix}.$$}
...
d'o\`u le r\'esultat.}
  \item \reponse{{\it Montrons que $A$ admet deux valeurs propres r\'eelles distinctes que l'on note $\lambda_1$ et $\lambda_2$ avec $\lambda_1<\lambda_2$.}
...
$$\lambda_1={\frac{1-\sqrt{5}}{2}}<\lambda_2={\frac{1+\sqrt{5}}{2}}.$$}
  \item \reponse{{\it Trouvons des vecteurs propres $\varepsilon_1$ et $\varepsilon_2$ associ\'es aux valeurs propres $\lambda_1$ et $\lambda_2$, sous la forme 
$\displaystyle\begin{pmatrix}\alpha \\  1\end{pmatrix}$, avec $\alpha\in\R$.}
...
$\displaystyle \varepsilon_2=\begin{pmatrix}\lambda_2 \\ 1\end{pmatrix}$}
  \item \reponse{{\it D\'eterminons les coordonn\'ees du vecteur $\displaystyle\begin{pmatrix}F_1 \\  F_0\end{pmatrix}$ dans la base 
$(\varepsilon_1,\varepsilon_2)$, on les note $x_1$ et $x_2$.}
...
x_2&=-{\frac{1}{\lambda_1-\lambda_2}}={\frac{1}{\sqrt{5}}}\end{align*}\right.$$}
  \item \reponse{{\it Montrons que $\displaystyle\begin{pmatrix}F_{n+1} \\  F_n\end{pmatrix}
...
d'o\`u le r\'esultat
$$F_n={\frac{\lambda_1^n}{\lambda_1-\lambda_2}}-{\frac{\lambda_2^n}{\lambda_1-\lambda_2}}\ .$$}
  \item \reponse{{\it Donnons un \'equivalent de $F_n$ lorsque $n$ tend vers $+\infty$.}
