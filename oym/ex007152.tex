...
\contenu{
  \texte{}
  \question{Soit $ABCD$ un carré direct de côté $1$, et soient $E$  et $F$ deux points tels que $AEFD$ soit un rectangle direct, avec $AE > 1$. Dans la suite on note $l=AE$.
...
Montrer que qu'il existe une similitude directe $s$ envoyant $A$ (resp. $E$, $F$ et $D$) sur $C$ (resp.  $B$, $E$ et $F$) ssi $l$ est égal au nombre d'or $(1+\sqrt 5)/2$.}
  \reponse{Il existe une unique similitude directe $s$ qui envoie $[AE]$ sur $[CB]$. Son rapport est $1/l$ et son angle $-\pi/2$.
