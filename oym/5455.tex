...
\contenu{
  \texte{}
  \question{Soit $f$ continue sur $[0,1]$ telle que $\int_{0}^{1}f(t)\;dt=\frac{1}{2}$. Montrer que $f$ admet un point fixe.}
  \reponse{Soit, pour $x\in[0,1]$, $g(x)=f(x)-x$. g est continue sur $[0,1]$ et 
