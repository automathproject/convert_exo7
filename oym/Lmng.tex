...
\exo7id{6028}
\titre{Exercice 6028}
\theme{Estimation et intervalle de confiance}
\auteur{quinio}
\date{2011/05/20}
\organisation{exo7}
\contenu{
  \texte{Le staff médical d'une grande entreprise fait ses
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{On obtient, sur l'échantillon, la moyenne $m_{e}=214$, l'écart-type $\sigma _{e}=55.77$.}
  \item \reponse{La moyenne sur l'entreprise est estimée par $m_{e}$.
L'écart-type est estimé par: $\widehat{\sigma _{e}}=\sqrt{\frac{100}{99}}55.77\simeq 56.05$.}
  \item \reponse{On en déduit, au seuil 95\%, un intervalle de confiance pour la
moyenne :
