...
\organisation{exo7}
\contenu{
  \texte{Soit~$(a_n)_{n\in\N}$ la suite définie par $a_0=1$ et $a_n =
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Pour $0\le t\le 1$ on a $t(1-t)(n-1)! \le t(1-t)\dots(n-t)\le n!$
    d'où $\frac1{6n}\le|a_n|\le1$ et $R=1$.}
  \item \reponse{$(-1)^na_n= \int_{t=0}^1t(1-t)(1-t/2)\dots(1-t/n)\,d t$.
