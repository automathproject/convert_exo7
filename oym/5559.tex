...
\contenu{
  \texte{}
  \question{Maximum du produit des distances aux cotés d'un triangle $ABC$ du plan d'un point $M$ intérieur à ce triangle (on admettra que ce maximum existe).}
  \reponse{Soit $M$ un point intérieur au triangle $ABC$. On pose $a=BC$, $b=CA$ et $c=AB$. On note $x$, $y$, $z$ et $\mathcal{A}$ les aires respectives des triangles $MBC$, $MCA$, $MAB$ et $ABC$.
On a
