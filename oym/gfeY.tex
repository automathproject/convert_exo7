...
de degr\'e $2$, $3$ \`a coefficients dans le corps $\mathbb{F}_3=\Zz/3\Zz$.}
  \item \question{D\'ecomposer les polyn\^omes suivants en facteurs irr\'eductibles dans 
$\mathbb{F}_3[x]$.
$$
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{On raisonne exactement comme pour l'exercice \ref{exoprec}. On peut
