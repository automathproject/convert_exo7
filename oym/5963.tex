\uuid{5963}
\titre{Exercice 5963}
\theme{Théorème de Fubini-Tonelli et convolutions , Produit de convolution}
\auteur{tumpach}
\date{2010/11/11}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Calculer la transform\'ee de Fourier de la gaussienne d\'efinie,
pour $x\in\mathbb{R}^n$, par $f(x) = e^{-\frac{a |x|^2}{2}}$, o\`u
$a>0$.}
  \reponse{Supposons tout d'abord $n=1$. Soit la gaussienne d\'efinie pour
