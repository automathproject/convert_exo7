...
\contenu{
  \texte{}
  \question{Soit $0<a<b$. Etude complète de la fonction $f(x)=\left(\frac{a^x+b^x}{2}\right)^{1/x}$.}
  \reponse{Puisque $a>0$, $b>0$ et que pour tout réel $x$, $\frac{a^x+b^x}{2}>0$, $f$ est définie sur $\Rr^*$, et pour
