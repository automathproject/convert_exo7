...
\contenu{
  \texte{}
  \question{Soit $u_n$ l'unique racine positive de l'équation $x^n+x-1=0$. Etudier la suite $(u_n)$.}
  \reponse{Pour $n$ naturel non nul et $x$ réel positif, posons $f_n(x)=x^n+x-1$.
