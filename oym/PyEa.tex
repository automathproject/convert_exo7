...
\theme{Développements limités, Equivalents}
\auteur{quercia}
\date{2010/03/11}
\organisation{exo7}
\contenu{
  \texte{Donner des équivalents simples pour les fonctions suivantes :}
\begin{enumerate}
...
donc $$\sqrt{x^2+1} -2\sqrt[3]{x^3+x} + \sqrt[4]{x^4+x^2} \sim \frac 1{12x}.$$}
  \item \reponse{Il faut distinguer les cas $x>0$ et $x<0$ pour trouver :
