...
\organisation{exo7}
\contenu{
  \texte{On veut calculer $\cos\frac{2\pi}{5}$ et $\sin\frac{2\pi}{5}$. Pour cela, on pose
...
$$z^2+z^3=e^{4i\pi/5}+e^{6i\pi/5}=e^{4i\pi/5}+e^{-4i\pi/5}=2\cos\frac{4\pi}{5}=b.$$}
  \item \reponse{Puisque $z\neq1$ et $z^5=e^{2i\pi}=1$,

$$1+z+z^2+z^3+z^4=\frac{1-z^5}{1-z}=\frac{1-1}{1-z}=0.$$}
  \item \reponse{$a+b=z+z^2+z^3+z^4=-1$ et $ab=(z+z^4)(z^2+z^3)=z^3+z^4+z^6+z^7=z+z^2+z^3+z^4=-1$. Donc,
