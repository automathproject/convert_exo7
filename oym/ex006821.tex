...
\organisation{exo7}
\contenu{
  \texte{Soit $f:O \subset \Rr^3 \to \Rr$ une fonction de classe
$C^1$ sur l'ouvert $O$ et $(x_o,y_o,z_o) \in O$ tel que
$f(x_o,y_o,z_o) = 0$.}
\begin{enumerate}
  \item \question{Donner une condition suffisante pour
...
Justifier votre réponse.}
  \item \question{Si la condition donnée en 1. est satisfaite,
