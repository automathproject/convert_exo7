...
\organisation{exo7}
\contenu{
  \texte{Démontrer les identités suivantes, en précisant à chaque fois leur domaine de validité~:}
\begin{enumerate}
...
=\Im(e^{ix}(j^2+1+j))=0.$$}
  \item \reponse{$\tan\left(\frac{\pi}{4}-x\right)$, $\tan\left(\frac{\pi}{4}+x\right)$ et $\frac{2}{\cos(2x)}$ existent si et seulement si
