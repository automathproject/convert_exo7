...
\contenu{
  \texte{}
  \question{Montrer que le polyn\^ome $P_n$ d\'efini par
...
est un polyn\^ome de degr\'e $n$ dont les racines sont
 r\'eelles, simples, et appartiennent \`a $[-1,1]$.}
  \reponse{$Q_n(t) = (1-t^2)^n$ est un polyn\^ome de degr\'e $2n$, on le d\'erive $n$ fois, on obtient un polyn\^ome de degr\'e $n$.
