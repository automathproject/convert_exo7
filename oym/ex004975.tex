\uuid{4975}
\titre{Sphère définie par ses intersections}
\theme{}
\auteur{quercia}
\date{2010/03/17}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Soit $S$ une partie de l'espace contenant au moins deux points et telle
que pour tout plan $P$, $P\cap S$ est un cercle, un singleton ou vide.
Montrer que $S$ est une sphère.}
  \reponse{Soient $A,B$ deux points de $S$ distincts. Intersection de $S$ avec
