...
\organisation{exo7}
\contenu{
  \texte{Soit $  G  $ un groupe ; on note $  D(G)  $ le
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Il faut montrer que pour $x\in G$ et $y\in D(G)$, $xyx^{-1} \in D(G)$.
...
sous-groupe distingu\'e de $G$.}
  \item \reponse{Soit $\alpha,\beta \in G/D(G)$, alors il existe
...
\begin{itemize}}
  \item \reponse{[$\bullet$] Si $D(G) \subset H$ alors $G/D(G)$ est un sous-groupe de $G/H$ donc
$G/H$ est commutatif car $G/D(G)$ l'est.}
  \item \reponse{[$\bullet$] Si $G/H$ est commutatif alors pour $g,h \in G$
