...
\contenu{
  \texte{}
  \question{Soit $\alpha \in  K$, et $A,B \in \mathcal{M}_n(K)$. \'Etudier l'équation d'inconnue
$X \in \mathcal{M}_n(K)$ : $\alpha X + (\mathrm{tr} X)A = B$.}
  \reponse{$(\alpha + \mathrm{tr} A)\mathrm{tr} X = \mathrm{tr} B$.
