...
\contenu{
  \texte{}
  \question{Calculer $a_n=\prod_{k=1}^{n}\sin\frac{k\pi}{n}$, $b_n=\prod_{k=1}^{n}\cos(a+\frac{k\pi}{n})$ et $c_n=\prod_{k=1}^{n}\tan(a+\frac{k\pi}{n})$ en éliminant tous les cas particuliers concernant $a$.}
