...
\contenu{
  \texte{}
  \question{Existence, unicité et calcul de $a$ et $b$ tels que $\int_{0}^{1}(x^4-ax-b)^2\;dx$ soit minimum (trouver deux démonstrations, une dans la mentalité du lycée et une dans la mentalité maths sup).}
  \reponse{\textbf{1ère solution.}
