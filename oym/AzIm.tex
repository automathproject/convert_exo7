...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Pour $f\in {\cal F}$, par le théorème des accroissements finis, 
...
$\mathcal{F}$ est équicontinue.}
  ...
  \item \reponse{Notons $\mathcal{H} = \{ f_n \mid n\in \Nn \}$.
...
Donc en posant $\eta = \frac\epsilon L$ comme ci-dessus on prouve l'équicontinuité de $\mathcal{H}$ en $x_0$, puis partout.}
  \item \reponse{Notons $\mathcal{H}(x) = \{ f_n(x) \mid n\in \Nn \}$.
Alors par hypothèse, 
...
$\mathcal{H}(x)$ est relativement compact.}
  \item \reponse{Comme $\Rr^n$ n'est pas compact on ne peut pas appliquer directement le théorème d'Ascoli.
...
Donc de la suite $({f_n}_{|B_R})_n$ on peut extraire une sous-suite convergente (sur $B_R$).}
  \item \reponse{Pour $R=1$ nous extrayons de $(f_n)_n$ une sous-suite $(f_{\phi_1(n)})_n$ qui converge sur $B_1$.
