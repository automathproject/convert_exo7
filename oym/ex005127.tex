...
\contenu{
  \texte{}
  \question{Déterminer les complexes $z$ tels que $z$, $\frac{1}{z}$ et $z-1$ aient même module.}
  \reponse{Soient $z$ un complexe non nul, $M$ le point d'affixe $z$ et $A$ le point d'affixe $1$.
