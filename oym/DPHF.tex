...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$\mbox{rg}u=\mbox{rg}(u(i),u(j),u(k))=rg(u(j),u(k),u(i))$. La matrice de cette dernière famille dans la base $(i,j,k)$ est $\left(
\begin{array}{ccc}
1&0&0\\
0&1&0\\
-3&3&1
...
\end{array}
\right).$$}
  \item \reponse{(Questions 2) et 3)). Posons $e_1=xi+yj+zk$ ($e_1$, $e_2$ et $e_3$ désignent d'autres vecteurs que ceux du 1)).
...
\end{array}
\right).$$}
  \item \reponse{Voir question précédente.}
  \item \reponse{Soit $T$ est la matrice de $u$ dans la base $(e_1,e_2,e_3)$. $T=
\left(
\begin{array}{ccc}
1&1&0\\
0&1&1\\
