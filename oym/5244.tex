...
\contenu{
  \texte{}
  \question{Donner un exemple de suite $(u_n)$ divergente, telle que $\forall k\in\Nn^*\setminus\{1\}$, la suite $(u_{kn})$ converge.}
  \reponse{On pose $u_0=0$, $u_1=0$, $u_2=1$, $u_3=1$, $u_4=0$, $u_5=1$,... c'est-à-dire 
