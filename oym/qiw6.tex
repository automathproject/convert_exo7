...
\organisation{exo7}
\contenu{
  \texte{Dans $\Rr^3$, espace vectoriel euclidien orienté rapporté à la base orthonormée directe $(i,j,k)$, déterminer l'image du plan d'équation $x+y=0$ par}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $s$ la symétrie orthogonale par rapport au plan $P'$ d'équation $x-y+z=0$. $s(P)$ est le plan de vecteur normal $s(n)$. 
...
\end{center}}
  \item \reponse{Notons $\sigma$ la symétrie orthogonale par rapport au vecteur $u=(1,1,1)$. $\sigma(P)$ est le plan de vecteur normal 
...
\end{center}}
  \item \reponse{Notons $r$ la rotation d'angle $\frac{\pi}{4}$ autour du vecteur unitaire $u=\frac{1}{\sqrt{3}}(1,1,1)$. $r(P)$ est le plan de vecteur normal 
