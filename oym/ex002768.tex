...
\begin{enumerate}
  ...
  \item \reponse{\textbf{Par substitution.} La première équation s'écrit aussi $y=1-2x$.
...
N'oubliez pas de vérifier que votre solution fonctionne !}
  \item \reponse{\textbf{Par le pivot de Gauss.} On garde la ligne $L_1$ et on remplace la ligne 
$L_2$ par $2L_2-3L_1$ :
$$
\left\{\begin{array}{ccccc}2x & + & y & = & 1\\ 3x & + & 7y & = & -2  \end{array}\right.
\iff 
...
$x=\frac{9}{11}$.}
  \item \reponse{\textbf{Par les matrices.} En terme matriciel le système s'écrit
...
X = A^{-1} \begin{pmatrix} 1 \\ -2 \end{pmatrix} =  \frac{1}{11}\begin{pmatrix} 9 \\ -7 \end{pmatrix}$$}
  \item \reponse{\textbf{Par les formules de Cramer.}
