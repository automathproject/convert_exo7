...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Posons $g=f'+\alpha f$. La fonction $g$ est continue sur $\Rr$ et la fonction $f$ est solution sur $\Rr$ de l'équation différentielle $y'+\alpha y=g$. De plus, $\lim_{x \rightarrow +\infty}g(x)=\ell$. Ensuite,
...
\end{center}}
  \item \reponse{$f''+f'+f=\left(f'-jf\right)'-j^2\left(f'-jf\right)$. D'après 1), comme $\text{Re}(-j^2)=\text{Re}(-j)= \frac{1}{2}>0$,
...
\end{center}}
  \item \reponse{Montrons le résultat par récurrence sur $n$.
