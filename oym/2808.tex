\uuid{2808}
\titre{Exercice 2808}
\theme{Intégrales, Changements de coordonnées}
\auteur{burnol}
\date{2009/12/15}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Il est intéressant que l'équation de l'exercice précédent
...
$\frac{\partial
 ...
 b}{\partial y}$ pour $a+ib = g(x+iy)$.}
  \reponse{On a $w=g(z)$ avec $g(z)=a(z)+ib(z)$ une fonction holomorphe et avec $z=x+iy$. Utilisons de nouveau le changement
de coordonn\'ees:
