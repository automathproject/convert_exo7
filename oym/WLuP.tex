...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $(i,j)\in\{1,...,p\}\times\{1,...,r\}$. Le coefficient ligne $i$, colonne $j$, de la matrice $M+N$ est la somme du coefficient ligne $i$, colonne $j$, de la matrice $M$ et du coefficient ligne $i$, colonne $j$, de la matrice $N$ ou encore la somme du coefficient ligne $i$, colonne $j$, de la matrice $A$ et du coefficient ligne $i$, colonne $j$, de la matrice $A'$. On a des résultats analogues pour les autres valeurs du couple $(i,j)$ et donc
