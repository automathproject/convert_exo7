...
\organisation{exo7}
\contenu{
  \texte{Soit $E$ un espace norm\'e. Si $A$ et $B$ sont deux parties de $E$, on note
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Pour montrer que $A+B$ est fermé, nous allons montrer que toute suite de $A+B$ qui converge, converge vers un élément de $A+B$. Soit $(x_n)$ un suite
...
Maintenant $x = a+b$ donc $x\in A+B$.}
  \item \reponse{Soit $F = \{ (x,y)\in \Rr^2 \mid xy\ge 1 \text{ et } x \ge 0\}$ , soit
