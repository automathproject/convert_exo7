...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Pour montrer que $||Df(x)||_{{\cal L}(\Rr^n,\Rr)}\leq 1$,
...
$$|Df(x)(x-y)| \geq ||x-y||$$ d'o\`u la deuxi\`eme inégalité.}
  \item \reponse{Raisonnons par l'absurde. Supposons qu'il existe deux point
