...
\organisation{exo7}
\contenu{
  \texte{Soit $f(x) =\sum_{n=1}^{+\infty}\frac{x^n\sin(nx)}{n}$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Pour $x\in]-1,1[$ et $n$ entier naturel non nul, posons $f_n(x)=\frac{x^n\sin(nx)}{n}$. 
...
\end{center}}
  \item \reponse{Ainsi, pour $x\in]-1,1[$
