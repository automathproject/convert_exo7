...
\organisation{exo7}
\contenu{
  \texte{Soit $f$ une application de $\Cc$ dans $\Cc$, $\Rr$-linéaire.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $f$ un endomorphisme du $\Rr$-espace vectoriel $\Cc$. Pour tout nombre complexe $z$
...
\end{center}}
  \item \reponse{Soient $z$ et $z'$ deux nombres complexes. On rappelle que
