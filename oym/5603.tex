...
\contenu{
  \texte{}
  \question{Rang de la matrice $\left(
\begin{array}{cccc}
...
\end{array}
\right)$.}
  \reponse{(C'est en fait un exercice sur les polynômes de \textsc{Tchebychev} de 1ère espèce et vous pouvez généraliser cet exercice en passant au format $n$ au lieu du format $4$.)
