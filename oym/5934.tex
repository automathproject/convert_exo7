\uuid{5934}
\titre{Exercice 5934}
\theme{Fonctions mesurables, intégrale de Lebesgue }
\auteur{tumpach}
\date{2010/11/11}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Soit $(\Omega, \Sigma, \mu)$ un espace mesur\'e et $f~:\Omega
...
est ($\Sigma$-$\mathcal{B}(\mathbb{R})$)-mesurable.}
  \reponse{Soit $(\Omega, \Sigma, \mu)$ un espace mesur\'e et $f~:\Omega
\rightarrow \mathbb{R}$ une fonction
