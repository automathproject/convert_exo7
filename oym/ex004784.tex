\uuid{4784}
\titre{Points isol{\'e}s (Ens Ulm MP$^*$ 2003)}
\theme{}
\auteur{quercia}
\date{2010/03/16}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Les solutions de l'{\'e}quation $u^2=\mathrm{id}_{\R^n}$ pour~$u\in\mathcal{L}({\R^n})$
sont-elles isol{\'e}es~?}
  \reponse{Oui pour $\pm\mathrm{id}_{\R^n}$, non pour les autres (les sym{\'e}tries non triviales).
