...
\contenu{
  \texte{}
  \question{Soient $n\in\Nn^*$ puis $\varphi_1$,..., $\varphi_n$ $n$ formes linéaires sur un $\Kk$-espace $E$ de dimension $n$.
...
Montrer que la famille $(\varphi_1,...,\varphi_n)$ est liée si et seulement si il existe un vecteur $x$ non nul tel que $\forall i\in\llbracket1,n\rrbracket,\;\varphi_i(x) = 0$.}
  \reponse{Soit $\begin{array}[t]{cccc}f~:&E&\rightarrow&\Kk^n\\
