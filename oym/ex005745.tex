...
\organisation{exo7}
\contenu{
  \texte{Déterminer le rayon de convergence de la série entière proposée dans chacun des cas suivants :}
\begin{enumerate}
...
\end{center}}
  \item \reponse{D'après la formule de \textsc{Stirling}
...
\end{center}}
  \item \reponse{Pour $n\in\Nn^*$, posons $a_n=\frac{C_{2n+2}^{n+1}}{(n+1)^{n+1}}$.
...
\end{center}}
  \item \reponse{On a vu que $\ln(n!)\underset{n\rightarrow+\infty}{\sim}n\ln n$. Donc la série entière proposée a même rayon de convergence que la série entière associée à la suite $\left(\frac{(n\ln n)^a}{n!^b}\right)$. Puis
...
\end{center}}
  \item \reponse{Si $a=0$, $R=+\infty$. On suppose $a\neq0$.
