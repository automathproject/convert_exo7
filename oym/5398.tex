...
\contenu{
  \texte{}
  \question{Soit $f$ continue sur $\Rr^+$ à valeurs dans $\Rr$ admettant une limite réelle quand $x$ tend vers $+\infty$. Montrer que $f$ est uniformément continue sur $\Rr^+$.}
  \reponse{Posons $\ell=\lim_{x\rightarrow +\infty}f(x)$.
