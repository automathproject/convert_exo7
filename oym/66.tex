...
\contenu{
  \texte{}
  \question{D\'eterminer par le calcul et g\'eom\'etriquement les nombres complexes $z$ tels
que $\Bigl\vert\frac{z-3}{z-5}\Bigr\vert= k$ ($k>0$, $k\neq1$).
G\'en\'eraliser pour $\Bigl\vert\frac{z-a}{z-b}\Bigr\vert=k$.}
  \reponse{M\'ethode analogue \`a celle de l'exercice \ref{exo:compl}. On trouve $z=
