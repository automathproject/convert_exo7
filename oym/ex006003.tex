...
\organisation{exo7}
\contenu{
  \texte{Dans l'ancienne formule du Loto il fallait choisir 6 numéros parmi 49.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Combien de grilles ?
Il y en a $\binom{49}{6}=13\,983\,816$}
  \item \reponse{Combien de grilles avec 2 nombres consécutifs ?
