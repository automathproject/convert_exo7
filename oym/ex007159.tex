\exo7id{7159}
\titre{Isométries d'un triangle équilatéral}
\theme{}
\auteur{megy}
\date{2017/05/13}
\organisation{exo7}
\contenu{
  \texte{Soit $\mathcal T=ABC$ un triangle équilatéral et $G=Isom(\mathcal T)$ son groupe d'isométries.}
\begin{enumerate}
