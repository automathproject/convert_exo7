...
\organisation{exo7}
\contenu{
  \texte{Soit une fonction $f$ de classe $\mathcal{C}^2$ sur le disque unité du plan, telle que son laplacien
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{On pose $g(r,\theta) = f(r\cos\theta,r\sin\theta)$,
