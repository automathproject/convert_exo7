...
\exo7id{5967}
\titre{Exercice 5967}
\theme{Intersections des $L^p$ et convergences, Convergences}
\auteur{tumpach}
\date{2010/11/11}
\organisation{exo7}
\contenu{
  \texte{Soit $\{f_{n}\}_{n\in\mathbb{N}}$ la suite de fonctions d\'efinies
par~:
$$
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Quelque soit $g$ continue \`a support compact,
$$
