\uuid{4978}
\titre{Composée de demi-tours par rapport aux arêtes d'un tétraèdre}
...
\contenu{
  \texte{}
  \question{Soit $ABCD$ un tétraèdre régulier, et $d_{AB},d_{AC},d_{AD}$ les $\frac12$-tours
autour des droites $(AB),(AC),(AD)$.
Simplifier $f = d_{AB} \circ d_{AC} \circ d_{AD}$.}
  \reponse{$d_{AD}(D) = D,\quad d_{AC}(D) = D'$ tq $\vec{AD'} = \vec{DC}$. \par
