...
\contenu{
  \texte{}
  \question{Soient $(u_n)$, $(v_n)$ et $(w_n)$ les suites définies par la donnée de $u_0$,
...
déduire $\lim_{n\rightarrow +\infty}u_n$, $\lim_{n\rightarrow +\infty}v_n$et $\lim_{n\rightarrow +\infty}w_n$.}
  \reponse{Pour tout entier naturel $n$, on a $u_{n+1}-v_{n+1}=-\frac{1}{2}(u_n-v_n)$  et donc, $u_n-v_n=\left(-\frac{1}{2}\right)^n(u_0-v_0)$.
