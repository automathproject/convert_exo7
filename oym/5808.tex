...
\contenu{
  \texte{}
  \question{Soit $Q$ une forme quadratique sur un $\Rr$-espace vectoriel $E$. On note $\varphi$ sa forme polaire.

On suppose que $\varphi$ est non dégénérée mais non définie. Montrer que $Q$ n'est pas de signe constant.}
  \reponse{Dans le cas où $E$ est de dimension finie, la signature de $Q$ permet de conclure immédiatement. Supposons donc que $E$ n'est pas de dimension fine.
