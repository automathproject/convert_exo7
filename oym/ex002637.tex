...
\organisation{exo7}
\contenu{
  \texte{Soit $g\colon\R_{>0}\times \R_{>0}\to \R$ une fonction
de classe $C^1$
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Un calcul imm\'ediat donne $\mathrm d u+\mathrm d v =\mathrm d g$.}
  \item \reponse{Par cons\'equent, $g=u+v+c$ o\`u la constante $c$ est d\'etermin\'ee par
la condition
\[
3=g(1,1)= u(1,1)+v(1,1)+c=1+1+c
\]
d'o\`u $c=1$.}
  \item \reponse{Un calcul direct montre que l'application r\'eciproque 
\[
...
\]}
  \item \reponse{$\mathrm d (g \circ k)=\mathrm d (u \circ k)+ \mathrm d (v \circ k)
=\mathrm d u +\mathrm d v$ car $u(k(u,v))=u$ et $v(k(u,v))=v$.}
  \item \reponse{Un calcul imm\'ediat donne 
