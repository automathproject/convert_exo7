...
\organisation{exo7}
\contenu{
  \texte{Les phrases suivantes sont-elles équivalentes~?}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Oui. Dans les deux cas, chaque fois que l'on se donne un réel $x_0$, $f(x_0)$ et $g(x_0)$ sont tous deux nuls.}
  \item \reponse{Non. La deuxième affirmation implique la première mais la première n'implique pas la deuxième. La première
