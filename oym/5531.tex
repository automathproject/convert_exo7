...
\contenu{
  \texte{}
  \question{Etude complète de la courbe d'équation polaire $r=\frac{2\cos\theta+1}{2\sin\theta+1}$.}
  \reponse{\textbf{Domaine d'étude.} Notons $D$ le domaine de définition de la fonction $r~:~\theta\mapsto\frac{2\cos\theta+1}{2\sin\theta+1}$.
