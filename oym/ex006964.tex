...
\contenu{
  \texte{}
  \question{Existe-t-il une fraction rationnelle $F$ telle que 
$$\big(F(X)\big)^2=(X^2+1)^3 \ \ ?$$}
  \reponse{\'Ecrivons $F(X)=\frac{P(X)}{Q(X)}$ avec $P$ et $Q$ deux polynômes premiers entre eux, avec $Q$ unitaire.
