...
\organisation{exo7}
\contenu{
  \texte{Soit $E$ et $F$ deux evn sur $\Cc$. Une application de $E$ dans
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Puisque $\Rr$ est un sous-corps de $\Cc$, il est clair que $\varphi$
...
pour $f_1$ et $f_3$, ne sont vérifiées qu'en $0$ pour $f_2$.}
  \item \reponse{La fonction $g :\Cc\to\Cc$ peut s'écrire $g_1+ig_2$ où
