...
\organisation{exo7}
\contenu{
  \texte{Soit $E = \mathcal{C}([a,b],\R)$ et $(a_n)$ une suite d'éléments de $[a,b]$.
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$(a_n)$ est partout dense.}
  \item \reponse{Si les $a_n$ sont distincts, on choisit pour tout~$n$
