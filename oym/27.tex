\uuid{27}
\titre{Exercice 27}
\theme{Nombres complexes, Racines carrées, équation du second degré}
\auteur{bodin}
\date{1998/09/01}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Calculer les racines carr\'ees de $1,\ i,\ 3+4i,\
8-6i,$ et $7+24i$.}
  \reponse{\textbf{Racines carr\'ees.} Soit $z= a+ib$ un nombre complexe avec
