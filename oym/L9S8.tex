\uuid{L9S8}
\exo7id{3483}
\titre{$\mathrm{rg}(BC)$, Centrale MP 2006}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$B$ admet $r$ lignes indépendantes d'indices $i_1,\dots,i_r$
  ...
  \item \reponse{Soient $i_1,\dots,i_r$ $r$ indices tels que les
  ...
  \item \reponse{Comprendre dans cette question que $B,C$ ne sont pas
