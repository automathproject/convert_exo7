...
\right)$ ($a$ réel donné). Calculer $\lim_{n \rightarrow +\infty}A_n^n$.}
  \reponse{Puisque $\left(\frac{1}{\sqrt{1+\frac{a^2}{n^2}}}\right)^2+\left(\frac{\frac{a}{n}}{\sqrt{1+\frac{a^2}{n^2}}}\right)^2=1$, il existe un unique réel $\theta_n\in[-\pi,\pi[$ tel que
