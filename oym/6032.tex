\uuid{6032}
\titre{Exercice 6032}
\theme{Tests et tests du khi deux}
\auteur{quinio}
\date{2011/05/20}
\organisation{exo7}
\contenu{
  \texte{}
  \question{On s'intéresse au problème des algues toxiques qui
...
avec le risque $\alpha =0.05$, le nombre de plages atteintes ?>>}
  \reponse{Posons $H_{0}$ <<les rejets chimiques ne modifient pas le
