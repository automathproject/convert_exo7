...
\contenu{
  \texte{}
  \question{Soient $(x_1,..,x_n)$ une famille de $n$ vecteurs de rang $r$ et $(x_1,...,x_m)$ une sous famille de rang $s$ ($m\leqslant n$ et $s\leqslant r$). Montrer que $s\geqslant r+m-n$. Cas d'égalité ?}
  \reponse{Si $m=n$, c'est immédiat.
