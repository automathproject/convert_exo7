...
\contenu{
  \texte{}
  \question{Un candidat se présente à un concours où, cette fois, les
...
et donner sa loi de probabilité, son espérance.}
  \reponse{Puisque les réponses sont données au hasard, chaque grille-réponses est en fait la 
