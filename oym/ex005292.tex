...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $n$ un entier relatif.
...
Enfin, $5n^3+n$ est divisible par $2$ et $3$ et donc par $2\times 3=6$. On a montré que~:~$\forall n\in\Zz,\;6|(5n^3+n)$. (Tout ceci s'exprime beaucoup mieux à l'aide de congruences. Par exemple~:~si $n\equiv1\;(3)$, $5n^2+1\equiv5.1^2+1=6\equiv0\;(3)$)}
  \item \reponse{$4^{2^n}$ signifie $(...((4^2)^2)^2...)^2$. Etudions la suite de ces élévations au carré successives modulo $7$. $4^{2^0}=4$ est dans $4+7\Zz$. $4^{2^1}=16$ est dans $2+7\Zz$. $4^{2^2}=16^2=(7k+2)^2=4+7k'$ est dans $4+7\Zz$...
