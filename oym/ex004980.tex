\uuid{4980}
\titre{Groupes d'isotropie}
\theme{}
\auteur{quercia}
\date{2010/03/17}
\organisation{exo7}
\contenu{
  \texte{Déterminer {\it toutes\/} les isométries}
\begin{enumerate}
...
\begin{enumerate}
  ...
  \item \reponse{si les droites ne sont pas perpendiculaires :
      \halign{ \hskip 5cm #\hfill&\quad(#)\cr
      identité &1\cr
