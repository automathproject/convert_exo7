...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$E=\mbox{Vect}(I,J)$. Donc, $E$ est un sous-espace vectoriel de $\mathcal{M}_2(\Rr)$. La famille $(I,J)$ est clairement libre et donc est une base de $E$. Par suite, $\mbox{dim}E=2$.}
  \item \reponse{$J^2=\left(
\begin{array}{cc}
1&1\\
0&1
\end{array}
...
$E$ contient $I=1.I+0.J$. $(E,+)$ est un sous-groupe de $(\mathcal{M}_2(\Rr),+)$ et, d'après $(*)$, $E$ est stable pour $\times$. Donc, $(E,+,\times)$ est un sous-anneau de $(\mathcal{M}_2(\Rr),+,\times)$.}
  \item \reponse{Soit $((x,y),(x',y'))\in(\Rr^2)^2$.
