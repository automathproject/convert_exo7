\uuid{8dkv}
\exo7id{5728}
\titre{*** I Polynômes de \textsc{Bernstein}. Théorème de \textsc{Weierstrass}}
\theme{Suites et séries de fonctions}
\auteur{rouget}
\date{2010/10/16}
\organisation{exo7}
\contenu{
  \texte{Soit $f$ une application continue sur $[0,1]$ à valeurs dans $\Rr$. Pour $n$ entier naturel non nul, on définit le $n$-ème polynôme de \textsc{Bernstein} associé à $f$ par 
...
ce qui reste vrai pour n = 1.}
  \item \reponse{D'après la question précédente
