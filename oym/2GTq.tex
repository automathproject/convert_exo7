...
\exo7id{77}
\titre{Exercice 77}
\theme{Nombres complexes, Géométrie}
\auteur{bodin}
\date{1998/09/01}
\organisation{exo7}
\contenu{
  \texte{Soit $(A_{0},A_{1},A_{2},A_{3},A_{4})$ un pentagone r\'egulier. On note $O$ son centre et on
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Comme $(A_{0},\ldots,A_{4})$ est un pentagone r\'egulier, on a
...
d\'eduit que $\cos(\frac{2\pi}{5})=\frac{\sqrt{5}-1}{4}$.}
  ...
  \item \reponse{$BI=|i/2+1|=\frac{\sqrt{5}}{2}$. $BJ=BI-1/2=\frac{\sqrt{5}-1}{2}$.}
  \item \reponse{Pour tracer un pentagone r\'egulier, on commence par tracer un
