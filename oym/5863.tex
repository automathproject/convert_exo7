...
\contenu{
  \texte{}
  \question{Pour $X=(x_i)_{1\leqslant i\leqslant n}\in\mathcal{M}_{n,1}(\Rr)$, on pose $\|X\|_2=\sqrt{\sum_{i=1}^{n}x_i^2}$. Pour $A\in\mathcal{S}_n(\Rr)$, on note $\rho(A)$ le rayon spectral de $A$ c'est-à-dire $\rho(A)=\text{Max}\{|\lambda|,\;\lambda\in\text{Sp}(A)\}$.
...
Montrer que $\forall A\in\mathcal{S}_n(\Rr)$, $|||A|||_2=\rho(A)$ où $|||A|||_2=\text{Sup}\left\{ \frac{\|AX\|_2}{\|X\|_2},\;X\in\mathcal{M}_{n,1}(\Rr)\setminus\{0\}\right\}$.}
  \reponse{Soit $D=\text{diag}(\lambda_i)_{1\leqslant i\leqslant n}\in\mathcal{D}_n(\Rr)$. Pour $X=(x_i)_{1\leqslant i\leqslant n}\in\mathcal{M}_{n,1}(\Rr)$,
