...
\organisation{exo7}
\contenu{
  \texte{L'espace $(\Rr , d)$ est-il complet si $d$ est l'une des
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $(u_n)$ une suite de Cauchy pour $d$.
Donc
...
Donc $\Rr$ est complet pour $d$.}
  \item \reponse{Montrons que $d$ ne définit pas une distance complète.
...
$u\in \Rr$.}
  \item \reponse{La fonction $\ln(1+u)$ est continue et ne s'annule qu'en $u=0$. 
