...
\contenu{
  \texte{}
  \question{Soit $f~:~\Rr\rightarrow\Rr$ une application uniformément continue sur $\Rr$. Montrer qu'il existe deux réels $a$ et $b$ tels que $\forall x\in\Rr$, $|f(x)|\leqslant a|x| +b$.}
  \reponse{Soit $f$ une application uniformément continue sur $\Rr$. 
