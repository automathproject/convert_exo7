...
\contenu{
  \texte{}
  \question{Soit $f$ un endomorphisme de $E$ (ev de dimension finie sur $ K$) tel que
$\chi_f$ soit irréductible. Montrez que pour aucun endomorphisme $g$
le crochet de Lie $[f,g] = f\circ g - g\circ f$ n'est de rang un.}
  \reponse{Supposons qu'il existe $g\in\mathcal{L}(E)$ tel que $\mathrm{rg}(f\circ g - g\circ f) = 1$.
