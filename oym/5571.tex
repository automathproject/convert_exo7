...
\contenu{
  \texte{}
  \question{Montrer que toute suite de polynômes non nuls de degrés deux à deux distincts est libre.

Montrer que toute suite de polynômes non nuls de valuations deux à deux distinctes est libre.}
  \reponse{Soient $n$ un entier naturel non nul puis $P_1$,..., $P_n$ $n$ polynômes non nuls de degrés respectifs $d_1<...<d_n$.
