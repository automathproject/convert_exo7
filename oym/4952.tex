\uuid{4952}
\titre{Point équidistant d'une famille de droites}
...
\contenu{
  \texte{}
  \question{Pour $\lambda \in \R$ on considère la droite $D_\lambda$ d'équation
cartésienne : $(1-\lambda^2)x + 2\lambda y = 4\lambda + 2$.

Montrer qu'il existe un point $M_0$ équidistant de toutes les droites
$D_\lambda$.}
  \reponse{Nous savons que la distance d'un point $M_0(x_0,y_0)$ à une droite $D$ d'équation $ax+by+c=0$ est donnée par la formule
