...
\organisation{exo7}
\contenu{
  \texte{Nature et \og éléments caractéristiques \fg~de la quadrique $(\mathcal{S})$ dont une équation dans un repère orthonormé donné $\mathcal{R}=(O,i,j,k)$ de l'espace de dimension $3$ est :}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Pour $(x,y,z)\in\Rr^3$, on pose $Q(x,y,z)=x^2+y^2+z^2-2yz$.
...
La surface $(\mathcal{S})$ est un paraboloïde elliptique de sommet $S$ de coordonnées $\left(2,\frac{1}{\sqrt{2}},\frac{3}{\sqrt{2}}\right)$ dans $\mathcal{R}'$ et donc $\left(2,2,1\right)$ dans $\mathcal{R}$.}
  \item \reponse{En posant $X=\frac{1}{\sqrt{2}}(x+y)$, $Y=\frac{1}{\sqrt{2}}(-x+y)$ et $Z = z$, on obtient : $2X^2 + Z^2 = 1$.
...
\end{array}
\right.$.}
  \item \reponse{Pour $(x,y,z)\in\Rr^3$, posons $Q(x,y,z)=x^2+y^2+z^2-2xy+2xz$.
...
La surface $(\mathcal{S})$ est un hyperboloïde à deux nappes de centre de coordonnées $\left(0,-1+\frac{\sqrt{2}}{4} ,1+\frac{\sqrt{2}}{4}\right)$ dans le repère $\mathcal{R}'$.}
  \item \reponse{On pose $X =\frac{1}{\sqrt{5}}(x-2y)$, $Y =\frac{1}{\sqrt{5}}(2x+y)$ et $Z = z$. Dans le repère $\mathcal{R}'$ ainsi défini, la surface $(\mathcal{S})$ admet pour équation $5X^2 + 5Z^2-\frac{2}{\sqrt{5}}(X+2Y) +\frac{4}{\sqrt{5}}(-2X+Y) = 0$ ou encore 
...
\right.$  dans $\mathcal{R}'$ et de rayon $\frac{1}{\sqrt{5}}$.}
  \item \reponse{$x^2-4x-3y-2 = 0\Leftrightarrow(x-2)^2 =3(y+2)$. La surface $(\mathcal{S})$ est un cylindre parabolique de direction $(Oz)$.}
  \item \reponse{Pour $(x,y,z)\in\Rr^3$, posons $Q(x,y,z)= 7x^2-2y^2+4z^2+4xy+20xz+16yz$. La matrice de $Q$ dans la base canonique $(i,j,k)$ de $\Rr^3$ est $A =\left(
\begin{array}{ccc}
7&2&10\\
2&-2&8\\
10&8&4
...
La surface $(\mathcal{S})$ est un paraboloïde hyperbolique. Son point selle est le point de cordonnées $(-8,6,2)$ dans le repère $\mathcal{R}'$.}
  \item \reponse{La surface $(\mathcal{S})$ admet pour équation cartésienne : $x^2+y^2+z^2-xy-xz-zx-x+y = 0$.
...
\right.$ dans le repère $\mathcal{R}'$ et de rayon $\frac{\sqrt{2}}{3}$.}
  \item \reponse{En posant $X=y$, $Y=\frac{1}{\sqrt{2}}(y+z)$ (et $Z=\frac{1}{\sqrt{2}}(-y+z)$, $xy + yz=0\Leftrightarrow XY=\sqrt{2}$.

La surface $(\mathcal{S})$ est un cylindre hyperbolique.}
  \item \reponse{Pour $(x,y,z)\in\Rr^3$, posons $Q(x,y,z)=xy+yz+zx$.
