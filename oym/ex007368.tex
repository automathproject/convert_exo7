\uuid{7368}
\titre{Sur le nombre de solutions d'une équation du second degré}
\theme{}
\auteur{mourougane}
\date{2021/08/10}
\organisation{exo7}
\contenu{
  \texte{\textit{Le but de ce problème est de montrer que l'équation $X^2+X+1=0$ peut avoir un nombre arbitrairement grand de solutions dans les anneaux $\Z/n\Z$.}
