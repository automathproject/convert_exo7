...
\contenu{
  \texte{}
  \question{Trouver les plans tangents à l'ellipsoïde d'équation $x^2+2y^2+3z^2 = 21$ qui sont  parallèles au plan d'équation $x+4y+6z=0$.}
  \reponse{En un point $M_0(x_0,y_0,z_0)$ de l'ellipsoïde la règle de dédoublement des termes fournit une équation du plan tangent : $xx_0+2yy_0+3zz_0 = 21$.
