...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soient $a,b >0$. On veut d\'emontrer
...
donc bien l'in\'egalit\'e voulue.}
  \item \reponse{Quitte \`a \'echanger
...
\sqrt{b}$$ on obtient $$a\leqslant \sqrt{ab} \leqslant b.$$}
  \item \reponse{Il faut avant tout remarquer que pour tout $n$,
...
strictement positives.
    \begin{enumerate}}
  \item \reponse{On veut montrer que pour chaque $n$, $u_n\leqslant v_n$. L'in\'egalit\'e est claire pour $n=0$
  ...
  \item \reponse{On sait d'apr\`es 2. que $u_n\leqslant u_{n+1}\leqslant v_n$.
 ...
 $v_{n+1}\leqslant v_n$ i.e. $(v_n)$ est d\'ecroissante.}
  \item \reponse{Pour tout $n$, on a $u_0\leqslant u_n\leqslant v_n\leqslant v_0$.
