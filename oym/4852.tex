...
\contenu{
  \texte{}
  \question{Montrer qu'un plan euclidien n'est pas r{\'e}union de cercles disjoints non
r{\'e}duits {\`a} un point.}
  \reponse{Supposons qu'il existe une famille $(\mathcal{C}_i = \mathcal{C}(a_i,R_i))_{i\in I}$ de cercles disjoints
