...
\contenu{
  \texte{}
  \question{Soient $E$ un espace de dimension finie $n$ non nulle et $f$ un endomorphisme nilpotent de $E$. Montrer que $f^n=0$.}
  \reponse{\textbf{1ère solution.} Si $f=0$, c'est immédiat . Sinon, soit $p$ l'indice de nilpotence de $f$ ($p\geqslant2$).
