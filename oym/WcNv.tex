...
\organisation{exo7}
\contenu{
  \texte{Par des considérations géométriques répondez aux questions suivantes :}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Si les deux droites vectorielles sont distinctes alors elles engendrent un plan vectoriel 
...
Dans tout les cas elles n'engendrent pas $\Rr^3$ et ne sont donc pas supplémentaires.}
  \item \reponse{Si $P$ et $P'$ sont deux plans vectoriels alors $P\cap P'$ est une droite vectorielle si $P \neq P'$
...
Donc l'intersection $P\cap P'$ n'est jamais réduite au vecteur nul. Ainsi $P$ et $P'$ ne sont pas supplémentaires.}
  \item \reponse{Soit $D$ une droite et $P$ un plan, $u$ un vecteur directeur de $D$. 
