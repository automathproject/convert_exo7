\exo7id{4760}
\titre{Normes de polyn{\^o}mes}
\theme{}
\auteur{quercia}
\date{2010/03/16}
\organisation{exo7}
\contenu{
  \texte{Soit $a\in\R$. On pose pour $P\in\R[X]$~: $N_a(P) = |P(a)| +  \int_{t=0}^1 |P'(t)|\,d t$.
Montrer que\dots}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$(P_n)$ converge vers $0$ pour $a\in{]-2,2[}$ et vers $1$ pour $a=2$.
    La suite est non born{\'e}e si $|a| > 2$~; elle est born{\'e}e divergente pour $a=-2$.}
  \item \reponse{$(X/b)^n$ converge vers $1$ pour $N_b$ et vers $0$ pour $N_a$.}
\end{enumerate}
}