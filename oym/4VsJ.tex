...
\organisation{exo7}
\contenu{
  \texte{Soit $C$ l'ensemble des applications de $\Rr$ dans $\Rr$, croissantes sur $\Rr$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$C$ contient l'identité de $\Rr$, mais ne contient pas son opposé. Donc, $C$ n'est pas un espace vectoriel.}
  \item \reponse{Montrons que $V$ est un sous-espace vectoriel de l'espace vectoriel des applications de $\Rr$ dans $\Rr$.
