...
\end{enumerate}
\begin{enumerate}
  \item \reponse{L'algorithme d'Euclide permet de calculer le pgcd par 
une suite de divisions euclidiennes.

\begin{enumerate}}
  \item \reponse{$X^5-2X^4+X^2-X-2=(X^3-X^2-X-2)(X^2-X)+2X^2-3X-2$ 
...
$$\pgcd(X^3-X^2-X-2,X^5-2X^4+X^2-X-2)=X-2$$}
  \item \reponse{$X^4+X^3-2X+1=(X^3+X+1)(X+1)-X^2-4X$
...
car $-X^2-4X$ et $17X+1$ n'ont pas de racine (même complexe) commune.}
  \item \reponse{$X^5+3X^4+X^3+X^2+3X+1=(X^4+2X^3+X+2)(X+1)-X^3-1$

puis $X^4+2X^3+X+2=(-X^3-1)(-X-2)+2X^3+2$

$$\pgcd(X^5+3X^4+X^3+X^2+3X+1,X^4+2X^3+X+2)=X^3+1$$}
  \item \reponse{$nX^{n+1}-(n+1)X^n+1$
