...
\organisation{exo7}
\contenu{
  \texte{Rappel: si $A$ est un anneau (en particulier, si $A$ est un corps), on note $GL_n(A)$ l'ensemble des matrices carrées de dimension $n$ à coefficient dans $A$, qui sont inversibles.
