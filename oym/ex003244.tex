...
\contenu{
  \texte{}
  \question{Soit $P\in\C[X]$ de degr{\'e} $d$ dont toutes les racines sont de module
...
Montrer que les racines de~$Q$ sont de module~$1$.}
  \reponse{Pour $z\in\mathbb{U}$, on a $Q(z) = 0 \Leftrightarrow {P(z)}/{z^d\overline P(\overline
