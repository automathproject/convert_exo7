...
\contenu{
  \texte{}
  \question{Soit $n$ un entier naturel supérieur ou égal à $2$ et $\omega=e^{2i\pi/n}$.

Soit $A =(\omega^{(j-1)(k-1)})_{1\leqslant j,k\leqslant n}$. Montrer que $A$ est inversible et calculer $A^{-1}$.}
  \reponse{Calculons $A\overline{A}$. Soit $(j,k)\in\llbracket1,n\rrbracket^2$. Le coefficient ligne $j$, colonne $k$ de $A\overline{A}$ vaut
