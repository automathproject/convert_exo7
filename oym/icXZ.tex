...
\organisation{exo7}
\contenu{
  \texte{Soit $S(t) = \sum_{n=1}^\infty \frac{t^n}{1+t^n}$.}
\begin{enumerate}
...
\begin{enumerate}
  ...
  \item \reponse{$S(t) = \sum_{n=1}^\infty \sum_{k=1}^\infty (-1)^{k-1}t^{kn}
