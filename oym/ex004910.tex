\exo7id{4910}
\titre{Normales concourantes, Centrale P' 1996}
\theme{}
\auteur{quercia}
\date{2010/03/17}
\organisation{exo7}
\contenu{
  \texte{Soit~${\cal P}$ la parabole d'équation $y^2 = 2px$ et $M_0=(x_0,y_0)\in{\cal P}$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$M = (2pt^2,2pt) \Rightarrow 2t^2+2tt_0+1=0$. Il y a deux solutions si
         $|t_0| >\sqrt2$, une seule si $|t_0|=\sqrt2$ et aucune si
         $|t_0| <\sqrt2$.}
  \item \reponse{$t_1+t_2 = -t_0$, $t_1^2+t_2^2=t_0^2-1$.
