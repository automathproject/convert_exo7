...
\organisation{exo7}
\contenu{
  \texte{On pose $u_0=1$, $v_0=0$, puis, pour $n\in\Nn$, $u_{n+1}=2u_n+v_n$ et $v_{n+1}=u_n+2v_n$.}
\begin{enumerate}
...
$$\forall n\in\Nn,\;u_n=\frac{3^n+1}{2}\;\mbox{et}\;v_n=\frac{3^n-1}{2}.$$}
  \item \reponse{Soit $n\in\Nn$. $u_{n+1}+v_{n+1}=3(u_n+v_n)$. Donc, la suite $u+v$ est une suite géométrique de raison $3$ et de premier terme $u_0+v_0=1$. On en déduit que 
