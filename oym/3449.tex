...
\contenu{
  \texte{}
  \question{Soit un déterminant symétrique réel d'ordre impair dont les coefficients
sont entiers, les diagonaux étant de plus pairs.
Montrer que ce déterminant est pair.}
  \reponse{$\det(M) = \sum_{\sigma\in S_n}\varepsilon(\sigma)a_{1\sigma(1)}\dots a_{n\sigma(n)}$.
