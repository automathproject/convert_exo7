\uuid{4789}
\titre{Polyn{\^o}mes scind{\'e}s (Ens Ulm-Lyon-Cachan MP$^*$ 2003)}
\theme{}
\auteur{quercia}
\date{2010/03/16}
\organisation{exo7}
\contenu{
  \texte{Soit~$n\in\N^*$ et~$\sigma\in\R^n$.
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$\Omega$ est ouvert~: si~$P$ a $n$ racines distinctes $a_1<a_2<\dots< a_n$
  ...
  \item \reponse{D{\'e}j{\`a}, si l'on munit $\R^n$ et $\R_n[X]$ de normes convenables,
