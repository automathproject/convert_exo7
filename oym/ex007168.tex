...
\organisation{exo7}
\contenu{
  \texte{% cocyclicité, bissectrice, puissance
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Par construction, la droite $\Delta$ est la hauteur et la médiane de $ABD$. Le triangle est donc isocèle en $A$ et $\Delta$ est également sa bissectrice, ce qui montre que $\widehat{BAA_1} = \widehat{A_1AD}$ et donc que $D\in (AC)$.}
  \item \reponse{Il suffit de prouver que $(A_2A_1,A_2C)=(DA_1,DC)$.
\begin{center}
...
ce qu'il fallait démontrer.}
  \item \reponse{Remarquons déjà que $AB=AD$.  D'autre part, il suffit de montrer que
