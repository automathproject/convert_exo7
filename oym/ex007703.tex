...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Comme $F $ est un paramétrage de la surface régulière $T$, les vecteurs 
 ...
 elle dépend de fa\c con $\mathcal{C}^\infty$ de $(\varphi,\theta)$.}
  \item \reponse{Comme la matrice de la métrique riemannienne est constante, les symboles de Christoffel
 ...
 On en déduit que la courbure de Gauss est identiquement nulle.}
  \item \reponse{D'après la question précédente $\int_T K(m)d\sigma(m)=0$}
\end{enumerate}
}