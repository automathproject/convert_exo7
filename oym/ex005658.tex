...
\contenu{
  \texte{}
  \question{Soit $A$ une matrice carrée de format $n$.

Montrer que $A$ est nilpotente si et seulement si $\forall k\in\llbracket1,n\rrbracket$, $\text{Tr}(A^k) =0$.}
  \reponse{\textbullet~Si $A$ est nilpotente, pour tout $k\in\llbracket1,n\rrbracket$, $A^k$ est nilpotente et donc $0$ est l'unique valeur propre dans $\Cc$ de $A^k$. Par suite, $\forall k\in\llbracket1,n\rrbracket$, $\text{Tr}(A^k) = 0$.
