...
\organisation{exo7}
\contenu{
  \texte{Soit $u$ la suite définie par $u_0=\frac{\pi}{2}$ et, $\forall n\in\Nn,\;u_{n+1}=\sin(u_n)$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Il est immédiat que la suite $u$ est définie et à valeurs dans $[-1,\frac{\pi}{2}]$.
...
La suite $u$ est strictement positive, strictement décroissante, de limite nulle.}
  \item \reponse{Soit $\alpha\in\Rr$. Puisque $u_{n}$ tend vers $0$ quand $n$ tend vers $+\infty$,
