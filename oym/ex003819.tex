...
\organisation{exo7}
\contenu{
  \texte{Soit $A\in\mathcal{M}_n(\R)$ telle que $A^2 = -I_n$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$\det(A)^2 = (-1)^n.$}
  \item \reponse{$A$ est $\C$-diagonalisable (annulateur simple) et ses valeurs propres
...
$A$ et $A'$ sont $\R$-semblables.}
  \item \reponse{Soit $e_1$ unitaire et $e'_1 = Ae_1$. Alors $e'_1$ est unitaire et
