...
\contenu{
  \texte{}
  \question{Montrer que la matrice de \textsc{Hilbert} $H_n =\left(\frac{1}{i+j-1}\right)_{1\leqslant i,j\leqslant n}$ est définie positive.}
  \reponse{La matrice $H_n$ est symétrique réelle. Soit $X=(x_i)_{1\leqslant i\leqslant n}\in\mathcal{M}_{n,1}(\Rr)$.
