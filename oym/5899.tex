...
\contenu{
  \texte{}
  \question{Déterminer la différentielle en tout point de $\begin{array}[t]{cccc}
...
\end{array}$.}
  \reponse{On munit $(\Rr^3)^2$ de la norme définie par $\forall(x,y)\in(\Rr^3)^2$, $\|(x,y)\|=\text{Max}\{\|h\|_2,\|k\|_2\}$.
