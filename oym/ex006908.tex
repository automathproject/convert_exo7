...
\organisation{exo7}
\contenu{
  \texte{Dans une dictature militaire, le dictateur veut augmenter le nombre de
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$P(X=k)=0,5^k 0,5= 0,5^{k+1}$ si $0\le k\le 4$, $P(X=5)=0,5^5$.}
  \item \reponse{$E(X)=\sum_{0\le k\le 5} kP(X=k)= \frac 14+ 2\frac 18+3\frac 1{16}+4\frac{1}{32}+5\frac{1}{32}=0,96875$.
