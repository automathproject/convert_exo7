...
\contenu{
  \texte{}
  \question{Montrer en revenant à la définition que $f(x)=\frac{3x-1}{x-5}$ est continue en tout point de $\Rr\setminus\{5\}$.}
  \reponse{Soit $x_0\in\Rr\setminus\{5\}$. Pour $x\neq5$, 
