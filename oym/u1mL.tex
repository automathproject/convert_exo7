...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Puisque les fonctions $t\mapsto\left(
\begin{array}{cc}
...
\end{center}}
  \item \reponse{Puisque les fonctions $t\mapsto \frac{1}{t^2+1}\left(
\begin{array}{cc}
t&-1\\
\rule{0mm}{6mm}1&t
\end{array}
...
\end{center}}
  \item \reponse{Si de plus $y= \frac{1}{x}$, le système s'écrit $\left\{
\begin{array}{l}
