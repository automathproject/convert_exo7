...
\contenu{
  \texte{}
  \question{Soient $f$ et $g$ deux endomorphismes d'un $\Cc$-espace vectoriel de dimension finie non nulle qui commutent. Montrer que $f$ et $g$ sont simultanément trigonalisables.}
  \reponse{Montrons le résultat par récurrence sur $n =\text{dim} E\geqslant 1$.
