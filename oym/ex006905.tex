...
\organisation{exo7}
\contenu{
  \texte{Un transporteur aérien a observé que  25\% en moyenne des personnes ayant réservé 
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{La loi de $X$ est une loi binomiale de paramètres $n=23$, $p=0,75$ : 
$P(X=k)={k\choose{n}}p^k(1-p)^{n-k}$ si $0\le k\le n$.
Son espérance est $np=17,25$.}
  \item \reponse{$P(X\le 20)=1-P(X\in\{21, 22, 23\})\simeq 0,951$.}
\end{enumerate}
}