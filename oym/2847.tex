...
\contenu{
  \texte{}
  \question{Que vaut $\int_{|z| = N} \tan(\pi z) \,dz$, pour $N\in\Nn$, $N\geq1$?}
  \reponse{Comme $\tan(\pi z) =\frac{\sin(\pi z)}{\cos(\pi z)}$ cette fonction est une fonction m\'eromorphe de $\C$ ayant que des p\^oles simples en
