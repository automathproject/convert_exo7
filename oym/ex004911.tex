\uuid{4911}
\titre{Croisillons sur une parabole, Centrale MP 2000}
\theme{}
\auteur{quercia}
\date{2010/03/17}
\organisation{exo7}
\contenu{
  \texte{Pour $p>0$ on donne la courbe~$\Gamma$ d'équation $y^2=2px$.
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$x_C-x_A = 2p\pm\sqrt{4p^2+8pxA}$.}
  \item \reponse{$x_{n+1} = x_n + \sqrt{8px_n+4p^2}+2p
