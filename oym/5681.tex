...
\contenu{
  \texte{}
  \question{Trouver $A$ dans $\mathcal{M}_n(\Rr)$ telle que la comatrice de $A$ soit $\left(
\begin{array}{cccc}
1&0&\ldots&0\\
2&\vdots& &\vdots\\
\vdots&\vdots& &\vdots\\
...
\end{array}
\right)$.}
  \reponse{Soit $B$ la matrice de l'énoncé. $\text{rg}B = 1$ et si $A$ existe, nécessairement $\text{rg}A = n-1$ (exercice \ref{ex:rou18bis}).
