\uuid{7772}
\titre{Sous-groupes finis de $GL_n(\Zz)$}
\theme{}
\auteur{mourougane}
\date{2021/08/11}
\organisation{exo7}
\contenu{
  \texte{Si $p$ et $q$ sont deux entiers naturels, on note $p\wedge q$ le plus grand commun diviseur de $p$ et $q$, on note également $p|q$ si $p$ divise $q$. Si $m$ est un entier supérieur ou égal à 1, on note $\Phi_m(X)$ le polynôme cyclotomique d’ordre $m$, $$\Phi_m(X) =\Pi_{\{k\in\{1,..,m\}/k\wedge m=1\}}(X-e^{2ik\pi/m}).$$
