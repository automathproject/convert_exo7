\uuid{A9LZ}
\exo7id{4632}
\titre{$\sum_{n=1}^\infty  \frac{a}{n^2+a^2}$ (Centrale MP 2003)}
...
\begin{enumerate}
  ...
  \item \reponse{On peut supposer $a > 0$ car $I(-a) = -I(a)$ et $I(0) = 0$.
  ...
  \item \reponse{Déjà fait, $ \int_{u=0}^{+\infty}e^{-u}\sin(au)\,d u =  \frac{a}{a^2+1}$.
    Il doit y avoir une autre méthode pour la question précédente ?!}
  \item \reponse{En comparant avec~{\bf 1)} pour~$x=0$ on obtient~:
