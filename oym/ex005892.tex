...
\contenu{
  \texte{}
  \question{Donner un développement limité à l'ordre $3$ en $0$ de la fonction implicitement définie sur un voisinage de $0$ par l'égalité $e^{x+y}+y-1 = 0$.}
  \reponse{Soit $x\in\Rr$. La fonction $f_x:y\mapsto e^{x+y}+y-1$ est continue et strictement croissante sur $\Rr$ en tant que somme de fonctions continues et strictement croissantes sur $\Rr$. Donc la fonction $f_x$ réalise une bijection de $\Rr$ sur $]\lim_{y \rightarrow -\infty}f_x(y),\lim_{y \rightarrow +\infty}f_x(y)[=\Rr$. En particulier, l'équation $f_x(y)=0$ a une et une seule solution dans $\Rr$ que l'on note $\varphi(x)$.
