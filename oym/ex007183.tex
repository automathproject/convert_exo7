...
\[ a^4+b^4+c^4 \geq abc(a+b+c).\]}
  \reponse{Partir du membre de gauche et appliquer l'inégalité arithmético-géométrique à trois variables ne donne pas immédiatement le résultat. Si on développe le membre de droite, on obtient
\[ a^2bc+b^2ca+c^2ab,\]
