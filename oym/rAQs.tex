...
\organisation{exo7}
\contenu{
  \texte{Soit $E =\Rr[X]$. On munit $E$ du produit scalaire $P|Q =\int_{-1}^{1}P(t)Q(t)\;dt$.}
\begin{enumerate}
...
\begin{enumerate}
  ...
  \item \reponse{Soient $n\in\Nn^*$ et $P\in E$. Une intégration par parties fournit
...
\end{center}}
  \item \reponse{On applique maintenant la formule $(*)$ dans le cas particulier $P =L_n$. On obtient 
