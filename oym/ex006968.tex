...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$F=\frac{X^5+X^4+1}{X^3-X}$.
...
Pour obtenir $a$ :
\begin{itemize}}
  \item \reponse{on multiplie l'égalité par $X$ : $\frac{X(X^2+X+1)}{X(X-1)(X+1)}=X \left(\frac{a}{X}+\frac{b}{X-1}+\frac{c}{X+1}\right)$,}
  \item \reponse{on simplifie $\frac{X^2+X+1}{(X-1)(X+1)}= a+\frac{bX}{X-1}+\frac{cX}{X+1}$,}
  \item \reponse{on remplace $X$ par $0$ et on obtient $-1= a+0+0$, donc $a=-1$.
\end{itemize}
...
$$\frac{X^5+X^4+1}{X^3-X} = X^2+X+1-\frac{1}{X}+\frac{\tfrac12}{X+1}+\frac{\tfrac32}{X-1}$$}
  \item \reponse{$G=\frac{X^3+X+1}{(X-1)^3(X+1)}$. 
...
\begin{itemize}}
  \item \reponse{En multipliant les deux membres de l'égalité par $(X-1)^3$, 
en simplifiant puis en remplaçant $X$ par $1$, 
on obtient $a=\frac32$.}
  \item \reponse{De même, en multipliant par $X+1$, 
en simplifiant puis en remplaçant $X$ par $-1$, 
on obtient $d=\frac18$.}
  \item \reponse{En multipliant par $X$ et en regardant la limite 
  quand $X\to +\infty$, on obtient $1=c+d$. Donc $c=\frac78$.}
  \item \reponse{En remplaçant $X$ par $0$, il vient $-1=-a+b-c+d$.
  Donc $b = \frac54$.
\end{itemize}
...
+ \frac{\tfrac78}{X-1}  + \frac{\tfrac18}{X+1}$$}
  \item \reponse{$H=\frac{X}{(X^2+1)(X^2+4)}$.
...
$$\frac{X}{(X^2+1)(X^2+4)} = \frac{aX+b}{X^2+1} + \frac{cX+d}{X^2+4}$$
  ...
  \begin{itemize}}
  \item \reponse{En remplaçant $X$ par $0$, on obtient $0=b+\frac{1}{4}d$.}
  \item \reponse{En multipliant les deux membres par $X$, on obtient 
    $\frac{X^2}{(X^2+1)(X^2+4)} = \frac{aX^2+bX}{X^2+1} + \frac{cX^2+dX}{X^2+4}$.
    En calculant la limite quand $X\to +\infty$, on a $0=a+c$.}
  \item \reponse{Enfin, en évaluant les fractions en $X=1$ et $X=-1$, 
...
$$\frac{X}{(X^2+1)(X^2+4)} = \frac{\frac{1}{3}X}{X^2+1} - \frac{\frac{1}{3}X}{X^2+4}$$}
  \item \reponse{$K=\frac{2X^4+X^3+3X^2-6X+1}{2X^3-X^2}$.
