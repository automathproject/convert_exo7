...
\contenu{
  \texte{}
  \question{Soit~$A\in\mathcal{M}_n(\C)$ nilpotente. Montrer que~$A$ et $2A$ sont semblables.}
  \reponse{Soit $f$ un endomorphisme d'un ev $E$ ayant $A$ pour matrice.
