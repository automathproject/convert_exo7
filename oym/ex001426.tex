...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$\mathcal{S}_{N}$ est l'ensemble des permutations de l'ensemble
...
$\mathcal{A}_{n+2}$.}
  \item \reponse{$\mathcal{A}_5$ est  de cardinal $5 !/2=60$, et comme $24 = \mathrm{Card} \mathcal{S}_4$ ne divise
pas $60$    alors $\mathcal{A}_5$  n'a pas de sous-groupe d'ordre
$24$.}
  \item \reponse{C'est un peu plus délicat car $\mathrm{Card} \mathcal{S}_5 = 5 ! = 120$ divise
...
\begin{itemize}}
  \item \reponse{Le cas $\sigma = \sigma_1$ n'est pas possible car alors $\sigma_1$ serait un cycle d'ordre $5$ et donc
de signature $-1$ dans $\mathcal{A}_6$.}
  \item \reponse{Si $\sigma = \sigma_1 \circ \sigma_2$ alors les longueurs de $\sigma_1$
  et $\sigma_2$ sont $(4,2)$ ou $(2,2)$, et l'ordre de leur composée
  $\sigma_1 \circ \sigma_2$ est donc $4$ ou $2$ mais pas $5$.}
  \item \reponse{Si $\sigma = \sigma_1 \circ \sigma_2 \circ \sigma_3$ alors
