...
\organisation{exo7}
\contenu{
  \texte{On sait qu'à une date donnée, 3\% d'une population
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{La probabilité pour une personne d'être malade si son test est
positif est $P(M/T^{+})=P(T^{+}/M)P(M)/P(T^{+})$
or $P(T^{+})=P(T^{+}/M)P(M)+P(T^{+}/S)P(S)=0.95\cdot 0.03+0.1\cdot
0.97=0.125\,5$. 
D'où : $P(M/T^{+})=22.7\%$.}
  \item \reponse{La probabilité pour une personne d'être saine si son test est
positif est $P(S/T^{+})=1-P(M/T^{+})=77.3\%$.}
  \item \reponse{La probabilité pour une personne d'être malade si son test est négatif 
est $P(M/T^{-})=0.0017$.}
  \item \reponse{La probabilité pour une personne d'être saine si son test est négatif
