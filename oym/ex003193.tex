\uuid{3193}
\titre{Diviseurs premiers de la suite $(P(n))$ (Ens ULM-Lyon-Cachan MP$^*$ 2003)}
\theme{}
\auteur{quercia}
\date{2010/03/08}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Soit $P\in\Z[X]$ non constant et $E$ l'ensemble des diviseurs premiers d'au moins un $P(n)$, $n\in\Z$.
Montrer que~$E$ est infini.}
  \reponse{On suppose $E$ fini et on montre que~$P$ est constant~: il existe~$a\in\Z$
