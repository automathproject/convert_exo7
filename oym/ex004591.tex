\uuid{4591}
\titre{Ens Ulm-Lyon-Cachan MP$^*$ 2003}
\theme{}
\auteur{quercia}
\date{2010/03/14}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Soit~$\alpha>0$. On considère la fonction $f_\alpha$ : $x \mapsto\sum_{n=1}^\infty e^{-n^\alpha}e^{inx}$.
...
soit développable en série entière en tout point de~$\R$.}
  \reponse{Il y a dérivation terme à terme facilement et indéfiniment.
