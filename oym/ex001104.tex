...
\organisation{exo7}
\contenu{
  \texte{Soit $f$ l'endomorphisme de $\Rr^2$ de matrice $A=\begin{pmatrix} 2&\frac 23\\
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Notons $P$ la matrice de passage de la base canonique 
...
\begin{pmatrix} 1 & 0 \\ 0 & \frac13 \\  \end{pmatrix}$$}
  \item \reponse{Il est très facile de calculer la puissance d'une matrice diagonale :
...
-15 + \frac{15} {3^n}& -6 + \frac{10} {3^n}\\                    
       \end{pmatrix}$$}
  \item \reponse{Si l'on note $X_n = \begin{pmatrix}x_n \\ y_n \end{pmatrix}$
