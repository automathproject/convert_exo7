...
\organisation{exo7}
\contenu{
  \texte{Dans $E=\Rr^4$, on considère $V=\{(x,y,z,t)\in E/\;x-2y=0\;\mbox{et}\;y-2z=0\}$ et $W=\{(x,y,z,t)\in E/\;x+z=y+t\}$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Pour $(x,y,z,t)\in\Rr^4$, on pose $f((x,y,z,t))=x-2y$, $g((x,y,z,t))=y-2z$ et $h((x,y,z,t))=x-y+z-t$. $f$,
...
de $\Rr^4$.}
  \item \reponse{Soit $(x,y,z,t)\in\Rr^4$.
...
$(e)$ est libre et est donc une base de $V\cap W$.}
  \item \reponse{Soit $u=(x,y,z,t)$ un vecteur de $\Rr^4$.
