\uuid{4096}
\titre{Zéros entrelacés (Centrale MP 2003)}
\theme{}
\auteur{quercia}
\date{2010/03/11}
\organisation{exo7}
\contenu{
  \texte{Soient $r$ et $q$ deux fonctions continues définies sur~$I={[a,b]}$ telles que~:
...
\begin{enumerate}
  ...
  \item \reponse{$W' = (q-r)yz$. $W(x_1)-W(x_0) = y'(x_0)z(x_0) - y'(x_1)z(x_1)$ (non simplifiable).}
  \item \reponse{Si $z$ ne s'annule pas dans $]x_0,x_1[$ alors $W'$ est de signe constant
    ...
    ou $z(x_1) \ne 0$.}
  \item \reponse{On prend $r=q$, $z=u$. Si $u(x_0)\ne 0$
