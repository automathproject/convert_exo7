...
\contenu{
  \texte{}
  \question{Soit $f$ un endomorphisme d'un espace euclidien de dimension $n$ qui conserve l'orthogonalité. Montrer qu'il existe un réel positif $k$ tel que $\forall x\in E$, $\|f(x)\| = k\|x\|$.}
  \reponse{Il s'agit de montrer qu'un endomorphisme d'un espace euclidien $E$ qui conserve l'orthogonalité est une similitude.
