\uuid{5922}
\titre{Exercice 5922}
\theme{Intégrale de Riemann, Peut-on intervertir limite et intégrale ?}
\auteur{tumpach}
\date{2010/11/11}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Pour tout $n\in\mathbb{N}$, on d\'efinit
...
$f$ n'est pas \emph{uniforme} sur $]0,1]$.}
  \reponse{Pour tout $n\in\mathbb{N}$, on d\'efinit
$f_{n}:]0,1]\rightarrow\mathbb{R}$ par~: $f_{n}(x)= n e^{-nx}$.
