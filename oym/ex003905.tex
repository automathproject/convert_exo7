...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$4\cos\left(\theta-\frac\pi{12}\right) = 2 \iff
               \theta \equiv \pm\frac\pi3 + \frac\pi{12} (\mathrm{mod}\, {2\pi})$.}
  \item \reponse{$\sin\theta + \dots + \sin4\theta
               ...
               $\theta \in \{ 0, \pi, \pi/2, 3\pi/2, 2\pi/5, 4\pi/5,
                                   6\pi/5, 8\pi/5 \}$.}
  \item \reponse{$\cos\theta \in \left\{ -\frac 12, \pm\frac 1{\sqrt2} \right\} \iff
               \theta \equiv \pm\frac {2\pi}3 (\mathrm{mod}\, {2\pi})
               \text{ ou } \theta \equiv \frac \pi4 (\mathrm{mod}\, {\frac\pi2})$.}
  \item \reponse{$2\sin(3\theta/2)\sin(\theta/2) = 2\sin(3\theta/2)\cos(3\theta/2)
             \iff
             \theta \equiv 0 (\mathrm{mod}\, {\frac {2\pi}3}) \text{ ou }
             \theta \equiv \frac \pi4 (\mathrm{mod}\, \pi) \text{ ou }
             \theta \equiv \frac {3\pi}2 (\mathrm{mod}\, {2\pi})$.}
  \item \reponse{$2\cos4\theta\cos3\theta = \cos4\theta \iff
             \theta \equiv \frac \pi8 (\mathrm{mod}\, {\frac \pi4}) \text{ ou }
             \theta \equiv \pm\frac \pi9 (\mathrm{mod}\, {\frac{2\pi}3})$.}
  \item \reponse{$2\cos7\theta\cos5\theta = \sqrt3\cos5\theta \iff
             \theta \equiv \frac \pi{10} (\mathrm{mod}\, {\frac \pi5}) \text{ ou }
             \theta \equiv \pm\frac \pi{42} (\mathrm{mod}\, {\frac{2\pi}7})$.}
  \item \reponse{$\theta\equiv 0\mathrm{mod}\, {\frac\pi3} \text{ ou } \theta\equiv\pm\frac \pi{12} (\mathrm{mod}\, {\frac \pi2})$.}
  \item \reponse{$\cos^3\theta\sin3\theta + \cos3\theta\sin^3\theta
                = \frac 34\sin4\theta
                 \Rightarrow  \theta \equiv \frac \pi8 (\mathrm{mod}\, {\frac \pi2})$.}
  \item \reponse{$\theta\equiv 0 (\mathrm{mod}\, {\frac \pi8})$.}
  \item \reponse{$\sin\theta = \frac 12 \Leftrightarrow
           \theta\equiv \frac\pi6 (\mathrm{mod}\, {2\pi})$ ou
          $\theta\equiv \frac{5\pi}6 (\mathrm{mod}\, {2\pi})$.}
  \item \reponse{$\theta \equiv 0,\pm\arctan\sqrt5 (\mathrm{mod}\,\pi)$.}
  \item \reponse{$\cos^2\theta - \sin^2\theta
  ...
  \item \reponse{$\tan x = \tan y = \frac 12$.}
\end{enumerate}
}