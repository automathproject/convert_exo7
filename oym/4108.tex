...
\contenu{
  \texte{}
  \question{Soit une application $A$ de classe $\mathcal{C}^\infty$ sur~$\R$ à valeurs dans~$\mathcal{M}_n(\C)$,
...
{\it Indication~: commencer par le cas $n=1$, $A$ constante.}}
  \reponse{Pour $n=1$ et $A(t)=a>0$ on trouve après les incantations usuelles
