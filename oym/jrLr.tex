...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $G$ l'isobarycentre du triangle $(ABC)$. On a donc $G=\mbox{bar}(A(1),B(1),C(1))$. Notons $A'$, $B'$ et $C'$ les milieux respectifs des côtés $[B,C]$, $[C,A]$ et $[A,B]$. D'après le théorème du barycentre partiel, 
...
Réciproquement, un cercle passant par $A$, $B$ et $C$ a pour centre un point à égale distance de ces points et donc nécessairement de centre $O$ et de rayon $OA$. Ceci démontre l'existence et l'unicité du cercle circonscrit au triangle $(ABC)$~:~c'est le cercle de centre $O$ et de rayon $OA$.}
  \item \reponse{Les hauteurs issues de $A$ et $B$ ne sont pas parallèles (car perpendiculaires à deux droites non parallèles). Elles admettent ainsi un et un seul point d'intersection. Ceci assure l'unicité d'un point commun aux trois hauteurs.
