...
\contenu{
  \texte{}
  \question{Soit $(u_n)$ une suite réelle positive, $U_n=\sum_{i=0}^n u_i$ et
...
Étudier la suite de terme général $\frac1{n^2u_n}\sum_{k=0}^n ku_k$.}
  \reponse{On remarque déjà que $\sum u_i$ diverge car $u_n\sim\frac{U_n}{n\alpha}\ge \frac{U_1}{n\alpha}$.
