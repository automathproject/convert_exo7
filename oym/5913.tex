...
\contenu{
  \texte{}
  \question{Une courbe fermée $(C)$ est le support d'un arc paramétré $\gamma$ de classe $C^1$ régulier et simple. On note $\mathcal{L}$ sa longueur et $\mathcal{A}$ l'aire délimitée par la courbe fermée $(C)$. Montrer que
