...
\organisation{exo7}
\contenu{
  \texte{Décomposer les fractions rationnelles suivantes~; en
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{${1 \over x^2+a^2}$ est un élément simple.
Primitives~: ${1 \over a} \arctan({x \over a})+k$.}
  \item \reponse{${1 \over{(1+x^2)}^2}$ est un élément simple.
Primitives~: ${1 \over2} \arctan x + {x \over2(1+x^2)}+k$.}
  \item \reponse{${x^3 \over x^2-4}=x+{2 \over x-2}+{2 \over x+2}$.
Primitives~: ${x^2 \over2}+ \ln(x^2-4)^2 +k$.}
  \item \reponse{${4x \over{(x-2)}^2}={4 \over x-2}+{8 \over{(x-2)}^2}$.
Primitives~: $4 \ln\vert x-2\vert-{8 \over x-2}+k$.}
  \item \reponse{${1 \over x^2+x+1}$ est un élément simple.
Primitives~: ${2 \over\sqrt3} \arctan{(2x+1) \over\sqrt3}+k$.}
  \item \reponse{$ {1 \over{(t^2+2t-1)}^2} = {1 \over8{(t+1+ \sqrt2)}^2 }+
...
+{1 \over4^3}\ln\vert x+1 \vert+k$.}
  \item \reponse{${x^7+x^3-4x-1 \over x{(x^2+1)}^2}= x^2-2-{1 \over x} +{x+4 \over x^2+1}+
{x-6 \over{(x^2+1)}^2}$.\newline
Primitives~: ${x^3 \over3}-2x -\ln\vert x \vert+{1 \over2}\ln
(1+x^2) +\arctan x -{6x+1 \over2(x^2+1)} +k$.}
  \item \reponse{${3x^4-9x^3+12x^2-11x+7\over(x-1)^3(x^2+1)}={1\over
