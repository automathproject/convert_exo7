...
\organisation{exo7}
\contenu{
  \texte{Soit $P$ un polynôme réel de degré supèrieur ou égal à $2$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Si $P$ admet $n$ racines réelles simples, le théorème de \textsc{Rolle} fournit au moins $n-1$ racines réelles deux à deux distinctes pour $P'$. Mais, puisque $P'$ est de degré $n-1$, ce sont toutes les racines de $P'$, nécessairement toutes réelles et simples.
