...
\contenu{
  \texte{}
  \question{Soit $A=(a_{i,j})_{1\leq i,j\leq n}$ où, pour tout $i$ et tout $j$, $a_{i,j}\in\{-1,1\}$. Montrer que $\mbox{det}\;A$ est un entier divisible par $2^{n-1}$.}
  \reponse{On procède par récurrence sur $n\geq1$.
