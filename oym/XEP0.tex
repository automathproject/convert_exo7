\uuid{XEP0}
\exo7id{5847}
\titre{** I Distance d'un point à une partie}
\theme{Topologie}
\auteur{rouget}
\date{2010/10/16}
\organisation{exo7}
\contenu{
  \texte{Soit $A$ une partie non vide d'un espace vectoriel normé $(E,\|\;\|)$.
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $x\in E$. $\left\{\|x-a\|,\;a\in A\right\}$ est une partie non vide et minorée (par $0$) de $\Rr$. $\left\{\|x-a\|,\;a\in A\right\}$ admet donc une borne inférieure dans $\Rr$. On en déduit l'existence de $d_A(x)$.}
  \item \reponse{\begin{enumerate}}
  \item \reponse{Soit $A$ une partie fermée et non vide de $E$. Soit $x\in E$.
...
\end{center}}
  \item \reponse{Posons $d=d_A(x)$. Pour chaque entier naturel $n$, il existe $a_n\in A$ tel que $d\leqslant \|x-a_n\|\leqslant d+ \frac{1}{n}$.
