\uuid{7118}
\titre{Angle inscrit dans le cas limite}
\theme{}
\auteur{megy}
\date{2017/02/08}
\organisation{exo7}
\contenu{
  \texte{}
  \question{% n'utilise que des triangles isocèles et rectangles
...
\end{center}}
  \reponse{Traçons la figure, où on a placé $I$ le milieu de $[AB]$, de telle sorte que $\frac12(OA,OB)=(OA,OI)$.
