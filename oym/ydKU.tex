...
\exo7id{2039}
\titre{Exercice 2039}
\theme{Droites du plan ; droites et plans de l'espace, Droites et plans dans l'espace}
\auteur{liousse}
\date{2003/10/01}
\organisation{exo7}
\contenu{
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Notons $P$ le plan d'équation $2x+2y-z=1$. Et soit $M_0=(x_0,y_0,z_0)$ un point quelconque.
...
$p(M_0)=(x_0+2\lambda_0,y_0+2\lambda_0,z_0-\lambda_0)$.}
  \item \reponse{Notons $D$ la droite d'équation $\left\{\begin{array}{l}x+y+z=1 \\2x-z=2 \end{array}\right.$
...
avec les valeurs de $\lambda_1,\lambda_2$ obtenues.}
  \item \reponse{Le principe est similaire, voici les étapes :
  \begin{enumerate}}
  \item \reponse{Trouver une équation du plan. Un vecteur normal au plan est $\vec u \wedge \vec{u'}=(-1,-2,-2)$.
Donc le plan est d'équation $x+2y+2z-2=0$.}
  \item \reponse{Chercher le projeté d'un point $M_0=(x_0,y_0,z_0)$ sous la forme 
$M_0+\lambda \cdot \overrightarrow{AB}$. Trouver $\lambda_0$ de sorte que $M_0+\lambda_0 \cdot \overrightarrow{AB}$
appartiennent au plan.}
  \item \reponse{On trouve $\overrightarrow{AB}=(-1,0,3)$ et $\lambda_0=-\frac15(x_0+2y_0+2z_0-2)$
