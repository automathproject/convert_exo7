...
\contenu{
  \texte{}
  \question{Calculer le volume de l'intérieur de l'ellipsoïde d'équation $x^2+ \frac{1}{2}y^2+ \frac{3}{4}z^2+xz=1$.}
  \reponse{\textbf{1ère solution.} $V=\displaystyle\iiint_{x^2+ \frac{1}{2}y^2+ \frac{3}{4}z^2+xz\leqslant1}dxdydz$. Or $x^2+ \frac{1}{2}y^2+ \frac{3}{4}z^2+xz=\left(x+ \frac{z}{2}\right)^2+ \frac{y^2}{2}+ \frac{z^2}{2}$. On pose donc $u=x+ \frac{z}{2}$, $v= \frac{y}{\sqrt{2}}$ et $w= \frac{z}{\sqrt{2}}$.
