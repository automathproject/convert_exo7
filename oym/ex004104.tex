...
\organisation{exo7}
\contenu{
  \texte{Soit $I=[a,b]\subset \R$. On suppose que la fonction $\Delta$ est strictement
positive sur $I$.
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $f$ non identiquement nulle vérifiant $f''=\lambda\Delta f$ avec $\lambda > 0$~:
  ...
  \item \reponse{$(f\mid g) =  \int_{t=a}^bf'(t)g'(t)\,d t = - \int_{t=a}^bf''(t)g(t)\,d t  = - \int_{t=a}^bf(t)g''(t)\,d t$.}
  \item \reponse{\begin{enumerate}}
  \item \reponse{Si $f_\lambda$ a un nombre fini de zéros, soit $x_n$ le
