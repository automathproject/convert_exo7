...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$J^n = I$. $J$ annule le polynôme $X^n-1$ qui est à racines simples dans $\Cc$ et donc $J$ est diagonalisable dans $\Cc$.
...
\textbf{Remarque.} La seule connaissance de $D$ suffit pour le 2).}
  \item \reponse{Soit $A$ la matrice de l'énoncé.
