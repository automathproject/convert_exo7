...
\contenu{
  \texte{}
  \question{Soient $E$ un espace de dimension finie et $F$ et $G$ deux sous-espaces de $E$. Condition nécessaire et suffisante sur $F$ et $G$ pour qu'il existe un endomorphisme $f$ de $E$ tel que $F=\text{Ker}f$ et $G=\text{Im}f$.}
  \reponse{Une condition nécessaire est bien sur $\text{dim}F +\text{dim}G =\text{dim}E$ (et non pas $F\oplus G = E$).
