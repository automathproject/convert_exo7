...
\organisation{exo7}
\contenu{
  \texte{Soit~$H$ un espace euclidien, $(y_j)_{j\in I}$ une famille de vecteurs
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Le sous-espace vectoriel engendré a un orthogonal nul.}
  \item \reponse{N'importe quelle famille génératrice convient (équivalence des normes).}
  \item \reponse{$1=\|y_i\|^2 = \|y_i\|^4 + \sum_{j\ne i}(y_i\mid y_j)^2 \Rightarrow \forall\ j\ne i,\ (y_i\mid y_j) = 0$.}
  \item \reponse{Par polarisation on a~:
