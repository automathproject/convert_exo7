...
\contenu{
  \texte{}
  \question{Déterminer $\lambda$ et $\mu$ complexes tels que les zéros de $z^4-4z^3-36z^2+\lambda z+\mu$ soient en progression arithmétique. Résoudre alors l'équation.}
  \reponse{Posons $P=X^4-4X^3-36X^2+\lambda X+\mu$.
