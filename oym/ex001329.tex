...
\organisation{exo7}
\contenu{
  \texte{Soit $E$ un ensemble muni d'une loi interne $\star$. On appelle translation à droite (resp. à gauche) par $a\in E$, l'application $d_{a}$ (resp. $g_{a})$ de $E$ dans $E$ définie par $d_{a}(x)=a\star x$ (resp. $g_{a}(x)=x\star a$).}
\begin{enumerate}
