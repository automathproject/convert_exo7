...
\contenu{
  \texte{}
  \question{Soit $\omega=x^2dx+y^2dy$. Calculer l'intégrale de $\omega$ le long de tout cercle du plan parcouru une fois dans le sens trigonométrique. Même question avec $\omega=y^2dx+x^2dy$.}
