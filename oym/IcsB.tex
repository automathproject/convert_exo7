...
\organisation{exo7}
\contenu{
  \texte{Limite quand $n$ tend vers $+\infty$ de}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Pour $n\in\Nn^*$, $\left|\frac{\sin n}{n}\right|\leq\frac{1}{n}$. Comme $\frac{1}{n}\underset{n\rightarrow+\infty}{\longrightarrow}0$, $\frac{\sin n}{n}\underset{n\rightarrow+\infty}{\longrightarrow}0$.
...
\end{center}}
  \item \reponse{Quand $n$ tend vers $+\infty$, $\ln\left(\left(1+\frac{1}{n}\right)^n\right)=n\ln\left(1+\frac{1}{n}\right)\sim n\times \frac{1}{n}=1$. Donc, $\ln\left(\left(1+\frac{1}{n}\right)^n\right)$ tend vers $1$ puis, $\left(1+\frac{1}{n}\right)^n=e^{n\ln(1+1/n)}$ tend vers $e^1=e$.
...
\end{center}}
  \item \reponse{Pour $n\in\Nn^*$, posons $u_n=\frac{n!}{n^n}$. Pour $n$ entier naturel non nul, on a
...
\end{center}}
  \item \reponse{Quand $n$ tend vers $+\infty$, $\sqrt[n]{n^2}=e^{\frac{1}{n}\ln(n^2)}=e^{2\ln n/n}=e^{o(1)}$, et donc $\sqrt[n]{n^2}$ tend vers $1$.
...
\end{center}}
  \item \reponse{$\sqrt{n+1}-\sqrt{n}=\frac{1}{\sqrt{n+1}+\sqrt{n}}\rightarrow0$.}
  \item \reponse{$\frac{1}{n^3}\sum_{k=1}^{n}k^2=\frac{n(n+1)(2n+1)}{6n^3}\sim\frac{2n^3}{6n^3}=\frac{1}{6}$.}
  \item \reponse{$\prod_{k=1}^{n}2^{k/2^k}=2^{\frac{1}{2}\sum_{k=1}^{n}\frac{k}{2^{k-1}}}$. Pour $x$ réel, posons $f(x)=\sum_{k=1}^{n}kx^{k-1}$. $f$ est dérivable sur $\Rr$ en tant que polynôme et pour tout réel $x$, 
