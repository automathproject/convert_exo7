...
\exo7id{2824}
\titre{Exercice 2824}
\theme{Prolongement analytique et résidus, Deux séries de Fourier}
\auteur{burnol}
\date{2009/12/15}
\organisation{exo7}
\contenu{
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $\phi (t,z) =\frac{z-1}{1+t(z-1)}$ et notons $D=\{ |z-1|<1\}$. Pour tout $t\in [0,1]$ et tout $z\in D$ on a
...
\end{eqnarray*}}
  \item \reponse{Si $\Re(z) \geq \delta$, alors
...
D'o\`u la convergence uniforme.}
  \item \reponse{Voir ci-dessus.}
  \item \reponse{On a $z=1+e^{i\phi} = (e^{i\frac{\phi}{2}}+e^{-i\frac{\phi}{2}})e^{i\frac{\phi}{2}}=2\cos \frac{\phi}{2}e^{i\frac{\phi}{2}}$. D'o\`u $\mathrm{Arg} (z) = \frac{\phi}{2}$ et $r=|z|=2|\cos \frac{\phi}{2} | =2\cos \frac{\phi}{2}$.
Comme :
\begin{eqnarray*}
