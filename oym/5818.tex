...
\contenu{
  \texte{}
  \question{Déterminer l'orthoptique d'une parabole, c'est-à-dire l'ensemble des points du plan par lesquels il passe deux tangentes à la parabole qui soient perpendiculaires.}
  \reponse{\textbf{Solution géométrique.}
