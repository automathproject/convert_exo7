...
\organisation{exo7}
\contenu{
  \texte{On consid\`ere les fonctions $f\colon \R^2\longrightarrow \R^3$ et
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$g(f(x,y))= xy^2 \sin^2 (xy) \cos x \exp(y^2)$}
...
\end{align*}}
  \item \reponse{Calculons d'abord
\begin{align*}
...
\right]
\end{align*}}
  \item \reponse{La matrice jacobienne $\mathrm J_{g\circ f}$ de la fonction
