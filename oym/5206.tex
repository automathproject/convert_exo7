...
\contenu{
  \texte{}
  \question{Montrer qu'il n'existe pas de triangle équilatéral dont les sommets appartiennent aux points d'intersection des lignes d'une feuille blanche quadrillée usuelle.}
  \reponse{Il revient au même de démontrer que, si le plan est rapporté à un repère orthonormé, il n'existe pas de triangle équilatéral dont les sommets ont pour coordonnées des nombres entiers.
