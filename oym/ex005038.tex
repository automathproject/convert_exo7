\uuid{5038}
\titre{Points équidistants sur la tangente}
\theme{}
\auteur{quercia}
\date{2010/03/17}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Soit $\mathcal{C}$ une courbe paramétrée, $(M,\vec t,\vec n)$ le repère de Frenet en un
...
concourantes.}
  \reponse{$c_i = \frac1{\sqrt{1+a^2c^2}}\left(\frac{ac'}{1+a^2c^2} \pm c\right)$
