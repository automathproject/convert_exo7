...
\contenu{
  \texte{}
  \question{Soit $A$ une matrice carrée réelle symétrique positive de format $n$.
Montrer que $1 +\sqrt[n]{\text{det}(A)}\leqslant\sqrt[n]{\text{det}(I_n+A)}$.}
  \reponse{La matrice $A$ est symétrique réelle positive. Donc ses valeurs propres $\lambda_1$,..., $\lambda_n$ sont des réels positifs. De plus,
