...
\exo7id{612}
\titre{Exercice 612}
\theme{Limites de fonctions, Théorie}
\auteur{bodin}
\date{1998/09/01}
\organisation{exo7}
\contenu{
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $p>0$ la p\'eriode: pour tout $x\in \Rr$,
...
Comme $f(a) \not= f(b)$ nous obtenons une contradiction.}
  \item \reponse{Soit $f: \Rr \longrightarrow \Rr$ une fonction croissante et major\'ee par $M\in \Rr$. 
Notons 
$$ F = f(\Rr) = \{ f(x) \ | \ x \in \Rr \}.$$
