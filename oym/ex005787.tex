...
\end{enumerate}
\begin{enumerate}
  \item \reponse{${^t}S={^t}({^t}AA)={^t}A{^t}({^t}A) ={^t}AA = S$. Donc $S\in\mathcal{S}_n(\Rr)$.
...
\end{center}}
  \item \reponse{Soit $S\in\mathcal{S}_n^+(\Rr)$. D'après le théorème spectral, il existe $P$ dans $O_n(\Rr)$ et $D$ dans $\mathcal{D}_n(\Rr)$ telles que $S = PD{^t}P$.
...
\end{align*}}
  \item \reponse{Montrons que les matrices $A$ et $S$ ont même noyau. Soit $X\in\mathcal{M}_{n,1}(\Rr)$. 
...
\end{center}}
  \item \reponse{Soit $S\in\mathcal{S}_n^+(\Rr)$.
