...
\organisation{exo7}
\contenu{
  \texte{Soit $f$ l'endomorphisme de $\Rr^3$ dont la matrice dans la base canonique est $A$. Trouver les sous espaces stables par $f$ dans chacun des cas suivants :}
\begin{enumerate}
