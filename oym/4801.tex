\uuid{4801}
\titre{Principe du maximum, ULM-Lyon-Cachan MP$^*$ 2005}
...
\contenu{
  \texte{}
  \question{Soit $P\in\C[X]$ et $U$ un ouvert de~$\C$ born{\'e}.
Montrer que $\sup(|P(x)|,\ x\in U) = \sup(|P(x)|,\ x\in \mathrm{Fr}(U))$.}
  \reponse{On suppose $P$ non constant, sans quoi le r{\'e}sultat est trivial.
