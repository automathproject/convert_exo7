...
\contenu{
  \texte{}
  \question{Soit $(u_n)_{n\in\Nn}$ une suite de réels positifs. Trouver la nature de la série de terme général $v_n =\frac{u_n}{(1+u_1)\ldots(1+u_n)}$, $n\geqslant1$,  connaissant la nature de la série de terme général $u_n$ puis en calculer la somme en cas de convergence.}
  \reponse{Pour $n\geqslant2$, $v_n=\frac{u_n+1-1}{(1+u_1)\ldots(1+u_n)}=\frac{1}{(1+u_1)\ldots(1+u_{n-1})}-\frac{1}{(1+u_1)\ldots(1+u_n)}$  et d'autre part $v_1=1-\frac{1}{1+u_1}$. Donc, pour $n\geqslant2$
