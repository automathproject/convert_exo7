...
\organisation{exo7}
\contenu{
  \texte{Soit $X$ un espace muni d'une m\'etrique $\mathrm{dist} : X\times X \to
\R_+$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{On v\'erifie facilement les trois propri\'et\'es de
m\'etrique.}
  \item \reponse{Soit $f:\R_+ \to \R_+ \, ,\,
...
$x\geq 0\, ,\, y\geq 0\, $.}
  \item \reponse{D'apr\`es le cours, la m\'etrique $\mathrm{dist}$ et la m\'etrique
