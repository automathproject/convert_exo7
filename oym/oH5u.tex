...
\exo7id{2564}
\titre{Exercice 2564}
\theme{Sujets de l'année 2004-2005, Devoir à la maison}
\auteur{delaunay}
\date{2009/05/19}
\organisation{exo7}
\contenu{
  \texte{Soit $E$ un espace vectoriel sur un corps $K$ ($K=\R$ ou $\C$), on appelle {\it projecteur}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{{\it Montrons que $\mathrm{Id}_E-p$ est un projecteur et calculons $p\circ(\mathrm{Id}_E-p)$ et $(\mathrm{Id}_E-p)\circ p$.}
...
donc pour tout $\vec x\in E$, on a $p(\vec x-p(\vec x))=\vec 0$.}
  \item \reponse{{\it Montrons que pour tout $\vec x\in \Im p$, on a $p(\vec x)=\vec x$.}

Soit $\vec x\in \Im p$, il existe $\vec y\in E$ tel que $\vec x=p(\vec y)$, on a donc 
$p(\vec x)=p^2(\vec y)=p(\vec y)=\vec x$.}
  \item \reponse{{\it On en d\'eduit que $\Im p$ et $\ker p$ sont suppl\'ementaires.}
...
explicitement la d\'ecomposition.)}
  \item \reponse{{\it Montrons que le rang de $p$ est \'egal \`a la trace de $p$.}
