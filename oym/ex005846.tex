...
\contenu{
  \texte{}
  \question{Soit $E$ le $\Rr$-espace vectoriel des fonctions continues sur $[0,1]$ à valeurs dans $\Rr$. On munit $E$ de $\|\;\|_\infty$.
...
$D$ est la partie de $E$ constituée des applications dérivables et $P$ est la partie de $E$ constituée des fonctions polynomiales. Déterminer l'intérieur de $D$ et l'intérieur de $P$.}
  \reponse{Soit $f\in E$. Pour $n\in\Nn^*$, soit $g_n$ l'application définie par $\forall x\in[0,1]$, $g_n(x) = f(x)+ \frac{1}{n}\left|x- \frac{1}{2}\right|$.
