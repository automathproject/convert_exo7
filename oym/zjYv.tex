...
\organisation{exo7}
\contenu{
  \texte{Soient $(u_n)_{n\in\Nn}$ une suite réelle et $(v_n)_{n\in\Nn}$ la suite définie par~:~$\forall n\in\Nn,\;v_n=\frac{u_0+u_1+...+u_n}{n+1}$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $\varepsilon>0$. Il existe un rang $n_0$ tel que, si $n\geq n_0$ alors $|u_n-\ell|<\frac{\varepsilon}{2}$. Soit $n$ un entier naturel strictement supérieur à $n_0$.
...
La réciproque est fausse. Pour $n$ dans $\Nn$, posons $u_n=(-1)^n$. La suite $(u_n)$ est divergente. D'autre part, pour $n$ dans $\Nn$, $\sum_{k=0}^{n}(-1)^k$ vaut $0$ ou $1$ suivant la parité de $n$ et donc, dans tous les cas, $|v_n|\leq\frac{1}{n+1}$. Par suite, la suite $(v_n)$ converge et $\lim_{n\rightarrow +\infty}v_n=0$.}
  \item \reponse{Si $u$ est bornée, il existe un réel $M$ tel que, pour tout naturel $n$, $|u_n|\leq M$.
...
Mais, si $n$ est impair, $v_n=0$, et si $n$ est pair, $v_n=\frac{1}{n+1}\times u_n=\frac{n}{2(n+1)}$, et dans tous les cas $|v_n|\leq\frac{1}{n+1}\frac{n}{2}\leq\frac{1}{n+1}\frac{n+1}{2}=\frac{1}{2}$ et la suite $v$ est bornée.}
  \item \reponse{Si $u$ est croissante, pour $n$ entier naturel donné on a~:
