...
\organisation{exo7}
\contenu{
  \texte{On consid\`ere le syst\`eme $Ax=b$ avec
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{It\'eration de Gauss-Seidel : $(D-E)X_{n+1}=FX_n +b$ avec
...
&&&0&3\\
&&&&0\end{array}\right)$$}
  \item \reponse{$e_n=X_n-X^*,\quad, X_{n+1}=(D-E)^{-1}FX_n +(D-E)^{-1}b,\quad
...
$$\|e_n\|_\infty\leq \frac{17}{18}\|e_n\|_\infty$$}
  \item \reponse{$$(D-E)^{-1}=\left(\begin{array}{ccccc}
\frac{1}{3}&0&0&0&0\\
