...
\contenu{
  \texte{}
  \question{Montrer que pour tout nombre complexe $z$ dans le disque unité $\Delta$, $$\left|\frac{4z+3}{4+3z}\right|\leq 1.$$}
  \reponse{Soit $\varphi (z) =\frac{4z+3}{4+3z}$.
