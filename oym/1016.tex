\uuid{1016}
\titre{Exercice 1016}
\theme{Espaces vectoriels de dimension finie, Dimension}
\auteur{legall}
\date{1998/09/01}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Montrer que tout sous-espace vectoriel d'un espace vectoriel de dimension finie
est de dimension finie.}
  \reponse{Soit $E$ un espace vectoriel de dimension $n$ et $F$ un sous-espace vectoriel de $E$.
