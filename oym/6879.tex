...
\contenu{
  \texte{}
  \question{Calculer le travail $W$ de la force $\vec{F}(x,y,z)=(yz,zx,xy)$ le long de l'hélice $H$ 
paramétrée par $x=\cos t$, $y=\sin t$ et $z=t$ o\`u $t$ varie de $0$ à $ \frac{\pi}{4}$.}
  \reponse{Notons $\omega= yz dx + zx dy + xy dz$ la forme différentielle associée à $\vec{F}(x,y,z)$.
