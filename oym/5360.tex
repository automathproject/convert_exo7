...
Montrer que $\{A_1,...,A_p\}$ est un sous groupe de $(GL_n(\Rr),\times)$.}
  \reponse{$G=\{A_1,...,A_p\}$ est déjà une partie non vide de $GL_n(\Rr)$, stable pour $\times$. Il reste à vérifier que $G$ est stable pour le passage à l'inverse.
