...
\contenu{
  \texte{}
  \question{Trouver toutes les applications $f~:~\Rr\rightarrow\Rr$, continues sur $\Rr$ telles que $\forall(x,y)\in\Rr^2$, $f(x)f(y) =\int_{x-y}^{x+y}f(t)\;dt$.}
  \reponse{La fonction nulle est solution. Dorénavant, $f$ est une éventuelle solution non nulle.  Il existe donc $x_0\in\Rr$ tel que $f(x_0)\neq0$. 
