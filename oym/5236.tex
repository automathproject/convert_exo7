...
\contenu{
  \texte{}
  \question{Etudier les deux suites $u_n=\left(1+\frac{1}{n}\right)^n$  et $v_n=\left(1+\frac{1}{n}\right)^{n+1}$.}
  \reponse{Les suites $u$ et $v$ sont définies à partir du rang $1$ et strictement positives.
