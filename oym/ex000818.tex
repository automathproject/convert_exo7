\uuid{818}
\titre{Int\'egrales de Wallis}
\theme{}
\auteur{ridde}
\date{1999/11/01}
\organisation{exo7}
\contenu{
  \texte{Soit $I_{n} = \int_0^{\frac{\pi}2} \sin ^n tdt$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Par IPP, $I_{n+2} = \frac{n+1}{n+2} I_n$.}
  \item \reponse{$I_0 = \pi/2$ et $I_1 = 1$ et
\[ 
...
= \frac{2^{2p} (p!)^2}{(2p+1)!}
\]}
  \item \reponse{En regardant l'intégrand.}
  \item \reponse{D'après la question précédente, $0 < I_{n+2} \leq I_{n+1} \leq I_n$ donc
\[
...
soit $n I_n I_{n+1} = \frac{n}{n+1} \frac{\pi}{2}$, ce qui peut aussi se démontrer par récurrence.}
  \item \reponse{Comme $\frac{\pi}{2(n+1)} I_n I_{n+1} \sim I_n^2$ on en déduit que $I_n \sim \sqrt{\frac{\pi}{2n}}$.}
\end{enumerate}
}