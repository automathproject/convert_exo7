...
\organisation{exo7}
\contenu{
  \texte{Afin de mieux satisfaire leurs clients, une grande société
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{L'intervalle de temps de $4$ minutes est la répétition de $240$
...
binomiale, de paramètres $n=240$ et $p=\frac{1}{20}$.}
  \item \reponse{Comme $n\geq 30$ et $np\leq 15,$ il est possible d'approcher cette loi
par une loi de Poisson de paramètre $\lambda $ estimé par $np=12$.}
  \item \reponse{Un échantillon de taille $200$ a été réalisé pour
