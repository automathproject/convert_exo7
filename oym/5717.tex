...
\contenu{
  \texte{}
  \question{Deux calculs de $I =\int_{0}^{\pi/2}\ln(\sin x)\;dx$.
...
\textbf{2) (*** I)} Calculer $P_n=\prod_{k=1}^{n-1}\sin\frac{k\pi}{2n}$ (commencer par $P_n^2$) et en déduire $I$.}
  \reponse{La fonction $f~:~x\mapsto\ln(\sin x)$ est continue sur $\left]0,\frac{\pi}{2}\right]$. De plus, quand $x$ tend vers $0$, $\ln(\sin x)\sim\ln x=o\left(\frac{1}{\sqrt{x}}\right)$. Par suite, $f$ est intégrable sur$\left]0,\frac{\pi}{2}\right]$.
