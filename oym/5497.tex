...
\contenu{
  \texte{}
  \question{Soit $P\in\Rr_3[X]$ tel que $\int_{-1}^{1}P^2(t)\;dt=1$. Montrer que $\mbox{sup}\{|P(x)|,\;|x|\leq1\}\leq2$. Cas d'égalité~?}
  \reponse{L'application $(P,Q)\mapsto\int_{0}^{1}P(t)Q(t)\;dt$ est un produit scalaire sur $E=\Rr_3[X]$. Déterminons une base orthonormée de $E$. Pour cela, déterminons $(Q_0,Q_1,Q_2,Q_3)$ l'orthonormalisée de la base canonique $(P_0,P_1,P_2,P_3)=(1,X,X^2,X^3)$.
