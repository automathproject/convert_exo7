...
\contenu{
  \texte{}
  \question{Soit $A$ une matrice rectangulaire de format $(p,q)$ et $B$ une matrice de format $(q,p)$. Comparer les polynômes caractéristiques de $AB$ et $BA$.}
  \reponse{Si $p = q$, le résultat est connu : $\chi_{AB}=\chi_{BA}$.
