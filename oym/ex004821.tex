\exo7id{4821}
\titre{Rayon spectral (Centrale MP 2001)}
\theme{}
\auteur{quercia}
\date{2010/03/16}
\organisation{exo7}
\contenu{
  \texte{Soit $E$ un espace vectoriel complexe de dimension finie.
...
\begin{enumerate}
  ...
  \item \reponse{Consid{\'e}rer la matrice de $f^p$ dans une base propre pour~$f$.}
  \item \reponse{On sait que $f^p = \sum_{\lambda\in\mathrm{spec}(f)} \lambda^pP_\lambda(p)$
