...
\organisation{exo7}
\contenu{
  \texte{Soient $a>0$ et $b>0$. Pour $n\in\Nn^*$ et $x\in\Rr$, on pose $f_n(x)=\left(1+\frac{x}{n}\right)^n$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$$f_n(a)=\text{exp}\left(n\ln\left(1+\frac{a}{n}\right)\right)\underset{n\rightarrow+\infty}{=}\text{exp}\left(a-\frac{a^2}{2n}+o\left(\frac{1}{n}\right)\right)= e^a\left(1-\frac{a^2}{2n}+o\left(\frac{1}{n}\right)\right).$$
...
Donc, si $ab\neq0$, $f_n(a+b)-f_n(a)f_n(b)\underset{n\rightarrow+\infty}{\sim}-\frac{ab\;e^{a+b}}{n}$. Si $ab=0$, il est clair que $f_n(a+b)-f_n(a)f_n(b)=0$.}
  \item \reponse{$e^{-a}f_n(a)\underset{n\rightarrow+\infty}{=}\text{exp}\left(-a+\left(a-\frac{a^2}{2n}+\frac{a^3}{3n^2}\right)+o\left(\frac{1}{n^2}\right)\right)
