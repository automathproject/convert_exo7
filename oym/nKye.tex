...
\organisation{exo7}
\contenu{
  \texte{%Abou-Jaoudé, Chevalier p76
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Comme $d(x,y)  = 1$, si $x\neq y$, on a donc que $d(x,y) =
...
in\'egalit\'es sont contradictoires.}
  \item \reponse{Soit $B_d(a,r)$ une boule ouverte; montrons qu'elle est ferm\'ee.
...
analogue.}
  \item \reponse{Soient $B_d(a,r)$ et $B_d(b,s)$ deux boules ouvertes ayant une
...
$d(b,z)< \sup(r,s) = s$, d'o\`u une inclusion de $B_d(a,r)$ dans $B_d(b,s)$.
 ...
 Cons\'equence: deux boules ouvertes de m\^eme rayon $r$ qui se rencontrent sont confondues.}
  \item \reponse{Soient $ A = B_d(a,r)$ et $B = B_d(b,r)$ deux boules ouvertes de rayon
$r$ contenues
