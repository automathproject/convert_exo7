\uuid{Wkcg}
\exo7id{3669}
\titre{Projection sur un sous-espace vectoriel de dimension finie}
\theme{Exercices de Michel Quercia, Produit scalaire}
\auteur{quercia}
\date{2010/03/11}
\organisation{exo7}
\contenu{
  \texte{Soit $E$ un espace vectoriel muni d'un produit scalaire (de dimension éventuellement infinie)
