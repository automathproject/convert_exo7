...
\organisation{exo7}
\contenu{
  \texte{Soit $  G  $ un groupe, $  H  $ et $  K  $ deux
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $\phi : H\times K \rightarrow HK$ d\'efinie par
...
$\mathrm{Card} HK = \mathrm{Card} H . \mathrm{Card} K$.}
  \item \reponse{Supposons qu'il existe deux sous-groupes $H$ et $K$ distincts et d'ordre
