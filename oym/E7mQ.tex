...
\exo7id{5964}
\titre{Exercice 5964}
\theme{Intersections des $L^p$ et convergences, Cas d'une mesure finie}
\auteur{tumpach}
\date{2010/11/11}
\organisation{exo7}
\contenu{
  \texte{Soit $\Omega$ un sous-ensemble de $\mathbb{R}^n$ dont la mesure de
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Si $f\in L^{\infty}(\Omega)$, alors
$$
...
\subset L^{q}(\Omega) \subset L^{1}(\Omega).
$$}
  \item \reponse{Montrons que pour $q<p$, l'inclusion
