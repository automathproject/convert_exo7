...
\contenu{
  \texte{}
  \question{Soient $\alpha$ et $\beta$ deux nombres r\'eels. Mettre le nombre complexe $z  =
...
$$ \sum_{p=0}^{n}C_n^p \cos  [p\alpha + (n-p)\beta ].$$}
  \reponse{Soit $(\alpha,\beta)\in\R^2$ et $z$ le nombre complexe
