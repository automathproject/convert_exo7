\exo7id{7161}
\titre{Isométries d'un carré}
\theme{}
\auteur{megy}
\date{2017/05/13}
\organisation{exo7}
\contenu{
  \texte{Soit $\mathcal C=ABCD$ un carré plein du plan (c'est-à-dire l'enveloppe convexe de ses sommets) et $O$ son centre.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Montrons d'abord qu'une isométrie du carré permute les sommets.
\begin{enumerate}}
  \item \reponse{Première preuve : 
