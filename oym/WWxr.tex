...
\organisation{exo7}
\contenu{
  \texte{Résoudre dans $\Rr$ les équations suivantes~:}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$\ch x=2\Leftrightarrow x=\pm\Argch2=\pm\ln(2+\sqrt{2^2-1})=\pm\ln(2+\sqrt{3})$. Les solutions sont $\ln(2+\sqrt{3})$ et
$-\ln(2+\sqrt{3})$ (ou encore $\ln(2-\sqrt{3})$ car $(2+\sqrt{3})(2-\sqrt{3})=1$).}
  \item \reponse{Une solution est nécessairement dans $\left[-\frac{1}{2},\frac{1}{2}\right]$. Soit donc $x\in\left[-\frac{1}{2},\frac{1}{2}\right]$.
...
\end{center}}
  \item \reponse{Soit $x\in\Rr$. $\Arcsin x$ existe si et seulement si $x\in[-1,1]$. Ensuite,
