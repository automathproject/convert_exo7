...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Un repère de $(\mathcal{D})$ est $\left(A,\overrightarrow{u}\right)$ où $A(0,-1,2)$ et $\overrightarrow{u}(3,3,1)$.
...
\end{align*}}
  \item \reponse{Un repère de $(\mathcal{D})$ est $\left(A,\overrightarrow{u}\right)$ où $A(0,-1,2)$ et $\overrightarrow{u}(3,3,1)$. De plus, $S=A$.
