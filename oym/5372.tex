...
\contenu{
  \texte{}
  \question{Calculer $\mbox{det}(\mbox{com}A)$ en fonction de $\mbox{det}A$ puis étudier le rang de $\mbox{com}A$ en fonction du rang de $A$.}
  \reponse{On a toujours $A\times{^t}\mbox{com}A=(\mbox{det}A)I_n$ et donc 
