...
\organisation{exo7}
\contenu{
  \texte{Déterminer la partie singulière, le résidu, et
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Comme $\sin(z) =z -\frac{z^3}{3!}+... =z(1+o(z))$,
...
La partie singuli\`ere de la s\'erie de Laurent est $\frac{1}{z}$ et le terme constant est $0$.}
  \item \reponse{On a $\sin(z) -\sh(z) =(z-\frac{z^3}{3!} +\frac{z^5}{5!}+O(z^7)) -(z+\frac{z^3}{3!} +\frac{z^5}{5!}+O(z^7)) =-\frac{z^3}{3} + O(z^7)$. D'o\`u
$$f(z) =\frac{1}{\sin(z) -\sh(z)} = -\frac{3}{z^3} (1+O(z^4)) =-\frac{3}{z^3} + O(z).$$}
  \item \reponse{On obtient de mani\`ere analogue que $$f(z) =\frac{1}{z \sin(z) \sh(z)} =\frac{1}{z^3} +O(z).$$}
\end{enumerate}
}