...
\contenu{
  \texte{}
  \question{Soit $A = (a_{ij})\in\mathcal{M}_n(\R)$ symétrique. On dit que $A$ est à diagonale
...
et si $A$ est à diagonale faiblement dominante alors $A$ est positive.}
  \reponse{Pour $A$ à diagonale fortement dominante, récurrence sur $n$.
