...
\contenu{
  \texte{}
  \question{Soit $a\in[0,1[$ un r{\'e}el. En int{\'e}grant $e^{az}/\cosh z$ le long du rectangle de
sommets
$-R$, $+R$, $R+i\pi $, $-R+i\pi $, montrer que l'on a
$$ I= \int_{-\infty }^{+\infty } {e^{ax}\over \cosh x} \,dx = {\pi \over \cos(\pi a/2)}.$$}
  \reponse{Sur le c{\^o}t{\'e} $[R, R+i\pi ]$, la fonction $f(z) = e^{az}/\cosh z$ est major{\'e}e en module
par
