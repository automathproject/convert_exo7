...
\organisation{exo7}
\contenu{
  \texte{Soit $f$ la fonction $2\pi $-p\'eriodique sur $\Rr$ telle que 
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$a_0 = \pi$ et pour $n\ne 0$, $a_n = \frac{2}{\pi n^2} ((-1)^n - 1)$ (nul quand $n$ est pair), $b_n=0$.}
  \item \reponse{Par la formule de Parseval 
	\[
	\frac{2 \pi^2}{3} 
  ...
  \item \reponse{Comme
	...
	= \frac{\pi^4}{90}$.}
  \item \reponse{C'est le théorème de Dirichlet. Appliqué en $x=0$, cela implique que 
