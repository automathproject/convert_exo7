...
\contenu{
  \texte{}
  \question{Trouver une partie $A$ de $\Rr$ telle que les sept ensembles $A$,  $\overline{A}$, $\overset{\circ}{A}$, $\overline{\overset{\circ}{A}}$, $\overset{\circ}{\overline{A}}$, $\overline{\overset{\circ}{\overline{A}}}$ et $\overset{\circ}{\overline{\overset{\circ}{A}}}$  soient deux à deux distincts.}
  \reponse{L'exercice \ref{ex:rou6} montre que l'on ne peut pas faire mieux.
