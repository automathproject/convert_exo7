...
\organisation{exo7}
\contenu{
  \texte{On considère la forme différentielle $$\omega= \frac{-y}{x^2+y^2}dx+\frac{x}{x^2+y^2} dy.$$}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{La forme $\omega= \frac{-y}{x^2+y^2}dx+\frac{x}{x^2+y^2} dy$ est définie
sur $\Rr^2 \setminus \{(0,0)\}$.}
  \item \reponse{Paramétrons le cercle $C$ par $x=\cos t$, $y=\sin t$ avec $t\in [0;2\pi]$.
On obtient :
\begin{align*}
 ...
 &=& 2\pi.&&
 \end{align*}}
  \item \reponse{La forme $\omega$ n'est pas exacte, sinon son intégrale curviligne sur la courbe
