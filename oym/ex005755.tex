...
\contenu{
  \texte{}
  \question{Soit $A$ une matrice carrée complexe de format $p\in\Nn^*$.
Rayon de convergence et somme en fonction de $\chi_A$ de la série entière $\sum_{n=0}^{+\infty}\text{Tr}(A^n)z^n$.}
  \reponse{Posons $\text{Sp}_\Cc A=\left(\lambda_1,\ldots,\lambda_p\right)$. On sait que pour tout entier naturel $n$, $\text{Tr}(A^n) =\lambda_1^n+...+\lambda_p^n$.
