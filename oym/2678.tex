...
\contenu{
  \texte{}
  \question{En int{\'e}grant $e^{2iaz -z^2}$ le long du rectangle de sommets $0$, $R$, $R+ia$, $ia$, et
...
(On admettra la formule $\int_0^{+\infty }e^{-x^2}\,dx = \sqrt \pi /2$.)}
  \reponse{On int{\`e}gre $f(z) = e^{2iaz -z^2}$ sur le rectangle. Il n'y a aucun p{\^o}le, donc
