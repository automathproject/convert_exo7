...
est un paramétrage du cercle unité du plan complexe euclidien parcouru dans le sens trigonométrique.}
  \item \reponse{Comme le rayon de convergent de la série qui définit $\cosh$ est infini, 
...
\end{eqnarray*}}
  \item \reponse{Comme l'intégrale de la fonction $\frac{\cosh(z)}{z}$ sur le chemin fermé $\partial\Delta$ de $\Cc^\times$ n'est pas nulle,
