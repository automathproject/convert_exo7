...
\contenu{
  \texte{}
  \question{Déterminer le PGCD de $X^6-7X^4+8X^3-7X+7$ et $3X^5-7X^3+3X^2-7$.}
  \reponse{$X^6-7X^4+8X^3-7X+7=(X^6+8X^3+7)-(7X^4+7X)=(X^3+1)(X^3+7)-7X(X^3+1)=(X^3+1)(X^3-7X+7)$ et $3X^5-7X^3+3X^2-7=3X^2(X^3+1)-7(X^3+1)=(X^3+1)(3X^2-7)$. Donc,
