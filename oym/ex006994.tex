\exo7id{6994}
\titre{Variation de la constante}
\theme{}
\auteur{blanc-centi}
\date{2015/07/04}
\organisation{exo7}
\contenu{
  \texte{Résoudre les équations différentielles suivantes en trouvant 
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$y' - (2x - \frac{1}{x})y = 1$ sur $]0;+\infty[$
  \begin{enumerate}}
  \item \reponse{\textbf{Résolution de l'équation homogène $y' - (2x - \frac{1}{x})y = 0$.}
  ...
  \item \reponse{\textbf{Recherche d'une solution particulière.}
  ...
  \item \reponse{\textbf{Solution générale.}    
