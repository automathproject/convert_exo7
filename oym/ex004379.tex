...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Intégrer par parties.}
  \item \reponse{Intégrer deux fois par parties.}
  \item \reponse{Pour $0<u<v$~: $ \int_{t=u}^{v}e^{-it^2/2}\,d t =
  ...
  \item \reponse{On pose $f(t) = f(0) + t\varphi(t)$ avec $\varphi$ de
