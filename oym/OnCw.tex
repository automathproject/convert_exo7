...
\organisation{exo7}
\contenu{
  \texte{Soit $k$ un corps de caractéristique différente
de $2$.
...
(x)=x+f(x)a$.}
\begin{enumerate}
  \item \question{On suppose désormais que $\tau$ est une isométrie relativement à $\phi$. Montrer que $a$ est isotrope.}
