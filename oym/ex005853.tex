...
\contenu{
  \texte{}
  \question{Soit $z$ un nombre complexe. Déterminer $\lim_{n \rightarrow +\infty}\left(1+ \frac{z}{n}\right)^n$.}
  \reponse{\textbf{1ère solution.} Soit $z\in\Cc$. Posons $z = x+iy$ où $(x,y)\in\Rr^2$ et $1+ \frac{r}{n}=r_ne^{i\theta}$ où $r_n\geqslant0$ et $\theta_n\in]-\pi,\pi]$ de sorte que 
