...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $G$ un groupe fini agissant sur un ensemble fini $E$.
 ...
 \frac{1}{\text{Card} G}\sum_{x\in E}\text{Card} Stab(x).$$}
  \item \reponse{Le groupe des déplacements du tétraède est isomorphe à $\mathcal{A}_4$.
