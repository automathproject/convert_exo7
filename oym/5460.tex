...
\contenu{
  \texte{}
  \question{Etude complète de $F(x)=\int_{x}^{2x}\frac{dt}{\sqrt{t^4+t^2+1}}$.}
  \reponse{Pour $t\in\Rr$, posons $g(t)=\frac{1}{\sqrt{t^4+t^2+1}}$. $g$ est continue sur $\Rr$ et admet donc des primitives sur $\Rr$. Soit $G$ une primitive de $g$ sur $\Rr$.
