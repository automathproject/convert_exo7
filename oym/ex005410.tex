...
\contenu{
  \texte{}
  \question{Soit $f$ une fonction convexe sur un intervalle ouvert $I$ de $\Rr$. Montrer que $f$ est continue sur $I$ et même dérivable à droite et à gauche en tout point de $I$.}
  \reponse{Supposons que $f$ est convexe sur un intervalle ouvert $I=]a,b[$ ($a$ et $b$ réels ou infinis).
