...
\contenu{
  \texte{}
  \question{Soient deux cercles se coupant en deux points distincts $A$ et $B$, et $\mathcal D$ une tangente commune, touchant les cercles en $C$ et $D$. Montrer que $(AB)$ coupe $[CD]$ en son milieu.
\begin{center}
\includegraphics{../images/img007142-1}
\end{center}}
  \reponse{Rappelons la figure:
