...
\contenu{
  \texte{}
  \question{Soient $A$ et $B$ deux éléments de $\mathcal{M}_n(\Rr)$. Montrer que si $A$ et $B$ sont semblables dans $\mathcal{M}_n(\Cc)$, elles le sont dans $\mathcal{M}_n(\Rr)$.}
  \reponse{Soient $A$ et $B$ deux matrices carrées réelles de format $n$ semblables dans $\mathcal{M}_n(\Cc)$.
