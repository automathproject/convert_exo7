\uuid{4924}
\titre{Triangle sur une hyperbole, Ensi P 91}
\theme{}
\auteur{quercia}
\date{2010/03/17}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Soit $\cal H$ une hyperbole équilatère et $ABC$ un triangle dont les
  ...
  \reponse{On se ramène à une hyperbole d'équation $xy = 1$.
