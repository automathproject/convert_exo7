...
\organisation{exo7}
\contenu{
  \texte{Soit $p(x) = \sum_{i=0}^{n} a_i \cdot x^i$. On suppose que tous les
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $\frac \alpha \beta \in \Qq$ avec $\pgcd(\alpha,\beta) = 1$.
...
$a_0$.}
  \item \reponse{Notons $\gamma = \sqrt 2+\sqrt 3$.
