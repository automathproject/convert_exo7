...
\contenu{
  \texte{}
  \question{Déterminer l'image par $z\mapsto \frac{3z+5}{z+2}$ du cercle
...
en $3$, de la droite verticale passant en $-2$.}
  \reponse{L'application $\Phi (z)=\frac{3z+5}{z+2}$ est une homographie. L'image d'un cercle est alors de nouveau
