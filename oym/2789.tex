...
\contenu{
  \texte{}
  \question{Retrouver le résultat de l'exercice précédent (l'exercice \ref{ex:burnol1.1.6}) de manière
  ...
  \reponse{Il suffit d'utiliser la formule de Leibniz de l'exercice \ref{ex:burnol1.1.5} et le fait que le coefficient $a_n$
