...
\organisation{exo7}
\contenu{
  \texte{Notons $a=1\;111\;111\;111$ et $b=123\;456\;789$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$a=9b+10$.}
  \item \reponse{Calculons le pgcd par l'algorithme d'Euclide. 
$a = 9b+10$, $b = 12345678 \times 10 + 9$, $10 = 1 \times 9 +1$.
Donc le pgcd vaut $1$;}
  \item \reponse{Nous reprenons les \'equations pr\'ec\'edentes en partant de la fin:
