...
\contenu{
  \texte{}
  \question{Soient $A$ et $B$ deux parties non vides et majorées de $\Rr$. Que dire de $\mbox{sup}(A\cap B)$, $\mbox{sup}(A\cup B)$, $\mbox{sup}(A+B)$ et $\mbox{sup}(AB)$~?~($A+B$ (resp. $AB$) désigne l'ensemble des sommes (resp. des produits) d'un élément de $A$ et d'un élément de $B$).}
