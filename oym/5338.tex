\uuid{5338}
\titre{Exercice 5338}
\theme{Fractions rationnelles, polynômes, équations algébriques}
\auteur{rouget}
\date{2010/07/04}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Soit $F=\frac{P}{Q}$ où $P$ et $Q$ sont des polynômes tous deux non nuls et premiers entre eux. Montrer que $F$ est paire si et seulement si $P$ et $Q$ sont pairs. Etablir un résultat analogue pour $F$ impaire.}
  \reponse{Soient $P$ et $Q$ deux polynômes non nuls et premiers entre eux, puis soit $F=\frac{P}{Q}$. Si $F$ est paire, alors $\frac{P(-X)}{Q(-X)}=\frac{P(X)}{Q(X)}$, ou encore $P(-X)Q(X)=P(X)Q(-X)$ $(*)$.
