\uuid{MhpD}
\exo7id{7001}
\titre{\'Equations de Bernoulli et Riccatti}
\theme{\'Equations différentielles, Pour aller plus loin}
\auteur{blanc-centi}
\date{2015/07/04}
\organisation{exo7}
\contenu{
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{\textbf{\'Equation de Bernoulli}
  \begin{enumerate}}
  \item \reponse{On suppose qu'une solution $y$ ne s'annule pas.
  ...
  \item \reponse{\'Equation $xy'+y-xy^3 = 0$.
