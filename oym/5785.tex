...
\contenu{
  \texte{}
  \question{Développer en série de \textsc{Fourier} la fonction $f~:~x\mapsto x-E(x)-\frac{1}{2}$.}
  \reponse{La fonction $f$ est $1$-périodique, continue par morceaux sur $\Rr$. On peut donc calculer ses coefficients de \textsc{Fourier}. 
