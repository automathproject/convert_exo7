...
\contenu{
  \texte{}
  \question{Calculer $\int_{0}^{+\infty}\frac{x}{\sh x}\;dx$ en écrivant cette intégrale comme somme d'une série.}
  \reponse{C'est presque le même exercice que l'exercice \ref{ex:rou3bis}. Pour tout réel $x>0$,
