...
\end{tikzpicture} 
\end{center}}
  \item \reponse{S'il est toujours possible de représenter le graphe d'une fonction comme une courbe 
...
\end{tikzpicture}  
\end{center}}
  \item \reponse{On constate, en utilisant la formule $\sin^2t=1-\cos^2t=-1-x(t)$, que
\begin{eqnarray*}
