...
\contenu{
  \texte{}
  \question{Soit $E$ un $\Rr$-espace vectoriel muni d'une norme, notée $\|\;\|$, vérifiant l'identité du parallélogramme. Montrer que cette norme est hilbertienne.}
  \reponse{Soit $N$ une norme sur $E$ vérifiant $\forall(x,y)\in E^2$ $(N(x+y))^2+(N(x-y))^2 = 2((N(x))^2+(N(y))^2)$.
