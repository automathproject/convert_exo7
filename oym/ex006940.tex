\uuid{6940}
\titre{Calcul de loi, fonction de répartition}
\theme{}
\auteur{ruette}
\date{2013/01/24}
\organisation{exo7}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$P(Z\leq t)=0$ si $t<0$ et $P(Z\leq t)=P(-\sqrt{t}\leq X\leq \sqrt{t})$
...
$f_Z(t)=\I1_{\Rr_+^*}(t)\frac{1}{\sqrt{2\pi t}}e^{-t/2}$.}
  \item \reponse{$F_{Y^3}(t)=P(Y^3\leq t)=P(Y\leq\sqrt[3]{t})=F_Y(\sqrt[3]{t})$. 
