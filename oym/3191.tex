\uuid{3191}
\titre{$\sum_{k=1}^{100}\frac k{x-k}\ge 1$ (Ens Ulm-Lyon-Cachan MP$^*$ 2003)}
...
\contenu{
  \texte{}
  \question{Montrer que l'ensemble des solutions de l'in{\'e}quation $\sum_{k=1}^{100}\frac k{x-k}\ge 1$
est une r{\'e}union finie d'intervalles disjoints. Calculer la somme des
longueurs de ces intervalles.}
  \reponse{Soit~$f(x) = \sum_{k=1}^{100}\frac k{x-k}$.
