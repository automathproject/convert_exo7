...
\contenu{
  \texte{}
  \question{On pose $u_1=1$ et, $\forall n\in\Nn^*,\;u_{n+1}=1+\frac{n}{u_n}$. Montrer que $\lim_{n\rightarrow +\infty}(u_n-\sqrt{n})=\frac{1}{2}$.}
  \reponse{Tout d'abord , on montre facilement par récurrence que, pour tout entier naturel non nul $n$, $u_n$ existe et $u_n\geq1$.
