...
\contenu{
  \texte{}
  \question{Pour $n\geq1$, on pose $H_n=\sum_{k=1}^{n}\frac{1}{k}$. Montrer que, pour $n\geq2$, $H_n$ n'est jamais un entier
...
les cas où $n$ est pair et $n$ est impair).}
  \reponse{Montrons par récurrence que, pour $n\geq2$, $H_n$ peut s'écrire sous la forme $\frac{p_n}{q_n}$ où $q_n$ est un
