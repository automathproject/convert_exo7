...
\contenu{
  \texte{}
  \question{Soit $(n,a,b)\in\Nn^*\times]0,+\infty[\times]0,+\infty[$. Quel est le plus grand terme du développement de $(a+b)^n$~?}
  \reponse{Soit $n$ un entier naturel non nul. Le terme général du développement de $(a+b)^n$ est $u_k=\binom{n}{k}a^kb^{n-k}$, $0\leq
