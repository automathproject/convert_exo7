...
\contenu{
  \texte{}
  \question{Soit $f(x) =\ln(1+x)$ pour $x$ réel positif. Soient $f_1 = f$, $f_2=f\circ f$ et $f_3= f\circ f\circ f$. Etudier la liberté de $(f_1,f_2,f_3)$ dans $[0,+\infty[^{[0,+\infty[}$.}
  \reponse{Les fonctions $f_1$, $f_2$ et $f_3$ sont bien définies sur $\Rr^+$.
