...
\contenu{
  \texte{}
  \question{$E=\Rr_n[X]$. Pour $0\leqslant k\leqslant n$, on pose $P_k=X^k(1-X)^{n-k}$. Montrer que la famille $(P_k)_{0\leqslant k\leqslant n}$ est une base de $E$.}
  \reponse{\textbf{Première solution.} Chaque $P_k$, $0\leqslant k\leqslant n$, est de degré $k+n-k=n$ et est donc dans $\Rr_n[X]$.
