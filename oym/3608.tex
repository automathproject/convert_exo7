\uuid{3608}
\titre{$\dim(\mathrm{Ker} f^2) = 2\dim(\mathrm{Ker} f)$, Mines-Ponts MP 2005}
...
\contenu{
  \texte{}
  \question{Soit $E$ un espace vectoriel de dimension finie et $f\in\mathcal{L}(E)$ tel que
...
et $k\in\N^*$ tels que $g^k = f$ alors $k$ divise $d$.}
  \reponse{En appliquant le théorème du rang à $f_{|\mathrm{Ker} f^2}$, on a~:
