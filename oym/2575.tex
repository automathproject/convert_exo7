\uuid{2575}
\titre{Exercice 2575}
\theme{Sujets de l'année 2004-2005, Rattrapage}
\auteur{delaunay}
\date{2009/05/19}
\organisation{exo7}
\contenu{
  \texte{}
  \question{({\it 4 points}) On suppose qu'une population $x$ de lapins et une population $y$ de loups sont gouvern\'ees par le syst\`eme suivant d'\'equations diff\'erentielles :
...
\end {enumerate}}
  \reponse{{\it On suppose qu'une population $x$ de lapins et une population $y$ de loups sont gouvern\'ees par le syst\`eme suivant d'\'equations diff\'erentielles} :
$$(S)\ \ \left\{\begin{align*}x'&= 4x-2y \\  y'&= x+y\end{align*}\right.$$
\begin {enumerate}
