...
\contenu{
  \texte{}
  \question{Trouver un polynôme de degré $5$ tel que $P(X)+10$ soit divisible par $(X+2)^3$ et $P(X)-10$ soit divisible par 
$(X-2)^3$.}
  \reponse{Soit $P$ un tel polynôme. $-2$ est racine de $P+10$ d'ordre au moins trois et donc racine de $(P+10)'= P'$ d'ordre au moins deux.
