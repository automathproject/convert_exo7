...
\organisation{exo7}
\contenu{
  \texte{Soit $D_\infty $ le groupe des isométries de la droite affine $\R $ formé par l'ensemble des éléments de la forme $\tau_1^n$ et $\tau_1^n \circ \sigma$, où $n\in \Z$, $\tau_1(x)=x+1$ et $\sigma (x)=-x$. On appelle $D_\infty$ {\it le groupe diédral infini}.}
\begin{enumerate}
