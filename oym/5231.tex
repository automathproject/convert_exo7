...
\contenu{
  \texte{}
  \question{Montrer que les suites définies par la donnée de $u_0$, $v_0$ et $w_0$ réels tels que $0<u_0<v_0<w_0$ et les relations de récurrence~:
...
ont une limite commune que l'on ne cherchera pas à déterminer.}
  \reponse{Montrons tout d'abord que~:
