...
\contenu{
  \texte{}
  \question{Déterminer les différents angles d'un tétraèdre régulier (entre deux faces, entre deux arêtes et entre une arête et une face).}
  \reponse{$$\includegraphics{../images/img005521-1}$$
