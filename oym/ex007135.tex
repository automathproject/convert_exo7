\uuid{7135}
\titre{Problème \og DPP\fg }
\theme{}
\auteur{megy}
\date{2017/02/08}
\organisation{exo7}
\contenu{
  \texte{Soit $\mathcal D$ une droite et $A$ et $B$ deux points situés d'un seul côté de $\mathcal D$. L'objectif est de construire un cercle passant par les deux points et tangent à la droite.}
\begin{enumerate}
