...
\contenu{
  \texte{}
  \question{Pour quelles valeurs de $a$ le polynôme $(X+1)^7-X^7-a$ admet-il une racine multiple réelle?}
  \reponse{Soit $x\in\R$ ; $x$ est une racine multiple de $P$ si et seulement si $P(x)=0$ et $P'(x)=0$:
$$
\begin{array}{rcl}
P(x)=P'(x) 0 
