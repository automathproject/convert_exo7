...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $z=re^{i\theta}\in\Cc$ avec $r\geq 0$ et $\theta\in ]-\pi,\pi]$.
\begin{eqnarray*}
...
% \end{tikzpicture}}
  \item \reponse{Soit $z=re^{i\theta}\in\Cc$ avec $r\geq 0$ et $\theta\in ]-\pi,\pi]$.
\begin{itemize}}
  \item \reponse{Si $\theta\in]-\frac{\pi}{3},\frac{\pi}{3}[$, $ 3\theta\in]-\pi,\pi[$
 et donc, $f(z)=\log(z^3)=\log_\Rr(r^3)+i3\theta=3\log_\Rr(r)+3i\theta=3\log(z)$.}
  \item \reponse{Si $\theta\in]\frac{\pi}{3},\pi[$, $ 3\theta\in]\pi,3\pi[$ et $ 3\theta-2\pi\in]-\pi,\pi[$
 et donc, $f(z)=\log(z^3)=\log_\Rr(r^3)+i(3\theta-2\pi)=3\log_\Rr(r)+3i\theta-2i\pi=3\log(z)-2i\pi$.}
  \item \reponse{Si $\theta\in]-\pi,-\frac{\pi}{3},[$, $ 3\theta\in]-3\pi,-\pi[$ et $ 3\theta+2\pi\in]-\pi,\pi[$
 et donc, $f(z)=\log(z^3)=\log_\Rr(r^3)+i(3\theta+2\pi)=3\log_\Rr(r)+3i\theta+2i\pi=3\log(z)+2i\pi$.
\end{itemize}
...
aux points de la demi-droite d'angle $\pi$.}
  \item \reponse{La réponse a été donnée dans la question précédente.}
\end{enumerate}
}