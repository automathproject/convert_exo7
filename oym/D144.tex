...
\exo7id{155}
\titre{Exercice 155}
\theme{Logique, ensembles, raisonnements, Récurrence}
\auteur{bodin}
\date{1998/09/01}
\organisation{exo7}
\contenu{
  \texte{Soit la suite $(x_n)_{n\in \Nn}$ d\'efinie par
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Montrons par r\'ecurrence $\forall n \in \Nn\  x_n > 3$.
Soit l'hypoth\`ese de r\'ecurrence :
$$(\mathcal{H}_n) : \quad x_n >3.$$

\begin{itemize}}
  \item \reponse{[$\bullet$] La proposition $\mathcal{H}_0$ est vraie car $x_0 = 4 > 3$.}
  \item \reponse{[$\bullet$] Soit $n\geq 0$, supposons $\mathcal{H}_n$ vraie et montrons
...
est vraie.}
  \item \reponse{[$\bullet$] Nous avons montré
...
\end{itemize}}
  \item \reponse{Montrons que  $x_{n+1}-3 - \frac{3}{2}(x_n-3)$ est positif.
$$x_{n+1}-3 - \frac{3}{2}(x_n-3) =
\frac{2{x_n}^2-3}{x_n+2}-\frac{3}{2}(x_n-3) =
\frac{1}{2}\frac{{x_n}^2-3x_n}{x_n+2}$$ Ce dernier terme est
positif car $x_n >3$.}
  \item \reponse{Montrons par r\'ecurrence $\forall n \in \Nn\  x_n > \left(\frac{3}{2}\right)^n+3$.
Soit notre nouvelle l'hypoth\`ese de r\'ecurrence :
$$(\mathcal{H}_n) \quad x_n >\left( \frac{3}{2}\right)^n+3.$$

\begin{itemize}}
  \item \reponse{[$\bullet$] La proposition $\mathcal{H}_0$ est vraie.}
  \item \reponse{[$\bullet$] Soit $n\geq 0$, supposons que $\mathcal{H}_n$ vraie et montrons
...
\left(\frac{3}{2}\right)^{n+1}$.}
  \item \reponse{[$\bullet$] Nous concluons en r\'esumant la situation :\\
$\mathcal{H}_{0}$ est vraie, et $\mathcal{H}_{n} \Rightarrow
\mathcal{H}_{n+1}$ quelque soit $n$. Donc $\mathcal{H}_{n}$ est
toujours vraie.
\end{itemize}}
  \item \reponse{La suite $(x_n)$ tend vers $+\infty$ et n'est donc pas convergente.}
\end{enumerate}
}