...
$\frac{X}{(X+ i )^2}$
en \'el\'ements simples sur $\mathbb{C}$.}
  \item \question{D\'ecomposer $\frac{X^2+1}{X^4+1}$ en \'el\'ements simples sur $\mathbb{R}$ et sur $\mathbb{C}$.}
  \item \question{D\'ecomposer 
$\frac{X}{X^4+1}$
...
$ j =-\frac{1}{2}+\frac{\sqrt{3}}{2} i $.}
  \item \reponse{$\frac{X^3-2}{X^4(X^2+X+1)^2} = 
