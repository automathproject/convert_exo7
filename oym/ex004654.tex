\exo7id{4654}
\titre{$\sum_{n=-\infty}^\infty R(n)e^{inx}$, $R =$ fraction rationnelle}
\theme{}
\auteur{quercia}
\date{2010/03/14}
\organisation{exo7}
\contenu{
  \texte{Soit $R$ une fraction rationnelle à coefficients complexes, de degré strictement
