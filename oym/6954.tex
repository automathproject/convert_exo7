\uuid{6954}
\titre{Le paradoxe des cordes de Bertrand}
\theme{}
\auteur{ruette}
\date{2013/01/24}
\organisation{exo7}
\contenu{
  \texte{}
  \question{On considère un cercle. On choisit une corde au hasard et on cherche la
...
rigoureuse du hasard.
  ...
  \reponse{Voici plusieurs façons de définir une corde, qui mènent à choisir un point
