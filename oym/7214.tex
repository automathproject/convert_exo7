...
\contenu{
  \texte{}
  \question{On considère la fonction $f : \C\to \C, z\mapsto \sqrt{|xy|}$, où l'on a noté $z=x+iy$ la forme algébrique de $z$. Montrer qu'elle vérifie les conditions de Cauchy-Riemann en l'origine, mais qu'elle n'est pas $\C$-dérivable en l'origine.}
  \reponse{Ici on a \(f(x+iy)=u(x,y)+iv(x,y)\) où \(u(x,y)=\sqrt{|xy|}\) et \(v(x,y)=0\) pour tout \((x,y)\in \R^2\).
\begin{enumerate}
