...
\contenu{
  \texte{}
  \question{Dans $\Rr^4$ muni du produit scalaire usuel, on pose~:~$V_1=(1,2,-1,1)$ et $V_2=(0,3,1,-1)$.
On pose $F=\mbox{Vect}(V_1,V_2)$. Déterminer une base orthonormale de $F$ et un système d'équations de $F^\bot$.}
  \reponse{La famille $(V_1,V_2)$ est clairement libre et donc une base de $F$. Son orthonormalisée $(e_1,e_2)$ est une base orthonormée de $F$.
