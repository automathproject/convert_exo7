...
\end{enumerate}
\begin{enumerate}
  \item \reponse{L'espace vectoriel $\mathbb{R}$ a deux sous-espaces : celui formé du vecteur nul $\{0\}$  et $\Rr$ lui-m\^eme.
\\
...
les plans vectoriels et lui-m\^eme.}
  \item \reponse{On consid\`ere deux droites vectorielles de $\mathbb{R}^3$ dont des vecteurs directeurs 
