...
\contenu{
  \texte{}
  \question{Equation cartésienne du cylindre de révolution $(\mathcal{C})$ de rayon $R$ et d'axe $(\mathcal{D})$ d'équations $\left\{
\begin{array}{l}
x=z+2\\
y=z+1
\end{array}
\right.$. Déterminer $R$ pour que la droite $(Oz)$ soit tangente au cylindre.}
  \reponse{Un repère de $(\mathcal{D})$ est $\left(A,\overrightarrow{u}\right)$ où $A(2,1,0)$ et $\overrightarrow{u}(1,1,1)$.
