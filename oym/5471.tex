...
\contenu{
  \texte{}
  \question{Condition nécessaire et suffisante sur $a$, $b$, $c$ et $d$ pour que les primitives de $\frac{(x-a)(x-b)}{x-c)^2(x-d)^2}$ soient rationnelles ($a$, $b$, $c$ et $d$ réels donnés).}
