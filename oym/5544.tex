...
\contenu{
  \texte{}
  \question{Déterminer l'image du cercle trigonométrique par la fonction
$\begin{array}[t]{cccc}f~:&\Cc&\rightarrow&\Cc\\
 &z&\mapsto&\frac{1}{1+z+z^2}
\end{array}$.}
  \reponse{Un point du plan est sur le cercle de centre $O$ et de rayon $1$ si et seulement si son affixe $z$
