...
\organisation{exo7}
\contenu{
  \texte{On considère la courbe paramétrée
$$\begin{array}{cccc}
        c~:~&]0,1[&\to&\Rr ^3\\
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Comme les composantes de $c$ sont de classe $\mathcal{C}^\infty$, elle est de classe $\mathcal{C}^\infty$.
  La dérivée de la dernière coordonnée ne s'annule jamais.
 La courbe $c$ est donc régulière.}
  \item \reponse{Le vecteur vitesse
 ...
 de la forme $e(s)=c(\phi(s))$ est un reparamétrage par longueur d'arc, car $de/ds$ est partout de norme $1$.}
  \item \reponse{On utilise le paramétrage par longueur d'arc.
