...
\contenu{
  \texte{}
  \question{D\'eterminer pour quelles valeurs de $ t\in {\Rr} $ les
vecteurs  
$$\big\{(1, 0, t),  (1, 1, t), (t,0,1)\big\}$$
forment une base de  $\Rr^3$.}
  \reponse{Quand le nombre de vecteurs égal la dimension de l'espace  nous avons les équivalences, entre 
