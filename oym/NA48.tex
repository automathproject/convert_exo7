\uuid{NA48}
\exo7id{4853}
\titre{Centre de gravit{\'e} d'une courbe param{\'e}tr{\'e}e}
\theme{Exercices de Michel Quercia, Fonctions vectorielles}
\auteur{quercia}
\date{2010/03/16}
\organisation{exo7}
\contenu{
  \texte{Soit $\varphi : {[a,b]} \to {\R^2}, t \mapsto {M_t}$ une courbe param{\'e}tr{\'e}e de classe
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{demi-cercle unit{\'e} $ \Rightarrow  x = 0$, $y = \frac 2\pi$.}
  \item \reponse{Sommes de Riemann + l'enveloppe convexe d'un compact est compacte.}
  \item \reponse{$\vec N\,'(t) = \vec\sigma(\vec M\,'(t))  \Rightarrow 
             \|\vec N\,'(t)\| = \|\vec M\,'(t))\|$.\par
