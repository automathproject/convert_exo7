...
\contenu{
  \texte{}
  \question{Montrer que tout hyperplan de $\mathcal{M}_n(\Kk)$ $(n\geq 2)$ contient au moins une matrice inversible.}
  \reponse{Soit $H$ un hyperplan de $\mathcal{M}_n(\Kk)$ et $f$ une forme linéaire non nulle sur $\mathcal{M}_n(\Kk)$ telle que $H=\mbox{Ker}f$.
