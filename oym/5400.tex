...
\contenu{
  \texte{}
  \question{Soient $a$ et $b$ deux réels tels que $0<a<b$. Montrer que $\bigcup_{k\geq1}]ka,kb[$ contient un intervalle de la forme $]A,+\infty[$ puis déterminer la plus petite valeur possible de $A$.}
  \reponse{Soient $a$ et $b$ deux réels fixés tels que $0<a<b$. Trouvons les entiers naturels non nuls $k$ tels que 
