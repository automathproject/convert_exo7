...
\organisation{exo7}
\contenu{
  \texte{On considère le contour $\Gamma$ et les points $w_1$, $w_2$, $w_3$ comme sur la figure ci-dessous
 \begin{center} 
 \begin{tikzpicture}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{On note d'abord que les indices de $w_1,w_2,w_3$ par rapport à $\Gamma$ sont respectivement $-1,1$ et $0$.
