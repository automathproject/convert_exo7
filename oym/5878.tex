...
\contenu{
  \texte{}
  \question{Déterminer le rayon de convergence puis calculer $\sum_{n=0}^{+\infty}(-1)^{n-1} \frac{C_{2n}^n}{2n-1}x^n$ quand $x$ appartient à l'intervalle ouvert de convergence. En déduire la valeur de $\sum_{n=0}^{+\infty} \frac{(-1)^{n-1}C_{2n}^n}{(2n-1)4^n}$.}
  \reponse{\textbullet~Pour $n\in\Nn$, posons $a_n=(-1)^{n-1} \frac{C_{2n}^n}{2n-1}$. La suite $(a_n)_{n\in\Nn}$ ne s'annule pas et pour $n\in\Nn$,
