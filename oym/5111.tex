...
\contenu{
  \texte{}
  \question{Parmi $f\circ g\circ h$, $g\circ h\circ f$ et $h\circ f\circ g$ deux sont injectives et une est surjective. Montrer que
$f$, $g$ et $h$ sont bijectives.}
  \reponse{On peut supposer sans perte de généralité que $f\circ g\circ h$ et $g\circ h\circ f$ sont injectives et que $h\circ
