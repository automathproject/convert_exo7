...
\contenu{
  \texte{}
  \question{Dans les barres de chocolat N., on trouve des images équitablement
...
Même question pour être sûr à $90$\%.}
  \reponse{La probabilité d'avoir Princecharmant dans la barre B est $\frac{1}{5}; $ si j'achète $n$ barres, la probabilité de n'avoir la
