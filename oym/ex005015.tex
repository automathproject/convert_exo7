\uuid{5015}
\titre{Cercle osculateur à une parabole}
\theme{}
\auteur{quercia}
\date{2010/03/17}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Soit $\cal P$ une parabole, $M \in \cal P$ et $\cal C$ le cercle osculateur à
$\cal P$ en $M$.
Montrer que, sauf cas particulier, $\cal C$ recoupe $\cal P$ en un deuxième
point $P$.
Déterminer l'enveloppe des droites $(MP)$.}
  \reponse{$M = (t^2/2p,t)  \Rightarrow  I = (3t^2/2p+p,-t^3/p^2)$.
         Soit $P = (u^2/2p,u)$ :
