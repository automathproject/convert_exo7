...
\contenu{
  \texte{}
  \question{Soit $f(x)=\frac{x}{1-x^2}$. Calculer $f^{(n)}(0)$ en moins de $10$ secondes puis $f^{(n)}(x)$ pour $|x|\neq1$ en à peine plus de temps).}
  \reponse{$f$ est de classe $C^\infty$ sur son domaine $\Rr\setminus\{-1,1\}$ en tant que fraction rationelle et en particulier admet un développement limité à tout ordre en $0$. Pour tout entier naturel $n$, on a
