...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $r=\frac pq\in \Qq$ et $x\notin\Qq$.
...
Ceci fournit une contradiction. Conclusion : $\sqrt{2}$ n'est pas un nombre rationnel.}
  \item \reponse{Soient $r,r'$ deux rationnels avec $r<r'$. Notons $x=r + \frac{\sqrt2}{2}(r'-r)$.
