\uuid{930}
\titre{Exercice 930}
\theme{Applications linéaires, Définition}
\auteur{legall}
\date{1998/09/01}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Soit $E$ un espace vectoriel de dimension $n$ et
...
famille  $\{ x,\phi(x),\phi^2(x), \ldots ,\phi ^{n-1}(x)\} $  est une base de $E$.}
  \reponse{Montrons que la famille  $\{ x,\phi(x),\phi^2(x), \ldots , \phi ^{n-1}(x) \}$ est
