\exo7id{4828}
\titre{Application presque contractante}
\theme{}
\auteur{quercia}
\date{2010/03/16}
\organisation{exo7}
\contenu{
  \texte{Soit $A$ une partie compacte d'un evn $E$ et $f : A \to  A$ telle que :
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$d(x_n,a)$ d{\'e}croit, donc tend vers $d$.  Il existe une
