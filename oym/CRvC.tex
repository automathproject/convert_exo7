\uuid{CRvC}
\exo7id{5973}
\titre{Coordonn\'ees sph\'eriques dans $\mathbb{R}^{n}$}
\theme{Compléments d'intégration, Théorème de Newton, réarrangement à symétrie sphérique}
\auteur{tumpach}
\date{2010/11/11}
\organisation{exo7}
\contenu{
  \texte{Soit $\Omega'$ l'ouvert de $\mathbb{R}^{n}$ d\'efini par
$$
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Posons $\Omega = \mathbb{R}^n\setminus\{
...
est un diff\'eomorphisme de $\Omega'$ sur $\Omega$.}
  \item \reponse{C'est la formule du changement de variable.}
  \item \reponse{On a~:
$$
