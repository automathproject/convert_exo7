...
\contenu{
  \texte{}
  \question{Déterminer les matrices $A$, carrées d'ordre $n$, telles que pour toute matrice carrée $B$ d'ordre $n$ on a $\mbox{det}(A+B)=\mbox{det}A+\mbox{det}B$.}
  \reponse{On suppose $n\geq2$. La matrice nulle est solution du problème.
