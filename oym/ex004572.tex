\exo7id{4572}
\titre{Division par $z-\rho$}
\theme{}
\auteur{quercia}
\date{2010/03/14}
\organisation{exo7}
\contenu{
  \texte{Soit $a(z) = \sum_{n=0}^\infty a_nz^n$ une série entière de rayon de
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Série produit de $a(z)$ et $\frac1{z-\rho}  \Rightarrow 
             b_n = \sum_{k=0}^\infty a_{k+n+1}\rho^k$.}
  \item \reponse{Si $a(\rho) \ne 0$ : $b(z)$ converge pour $|z|<\rho$ et tend vers
