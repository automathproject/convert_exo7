...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$E=\text{Vect}(I,J)$ est un sous-espace vectoriel de $\mathcal{M}_2(\Rr)$ de dimension inférieure ou égale à 2. De plus, la famille $(I,J)$ est libre car la matrice $J$ n'est pas une matrice scalaire et donc $\text{dim}E= 2$.}
  \item \reponse{Puisque $(E,+,.)$ est un espace vectoriel, $(E,+)$ est un groupe commutatif.
...
\textbf{Remarque.} Puisque $I\in E$, $M(x,y)$ est inversible dans $E$ si et seulement si $M(x,y)$ est inversible dans $\mathcal{M}_2(\Rr)$.}
  \item \reponse{Posons $X= xI+yJ$, $(x,y)\in\Rr^2$. 

  \begin{enumerate}}
  \item \reponse{D'après 1), $X^2=(x^2-y^2)I+(2xy+2y^2)J$. Donc
