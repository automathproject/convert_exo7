...
\organisation{exo7}
\contenu{
  \texte{Soit $y : \R \to \R$ une solution non identiquement nulle de
$y'' + e^t y = 0$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{L'ensemble des zéros est localement fini d'après Cauchy-Lipchitz.
  ...
  \item \reponse{Soit $b_n = \frac\pi{e^{a_n/2}}$.
