...
\organisation{exo7}
\contenu{
  \texte{Etudier (convergence simple, convergence absolue, convergence uniforme, convergence normale) les séries de fonctions de termes généraux :}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{\textbf{Convergence simple.} Chaque fonction $f_n$, $n\in\Nn$, est définie sur $\Rr$. Soit $x\in\Rr$.
...
\end{center}}
  \item \reponse{\textbf{Convergence simple.} Chaque fonction $f_n$, $n\in\Nn^*$, est définie sur $]0,+\infty[$. Soit $x\in]0,+\infty[$. Puisque $f_n(x)\underset{n\rightarrow+\infty}{\sim}\frac{1}{n^3x^2}>0$, la série numérique de terme général $f_n(x)$ converge. Donc
...
\end{center}}
  \item \reponse{\textbf{Convergence simple.} Chaque fonction $f_n$, $n\in\Nn$, est définie sur $\Rr$ et impaire. Soit $x\in\Rr^+$.
