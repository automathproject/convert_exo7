...
\end{enumerate}
\begin{enumerate}
  \item \reponse{(Formule de \textsc{Legendre}) Soit $n$ un entier naturel supérieur ou égal à $2$.
...
$$E(\frac{n}{p})+E(\frac{n}{p^2})+E(\frac{n}{p^3})+...$$}
  \item \reponse{L'exposant de $5$ dans la décomposition primaire de $1000!$ est
