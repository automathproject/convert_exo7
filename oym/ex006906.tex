...
\organisation{exo7}
\contenu{
  \texte{On lance $10$ fois une pièce supposée bien équilibrée. 
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$Y\sim B(10,1/2)$, $X=Y/10$.}
  \item \reponse{$P(X>0,5)=P(Y>5)=P(Y=6,7,8,9,10)\simeq 0,377$.}
  \item \reponse{$P(0,4\le X\le 0,6)=P(4\le Y\le 6)=P(Y=4,5,6)\simeq 0,656$}
  \item \reponse{$P(3\le Y\le 7)\simeq 0,891$. $P(2\le Y\le 8)\simeq 0,978$. Donc $a=3$.}
  \item \reponse{Oui. Non.}
\end{enumerate}
}