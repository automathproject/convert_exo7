...
\organisation{exo7}
\contenu{
  \texte{Soient $a$ et $b$ deux r\'eels, $a<b$. On consid\`ere la
...
$u_{n+1}=f(u_n)$ nous obtenons l'\'egalit\'e $\ell = f(\ell)$.}
  \item \reponse{La fonction $f$ définie par $f(x) = \frac{4x+5}{x+3}$ est continue et d\'erivable sur l'intervalle $[0,4]$ et $f([0,4])\subset [0,4]$.
...
\frac{1+\sqrt{21}}{2}=2,7912\ldots$}
  \item \reponse{Si $f$ est d\'ecroissante alors $f\circ f$ est croissante (car $x\leqslant y \Rightarrow
...
f\circ f(u_1),u_5 = f\circ f(u_3),\ldots)$.}
  \item \reponse{La fonction $f$ définie par $f(x) = (1-x)^2$ est continue et d\'erivable de $[0,1]$ dans $[0,1]$.
