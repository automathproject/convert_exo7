...
\organisation{exo7}
\contenu{
  \texte{Pour $z\in\Cc\setminus\{1\}$, on pose $Z=\frac{1+z}{1-z}$. Déterminer et construire
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$$|Z|=1\Leftrightarrow\frac{|1+z|^2}{|1-z|^2}=1\Leftrightarrow(1+x)^2+y^2=(1-x)^2+y^2\;\text{et}\;(x,y)\neq(1,0)\Leftrightarrow4x=0\Leftrightarrow x=0.$$
