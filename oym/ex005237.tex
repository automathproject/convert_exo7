...
\contenu{
  \texte{}
  \question{Etudier les deux suites $u_n=\sum_{k=0}^{n}\frac{1}{k!}$ et $v_n=u_n+\frac{1}{n.n!}$.}
  \reponse{Il est immédiat que $u$ croit strictement et que $v-u$ est strictement positive et tend vers $0$.
