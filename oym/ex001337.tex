...
\organisation{exo7}
\contenu{
  \texte{Soit  $G$  un groupe, $e$  son \' el\' ement neutre. Un
\' el\' ement  $g$  de  $G$  est
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{La matrice  $\begin{pmatrix}
...
\end{pmatrix}$.}
  \item \reponse{Notons  $e_G$  et  $e_H$  les \' el\' ements neutres respectifs
...
est  $n$.}
  \item \reponse{Raisonnons par l'absurde : Soit  $G$  un groupe fini.
