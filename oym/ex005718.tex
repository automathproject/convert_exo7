...
\contenu{
  \texte{}
  \question{En utilisant un développement de $\frac{1}{1-t}$, calculer $\int_{0}^{1}\frac{\ln t}{t-1}\;dt$.}
  \reponse{La fonction $f~:~t\mapsto\frac{\ln t}{t-1}$   est continue et positive sur $]0,1[$, négligeable devant $\frac{1}{\sqrt{t}}$ quand $t$ tend vers  $0$ et prolongeable par continuité en $1$. La fonction $f$ est donc intégrable sur $]0;1[$.
