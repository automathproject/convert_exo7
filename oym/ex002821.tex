...
\contenu{
  \texte{}
  \question{On considère la fonction analytique $f(z) =
...
séries de  Taylor.}
  \reponse{On a $\sin (z) = \frac{1}{2i}(e^{iz}-e^{-iz})=0$ si et seulement si $e^{2i\pi z}=1$ ce qui est le cas si et seulement si $z\in \pi \Z$.
