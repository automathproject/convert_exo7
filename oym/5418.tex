...
\contenu{
  \texte{}
  \question{Soit $f$ une fonction de classe $C^3$ sur $\Rr$ vérifiant~:~$\forall(x,y)\in\Rr^2,\;f(x+y)f(x-y)\leq(f(x))^2$.
Montrer que $\forall x\in\Rr,\;f(x)f''(x)\leq(f'(x))^2$ (Indication. Appliquer la formule de \textsc{Taylor}-\textsc{Laplace} entre $x$ et $x+y$ puis entre $x$ et $x-y$).}
  \reponse{Soit $(x,y)\in\Rr\times\Rr$. Puisque $f$ est de classe $C^3$ sur $\Rr$, la formule de \textsc{Taylor}-\textsc{Laplace} à l'ordre $2$ permet d'écrire
