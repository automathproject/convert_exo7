...
\contenu{
  \texte{}
  \question{Soit $A$ une matrice carrée de format $2$ telle que $A^2$ est diagonalisable et $\text{Tr}A\neq 0$. Montrer que $A$ est diagonalisable dans $\Cc$.}
  \reponse{$A$ est de format $2$ et donc, soit a deux valeurs propres distinctes et est dans ce cas diagonalisable dans $\Cc$, soit a une valeur propre double $\lambda$ non nulle car $\text{Tr}A = 2\lambda \neq 0$.
