...
\organisation{exo7}
\contenu{
  \texte{On note $P$ l'ensemble des fonctions~$f$ polynomiales par morceaux,
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Que c'est un espace préhilbertien.}
  \item \reponse{$g_x(t) = \min(t(1-x),x(1-t))$}
  \item \reponse{On note $g_i = g_{x_i}$~: $(g_1,\dots,g_n)$ est libre par
