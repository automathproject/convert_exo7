...
\contenu{
  \texte{}
  \question{Soit $(u_n)_{n\in\Nn}$ une suite de réels strictement positifs. Montrer que les séries de termes généraux $u_n$, $\frac{u_n}{1+u_n}$, $\ln(1+u_n)$ et $\int_{0}^{u_n}\frac{dx}{1+x^e}$  sont de mêmes natures.}
  \reponse{Pour $n\in\Nn$, posons $v_n=\ln(1+u_n)$, $w_n=\frac{u_n}{1+u_n}$ et $t_n=\int_{0}^{u_n}\frac{dx}{1+x^e}$.
