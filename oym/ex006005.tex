...
\organisation{exo7}
\contenu{
  \texte{Une entreprise pharmaceutique décide de faire des économies sur les
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{On utilise une loi binomiale, loi de la variable aléatoire:
...
$P(B)=\binom{4}{2}(\frac{2}{5})^{2}(\frac{3}{5})^{2}=0.3456$.}
  \item \reponse{La loi de probabilité de $X$ est une loi binomiale, loi de la variable
