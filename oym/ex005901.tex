...
\contenu{
  \texte{}
  \question{$E =\Rr^n$ est muni de sa structure euclidienne usuelle.
...
\end{array}$ est différentiable sur $E\setminus\{0\}$ et préciser $df$. Montrer que $f$ n'est pas différentiable en $0$.}
  \reponse{\textbf{1ère solution.} Pour $x=(x_1,\ldots,x_n)\in\Rr^n$, $f(x)=\sqrt{\sum_{i=1}^{n}x_i^2}$. $f$ est de classe $C^1$ sur $\Rr^n\setminus\{0\}$ en vertu de théorèmes généraux et pour tout $x=(x_1,\ldots,x_n)\in\Rr^n\setminus\{0\}$ et tout $i\in\llbracket1,n\rrbracket$
