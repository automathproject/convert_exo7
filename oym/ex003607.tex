\uuid{3607}
\titre{Nombre de noyaux et d'images}
\theme{}
\auteur{quercia}
\date{2010/03/10}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Soit $E$ un $ K$-ev de dimension finie et $u\in \mathcal{L}(E)$.
Montrer que les ensembles ${\cal K} = \{\mathrm{Ker}(P(u)),\ P\in K[X]\}$ et
${\cal I} = \{\Im(P(u)),\ P\in K[X]\}$ sont finis et ont même cardinal.}
  \reponse{Soit $\mu$ le polynôme minimal de~$u$ et ${\cal D}$ l'ensemble des
