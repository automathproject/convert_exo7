...
\contenu{
  \texte{}
  \question{On pose $\forall X=(x_i)_{1\leqslant i\leqslant n}\mathcal{M}_{n,1}(\Rr)$, $\|X\|_1=\sum_{i=1}^{n}|x_i|$ et $\|X\|_\infty=\underset{1\leqslant i\leqslant n}{\text{Max}}|x_i|$.
...
Déterminer les normes sur $\mathcal{M}_n(\Rr)$ respectivement associées aux normes $\|\;\|_1$ et $\|\;\|_\infty$ de $\mathcal{M}_{n,1}(\Rr)$. On notera $|||\;|||_1$ et $|||\;|||_\infty$ ces normes.}
  \reponse{\textbullet~Pour $\|\;\|_1$. Soient $A=(a_{i,j})_{1\leqslant i,j\leqslant n}\in\mathcal{M}_n(\Rr)$ puis $X=(x_i)_{1\leqslant i\leqslant n}\mathcal{M}_{n,1}(\Rr)$.
