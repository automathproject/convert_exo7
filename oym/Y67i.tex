...
\organisation{exo7}
\contenu{
  \texte{Soit $u_0\in]0,\frac{\pi}{2}]$. Pour $n\in\Nn$, on pose $u_{n+1}=\sin(u_n)$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Pour $x\in\left[0,\frac{\pi}{2}\right]$, posons $f(x)=\sin x$. On a $f\left(\left]0,\frac{\pi}{2}\right]\right)=]0,1]\subset\left]0,\frac{\pi}{2}\right]$. Donc, puisque $u_0\in\left]0,\frac{\pi}{2}\right]$, on en déduit que $\forall n\in\Nn,\;u_n\in\left]0,\frac{\pi}{2}\right]$.\rule[-5mm]{0mm}{10mm}
...
\end{center}}
  \item \reponse{Soit $\alpha$ un réel quelconque. Puisque la suite $u$ tend vers 0 , on a
