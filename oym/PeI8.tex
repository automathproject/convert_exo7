...
\organisation{exo7}
\contenu{
  \texte{Soit $E$ l'ensemble des fonctions continues strictement positives sur $[a,b]$.
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soient $m$ un réel strictement positif et, pour $t\in\Rr$, $f_m(t)=e^{mt}$. $f_m$ est bien un élément de $E$ et de plus,
...
Cette expression tend vers $+\infty$ quand $m$ tend vers $+\infty$ et $\varphi(E)$ n'est pas majoré.}
  \item \reponse{Soit $f$ continue et strictement positive sur $[a,b]$. L'inégalité 
