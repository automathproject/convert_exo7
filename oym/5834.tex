...
\contenu{
  \texte{}
  \question{Equation du cylindre $(\mathcal{C})$ de section droite la courbe $(C)$ d'équations $\left\{
\begin{array}{l}
z=x\\
2x^2+y^2=1
\end{array}
\right.$}
  \reponse{La direction du cylindre est orthogonale au plan d'équation $z=x$ et est donc engendrée par le vecteur $\overrightarrow{u}(1,0,-1)$.
