...
\organisation{exo7}
\contenu{
  \texte{Soit $a\in\R$, notons $A$ la matrice suivante
...
Ainsi la matrice $A$ est diagonalisable pour tout $a\neq 1$.}
  \item \reponse{{\it Lorsque $A$ est diagonalisable, calculons $A^n$ pour $n\in \N$}.
...
$$A^n=PD^nP^{-1}=P\begin{pmatrix}1&0 \\  0&a^n\end{pmatrix}P^{-1}={\frac{1} {a-1}}\begin{pmatrix}a-a^n&a^n-1 \\  a-a^{n+1}&a^{n+1}-1\end{pmatrix}$$}
  \item \reponse{{\it On suppose $A$ diagonalisable. On note $U_n$ le vecteur $U_{n}=\begin{pmatrix}u_{n} \\  u_{n+1}\end{pmatrix}$,  on exprime $U_{n+1}$ en fonction de $U_n$ et de $A$, puis $U_n$ en fonction de $U_0$ et de $A$.}
