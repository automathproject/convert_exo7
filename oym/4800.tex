\uuid{4800}
\titre{Une application polynomiale est ferm{\'e}e, ULM-Lyon-Cachan MP$^*$ 2005}
...
\contenu{
  \texte{}
  \question{Soit $f$ une fonction polynomiale sur~$\C$. Montrer que l'image par $f$ de tout
ferm{\'e} est un ferm{\'e}.}
  \reponse{Si $f$ est constante c'est {\'e}vident. Sinon, on a facilement $|f(z)|\xrightarrow[|z|\to\infty]{}\infty$.
