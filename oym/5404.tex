...
\contenu{
  \texte{}
  \question{Soit $f$ de $[0,1]$ dans lui-même telle que $\forall(x,y)\in([0,1])^2,\;|f(y)-f(x)|\geq|x-y|$. Montrer que $f=Id$ ou $f=1-Id$.}
  \reponse{On a $0\leq f(0)\leq 1$ et $0\leq f(1)\leq 1$. Donc $|f(1)-f(0)|\leq1$. Mais, par hypothèse, $|f(1)-f(0)|\geq1$. Par suite, $|f(1)-f(0)|= 1$ et nécessairement, $(f(0),f(1))\in\{(0,1),(1,0)\}$.
