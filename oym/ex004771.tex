\uuid{4771}
\titre{Comparaison de normes (ENS MP 2002)}
\theme{}
\auteur{quercia}
\date{2010/03/16}
\organisation{exo7}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$2^n\sum_{i=1}^n\|u_i\|^2$.}
  \item \reponse{Supposons qu'il existe une norme euclidienne $\|\ \|$ et deux r{\'e}els
  ...
  \item \reponse{M{\^e}me construction. On trouve
