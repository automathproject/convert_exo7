...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $r>0$ tel que $\overline{\Delta_r(c)}$ est un disque fermé inclus dans $D$.
...
Cette intégrale ne dépend pas de $r$ tel que $\overline{\Delta_r(c)}$ est inclus dans $D$.}
  \item \reponse{Si $f$ admet une primitive sur $D-\{c\}$, l'intégrale de $f$ sur tout chemin fermé de $D-\{c\}$ est nulle.
 En particulier, le résidu de $f$ en $c$ est nul.}
  \item \reponse{D'après la question précédente, il est nécessaire que le résidu de $f$ en $c$ soit nul.
