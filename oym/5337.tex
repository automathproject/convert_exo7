...
\contenu{
  \texte{}
  \question{Soit $U_n$ l'ensemble des racines $n$-ièmes de l'unité dans $\Cc$. Ecrire sous forme d'une fraction rationnelle (ou encore réduire au même dénominateur) $F=\sum_{\omega\in U_n}^{}\frac{\omega X+1}{\omega^2X^2+\omega X+1}$.}
  \reponse{Pour $k$ élément de $\{0,...,n-1\}$, posons $\omega_k=e^{2ik\pi/n}$. Décomposons $F$ en éléments simples (sur $\Cc$).
