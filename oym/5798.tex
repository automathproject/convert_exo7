...
\contenu{
  \texte{}
  \question{Soit $A$ une matrice carrée réelle. Montrer que les matrices ${^t}AA$ et $A{^t}A$ sont orthogonalement semblables.}
  \reponse{Puisque les matrices $S_1 ={^t}AA$ et $S_2 = A{^t}A$ sont symétriques réelles, ces deux matrices sont à valeurs propres réelles. On sait d'autre part que si $M$ et $N$ sont deux matrices quelconques alors les matrices $MN$ et $NM$ ont même polynôme caractéristique.
