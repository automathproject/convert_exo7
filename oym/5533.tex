...
\contenu{
  \texte{}
  \question{Construire la courbe d'équation cartésienne $x^2(x^2+y^2)-(y-x)^2=0$ après être passé en polaires .}
  \reponse{Soient $(R,\theta)\in\Rr^2$ puis $M$ le point du plan dont un couple de coordonnées polaires est $[r,\theta]$.
