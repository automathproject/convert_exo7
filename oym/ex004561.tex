\uuid{4561}
\titre{Fraction rationnelle de meilleure approximation (Ens Ulm-Lyon-Cachan MP$^*$ 2003)}
\theme{}
\auteur{quercia}
\date{2010/03/14}
\organisation{exo7}
\contenu{
  \texte{On note~$R$ l'ensemble des fractions rationnelles continues sur~$[0,1]$
et pour $m,n\in\N$~:
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$R$ est trivialement un $\R$-espace vectoriel. Le théorème de décomposition en éléments
  ...
  \item \reponse{Soit $(f_k)$ une suite d'éléments de~$R_{m,n}$ telle que $\|g-f_k\|\to d$ quand $k\to\infty$.
