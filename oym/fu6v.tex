...
\end{enumerate}
\begin{enumerate}
  \item \reponse{La fonction $x\mapsto\frac{1}{x}$ est continue et décroissante sur $]0,+\infty[$ et donc, pour $k\in\Nn^*$, on a~:
...
\end{center}}
  \item \reponse{Soit $n$ un entier naturel non nul.
