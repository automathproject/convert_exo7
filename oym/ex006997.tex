...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Il s'agit d'une équation homogène du second ordre. L'équation caractéristique associée est $r^2-3r+2=0$, qui admet deux solutions: $r=2$ et $r=1$. Les solutions sont donc les fonctions définies sur $\R$ par $y(x)=\lambda e^{2x}+\mu e^x$ ($\lambda,\mu\in\R$).}
  ...
  \item \reponse{L'équation caractéristique est $r^2-2r+1=0$, dont 1 est racine double. 
Les solutions de l'équation homogène sont donc de la forme $(\lambda x+\mu)e^x$.}
  \item \reponse{Les solutions de l'équation homogène sont les $\lambda\cos x+\mu \sin x$. 
