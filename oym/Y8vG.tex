...
\organisation{exo7}
\contenu{
  \texte{Montrer par contraposition les assertions suivantes, $E$ \'etant
un ensemble :}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Tout d'abord de fa\c{c}on ``directe". Nous supposons
...
Cela veut dire $A=B$.}
  \item \reponse{Ensuite, comme demand\'e, nous le montrons par contraposition.
