...
\organisation{exo7}
\contenu{
  \texte{% parallélogramme de Varignon, minimisation de périmètre
...
\end{align*}}
  \item \reponse{Le quadrilatère $AM_1OM_4$ est un parallélogramme direct ssi $a=m_1-m_2$ c'est-à-dire ssi $t=0$. Il s'agit de montrer que le périmètre calculé plus haut est minimal lorsque $t=0$.
