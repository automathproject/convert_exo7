...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$\varphi$ a des coordonn\'ees de classe $C^1$, elle l'est
donc aussi. On a
...
\mathbb{R}^2)=GL(\mathbb{R}^2$.}
  \item \reponse{D'apr\`es le th\'eor\`eme de
...
local). C'est un diff\'eomorphisme en $U$ et $\varphi(U)$.}
  \item \reponse{Soient $(X_1,y_1), (X_2,Y_2) \in \varphi(\mathbb{R}^2)$ avec
...
||(X_1,Y_1)-(X_2,Y_2)||.$$ Donc $\varphi^{-1}$ est lipschitzienne.}
  \item \reponse{Soit $(X_n,Y_n)$ une suite de cauchy dans
