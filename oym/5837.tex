...
\contenu{
  \texte{}
  \question{Trouver les plans tangents à la surface $(\mathcal{S})$ d'équation $x-8yz=0$ et contenant la droite $(\mathcal{D})$
...
\end{array}
\right.$.}
  \reponse{Le plan tangent $(P_0)$ en $(x_0,y_0,z_0)$ tel que $x_0-8y_0z_0 = 0$ admet pour équation $(x+x_0) -8(z_0y+y_0z)=0$ ou encore $x-8z_0y-8y_0z+8y_0z_0=0$.
