...
\contenu{
  \texte{}
  \question{Etude au voisinage de $0$ de $f(x)=\frac{1}{x}-\frac{1}{\Arcsin x}$ (existence d'une tangente~?)}
  \reponse{$\frac{1}{\sqrt{1-x^2}}\underset{x\rightarrow0}{=}1+\frac{x^2}{2}+\frac{3x^4}{8}+o(x^4)$, et donc 
