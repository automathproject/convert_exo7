...
\contenu{
  \texte{}
  \question{Soit $u$ une suite bornée d'un espace vectoriel normé de dimension finie ayant une unique valeur d'adhérence. Montrer que la suite $u$ converge.}
  \reponse{Soit $u = (u_n)_{n\in\Nn}$ une suite bornée de l'espace normé $(E,\|\;\|)$ ayant une unique valeur d'adhérence que l'on note $\ell$. Montrons que la suite $u$ converge vers $\ell$.
