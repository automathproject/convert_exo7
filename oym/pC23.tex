...
\organisation{exo7}
\contenu{
  \texte{Soit $f\in\mathcal{L}(\Rr^2)$. Pour $(x,y)\in\Rr^2$, on pose $f((x,y))=(x',y')$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Pour $(x,y)\in\Rr^2$, posons $f((x,y))=(x',y')$.
...
\right.$.
\end{center}}
  \item \reponse{Avec les notations précédentes,
...
où $a=\frac{\alpha+\delta}{2}+i\frac{\beta-\gamma}{2}$ et $b=\frac{\alpha-\delta}{2}+i\frac{\beta+\gamma}{2}$.}
  \item \reponse{Réciproquement, si $z'=az+b{\bar z}$, en posant $a=a_1+ia_2$ et $b=b_1+ib_2$ où $(a_1,a_2,b_1,b_2)\in\Rr^4$, on
obtient~:
