...
\contenu{
  \texte{}
  \question{Soit $A$ une matrice carrée complexe de format $n$ ($n\geqslant 2$) telle que pour tout élément $M$ de $M_n(\Cc)$, on ait $\text{det}(A+M)=\text{det}A+\text{det}M$. Montrer que $A = 0$.}
  \reponse{$A = 0$ convient.
