...
\contenu{
  \texte{}
  \question{Calculer $\lim_{n\rightarrow +\infty}\sum_{k=1}^{n}\frac{1}{1^2+2^2+...+k^2}$.}
  \reponse{Soit $k$ un entier naturel non nul. On sait que $\sum_{i=1}^{k}i^2=\frac{k(k+1)(2k+1)}{6}$. Déterminons alors trois réels $a$, $b$ et $c$ tels que, pour entier naturel non nul $k$, 
