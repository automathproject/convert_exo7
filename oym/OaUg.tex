...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$A$ est l'ensemble des nombres dont le développement décimal s'arrête
  ...
  \item \reponse{Stabilité par addition~: Soit $x=\frac{a}{b}\in A$ et
  ...
  \item \reponse{N'est pas un corps~: $2$ n'est pas inversible. Les seuls éléments
