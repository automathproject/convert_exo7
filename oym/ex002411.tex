...
\contenu{
  \texte{}
  \question{Soient $X$ et $Y$ deux espaces métriques compacts. Soit $\mathcal{A}$ l'ensembles des combinaisons linéaires finies
...
Montrer que toute fonction de $\mathcal{C}(X\times Y,\Rr)$ est limite uniforme de suites d'éléments de $\mathcal{A}$.}
  \reponse{On cherche à vérifier les hypothèses du théorème de Stone-Weierstrass.
\begin{itemize}
