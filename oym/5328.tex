...
\contenu{
  \texte{}
  \question{Déterminer $a\in\Cc$ tel que $P=X^5-209X+a$ admette deux zéros dont le produit vaut $1$.}
  \reponse{$a$ est solution du problème si et seulement si $X^5-209X+a$ est divisible par un polynôme de la forme $X^2+\alpha X+1$. Mais 
