\uuid{3732}
\titre{Déterminant de Gram, X MP$^*$ 2005}
...
\contenu{
  \texte{}
  \question{Soit $E$ un espace vectoriel réel de dimension quelconque, $(x_{1},\ldots,x_{n})$ et $(y_{1},\ldots,y_{n})$ deux familles
...
Montrer que $(\det [\phi(x_{i}, y_{j})])^{2}\le \det [\phi(x_{i}, x_{j})]\times \det [\phi(y_{i}, y_{j})]$.}
  \reponse{Quitte à remplacer $E$ par $\mathrm{vect}(x_1,\dots,y_n)$, on peut supposer $E$
