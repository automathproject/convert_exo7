...
\organisation{exo7}
\contenu{
  \texte{Soit $X$ l'ensemble des nombres premiers de la forme $4k + 3$ avec $k \in \Nn$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$X$ est non vide car, par exemple pour $k=2$, $4k+3=11$ est premier.}
  \item \reponse{$(4k+1)(4\ell+1) = 16k\ell + 4(k+\ell)+1 = 4(4k\ell+k+\ell)+1$.
Si l'on note l'entier $k' = 4k\ell+k+\ell$ alors $(4k+1)(4\ell+1) = 4k'+1$, 
ce qui est bien de la forme voulue.}
  \item \reponse{Remarquons que $2$ est le seul nombre premier pair, les autres sont de la forme
...
Nous obtenons une contradiction. Donc $a$ admet une diviseur premier $p$ de la forme $p=4\ell+3$.}
  \item \reponse{Dans l'ensemble $X = \{p_1,\ldots,p_n\}$ il y a tous les nombres premiers de la formes $4k+3$.
