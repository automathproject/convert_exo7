...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Le triangle $ABC$ est équilatéral direct ssi $C$ est l'image de $B$ par la rotation de centre $A$ et d'angle $\pi/3$. Ceci est équivalent à $c-a = e^{i\pi/3}(b-a) = -j^2(b-a)$.
Or, on a :
\begin{align*}
c-a  = -j^2(b-a) 
...
\end{align*}}
  \item \reponse{Fixons un repère orthonormé direct de centre $O$. 
\begin{center}
