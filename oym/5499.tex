...
\contenu{
  \texte{}
  \question{Soit $f$ continue strictement positive sur $[0,1]$. Pour $n\in\Nn$, on pose $I_n=\int_{0}^{1}f^n(t)\;dt$.
Montrer que la suite $u_n=\frac{I_{n+1}}{I_n}$ est définie et croissante.}
  \reponse{L'application $(f,g)\mapsto\int_{0}^{1}f(t)g(t)\;dt$ est un produit scalaire sur $C^0([0,1],\Rr)$. D'après l'inégalité de \textsc{Cauchy}-\textsc{Schwarz},
