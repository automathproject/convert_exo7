...
\organisation{exo7}
\contenu{
  \texte{Trouver toutes les solutions des syst\`emes suivantes :}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$3,5,7,11$ sont deux à deux premiers entre eux, donc la solution est
    ...
    \begin{align*}
      ...
      \end{cases}
    \end{align*}}
  \item \reponse{Un diviseur commun de $2001$ et $2002$ divise leur différence, et
