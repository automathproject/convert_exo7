...
\contenu{
  \texte{}
  \question{Calculer une application de Weingarten du paraboloïde hyperbolique $S$ d'équation $z=x^2-y^2$
au point $p(0,0,0)$. En déduire sa courbure de Gauss et ses directions principales.}
  \reponse{On paramètre la surface $S$ par
$F(u,v)=(u,v,u^2-v^2)$.
