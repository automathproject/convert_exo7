...
\organisation{exo7}
\contenu{
  \texte{Soit $f:\Rr^n \to \Rr^n$ une application continue. Elle est dite {\it propre}  si pour tout compact
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Supposons $f$ propre et soit $F$ un fermé. Montrons que $f(F)$ est un fermé. Soit $(y_n)$ une suite de $f(F)$ qui converge vers $y\in \Rr^n$. 
...
Par unicité de la limite $y=f(x)$. Donc $y \in f(F)$ et $f(F)$ est fermé.}
  \item \reponse{Dire $ \|f(x)\|\to \infty$ quand $\|x\|\to \infty$ est équivalent à
$$ \forall M >0\quad \exists m >0\quad \forall x \in \Rr^n \quad (x \notin B(0,m) \Rightarrow  f(x)\notin B(0,M)).$$
  \begin{enumerate}}
  \item \reponse{Supposons $f$ propre, soit $M>0$. Alors $B(0,M)$ est un compact
...
Donc si $x\notin B(0,m)$ alors $f(x) \notin B(0,M)$.}
  \item \reponse{Réciproquement, soit $K$ un compact de $\Rr^n$. Comme $f$ est continue
