...
\contenu{
  \texte{}
  \question{Soit $H$ un élément de $\mathcal{M}_n(\Cc)$ tel que $\forall A\in\mathcal{M}_n(\Cc),\;\exists\lambda_A\in\Cc/\;HAH=\lambda_AH$. Montrer que $\text{rg}H\leqslant 1$.}
  \reponse{Soit $r$ le rang de $H$. Il existe deux matrices carrées inversibles $P$ et $Q$ de format $n$ telles que $H =PJ_rQ$ où $J_r=\left(
\begin{array}{cc}
I_r&0\\
0&0
\end{array}
