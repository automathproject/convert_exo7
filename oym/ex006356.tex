...
\contenu{
  \texte{}
\begin{enumerate}
  \item \question{Montrer que la matrice $\begin{pmatrix}e^{-2t}\cos t & -\sin t\cr e^{-2t}\sin t &
...
\cr\end{pmatrix}$}
  \item \question{On considère maintenant l'équation différentielle ${d^2x(t)\over
