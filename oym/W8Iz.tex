...
\exo7id{5920}
\titre{Exercice 5920}
\theme{Intégrale de Riemann, Quelles sont les fonctions Riemann-intégrables ?}
\auteur{tumpach}
\date{2010/11/11}
\organisation{exo7}
\contenu{
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Consid\'erons la fonction $f~:[0,1]\rightarrow \mathbb{R}$
d\'efinie par~:
$$
 f(x) = \left\{\begin{array}{l} 1 \quad\text{si}\quad  x\in\mathbb{Q}\\
0 \quad\text{si} \quad x\in\mathbb{R}\setminus\mathbb{Q}
...
que $f$ n'est pas Riemann-int\'egrable sur $[0, 1]$.}
  \item \reponse{Consid\'erons la fonction $g~:[0,1]\rightarrow \mathbb{R}$
d\'efinie par~:
$$
 g(x) = \left\{\begin{array}{l} \frac{1}{q} \quad\text{si}\quad
 \, x=\frac{p}{q} \quad\text{avec}\,\, p \,\,\text{et} \,\,q \,\,\text{premiers entre eux}\\
