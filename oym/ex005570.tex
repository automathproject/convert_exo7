...
\contenu{
  \texte{}
  \question{On pose $f_a(x)=e^{ax}$ pour $a$ et $x$ réels. Etudier la liberté de la famille de fonctions $(f_a)_{a\in\Rr}$.}
  \reponse{Soient $a_1< ... <a_n$ $n$ réels deux à deux distincts et $\lambda_1$,..., $\lambda_n$ n réels tels que $\sum_{i=1}^{n}\lambda_if_{a_i}=0$ $(*)$.
