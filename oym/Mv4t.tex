...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $E$ un ensemble à $n$ éléments, $n\geq 1$, et $a$ un élément fixé de $E$. Soit $\begin{array}[t]{cccc}
...
et de même $\mbox{card}(\mathcal{P}_i(E))\leq\mbox{card}\mathcal{P}_p(E)$. Finalement, $\mbox{card}(\mathcal{P}_i(E))=\mbox{card}\mathcal{P}_p(E)$.}
  \item \reponse{Soient $E=\{a_1,...,a_n\}$ un ensemble à $n$ éléments et $a$ un élément fixé de $E$. Soit $k\in\{1,...,n-1\}$.
