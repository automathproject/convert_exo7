...
\contenu{
  \texte{}
  \question{\label{ex:rou18bis}
Soit $A$ une matrice carrée de format $n$. Etudier le rang de $\text{com}A$ en fonction du rang de $A$.}
  \reponse{\textbullet~Si $A$ est de rang $n$, c'est-à-dire inversible, l'égalité $(\text{com}A)\times\frac{1}{\text{det}A}{^t}A =I_n$ montre que $\text{com}A$ est inversible et donc de rang $n$.
