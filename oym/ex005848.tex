...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $x\in E$. Puisque $D$ est dense dans $E$, il existe une suite $(d_n)_{n\in\Nn}$ d'éléments de $D$ convergeant vers $x$ et puisque $f$ et $g$ sont continues et coincident sur $D$ et donc en $x$
...
On a montré que $f = g$.}
  \item \reponse{Soit $f\in\Rr^\Rr$. On suppose que $\forall(x,y)\in\Rr^2$ $f(x+y) = f(x)+f(y)$. Soit $a = f(1)$.
