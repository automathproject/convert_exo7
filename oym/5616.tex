...
\contenu{
  \texte{}
  \question{Résoudre dans $\mathcal{M}_n(\Rr)$ l'équation $M=\text{com}M$ ($n\geqslant2$).}
  \reponse{Si $\text{rg} M\leqslant n-1$, l'égalité $M=\text{com}M$ entraîne $M{^t}M=M{^t}(\text{com}M)=(\text{det}M)I_n=0$ et donc $M = 0$. En effet, 
