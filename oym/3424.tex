\uuid{3424}
\titre{Formule d'intégration numérique}
...
\contenu{
  \texte{}
  \question{Trouver trois réels $\alpha, \beta, \gamma$ tels que pour tout polynôme
de degré $\le 3$ on ait :
$$  \int_{2}^4 P(x)\; dx = \alpha P(2) + \beta P(3) + \gamma P(4).$$}
  \reponse{Notons $P(x)=ax^3+bx^2+cx+d$ un polynôme de degré $\le 3$.
\begin{enumerate}
