...
\contenu{
  \texte{}
  \question{Soit $\sigma$ une injection de $\Nn^*$ dans lui-même. Montrer que la série de terme général $\frac{\sigma(n)}{n^2}$ diverge.}
  \reponse{Soit $\sigma$ une permutation de $\llbracket1,n\rrbracket$. Montrons que la suite $S_n=\sum_{k=1}^{n}\frac{\sigma(k)}{k^2}$, $n\geqslant1$, ne vérifie pas le critère de \textsc{Cauchy}. Soit $n\in\Nn^*$.
