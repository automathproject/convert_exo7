...
\contenu{
  \texte{}
  \question{On munit $E =\ell^\infty(\Cc)$ le $\Cc$-espace vectoriel des suites bornées de la norme $\|u\|_\infty=\underset{n\in\Nn}{\text{sup}}\;|u_n|$.
...
Montrer que $\Delta$ et $C$ sont continus sur $(E,\|\;\|_\infty)$ et calculer leur norme.}
  \reponse{(La linéarité de $\Delta$ est claire et de plus $\Delta$ est un endomorphisme de $E$ car si $u$ est une suite bornée, $\Delta(u)$ l'est encore. Plus précisément,)
