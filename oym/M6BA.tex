...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$\chi_A=-(2+X)((3-X)(-1-X)+4)=-(X+2)(X^2-2X+1)=-(X+2)(X-1)^2$. 
...
\right)$ et donc $\text{Ker}(A-I)^2$ est le plan d'équation $4x+4y-z=0$.}
  \item \reponse{On note $f$ l'endomorphisme de $\Rr^3$ dont la matrice dans la base canonique de $\Rr^3$ est $A$. Le théorème de \textsc{Cayley}-\textsc{Hamilton} et le théorème de décomposition des noyaux permettent d'affirmer
...
\end{center}}
  \item \reponse{Soit $n\in\Nn$. Posons $T = D+N$ où $D=\text{diag}(-2,1,1)$ et $N =E_{2,3}$. On a $ND = DN$ et $N^2 = 0$. Puisque les matrices $D$ et $N$ commutent, la formule du binôme de \textsc{Newton} permet d'écrire
