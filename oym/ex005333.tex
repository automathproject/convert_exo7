...
\contenu{
  \texte{}
  \question{Soit $n\in\Nn^*$. Montrer que $(X-1)^{2n}-X^{2n}+2X-1$ est divisible par $2X^3-3X^2+X$ puis déterminer le quotient.}
  \reponse{Pour $n\geq0$, posons $P_n=(X-1)^{2n}-X^{2n}+2X-1$. $P_n(0)=P_n(1)=P_n(\frac{1}{2})=0$. $P_n$ admet $0$, $1$ et $\frac{1}{2}$ pour racines et est donc divisible par $X(X-1)(2X-1)=2X^3-3X^2+X$.
