\uuid{6863}
\titre{Exercice 6863}
\theme{Calculs d'intégrales, Applications : calculs d'aires, calculs de limites}
\auteur{bodin}
\date{2012/04/13}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Calculer l'aire intérieure d'une ellipse d'équation :
...
à $x\ge 0$, $y\ge 0$. Puis exprimer $y$ en fonction de $x$. Enfin calculer une intégrale.}
  \reponse{Calculons seulement un quart de l'aire : la partie du quadrant $x\ge 0, y\ge 0$.
