\uuid{7139}
\titre{Symétrique de l'orthocentre}
\theme{}
\auteur{megy}
\date{2017/04/05}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Soit $ABC$ un triangle, $H$ son orthocentre et $\mathcal C$ son cercle circonscrit. La hauteur issue de $B$ recoupe $\mathcal C$ en $H'$. Montrer que $H'$ est le symétrique de $H$ par rapport à la droite $(AC)$. 

\begin{center}
\includegraphics{../images/img007139-1}
\end{center}}
  \reponse{Si $ABC$ est rectangle, l'orthocentre coïncide avec un des sommets et la vérification de l'assertion est relativement facile. Dans la suite on suppose qu'on n'est pas dans ce cas.
