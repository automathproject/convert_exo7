...
\organisation{exo7}
\contenu{
  \texte{Etudier les courbes dont une équation polaire (en repère orthonormé direct) est}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$e = 2$. Il s'agit une hyperbole dont l'un des foyers est l'origine.
...
$K'=\Omega-\frac{1}{e}\overrightarrow{OA}=\left(-\frac{5}{3},0\right)$. Les directrices sont les droites $(D)$ et $(D')$ d'équations respectives $x = -1$ et $x=-\frac{5}{3}$.}
  \item \reponse{L'équation s'écrit $r=\frac{3}{\frac{1}{2}+\cos\theta}$. Donc $e =\frac{1}{2}$ et la courbe est une ellipse.
...
$B=\Omega+b\overrightarrow{j}=\left(-2,2\sqrt{3}\right)$ et $B=\Omega-b\overrightarrow{j}=\left(-2,-2\sqrt{3}\right)$}
  \item \reponse{L'équation $r=\frac{2}{1+\cos\left(\theta+\frac{\pi}{2}\right)}$. On reconnait une parabole dans une présentation non traditionnelle.
