...
\contenu{
  \texte{}
  \question{Soit $f$ une application continue sur un intervalle $I$ de $\Rr$ à valeurs dans $\Rr$. Montrer que $f$ est injective si et seulement si $f$ est strictement monotone et que dans ce cas $f(I)$ est un intervalle de même nature que $I$ (ouvert, semi-ouvert, fermé).}
  \reponse{Si $f$ est strictement monotone sur $I$, on sait que $f$ est injective.
