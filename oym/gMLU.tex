...
\exo7id{2608}
\titre{Exercice 2608}
\theme{Sujets de l'année 2007-2008, Examen}
\auteur{delaunay}
\date{2009/05/19}
\organisation{exo7}
\contenu{
  \texte{Soit $A$ la matrice 
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{{\it  Déterminons et factorisons le polyn\^ome caract\'eristique de $A$.} 
...
La matrice $A$ admet deux valeurs propres, $1$, valeur propre simple, et $-1$, valeur propre double.}
  \item \reponse{{\it D\'eterminons les sous-espaces propres et les sous-espaces caract\'eristiques de $A$.}
...
$e_2=(0,0,1)$ et $e_3=(0,1,0)$.}
  \item \reponse{{\it D\'emontrons qu'il existe une base de $\R^3$ dans laquelle la matrice de $f$ est 
$$B=\begin{pmatrix}1 & 0 & 0 \\  0&-1&2 \\ 0&0&-1\end{pmatrix}$$
...
$$P^{-1}=\begin{pmatrix}1/2 & 0 & 0 \\  0&0&1 \\ -1/2&1&0\end{pmatrix}.$$}
  \item \reponse{{\it Ecrivons la d\'ecomposition de Dunford de $B$.}  
...
Il est clair que la matrice $D$ est diagonalisable puisque diagonale, on vérifie facilement que $N^2=0$, c'est-à-dire que la matrice $N$ est nilpotente et que les deux matrices commutent, $DN=ND$. Ainsi la décomposition $B=D+N$ est bien la décomposition de Dunford de la matrice $B$.}
  \item \reponse{{\it Pour $t\in\R$, calculons $\exp tB$}.
...
$$\exp(tB)=\begin{pmatrix}e^t & 0 & 0 \\  0&e^{-t}&0 \\ 0&0&e^{-t}\end{pmatrix}\begin{pmatrix}1 & 0 & 0 \\  0&1&2t \\ 0&0&1\end{pmatrix}=\begin{pmatrix}e^t & 0 & 0 \\  0&e^{-t}&2te^{-t} \\ 0&0&e^{-t}\end{pmatrix}.$$}
  \item \reponse{{\it Donnons les solutions des syst\`emes diff\'erentiels $y'=By$ et $x'=Ax$, où $x$ et $y$ désignent des fonctions réelles à valeurs dans $\R^3$.} 
