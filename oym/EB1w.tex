...
\organisation{exo7}
\contenu{
  \texte{Résoudre sur l'intervalle $I$ proposé :}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{On note $J$ l'un des deux intervalles $]-\infty,0[$ ou $]0,+\infty[$. Sur $J$, l'équation $(E)$ s'écrit encore $y'- \frac{2}{x}y=0$. Comme la fonction $x\mapsto- \frac{2}{x}$ est continue sur $J$, les solutions de $(E)$ sur $J$ constituent un $\Rr$-espace vectoriel de dimension $1$. Enfin, la fonction $x\mapsto x^2$ est une solution non nulle de $(E)$ sur $J$ et donc $\mathcal{S}_J=\left\{
...
$$\includegraphics{../images/img005877-1}$$}
  \item \reponse{L'ensemble des solutions sur $]-\infty,0[$ ou $]0,+\infty[$ est $\{x\mapsto\lambda x,\;\lambda\in\Rr\}$.
...
Dans ce cas, $\mathcal{S}_\Rr$ est un $\Rr$-espace vectoriel de dimension $1$.}
  \item \reponse{L'ensemble des solutions sur $]-\infty,0[$ ou $]0,+\infty[$ est $\{x\mapsto \frac{\lambda}{x},\;\lambda\in\Rr\}$.
...
Dans ce cas, $\mathcal{S}_\Rr$ est un $\Rr$-espace vectoriel de dimension $0$.}
  \item \reponse{Soit $f$ une fonction dérivable sur $]0,+\infty[$.
...
\end{center}}
  \item \reponse{Si $f$ est une solution sur $\Rr$ de l'équation $x^2y'+2xy = 1$ alors $0^2\times f'(0)+0\times f(0)=1$ ce qui est impossible. Donc
