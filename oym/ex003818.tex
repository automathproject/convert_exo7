...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Si $^tUMV = D$ est diagonale alors $^tMM = VD^2{}^tV$. Inversement,
  ...
  \item \reponse{$M$ est limite de matrices $M_k$ inversibles que l'on peut décomposer
  ...
  \item \reponse{En diagonalisant $^tMM$ on trouve
