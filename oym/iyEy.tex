...
\end{enumerate}
\begin{enumerate}
  \item \reponse{On vérifie d'abord que $2\Arccos \frac{3}{4}\in[0,\pi]$ (sinon, l'équation 
...
$x = 2(\frac{3}{4})^2-1 = \frac{1}{8}$.}
  \item \reponse{Vérifions d'abord que $-\frac{\pi}{2}\le\Arcsin \frac{2}{5} + \Arcsin \frac{3}{5}\le\frac{\pi}{2}$. 
...
=\frac{3\sqrt{21}+8}{25}$.}
  \item \reponse{Supposons d'abord que $x$ est solution. Remarquons d'abord que $x$ est 
