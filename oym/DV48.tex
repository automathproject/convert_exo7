...
\organisation{exo7}
\contenu{
  \texte{On effectue un contrôle de fabrication sur des pièces dont une
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{La loi de $X$ est la loi binomiale $B(1000;0.02)$, d'espérance 20, 
d'écart-type $\sqrt{19.6}$.}
  \item \reponse{En approchant cette loi par celle d'une loi normale de paramètre
