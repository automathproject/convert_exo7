\uuid{4700}
\titre{$u_n^2+u_n-u_{n+1} \to 0$ (X MP$^*$ 2000)}
\theme{}
\auteur{quercia}
\date{2010/03/16}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Soit $u_n$ une suite r{\'e}elle born{\'e}e. On suppose que
$u_n^2+u_n-u_{n+1}\xrightarrow[n\to\infty]{} 0$. Montrer que $u_n\rightarrow 0$.}
  \reponse{Soit $E$ l'ensemble des valeurs d'adh{\'e}rence de~$(u_n)$. Si $u_{n_k}\xrightarrow[k\to\infty]{}\lambda$
