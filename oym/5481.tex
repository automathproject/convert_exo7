...
\contenu{
  \texte{}
  \question{Soit $a$ un réel non nul. Soit $f$ continue sur $\Rr$ et pèriodique de pèriode $T\neq0$. Montrer que l'équation
différentielle $y'+ay=f$ admet une et une seule solution périodique sur $\Rr$, de période $T$.}
  \reponse{On sait que les solutions sur $\Rr$ de l'équation proposée sont les fonctions de la forme~:
