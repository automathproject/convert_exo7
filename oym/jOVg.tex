...
\organisation{exo7}
\contenu{
  \texte{Les familles suivantes de $\Rr^4$ sont-elles libres ou liées ? Fournir des relations de dépendance linéaire quand ces relations existent.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{La matrice de la famille $(e_1,e_2,e_3)$ dans la base canonique de $\Rr^4$ est $\left(
\begin{array}{ccc}
3&1&7\\
0&5&5\\
1&0&2\\
...
Donc la famille $(e_1,e_2,e_3,e_4)$ est une famille libre (et donc une base de $E$).}
  \item \reponse{Notons $(u_1,u_2,u_3,u_4)$ la base canonique de $\Rr^4$.
...
La famille $(e_1,e_2,e_3,e_4)=(u_3,u_4,u_1,u_2)$ a même rang que la famille $(u_1,u_2,u_3,u_4)$ c'est-à-dire $4$. La famille $(e_1,e_2,e_3,e_4)$ est donc une base de $\Rr^4$.}
  \item \reponse{La matrice de la famille $(e_2,e_1,e_3,e_4)$ dans la base canonique de $\Rr^4$ est 
$\left(
\begin{array}{cccc}
1&2&4&1\\
1&-1&1&-2\\
