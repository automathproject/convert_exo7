...
\contenu{
  \texte{}
  \question{Montrer que pour tout réel $x$, $\int_{0}^{+\infty}\frac{\cos(xt)}{\ch t}\;dt = 2\sum_{n=0}^{+\infty}(-1)^n\frac{2n+1}{(2n+1)^2+x^2}$}
  \reponse{\textbf{Existence de l'intégrale.} Soit $x\in\Rr$. La fonction $f~:~t\mapsto\frac{\cos(xt)}{\ch t}$ est continue sur $[0,+\infty[$. De plus, pour tout réel positif $t$, $|f(t)|\leqslant\frac{1}{\ch t}$ et donc $|f(t)|\underset{t\rightarrow+\infty}{\sim}\frac{2}{e^t}\underset{t\rightarrow+\infty}{=}o\left(\frac{1}{t^2}\right)$. On en déduit que la fonction $f$ est intégrable sur  $[0,+\infty[$.
