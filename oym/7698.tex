...
\contenu{
  \texte{}
  \question{La courbure moyenne de la surface paramétrée suivante est-elle partout nulle ? 
$$\begin{array}{ccc}
...
\end{array}$$}
  \reponse{L'application $F$ est injective et différentiable car ses composantes le sont.
 On calcule
