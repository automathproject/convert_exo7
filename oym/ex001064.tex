...
\contenu{
  \texte{}
  \question{Que peut-on dire d'une matrice $A \in \mathcal{M}_n (\Rr)$ qui vérifie $\text{tr} (A \ {}^{t}\!{A}) = 0$ ?}
  \reponse{Notons $A=(a_{ij})$, notons $B = {}^{t}\!{A}$ si les coefficients sont $B=(b_{ij})$ 
