...
\contenu{
  \texte{}
  \question{Montrer que, pour tout entier naturel $n$, $2^{n+1}$ divise $E((1+\sqrt{3})^{2n+1})$.}
  \reponse{Posons $(1+\sqrt{3})^n=a_n+b_n\sqrt{3}$ où $a_n$ et $b_n$ sont des entiers naturels. On a alors $(1-\sqrt{3})^n=a_n-b_n\sqrt{3}$ et donc 
