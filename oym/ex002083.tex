...
\organisation{exo7}
\contenu{
  \texte{Calculer l'int\'egrale de $f:[a,b]\rightarrow \R$ comme
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{On calcul d'abord  $\int_0^{\frac \pi 2}  e^{it}\, dt$. Par le th\'eor\`eme de  Riemann-Darboux
c'est la limite de 
...
$\int_0^{\frac \pi 2} \cos t \, dt = 1$ et $\int_0^{\frac \pi 2}\sin t \, dt = 1$.}
  \item \reponse{On veut $x_k = aq^k$ ce qui donne bien $x_0=a$, mais il faut aussi $x_n = b$ donc
...
Donc $\int_a^b \frac {dt}{t} = \ln b - \ln a$.}
  \item \reponse{\`A l'aide des sommes g\'eom\'etrique est des taux d'accroissement on trouve 
