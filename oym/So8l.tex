\uuid{So8l}
\exo7id{5774}
\titre{** I Polynômes de \textsc{Tchebychev}}
\theme{Espaces préhilbertiens}
\auteur{rouget}
\date{2010/10/16}
\organisation{exo7}
\contenu{
  \texte{Soit $E=\Rr[X]$. Pour $(P,Q)\in E^2$, on pose $\varphi(P,Q)=\int_{-1}^{1}\frac{P(t)Q(t)}{\sqrt{1-t^2}}\;dt$. Pour $n\in\Nn$, on note $T_n$ le $n$-ème polynôme de \textsc{Tchebychev} de première espèce c'est-à-dire l'unique polynôme tel que $\forall\theta\in\Rr$, $T_n(\cos\theta)=\cos(n\theta)$.}
\begin{enumerate}
...
\end{center}}
  ...
  \item \reponse{Soit $(n,p)\in\Nn^2$. En posant $t=\cos\theta$, on obtient
...
\end{center}}
  \item \reponse{Soit $n\in\Nn$. Quand $p=n$, la formule précédente fournit
