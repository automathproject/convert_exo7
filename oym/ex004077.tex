\uuid{4077}
\titre{Coefficients périodiques}
\theme{}
\auteur{quercia}
\date{2010/03/11}
\organisation{exo7}
\contenu{
  \texte{Soit l'équation $(*) \Leftrightarrow y' + a(x)y = b(x)$ où $a,b$ sont des fonctions
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soient $y_0$ une solution particulière et $y_1$ une solution
