...
\contenu{
  \texte{}
  \question{Calculer de deux façons les racines carrées de $1+i$ et en déduire les valeurs exactes de $\cos\left(\frac{\pi}{8}\right)$
et $\sin\left(\frac{\pi}{8}\right)$.}
  \reponse{D'abord on a $1+i=\sqrt{2}e^{i\pi/4}$. Les racines carrées de $1+i$ dans $\Cc$ sont donc
