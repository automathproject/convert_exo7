...
\organisation{exo7}
\contenu{
  \texte{Soit $ABC$ un triangle équilatéral direct, et $P$ un point n'appartenant pas aux droites $(AB)$, $(BC)$ et $CA)$. La parallèle à $(BC)$ (resp. à $(CA)$ et $(AB)$) passant par $P$ coupe $(AB)$ (resp. $(BC)$ et $(CA)$) en $U$ (resp. $V$, $W$).
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Il suffit de montrer que $(AU,AW)=(PU,PW)$. 
\begin{center}
\includegraphics{../images/img007165-1}
\end{center}
Or, on a :
...
On procède de même pour l'autre quadrilatère.}
  \item \reponse{Pour chaque quadrilatère inscriptible, on peut en déduire  six égalités d'angles inscrits, car il y a $6=\binom{2}{4}$ façons de choisir une corde. Si $APUW$ est inscriptible, on a donc les égalités d'angles de droites:
...
On procède de même pour l'autre quadrilatère.}
  \item \reponse{Il suffit de montrer que $ABCP$ est inscriptible si et seulement si $(WU,WP)=(WV,WP)$. 
