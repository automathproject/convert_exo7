...
\end{enumerate}
\begin{enumerate}
  \item \reponse{La formule du binôme de \textsc{Newton} permet d'écrire
...
$$a_n^2-3b_n^2=(a_n+b_n\sqrt{3})(a_n-b_n\sqrt{3})=(2+\sqrt{3})^n(2-\sqrt{3})^n=(4-3)^n=1.$$}
  \item \reponse{On note que $(2+\sqrt{3})^n+(2-\sqrt{3})^n=(a_n+b_n\sqrt{3})+(a_n-b_n\sqrt{3})=2a_n$. Mais,
