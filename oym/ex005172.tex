...
\organisation{exo7}
\contenu{
  \texte{Soient $E$ un $\Kk$-espace vectoriel et $A$, $B$ et $C$ trois sous-espaces de $E$.}
\begin{enumerate}
...
$(A\cap B)+(A\cap C)\subset A\cap(B+C)$.}
  \item \reponse{Si on essaie de démontrer l'inclusion contraire, le raisonnement coince car la somme $y+z$ peut être dans
...
A\cap(B+C)$.}
  \item \reponse{$A\cap B\subset B\Rightarrow (A\cap B)+(A\cap C)\subset B+(A\cap C)$ mais aussi $(A\cap B)+(A\cap C)\subset
