...
\contenu{
  \texte{}
  \question{Calculer $\sum_{n=0}^{+\infty}\frac{(-1)^n}{3n+1}$.}
  \reponse{La suite $\left((-1)^n\frac{1}{3n+1}\right)_{n\in\Nn}$ est alternée en signe et sa valeur absolue tend vers $0$ en décroissant. Donc la série de terme général $(-1)^n\frac{1}{3n+1}$, $n\geqslant 1$, converge en vertu du critère spécial aux séries alternées.
