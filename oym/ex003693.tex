...
\contenu{
  \texte{}
  \question{Soit $E$ un espace euclidien de dimension $n>1$. Trouver toutes les fonctions $f$
de $E$ dans $\R$ continues telles que $u\perp v \Rightarrow f(u+v)=f(u)+f(v)$.}
  \reponse{$f$ linéaire et $f = x \mapsto\|x\|^2$ conviennent et l'ensemble~$\cal E$
