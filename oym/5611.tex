...
\contenu{
  \texte{}
  \question{Soient $A=(a_{i,j})_{1\leqslant i,j\leqslant n}$ et $B=(b_{i,j})_{1\leqslant i,j\leqslant n}$ deux matrices carrées de format $n$ telles que 
...
Montrer que si $AB=(c_{i,j})_{1\leqslant i,j\leqslant n}$ alors $c_{i,j}=0$ si $j\leqslant i+r+s-1$.}
  \reponse{Par hypothèse, $a_{i,j}= 0$ pour $j\leqslant i + r - 1$ et $bi,j = 0$ pour $j\leqslant i + s - 1$.
