...
\organisation{exo7}
\contenu{
  \texte{Soit $m\in\R$, et $A$ la matrice
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{{\it Factorisons le polyn\^ome caract\'eristique de $A$ et montrons que les valeurs propres de $A$ sont $-1$ et $1$.} (1,5 points)
\begin{align*}
...
Ainsi, les valeurs propres de la matrice $A$ sont $-1$, valeur propre simple, et $1$, valeur propre double.}
  \item \reponse{{\it Pour quelles valeurs de $m$ la matrice est-elle diagonalisable ? } (1,5 points)
