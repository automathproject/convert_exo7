...
\contenu{
  \texte{}
  \question{Soit $ADC$ un triangle équilatéral et $B$ le symétrique de $A$ par rapport à $D$. Montrer que $ABC$ est rectangle en $C$ et déterminer également $\widehat A$ et $\widehat B$.
\begin{center}
...
\end{tikzpicture}
\end{center}}
  \reponse{Comme par hypoth\`ese $DA = DC = DB$, les points $A$, $B$ et $C$ sont situés sur le cercle de centre $A$ et de diam\`etre $AB$. Donc, $ACB$ est rectangle en $C$. 
