\uuid{5150}
\titre{***I Inégalité de \textsc{Cauchy}-\textsc{Schwarz}}
\theme{}
\auteur{rouget}
\date{2010/06/30}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Soient $n\in\Nn^*$ et $a_1$, $a_2$,..., $a_n$, $b_1$, $b_2$,..., $b_n$, $2n$ réels. Montrer que
...
décroissantes puis utiliser, dans le cas général, les connaissances sur le second degré). Retrouver alors le résultat de l'exercice \ref{exo:suprou4bis}.}
  \reponse{Pour $x$ réel, posons $f(x)=\sum_{k=1}^{n}(a_k+b_kx)^2$. On remarque que pour tout réel $x$,
