...
\contenu{
  \texte{}
  \question{Soit $A$ une matrice orthogonale. Montrer que la valeur absolue de la somme des coefficients de $A$ est inférieure ou égale à $n$. Cas d'égalité si de plus tous les coefficients de $A$ sont positifs ?}
  \reponse{Soit $A =(a_{i,j})_{1\leqslant i,j\leqslant n}$ une matrice orthogonale. On pose $X =\left(
\begin{array}{c}
1\\
\vdots\\
1
