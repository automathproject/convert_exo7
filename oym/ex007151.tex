...
\organisation{exo7}
\contenu{
  \texte{%[d'après bac France, juin 2008]
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{L'application $s$ est une similitude directe, de rapport $2/3$, d'angle $arg(i)=\pi/2$, et de centre d'affixe $\frac{\frac{1-5i}{3}}{1-\frac{2}{3i}} = \frac{13-13i}{13}=1-i=z_A$.}
  \item \reponse{\begin{enumerate}}
  \item \reponse{On a $AB_{n+1}=s(A)s(B_n) = \frac{2}{3}AB_n$.}
  \item \reponse{D'après la question précédente, la suite réelle $AB_n$ est géométrique de raison $2/3$ et de terme initial $AB$, donc :
...
Comme $AB = 15/2$, on peut calculer explicitement $n$ à l'aide d'une calculatrice et on trouve $N= 17$, mais ce n'était pas demandé.}
  \item \reponse{Pour tout $n$, les points $A$, $B$ et $B_n$ sont distincts. Ils sont alignés ssi
