...
\organisation{exo7}
\contenu{
  \texte{Soient $a,b,c$ des r\'eels v\'erifiant $a^2+b^2+c^2=1$ et
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Calculons le d\'eterminant de $P$.
$$\det P=\begin{vmatrix}a^2&ab&ac \\  ab&b^2&bc \\  ac&bc&c^2\end{vmatrix}=abc\begin{vmatrix}a&a&a \\  b&b&b \\  c&c&c\end{vmatrix}=0.$$}
  \item \reponse{D\'eterminons les sous-espaces vectoriels de $\R^3$, $\ker P$ et $\Im P$.
...
Le sous-espace $\Im P$ est donc la droite vectorielle engendr\'ee par le vecteur $\begin{pmatrix}a \\  b \\  c\end{pmatrix}$.}
  \item \reponse{Soit $Q=I-P$, calculons $P^2$, $PQ$, $QP$ et $Q^2$.
  \begin{align*}
...
$$Q^2=(I-P)(I-P)=I^2-IP-PI+P^2=I-P-P+P=I-P=Q.$$}
  \item \reponse{Caract\'erisons g\'eom\'etriquement $P$ et $Q$.
