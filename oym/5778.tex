...
\contenu{
  \texte{}
  \question{Soit $E$ un espace préhilbertien réel et $(e_1,...,e_n)$ une famille de $n$ vecteurs unitaires de $E$ ($n\in\Nn^*$) telle que pour tout vecteur $x$ de $E$, on ait  $\|x\|^2 =\sum_{k=1}^{n}\left(x|e_k\right)^2$. Montrer que la famille $(e_1,...,e_n)$ est une base orthonormée de $E$.}
  \reponse{Soit $i\in\llbracket1,n\rrbracket$.
