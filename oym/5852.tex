...
\contenu{
  \texte{}
  \question{Donner un développement à la précision $ \frac{1}{n^2}$ de la $n$-ième racine positive $x_n$ de l'équation $\tan x = x$.}
  \reponse{Posons $I_0=\left[0, \frac{\pi}{2}\right[$ puis pour $n\in\Nn^*$, $I_n=\left]- \frac{\pi}{2}+n\pi, \frac{\pi}{2}+n\pi\right[$ et enfin $D =\displaystyle\bigcup_{n\in\Nn}I_n$.
