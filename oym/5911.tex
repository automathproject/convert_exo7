...
\contenu{
  \texte{}
  \question{Calculer le volume de $B=\{(x_1,\ldots,x_n)\in\Rr^n/\;x_1^2+\ldots+x_n^2\leqslant1\}$ (boule unité fermée de $\Rr^n$ pour $\|\;\|_2$).}
  \reponse{Pour $n\in\Nn^*$ et $R\geqslant0$, posons $B_n(R)=\{(x_1,\ldots,x_n)\in\Rr^n/\;x_1^2+\ldots+x_n^2\leqslant R^2\}$ et notons $V_n(R)$ le volume de $B_n(R)$. Par définition,
