...
\end{enumerate}
\begin{enumerate}
  \item \reponse{{\it Donnons un exemple de matrice dans $M_2(\R)$, diagonalisable sur $\C$ mais non diagonalisable sur $\R$}. (2 points)
...
Le polyn\^ome caract\'eristique de $A$ admet deux racines complexes conjugu\'ees distinctes $i$ et $-i$ elle est donc diagonalisable sur $\C$ mais elle ne l'est pas sur $\R$.}
  \item \reponse{{\it Donnons un exemple de matrice dans $M_2(\R)$ non diagonalisable, ni sur $\C$, ni sur $\R$.} (2 points) 
