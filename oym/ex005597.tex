...
\contenu{
  \texte{}
  \question{Montrer que tout hyperplan de $M_n(\Rr)$ contient des matrices inversibles.}
  \reponse{Soit $H$ un hyperplan de $\mathcal{M}_n(\Rr)$. $H$ est le noyau d'une forme linéaire non nulle $f$.
