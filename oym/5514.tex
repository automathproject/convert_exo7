...
\contenu{
  \texte{}
  \question{Soit $M(x,y,z)$ un point de $\Rr^3$ rapporté à un repère orthonormé. Déterminer la distance de $M$ à la droite 
$(D)$ $\left\{
\begin{array}{l}
x+y+z+1=0\\
2x+y+5z=2
...
\right.$. En déduire une équation du cylindre de révolution d'axe $(D)$ et de rayon $2$.}
  \reponse{\textbullet~Déterminons un repère de $(D)$.
\begin{center}
$\left\{
\begin{array}{l}
x+y+z+1=0\\
