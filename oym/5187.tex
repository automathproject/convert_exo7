...
\contenu{
  \texte{}
  \question{Soient $(e_i)_{1\leq i\leq 4}$ la base canonique de $\Rr^4$ et $f$ l'endomorphisme de $\Rr^4$ défini
par~:~$f(e_1)=2e_1+e_3$, $f(e_2)=-e_2+e_4$, $f(e_3)=e_1+2e_3$ et $f(e_4)=e_2-e_4$. Déterminer $\mbox{Ker}f$ et
$\mbox{Im}f$.}
  \reponse{Soit $u=(x,y,z,t)=xe_1+ye_2+ze_3+te_4\in\Rr^4$. Alors,
