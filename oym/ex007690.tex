...
\organisation{exo7}
\contenu{
  \texte{Soit $S$ la surface de $\Rr^3$ d'équation $2(2z^2+y^2)+x=0$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{La surface $S$ est le graphe de la fonction $\mathcal{C}^\infty$ $f~:~(y,z)\mapsto -2(2z^2+y^2)$.
 Elle est donc régulière.}
  \item \reponse{La surface $S$ est paramétrée par $F(u,v)=(-2(u^2+2v^2),u,v)$.}
  \item \reponse{Le point $A$ est obtenu au point de paramètre $(1,-1)$
