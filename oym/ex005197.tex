...
\contenu{
  \texte{}
  \question{Déterminer le projeté orthogonal du point $M(x_0,y_0)$ sur la droite $(D)$ d'équation $x+3y-5=0$ ainsi que son symétrique orthogonal.}
  \reponse{$(D)$ est une droite de vecteur normal $(1,3)$. Le projeté orthogonal $p(M_0)$ de $M_0$ sur $(D)$ est de la forme $M_0+\lambda.\vec{n}$ où $\lambda$ est un réel à déterminer. Le point $M_0+\lambda.\vec{n}$ a pour coordonnées $(x_0+\lambda,y_0+3\lambda)$.
