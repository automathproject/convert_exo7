...
\organisation{exo7}
\contenu{
  \texte{% De 444, cousquer}
\begin{enumerate}
  \item \question{Décomposer les fractions suivantes en éléments simples sur $\Cc$.
$$\frac{(3-2 i )X-5+3 i }{X^2+ i  X+2} \qquad\qquad \frac{X+ i }{X^2+ i } \qquad\qquad \frac{2X}{(X+ i )^2}$$}
  \item \question{Décomposer les fractions suivantes en éléments simples sur $\Rr$, puis sur $\Cc$.
$$\frac{X^5+X+1}{X^4-1} \qquad\qquad \frac{X^2-3}{(X^2+1)(X^2+4)} \qquad\qquad \frac{X^2+1}{X^4+1}$$}
\end{enumerate}
\begin{enumerate}
  \item \reponse{$$\begin{array}{rcl}
