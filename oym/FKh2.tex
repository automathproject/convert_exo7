...
\organisation{exo7}
\contenu{
  \texte{Dans $\R^2$, on d\'efinit les ensembles $F_{1}=\{(x,y)\in\R^2,\ y\leq0\}$ et
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Cette proposition est vraie. En effet soit $\epsilon > 0$,  d\'efinissons $M_1 = (\frac{2}{\epsilon},0)  \in F_1$ et
...
$\epsilon >0$ la proposition est donc d\'emontr\'ee.}
  \item \reponse{Soit deux points fix\'es $M_1$, $M_2$ v\'erifiant cette
...
$$ \forall M_1 \in F_1 \ \  \forall M_2 \in F_2 \quad \exists \epsilon \in ]0,+\infty[ \quad  \quad M_1M_2 \geqslant \epsilon $$ et cela exprime le fait que les ensembles $F_1$ et $F_2$ sont disjoints.}
  \item \reponse{Celle ci est \'egalement fausse, en effet supposons qu'elle soit
...
\'eloign\'es l'un de l'autre  que l'on veut.}
  \item \reponse{Cette proposition est vraie, il suffit de choisir
