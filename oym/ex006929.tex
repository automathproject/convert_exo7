...
\organisation{exo7}
\contenu{
  \texte{On mesure une certaine grandeur physique $G$ avec un appareil dont la
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{La meilleure estimation de $G$ est la valeur moyenne mesurée, $g_1 =1,364$. 
...
est un intervalle de confiance relatif à $G$ au seuil de 90\%.}
  \item \reponse{La meilleure estimation de $G$ est la valeur moyenne mesurée, $\bar{g}=\frac{1}{10}(g_1 +\cdots+g_{5})=1,365$. Soit 
