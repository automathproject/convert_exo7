...
\organisation{exo7}
\contenu{
  \texte{Extremums des fonctions suivantes :}
\begin{enumerate}
  \item \question{$f(x,y) = x^3+3x^2y -15x-12y$}
  \item \question{$f(x,y) = -2(x-y)^2+x^4+y^4$.}
\end{enumerate}
\begin{enumerate}
  \item \reponse{$f$ est de classe $C^1$ sur $\Rr^2$ qui est un ouvert de $\Rr^2$. Donc si $f$ admet un extremum local en un point $(x_0,y_0)$ de $\Rr^2$, $(x_0,y_0)$ est un point critique de $f$.
...
\end{center}}
  \item \reponse{La fonction $f$ est de classe $C^1$ sur $\Rr^2$ en tant que polynôme à plusieurs variables. Donc, si $f$ admet un extremum local en $(x_0,y_0)\in\Rr^2$, $(x_0,y_0)$ est un point critique de $f$. Soit $(x,y)\in\Rr^2$.
