...
\end{enumerate}
\begin{enumerate}
  \item \reponse{{\it Diagonalisons la matrice $A$.} (2 points)
...
$$P=\begin{pmatrix}1&-1 \\  1&1\end{pmatrix}\ {\hbox{et}}\ D=\begin{pmatrix}1&0 \\  0&-1\end{pmatrix}$$}
  \item \reponse{{\it Exprimons les solutions du syst\`eme diff\'erentiel $X'=AX$ dans une base de vecteurs propres et tra\c cons ses trajectoires.} (3 points)
