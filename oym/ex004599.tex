\exo7id{4599}
\titre{DSE de $(\Arcsin x)^2$}
\theme{}
\auteur{quercia}
\date{2010/03/14}
\organisation{exo7}
\contenu{
  \texte{On pose $f(x) = \frac{\Arcsin x}{\sqrt{1-x^2}}$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Produit de deux séries $ \Rightarrow  R \ge 1$.
          Lorsque $x\to1^-$   $f(x) \to +\infty  \Rightarrow  R = 1$.}
  \item \reponse{$(1-x^2)y' = xy+1  \Rightarrow  (n+2)a_{n+2} = (n+1)a_n  \Rightarrow 
  ...
  \item \reponse{$\Arcsin^2x = 2 \int_{t=0}^x f(t)\,d t
