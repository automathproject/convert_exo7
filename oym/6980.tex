...
\contenu{
  \texte{}
  \question{Montrer que l'équation $\Argsh x+\Argch x=1$ admet une unique solution, puis la déterminer.}
  \reponse{Soit $f(x)=\Argsh x+\Argch x$. La fonction $f$ est bien définie, continue, et strictement croissante, 
