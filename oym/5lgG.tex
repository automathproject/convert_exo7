\uuid{5lgG}
\exo7id{3666}
\titre{Expression analytique}
\theme{Exercices de Michel Quercia, Produit scalaire}
\auteur{quercia}
\date{2010/03/11}
\organisation{exo7}
\contenu{
  \texte{Soit $E$ un espace euclidien de dimension 4, ${\cal B} = (\vec e_1, \dots, \vec e_4)$
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$\biggl(\frac 1{\sqrt6}(1,-2,1,0), \frac 1{\sqrt{30}}(2,-1,-4,3) \biggr)$}
  \item \reponse{$\frac 1{10}\begin{pmatrix}3 &-4 &-1 &2  \cr
                          -4 &7  &-2 &-1 \cr
                          -1 &-2 &7 &-4  \cr
                           2 &-1 &-4 &3  \cr\end{pmatrix}$.}
  \item \reponse{$\sqrt{\frac 7{10}}$.}
\end{enumerate}
}