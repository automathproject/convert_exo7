\uuid{Qakx}
\exo7id{5871}
\titre{** I Exponentielle d'un endomorphisme anti-symétrique de $\Rr^3$}
...
\begin{enumerate}
  ...
  \item \reponse{Soit $\overrightarrow{\omega}\in\Rr^3$. $f_{\overrightarrow{\omega}}$ est un endomorphisme de $\Rr^3$ par bilinéarité du produit vectoriel. De plus, pour $(\overrightarrow{x},\overrightarrow{y})\in(\Rr^3)^2$,
