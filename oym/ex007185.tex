...
\contenu{
  \texte{}
  \question{%[modifier pour se ramener à un cas simple]
Soient $a$, $b$ et $c$ des réels strictement positifs. Montrer que
\[ \frac{c}{a} + \frac{a}{b+c} +\frac{b}{c} \geq 2.
\]}
  \reponse{En appliquant l'inégalité arithmético-géométrique, on voit que les $a$ et $c$ se simplifient mais pas $b$ et $b+c$. L'idée est alors de modifier la forme de l'inégalité pour obtenir la simplification. Or, l'inégalité est équivalente à 
