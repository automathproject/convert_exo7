...
\organisation{exo7}
\contenu{
  \texte{Soit $\mathcal{C}$ la courbe d'équation $x^2+y^2-2x+4y+1=0$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Le point $A(2,-2+\sqrt{3})$ est effectivement sur $\mathcal{C}$ car $(2-1)^2+(-2+\sqrt{3}+2)^2=1+3=4$. La tangente $(T)$ en $A$ à $\mathcal{C}$ est la droite passant par $A$ et de vecteur normal $\overrightarrow{A\Omega}$.
...
\Leftrightarrow x+\sqrt{3}y-5+2\sqrt{3}=0.$$}
  \item \reponse{Soit $\mathcal{C}'$ le cercle de centre $(1,0)$ et de rayon $2$. Une équation de ce cercle est $x^2+y^2-2x-3=0$. Par suite,
