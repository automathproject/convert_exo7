...
\organisation{exo7}
\contenu{
  \texte{\textit{On rappelle qu'à toute matrice $A=\begin{pmatrix} a&b\\c&d\end{pmatrix}$ de $SL(2,\Rr)$,
...
Par conséquent, si $Im(z)>0$, alors $Im\left(h_A(z)\right)>0$ et $h_A$ envoie $\mathbb{H}$ sur $\mathbb{H}$.}
  \item \reponse{Soit $z=x+iy$. On a $\frac{xi-y}{1\times i+0}=z$. La matrice $\begin{pmatrix} x&-y\\1&0\end{pmatrix}$
