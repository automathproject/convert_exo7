...
\contenu{
  \texte{}
  \question{Démontrer que $S_n$ est engendré par $\tau_{1,2}$ et le cycle $(2\;3\;...\;n\;1)$.}
  \reponse{D'après l'exercice \ref{exo:suprou2ter}, il suffit de montrer que pour $2\leq i\leq n$, $\tau_{1,i}$ peut s'écrire en utilisant uniquement $\tau=\tau_{1,2}$ et $c=(2\;3\;...\;n\;1)$. On note que $c^n=Id$.
