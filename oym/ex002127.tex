...
\contenu{
  \texte{}
  \question{Soient $G$ un groupe fini et commutatif et $\{ G_i\} _{i\in I }$ la famille des sous-groupes
...
$G$ contenant $a$ et engendrant $G$, $S-\{ a \}$ engendre encore $G$.}
  \reponse{Etant donn\'e $a\in F$, soit $S$ une partie de $G$ contenant $a$
