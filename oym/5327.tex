...
\contenu{
  \texte{}
  \question{Trouver les polynômes $P$ de $\Rr[X]$ vérifiant $P(X^2)=P(X)P(X+1)$ (penser aux racines de $P$).}
  \reponse{Les polynômes de degré inférieur ou égal à $0$ solutions sont clairement $0$ et $1$.
