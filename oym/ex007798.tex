...
\organisation{exo7}
\contenu{
  \texte{Soit $E=\Rr^2$ muni de la forme quadratique $q(x_1,x_2)=x_1^2-x_2^2$ non dégénérée de signature $(1,1)$. Le groupe $O(1,1)$ est par définition le groupe des isométries de $(E,q)$.}
\begin{enumerate}
