...
\contenu{
  \texte{}
  \question{\label{ex:rou17}
Soit $A$ une matrice carrée de format $n$. Calculer le déterminant de sa comatrice.}
  \reponse{On a toujours $A{^t}(\text{com}A)=(\text{det}A)I_n$. Par passage au déterminant et puisqu'une matrice a même déterminant que sa transposée, on obtient
