...
\organisation{exo7}
\contenu{
  \texte{Soit $E=\Rr^n$ muni de la norme euclidienne et $F =
...
\begin{enumerate}
  \item \question{Démontrer que $\forall A,B \in F : \|AB\|_{op} \le
\|A\|_{op} \cdot \|B\|_{op}$.}
  \item \question{Démontrer que pour $A\in F$, la série
...
\sum_{n=0}^\infty\frac1{n!} A^n$.}
  \item \question{Calculer $D_{\mathbf{0}} \exp$, où $\mathbf{0}$ est
