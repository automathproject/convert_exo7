\uuid{3161}
\titre{Suite r{\'e}currente (Mines MP 2003)}
\theme{}
\auteur{quercia}
\date{2010/03/08}
\organisation{exo7}
\contenu{
  \texte{}
  \question{On consid{\`e}re la suite $(x_n)$ {\`a} valeurs dans~$\Z/11\Z$ telle que pour tout~$n$
on ait $x_{n+3} = 4(x_{n+2}+x_{n+1}+x_n)$.
D{\'e}terminer les diff{\'e}rents comportements possibles de $(x_n)$.}
  \reponse{L'{\'e}quation caract{\'e}ristique, $X^3=4(X^2+X+1)$ admet trois racines distinctes
