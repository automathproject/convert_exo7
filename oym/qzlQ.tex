...
\organisation{exo7}
\contenu{
  \texte{Soit la fonction $f\colon\R^2\to\R$ d\'efinie par
$$
...
la fonction $f$ ne peut pas \^etre diff\'erentiable en $(0,0)$.}
  \item \reponse{L'association $\R^2 \to \R,\ v \mapsto D_vf(0,0)$
...
et de vecteurs directeurs $(v, D_vf(0,0))\in\R^3$ ne forment pas un plan.}
  \item \reponse{Dans $\R^2\setminus\{ (0,0)\}$, 
\begin{align*}
