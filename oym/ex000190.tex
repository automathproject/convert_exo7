...
\organisation{exo7}
\contenu{
  \texte{Les applications suivantes sont-elles injectives, surjectives, bijectives ?}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$f$ n'est pas surjective car $0$ n'a pas d'antécédent : en effet il n'existe pas de $n\in\Nn$ tel que $f(n)=0$ (si ce $n$ existait ce serait $n=-1$
...
$n+1=n'+1$ donc $n=n'$. Bilan $f$ est injective, non surjective et donc non bijective.}
  \item \reponse{Pour montrer que $g$ est bijective deux méthodes sont possibles. Première méthode : montrer que $g$ est à la fois injective et surjective.
...
et donc $g$ est bijective.}
  \item \reponse{Montrons que $h$ est injective. Soient $(x,y), (x',y') \in \Rr^2$ tels que $h(x,y)=h(x',y')$.
...
Mais vous devriez vous convaincre qu'il s'agit là d'une différence de rédaction, mais pas vraiment d'un raisonnement différent.}
  \item \reponse{Montrons d'abord que $k$ est injective : soient $x,x' \in \Rr\setminus \{1\}$ tels que $k(x)=k(x')$ alors
