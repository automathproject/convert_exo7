\exo7id{4728}
\titre{Fonctions p{\'e}riodiques (Ens Ulm-Lyon-Cachan MP$^*$ 2003)}
\theme{}
\auteur{quercia}
\date{2010/03/16}
\organisation{exo7}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Il est suppos{\'e} connu (et {\`a} savoir d{\'e}montrer) le fait suivant~:
  ...
  \item \reponse{D'apr{\`e}s la premi{\`e}re question, pour tout~$y\in\R\setminus\Q$
