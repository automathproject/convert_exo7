...
\exo7id{2793}
\titre{Exercice 2793}
\theme{Dérivabilité au sens complexe, fonctions analytiques, La fonction exponentielle}
\auteur{burnol}
\date{2009/12/15}
\organisation{exo7}
\contenu{
  \texte{Cet exercice propose une variante pour développer la
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{La formule de Taylor avec reste int\'egral est
$$g(b)= g(a) +g'(a)(b-a) +...+ \frac{g^{(n)} (a)}{n!} (b-a)^n+ \int_a^b \frac{(b-t)^n}{n!} g^{(n+1)}(t)\, dt$$
puis on remplace avec $a=0$ et $b=1$.}
  \item \reponse{Si $f'=f$ et si $f$ est $n$--fois d\'erivable au sens complexe, alors
...
Cette derni\`ere expression tend vers $0$ lorsque $n\to \infty$. D'o\`u $f(z)=\sum_{k=0}^\infty \frac{z^k}{k!}$.}
  \item \reponse{Fixons $z\in \Cc$ et notons $a_k=\frac{z^k}{k!}$. Alors :
