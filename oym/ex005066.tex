...
\organisation{exo7}
\contenu{
  \texte{Résoudre dans $I$ les inéquations suivantes~:}
\begin{enumerate}
  \item \question{$\cos x\leq\frac{1}{2},\;I=[-\pi,\pi]$,}
  \item \question{$\sin x\geq-\frac{1}{\sqrt{2}},\;I=\Rr$,}
  \item \question{$\cos x>\cos\frac{x}{2},\;I=[0,2\pi]$,}
  \item \question{$\cos^2x\geq\cos(2x),\;I=[-\pi,\pi]$,}
  \item \question{$\cos^2x\leq\frac{1}{2},\;I=[0,2\pi]$,}
  \item \question{$\cos\frac{x}{3}\leq\sin\frac{x}{3},\;I=[0,2\pi]$.}
\end{enumerate}
\begin{enumerate}
  \item \reponse{Pour $x\in[-\pi,\pi]$, $\cos x\leq\frac{1}{2}\Leftrightarrow x\in\left[-\pi,-\frac{\pi}{3}\right]\cup\left[\frac{\pi}{3},\pi\right]$.}
  \item \reponse{Pour $x\in\Rr$, $\sin
x\geq-\frac{1}{\sqrt{2}}\Leftrightarrow x\in\displaystyle\bigcup_{k\in\Zz}\left[-\frac{\pi}{4}+2k\pi,\frac{5\pi}{4}+2k\pi\right]$.}
  \item \reponse{Pour $x\in[0,2\pi]$,
...
\end{align*}}
  \item \reponse{Pour $x\in[-\pi,\pi]$, $\cos^2x\geq\cos(2x)\Leftrightarrow\frac{1}{2}(1+\cos(2x))\geq\cos(2x)\Leftrightarrow\cos(2x)\leq1\Leftrightarrow
x\in[-\pi,\pi]$.}
  \item \reponse{Pour $x\in[0,2\pi]$, $\cos^2x\leq\frac{1}{2}\Leftrightarrow-\frac{1}{\sqrt{2}}\leq\cos x\leq\frac{1}{\sqrt{2}}\Leftrightarrow
