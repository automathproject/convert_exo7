...
\contenu{
  \texte{}
  \question{Trouver toutes les classes de conjugaison de $S_4$. Donner la
liste des sous-groupes distingu\'es de $S_4$.}
  \reponse{Les classes de conjugaison de $S_n$ correspondent aux types possibles d'une permutation de
