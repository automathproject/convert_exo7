...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $C_R=\{R e^{i\theta } \,;\; 0\leq \theta \leq \frac{2\pi}{n}\}$.
...
lorsque $R\to\infty$.}
  \item \reponse{La fonction $z^a=\exp \left( a(\log r +i\alpha )\right)$ n'est  pas d\'efinie au voisinage de l'origine.
...
$$\int_0^\infty \frac{dx}{1+x^a}=\frac{\frac{\pi}{a}}{\sin\left(\frac{\pi}{a}\right)} \quad \text{pour} \quad a>1\, .$$}
  \item \reponse{Soit $x\in(0,\infty )$ et $a=u+iv$ avec $u>1$. Alors
...
du principe des z\'eros isol\'es et du fait que nous avons d\'eja \'etabli cette relation pour tout r\'eel $a>1$.}
  \item \reponse{\'Evident.}
  \item \reponse{On peut proc\'eder comme dans la question 3. Notons que
...
u©ì$$U_\epsilon =\left\{ 0< \Re (p) < 1-\epsilon \right\} \quad\text{ avec } \quad \epsilon >0 \; \; \text{petit}\, .$$}
  \item \reponse{Nous avons vu dans la question pr\'ec\'edente que la fonction $h(p,t)=\frac{e^{pt}}{1+e^t}$
