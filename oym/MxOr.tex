...
\exo7id{2424}
\titre{Exercice 2424}
\theme{Devoir maison : frontière et connexité}
\auteur{lescure}
\date{2007/10/01}
\organisation{exo7}
\contenu{
...
\begin{enumerate}
  ...
  \item \reponse{Si  $x \in\mathrm{Fr} (A) = \bar A \cap \overline{E \setminus A}$ , alors $\forall n \in \Nn^*$
...
$E \setminus A$ de $A$ dans $E,$ qui convergent l'une et l'autre vers $x.$}
  \item \reponse{On voit, qu'en posant pour $n \ge 1,$ d'une part $x_n=\frac 12-{\frac 1  {4n}}$ et d'autre part,
