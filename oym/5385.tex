...
Soit $A$ une partie non vide de $\Rr$. Pour $x\in\Rr$, on pose $f(x)=\mbox{Inf}\{|y-x|,\;y\in A\}$. Montrer que $f$ est continue en tout point de $\Rr$.}
  \reponse{Soit $(x,y)\in\Rr^2$ et $z\in A$. $|x-z|\leq|x-y|+|y-z|$. Or, $forall z\in A,\;|x-z|\geq d(x,A)$ et donc $d(x,A)-|x-y|$ est un minorant de $\{|y-z|,\;z\in A\}$. Par suite, $d(x,A)-|x-y|\leq d(y,A)$. On a montré que 
