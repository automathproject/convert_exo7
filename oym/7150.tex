...
\contenu{
  \texte{}
  \question{Fixons un repère orthonormé direct du plan.
...
\]}
  \reponse{Soit $z\mapsto \alpha z + \beta$ la représentation complexe d'une similitude directe. En coordonnées cartésiennes, elle s'écrit $\begin{pmatrix}x\\y\end{pmatrix} \mapsto  
\begin{pmatrix}
