...
\organisation{exo7}
\contenu{
  \texte{Résoudre sur $\R$ les équations différentielles suivantes:}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Il s'agit d'une équation différentielle linéaire d'ordre 1, à coefficients constants, avec second membre.\\ 
