...
\organisation{exo7}
\contenu{
  \texte{Soit $E=\Kk_n[X]$. $u$ est l'endomorphisme de $E$ défini par : $\forall P\in E,\; u(P)=P(X+1)-P$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$u$ est dans L(E) car $u$ est linéaire et si $P$ est un polynôme de degré au plus $n$ alors $u(P)$ est un polynôme de degré au plus $n$.
...
\end{center}}
  \item \reponse{On part de $P_0 = 1$ et aussi de $P_1 = X$ qui vérifient bien $u(P_0) = 0$ et $u(P_1) = P_0$.
