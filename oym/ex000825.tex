...
\organisation{exo7}
\contenu{
  \texte{Calculer les intégrales de fractions rationnelles suivantes.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$\frac{1}{x^2+2}$ est un élément simple.
$\int_0^1\frac{dx}{x^2+2} = \frac{1}{\sqrt{2}} \arctan \frac{1}{\sqrt{2}}$.}
  \item \reponse{Décomposition~: $\frac{1}{1-x^2} = \frac{1/2}{x+1} - \frac{1/2}{x-1}$. 
Intégrale~: $\int_{-1/2}^{1/2} \frac{dx}{1-x^2} = \ln 3$.}
  \item \reponse{Pas besoin de décomposer la fraction rationnelle, car $2x+1$ est 
la dérivée de $x^2+x-3$~! $\int_2^3 \frac{2x+1}{x^2+x-3}\,dx = \ln 3$.}
  \item \reponse{On peut évidemment décomposer la fraction rationnelle en 
éléments simples~: 
...
\frac{1}{2}\int_0^4 \frac{du}{u^2+16} = \frac{\pi}{32}$.}
  \item \reponse{La décomposition de $\frac{x^4+6x^3-5x^2+3x-7}{(x-4)^3}$ est
...
\ln\frac{3}{2}+2\arctan \frac{1}{7}$.}
  \item \reponse{La décomposition est $\frac{x^3+2x+1}{x^3-3x+2} = 
...
\frac{5}{3}-\frac{22}{9}\ln 2$.}
  \item \reponse{La décomposition de 
...
$\int_{1}^2 \frac{2x^8+5x^6-12x^5+30x^4+36x^2+24}
  ...
  \item \reponse{Décomposition de la fraction rationnelle~: 
...
\frac{\pi}{4}+2\ln 2$.}
  \item \reponse{Pour factoriser le dénominateur, penser à 
