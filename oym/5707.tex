...
\contenu{
  \texte{}
  \question{Développement limité à l'ordre $4$ de $\sum_{k=n+1}^{+\infty}\frac{1}{k^2}$ quand $n$ tend vers l'infini.}
  \reponse{Pour $n\in\Nn^*$, posons $R_n=\sum_{k=n+1}^{+\infty}\frac{1}{k^2}$. Puisque la série de terme général $\frac{1}{k^2}$, $k\geqslant 1$, converge, la suite $(R_n)$ est définie et tend vers $0$ quand $n$ tend vers $+\infty$.
