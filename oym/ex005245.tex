...
\contenu{
  \texte{}
  \question{Soit $f$ une application injective de $\Nn$ dans $\Nn$. Montrer que $\lim_{n\rightarrow +\infty}f(n)=+\infty$.}
  \reponse{Soit $f$ une application de $\Nn$ dans lui-même, injective. Montrons que $\lim_{n\rightarrow +\infty}f(n)=+\infty$.
