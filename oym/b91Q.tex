...
\organisation{exo7}
\contenu{
  \texte{Soient $f$ et $g$ deux fonctions de classe $\mathcal{C}^1$ sur $\R$ à valeurs
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$\det(J_\varphi(x,y)) =  f'(x)f'(y) - g'(x)g'(y) > 0$ donc le théorème
...
\end{align*}
  ...
  \item \reponse{On a $\varphi(x,y) = (u,v)$ si et seulement si $x = f^{-1}(u-g(y))$ et
