\uuid{3239}
\titre{Racines r{\'e}elles simples}
\theme{}
\auteur{quercia}
\date{2010/03/08}
\organisation{exo7}
\contenu{
  \texte{Soit $P = \sum_{k=0}^n a_kX^k \in {\R[X]}$ dont les racines sont r{\'e}elles simples.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $P(x) = a_n\prod_{k=1}^n(x-x_k)$.
      On a : $\sum_{k=0}^n \frac 1{(x-x_k)^2}
               = -\frac d{dx}\Bigl(\frac {P'}P\Bigr)(x) = \frac {P'^2 - PP''}{P^2}(x)$.}
  \item \reponse{Pour $k=1,x=0$, on a : $a_0a_2 \le \frac 12a_1^2$.\\
