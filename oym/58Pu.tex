\uuid{58Pu}
\exo7id{4633}
\titre{$\sum_{n=1}^\infty  \frac{a}{n^2+a^2}$ (Centrale MP 2000)}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$S_f(x) = \sum_{n=-\infty}^{+\infty} \frac{e^{2\pi a}-1}{\strut2\pi(a-in)}e^{inx}$.}
  \item \reponse{$\sum_{n\in\Z}\frac{(e^{2\pi a}-1)^2}{4\pi^2(a^2+n^2)} = \frac1{\strut2\pi} \int_{t=0}^{2\pi}|f(t)|^2\,d t
