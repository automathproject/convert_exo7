...
\contenu{
  \texte{}
  \question{Soit $(\mathcal{H})$ une hyperbole équilatère de centre $O$ et $P$ et $Q$ deux points de
...
$(\mathcal{H})$ en trois points formant un triangle équilatéral de centre $P$.}
  \reponse{On choisit un repère orthonormé dans lequel $P$ a pour coordonnées $(a,b)$, $a>0$, $b>0$ et l'hyperbole $\mathcal{H}$ a pour équation $xy=ab$.
