...
\contenu{
  \texte{}
  \question{Soit $X$ un ensemble non vide et ordonn\'e. Montrer qu'il existe une partie
...
L'ensemble $Y$ est-il unique?}
  \reponse{Pour tout $x\in X$, posons $C(x)=\{ y\in X \hskip 2pt |\hskip 2pt  x\ \hbox{\rm et}\ y \
