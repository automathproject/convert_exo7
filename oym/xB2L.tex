...
\exo7id{2311}
\titre{Exercice 2311}
\theme{Devoir à la maison et sujet de partiel}
\auteur{barraud}
\date{2008/04/24}
\organisation{exo7}
\contenu{
  \texte{Soit $\Zz_{36}=\Zz/36\Zz\ $ l'anneau des entiers modulo $36$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$\bar{n}$ est inversible ssi $\pgcd(n,36)=1$ (Bezout~!), i.e.
...
donc ssi $6|n$, soit $\bar{n}\in\{0,\pm6,\pm12,18\}$.}
  \item \reponse{Montrons que l'ensemble $\mathcal{I}$ des idéaux de $\Zz/36\Zz$ est en
...
\begin{itemize}}
  \item \reponse{$(\overline{ 1})=\Zz_{36}$,}
  \item \reponse{$(\overline{ 2})=\{0,\pm2,\pm4,\pm6,\pm8,\pm10,\pm12,\pm14,\pm16,18\}$,}
  \item \reponse{$(\overline{ 3})=\{0,\pm3,\pm6,\pm9,\pm12,\pm15,18\}$,}
  \item \reponse{$(\overline{ 4})=\{0,\pm4,\pm8,\pm12,\pm16\}$,}
  \item \reponse{$(\overline{ 6})=\{0,\pm6,\pm12\}$}
  \item \reponse{$(\overline{ 9})=\{0,\pm9,18\}$}
  \item \reponse{$(\overline{12})=\{0,\pm12\}$}
  \item \reponse{$(\overline{18})=\{0,18\}$}
  \item \reponse{$(\overline{36})=\{0\}$,
\end{itemize}}
  \item \reponse{Si $a,b\in A^{\times}$, alors $(a b)(b^{-1} a^{-1})=1$ donc $ab\in
A^{\times}$.

Si $ab\in A^{\times}$, soit $c=(ab)^{-1}$. Alors $a(bc)=1$ donc $a\in
A^{\times}$ et $b(ac)=1$ donc $b\in A^{\times}$.}
  \item \reponse{On a $(6x+1)(-6x+1)=1$ dans $\Zz_{36}[x]$, donc $18x+1$ y est inversible.}
  \item \reponse{Soit $f$ un inversible de $\Zz_{36}[x]$. Choisissons $P\in\Zz[x]$ tel que
