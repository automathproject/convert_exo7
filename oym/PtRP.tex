...
\organisation{exo7}
\contenu{
  \texte{Calculer l' intégrale de la forme différentielle $\omega$ le long du contour orienté $C$ dans les cas suivants :}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$C$ est l'arc paramétré $t\mapsto\left( \frac{t^2-1}{2},t\right)$, $t$ variant en croissant de $-1$ à $1$.
