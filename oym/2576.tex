...
\contenu{
  \texte{}
  \question{({\it 9 points}) Soit $u$ l'endomorphisme de $\R^3$, dont la matrice dans la base canonique est
...
$u(\varepsilon_3)=\varepsilon_2+\varepsilon_3$. D\'eterminer un vecteur propre $\varepsilon_1$  de $u$ non colin\'eaire \`a $\varepsilon_2$. 
  ...
  \end {enumerate}
\end {enumerate}}
  \reponse{{\it Soit $u$ l'endomorphisme de $\R^3$, dont la matrice dans la base canonique est}
$$A=\begin{pmatrix}3&2&-2 \\  -1&0&1 \\ 1&1&0 \\ \end{pmatrix}$$ 
\begin {enumerate}
