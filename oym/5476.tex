...
\contenu{
  \texte{}
  \question{Résoudre sur l'intervalle $I$ de $\Rr$ proposé les équations différentielles suivantes~:
...
\end{array}$$}
  \reponse{Les équations différentielles à résoudre dans cet exercice sont toutes linéaires du premier ordre.
