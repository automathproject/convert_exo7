...
\contenu{
  \texte{}
  \question{On munit $\Rr^n$ des lois produit usuelles. Parmi les sous-ensembles suivants $F$ de $\Rr^n$, lesquels
...
\end{array}$$}
  \reponse{Dans les cas où $F$ est un sous-espace, on a à chaque fois trois démarches possibles pour le
vérifier~:
