...
\end{enumerate}
\begin{enumerate}
  \item \reponse{D\'eterminons le polyn\^ome caract\'eristique de $A$.
...
&=-(1+X)[(X-4)(X+3)+10]=-(1+X)(X^2-X-2)=-(1+X)^2(X-2)\end{align*}$$}
  \item \reponse{D\'emontrons que les valeurs propres de $A$ sont $-1$ et $2$ et d\'eterminons les sous-espaces propres associ\'es. 
...
Le sous-espace caract\'eristique $E_{2}$ associ\'e \`a la valeur propre $2$ est donc la droite vectorielle engendr\'ee par le vecteur $(2,-2,-3)$ , il est de dimension $1$, \'egale \`a la multiplicit\'e de la racine $2$.}
  \item \reponse{D\'emontrons que $A$ est diagonalisable et donnons une base de $\R^3$ dans laquelle la matrice de $u$ est diagonale.
...
$$D=\begin{pmatrix}-1&0&0 \\  0&-1&0 \\  0&0&2\end{pmatrix}$$}
  \item \reponse{Trouvons une matrice $P$ telle que $P^{-1}AP$ soit diagonale.
