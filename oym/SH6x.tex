...
\organisation{exo7}
\contenu{
  \texte{Pour $z\in\Cc$, on pose $\ch z=\frac{1}{2}(e^z+e^{-z})$, $\sh z=\frac{1}{2}(e^z-e^{-z})$ et $\tanh z=\frac{\sh z}{\ch
z}$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $z\in\Cc$. $\sh z$ et $\ch z$ sont définis et donc, $\tanh z$ existe si et seulement si $\ch z\neq0$. Or,
