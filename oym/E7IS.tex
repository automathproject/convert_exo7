...
\exo7id{738}
\titre{Exercice 738}
\theme{Fonctions dérivables, Divers}
\auteur{bodin}
\date{2001/11/01}
\organisation{exo7}
\contenu{
  \texte{Soient $f,g :[a , b] \longrightarrow \R$ deux
fonctions continues
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Supposons par l'absurde, qu'il existe $x_{0}\in ]a,b]$  tel
...
d\'emontr\'e que $g (x) \neq g (a)$ pour tout $x \in ]a,b].$}
  \item \reponse{D'apr\`es la question pr\'ec\'edente, on a en particulier  $g (b)
...
relation requise.}
  \item \reponse{Pour chaque $x \in ]a,b[,$ on peut appliquer
la question 2. aux
 ...
 l'H\^opital''.}
  \item \reponse{Consid\'erons les deux fonctions $f
