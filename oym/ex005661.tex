...
\organisation{exo7}
\contenu{
  \texte{Soit $E =SL_2(\Zz) =\{\text{matrices carrées de format}\;2\;\text{à coefficients dans}\;\Zz\;\text{et de déterminant}\;1\}$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{\textbullet~$E$ contient $I_2$ et est inclus dans $GL_2(\Rr)$.
...
\end{center}}
  \item \reponse{Soit $A$ un élément de $E$ tel qu'il existe un entier naturel non nul $p$ tel que $A^p =I_2$.
