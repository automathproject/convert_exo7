...
\organisation{exo7}
\contenu{
  \texte{Soit $D$ le disque ouvert de~$\C$ de centre~$0$ et rayon~$1$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Complétude~: soit $(f_k)$ une suite d'éléments de~$E$ de Cauchy,
  ...
  \item \reponse{Soit $f\in E$ et $f_n(z) = f\Bigl(\frac{nz}{n+1}\Bigr)$.
