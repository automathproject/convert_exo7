...
\exo7id{2423}
\titre{Exercice 2423}
\theme{Devoir maison : les espaces ultramétriques}
\auteur{bodin}
\date{2007/10/01}
\organisation{exo7}
\contenu{
  \texte{%Abou-Jaoudé, Chevalier p75
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $x= \pm \frac ab = \pm \frac{a'}{b'}$. 
...
$\alpha-\beta=\alpha'-\beta'$. Donc $\nu(\pm \frac ab)= \nu(\frac{a'}{b'})$.}
  \item \reponse{Soit $x=p^\alpha x_1$, $y=p^\beta y_1$ avec $\alpha,\beta\in \Zz$ et les numérateurs et dénominateurs de $x_1,y_1\in \Qq$ non divisibles par $p$. Alors $xy= p^{\alpha+\beta}x_1y_1$. Donc $\nu(xy)=\alpha+\beta=\nu(x)+\nu(y)$.}
  \item \reponse{Soit $x,y\in \Zz$, $x=p^\alpha x_1$, $y=p^\beta y_1$. Supposons par exemple $\alpha \le \beta$,
alors
...
\begin{align*}
  ...
  &\ge \min(\nu(x),\nu(y)).\\
\end{align*}}
  \item \reponse{Il est clair que $d(x,y)=0$ si et seulement si $x=y$ et que
$d(x,y)=d(y,x)$.
