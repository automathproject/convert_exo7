...
\contenu{
  \texte{}
  \question{Former une équation du sixième degré dont les racines sont les $\sin\frac{k\pi}{7}$ où $k\in\{-3,-2,-1,1,2,3\}$ puis montrer que ces six nombres sont irrationnels.}
  \reponse{Pour $k$ élément de $\{-3,-2,-1,1,2,3\}$, posons $x_k=\sin\frac{k\pi}{7}$ (les $x_k$ sont deux à deux opposés). Il faut calculer les coefficients du polynôme
