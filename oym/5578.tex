...
\contenu{
  \texte{}
  \question{Soit $E$ un $\Kk$-espace vectoriel de dimension $n\geqslant3$. Montrer que l'intersection de $n-1$ hyperplans de $E$ est non nulle.}
  \reponse{Soit $n\geqslant3$. Montrons par récurrence que $\forall k\in\llbracket2,n-1\rrbracket$, si $H_1$,..., $H_k$ sont $k$ hyperplans de $E$, alors $\text{dim}(H_1\cap...\cap H_k)\geqslant n-k$.
