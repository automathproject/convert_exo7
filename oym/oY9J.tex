...
\organisation{exo7}
\contenu{
  \texte{Dans le groupe $\mathcal{S}_7$ des permutations de l'ensemble fini $\{1,2,\cdots,7\}$ on considère les deux permutations 
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Comme $\alpha$ et $\beta$ sont à support disjoint, ils commutent $\alpha\beta=\beta\alpha$}
  \item \reponse{L'ordre de $\alpha$ donner comme produit de cycles à support disjoint est le $ppcm$ des ordres des cycles qui le composent, donc $ppcm(3,2)=6$. Celui de la transposition $\beta$ est $2$.}
  \item \reponse{$\alpha^{-1}=(175)(43)$ et $\beta^{-1}=(26)$.}
  \item \reponse{Montrons que $S=\{\alpha^i\circ\beta^j, 0\leq i \leq 5, 0\leq j\leq 1\}$ est un sous-groupe de $\mathcal{S}_7$.
...
\alpha^{6-i}\beta^j$$ qui appartient donc à $S$.}
  \item \reponse{Soit $\alpha^i\circ\beta^j$ et $\alpha^k\circ\beta^l$ deux éléments de $S$ où $0\leq i \leq 5, 0\leq j\leq 1$ et $0\leq k \leq 5, 0\leq l\leq 1$.
...
L'ordre de $S$ est donc $6\times 2=12$.}
  \item \reponse{Soit $H$ un sous-groupe de $\mathcal{S}_7$ qui contient $\alpha$ et $\beta$.
Par stabilité par produit, il contient $\alpha^i$, $\beta^j$ et $\alpha^i\circ\beta^j$ pour tout $0\leq i \leq 5, 0\leq j\leq 1$. Il 
 contient donc $S$.}
  \item \reponse{On peut déduire des questions 4. et 6. précédentes que le sous-groupe de $\mathcal{S}_7$ engendré par $\alpha$ et $\beta$ est $S$.}
  \item \reponse{Comme $\alpha$ et $\beta$ sont à support disjoint, $\alpha\circ\beta=(157)(43)(26)$ est une écriture en produit de cycles à support disjoint. L'ordre de $\alpha\circ\beta$ est donc $ppcm(3,2,2)=6$.}
  \item \reponse{Une écriture en produit de cycles à support disjoint de $\alpha^i\circ\beta^j$ montre que son ordre est inférieur à $ppcm(3,2)=6$.
