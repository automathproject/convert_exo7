...
\contenu{
  \texte{}
  \question{Montrer que $\forall A\in\mathcal{M}_n(\Rr)$, $\text{exp}(A)$ est un polynôme en $A$.}
  \reponse{Soit $A\in\mathcal{M}_n(\Rr)$. Soit $k\in\Nn$. Puisque $\chi_A$ est de degré $n$, la division euclidienne de $X^k$ par $\chi_A$ s'écrit
