...
\contenu{
  \texte{}
  \question{Rang de la matrice $(i+j+ij)_{1\leqslant i,j\leqslant n}$.}
  \reponse{Pour $j\in\llbracket1,n\rrbracket$, notons $C_j$ la $j$-ème colonne de la matrice $A$. Posons encore $U=\left(
\begin{array}{c}
1\\
2\\
\vdots\\
