...
\contenu{
  \texte{}
  \question{Soit $S$ une matrice carrée d'ordre~$n$, à coefficients réels, symétrique
...
est définie négative.}
  \reponse{Soit $P$ orthogonale diagonalisant~$S$~: ${}^t\!PSP=\mathrm{Diag}(\lambda_1,\dots,\lambda_n)$
et $Y={}^t\!PX$.
