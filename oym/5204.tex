\uuid{5204}
\titre{*** Théorème de \textsc{Ménélaüs}}
...
\contenu{
  \texte{}
  \question{Soient $A$, $B$ et $C$ trois points non alignés. Soient $M$, $N$ et $P$ trois points appartenant respectivement aux droites $(BC)$, $(CA)$ et $(AB)$ et distincts de $A$, $B$ et $C$. Montrer que~:~
...
(Trouver une démonstration utilisant le théorème de \textsc{Thalès}, une utilisant la composée de deux homothéties et une utilisant des coordonnées.)}
  \reponse{$$\includegraphics{../images/img005204-1}$$
