\uuid{3290}
\titre{Racines de $(X^2+1)PP' + X(P^2+P'^2)$}
...
\contenu{
  \texte{}
  \question{Soit $P \in {\R[X]}$ ayant $n$ racines positives distinctes (entre autres).
...
faire appara{\^\i}tre $\frac {P'}P$, et D{\'e}montrer que $Q$ admet au moins $2n-2$ racines positives.}
  \reponse{$Q = (XP + P')(XP' + P) = XP^2\Bigl( X + \frac {P'}P \Bigr) \Bigl(\frac 1X + \frac {P'}P \Bigr)$.
