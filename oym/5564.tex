...
\contenu{
  \texte{}
  \question{Généralisation de l'exercice \ref{ex:rou1}. Soient $n$ un entier supérieur ou égal à $2$ puis $F_1$, ... , $F_n$ $n$ sous-espaces de $E$ où $E$ est un espace vectoriel sur un sous-corps $\Kk$ de $\Cc$.
