\uuid{4170}
\titre{Changement de variable singulier, Matexo}
...
\contenu{
  \texte{}
  \question{On considère la fonction de $\R^2$ sur lui-même définie par
$f(x,y)=(u,v)$, où
...
Caractériser $f (\R^2)$.}
  \reponse{$x=\sh(a),\ y=\sh(b)  \Rightarrow  u=\sh(a+b),\ v=\sh(a+b)+\ch(a+b)$.
