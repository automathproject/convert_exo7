...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Pour $P$ élément de $\Rr_n[X]$, 
...
$f$ est élément de $\mathcal{L}(\Rr_n[X],\Rr_{n+1}[X])$.}
  \item \reponse{La matrice $A$ cherchée est élément de $\mathcal{M}_{n+1,n}(\Rr)$.
...
\end{array}
\right).$$}
  \item \reponse{Soit $P\in\Rr_n[X]$ tel que $f(P)=0$.
