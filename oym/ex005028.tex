\uuid{5028}
\titre{Comparaison de longueurs (ENS MP 2002)}
\theme{}
\auteur{quercia}
\date{2010/03/17}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Soit $f : {[a,b]} \to \R$ continue concave, $\mathcal{C}^1$ par morceaux,
...
Montrer que la longueur de $L_2$ est supérieure ou égale à celle de $L_1$.}
  \reponse{Soit $(a_i)$ une subdivision de $[a,b]$ et $P$ la ligne brisée passant
