...
Faire le rapprochement avec l'exercice \ref{exn13}.}
  \reponse{Notons $g=f^n$. Alors $g$ est une application strictement contractante dans $X$ complet donc $g$ possède un unique point fixe que nous notons $x$.
