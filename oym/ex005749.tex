...
\contenu{
  \texte{}
  \question{Soient $P_n =\sum_{k=0}^{n}\frac{X^k}{k!}$ et $R > 0$ donné. Montrer que pour $n$ suffisamment grand, $P_n$ n'a pas de racine dans le disque fermé de centre $0$ et de rayon $R$.}
  \reponse{Soit $R > 0$. Notons $D_R$ le disque fermé de centre $0$ et de rayon $R$.
