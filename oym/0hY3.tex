...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$\int_0^{\frac \pi 2}x\sin x \, dx$
...
\int_0^{\frac \pi 2}x\sin x \, dx 
  ...
  &= 1 \\
\end{align*}}
  \item \reponse{$\int_0^1 \frac{e^x}{\sqrt{e^x+1}} \,  dx$
...
\int_0^1 \frac{e^x \, dx}{\sqrt{e^x+1}} \,  dx 
  ...
  &= 2\sqrt{e+1} -2\sqrt 2 \\
\end{align*}}
  \item \reponse{$\int_0^1\frac 1{\left( 1+x^2\right) ^2} \, dx$
...
\int_0^1\frac 1{\left( 1+x^2\right) ^2} \, dx 
  ...
  &= \frac 14 + \frac \pi8 \\
\end{align*}}
  \item \reponse{$\int_0^1\frac{3x+1}{\left( x+1\right) ^2} \,  dx$
...
\int_0^1\frac{3x+1}{\left( x+1\right) ^2} \,  dx
  ...
  &= 3 \ln 2 - 1 \\
\end{align*}}
  \item \reponse{Notons $I = \int_{\frac 12}^2\left( 1+\frac 1{x^2}\right) \arctan x \, dx$.
