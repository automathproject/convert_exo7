\uuid{3170}
\titre{$(X+z_0)^n,\dots,(X+z_k)^n$ (Centrale MP 2003)}
...
\contenu{
  \texte{}
  \question{Soit $k\in\N^*$ et $z_0,\dots,z_k$ des complexes.
...
base de~$C_n[X]$.}
  \reponse{D{\'e}j{\`a} il est n{\'e}cessaire que $k=n$. Supposant ceci r{\'e}alis{\'e}, la matrice de~$(P_0,\dots,P_k)$
