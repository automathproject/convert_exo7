...
\organisation{exo7}
\contenu{
  \texte{Soit $k$ un réel distinct de $-1$ et de $1$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{\textbullet~Pour tout réel $x$, $1-2k\cos x+k^2=(k-\cos x)^2+\sin^2x\geq0$. De plus,
...
(car $f_k(\Arccos k)=\frac{\sqrt{1-k^2}}{\sqrt{1-2k^2+k^2}}=1$).}
  \item \reponse{[\textbf{2ème cas}~:~$k>1$.] Pour tout réel $x$, $(1-2k\cos x+k^2)^{-3/2}(k-\cos x)>0$ et $f_k'(x)$ est du signe de $k\cos
x-1$.

$$\includegraphics{../images/img005079-2}$$

(car $f_k(\Arccos\frac{1}{k})=\frac{\sqrt{1-\frac{1}{k^2}}}{\sqrt{1-2+k^2}}=\frac{1}{k}$).}
  \item \reponse{[\textbf{3ème cas}~:~$k<-1$.] Pour tout réel $x$, $(1-2k\cos x+k^2)^{-3/2}(k-\cos x)<0$ et $f_k'(x)$ est du signe de
$1-k\cos x$.
...
\end{itemize}}
  \item \reponse{Pour $k\in\Rr\setminus\{-1,1\}$, posons $I_k=\int_{0}^{\pi}f_k(x)\;dx$.
