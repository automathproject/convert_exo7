...
\organisation{exo7}
\contenu{
  \texte{Pour $x\in\R^+$ et $n\in\N$, $n\ge 2$ on pose $f_n(x) = \frac{xe^{-nx}}{\ln n}$
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Il y a convergence normale sur tout intervalle $[a,+\infty[$ avec $a>0$.
  ...
  \item \reponse{Lorsque $x\to0^+$, $\frac{S(x)-S(0)}x = \sum_{n=2}^\infty\frac{e^{-nx}}{\ln n}
