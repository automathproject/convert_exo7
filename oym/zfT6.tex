...
\organisation{exo7}
\contenu{
  \texte{Soit $A$ un anneau, $B$ un sous-anneau de $A$,
$I$ un id\'eal de $A$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $J=B\cap I$. Soit $x,y\in J$, $a,b\in B$, alors $ax+by\in B$
  ...
  \item \reponse{On a le diagramme (de morphismes d'anneaux) suivant~:
    $$
    \xymatrix{%
      B\ar[r]^{i} 
       \ar[d]^{{\pi_{0}}}
