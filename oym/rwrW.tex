...
\organisation{exo7}
\contenu{
  \texte{Etudier l'existence et la valeur éventuelle des limites suivantes}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Si $x\in]0,\pi[$, $\sin x>0$, de sorte que la fonction proposée est bien définie sur un voisinage pointé de $\frac{\pi}{2}$ (c'est-à-dire un voisinage de $\frac{\pi}{2}$ auquel on a enlevé le point $\frac{\pi}{2}$) et de plus $(\sin x)^{1/(2x-\pi)}=e^{\ln(\sin x)/(2x-\pi)}$.
...
\end{center}}
  \item \reponse{Si $x\in]0,\pi[\setminus\left\{\frac{\pi}{2}\right\}$, $|\tan x|>0$, de sorte que la fonction proposée est bien définie sur un voisinage pointé de $\frac{\pi}{2}$ et de plus $|\tan x|^{\cos x}=e^{\cos x\ln(|\tan x|)}$. Quand $x$ tend vers $\frac{\pi}{2}$, 
...
\end{center}}
  \item \reponse{Quand $n$ tend vers $+\infty$, $\cos\frac{n\pi}{3n+1}+\sin\frac{n\pi}{6n+1}\rightarrow\cos\frac{\pi}{3}+\sin\frac{\pi}{6}=1$ (et on est en présence d'une indétermination du type $1^{+\infty}$). Quand $n$ tend vers $+\infty$,
...
\end{center}}
  \item \reponse{Quand $x$ tend vers $0$, $\ln(\cos x)\sim\cos x-1\sim-\frac{x^2}{2}$. Puis, $\ln|x|\ln(\cos x)\sim-\frac{x^2}{2}\ln|x|\rightarrow0$.
...
\end{center}}
  \item \reponse{Quand $x$ tend vers $\frac{\pi}{2}$, $\frac{1}{1-\sin x}$ tend vers $+\infty$. Posons $h=x-\frac{\pi}{2}$ puis $\varepsilon=\mbox{sgn}(h)$, de sorte que 
...
\end{center}}
  \item \reponse{Pour $x\in\Rr$, $2\cos^2x-3\cos x+1=(2\cos x-1)(\cos x-1)$ et donc 
...
\end{center}}
  \item \reponse{Quand $x$ tend vers $e$ par valeurs inférieures, $\ln(x)$ tend vers $1$ et donc
...
\end{center}}
  \item \reponse{Quand $x$ tend vers $1$ par valeurs supérieures, $x\ln x\rightarrow0$, et donc
...
\end{center}}
  \item \reponse{Quand $x$ tend vers $+\infty$, 
...
\end{center}}
  \item \reponse{Quand $x$ tend vers $0$ par valeurs supérieures,
...
\end{center}}
  \item \reponse{Quand $x$ tend vers $\frac{1}{\sqrt{2}}$,
