\uuid{5978}
\titre{Exercice 5978}
\theme{Compléments d'intégration, Théorème de Plancherel et transformée de Fourier d'une fonction radiale}
\auteur{tumpach}
\date{2010/11/11}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Soit $f~:\mathbb{R}^{3}\rightarrow \mathbb{R}$ une fonction
...
\sin(2\pi|k|r)\,dr.
$$}
  \reponse{A l'aide des coordonnées sphériques, on a
$$
\begin{array}{lcl}
