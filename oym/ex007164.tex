...
\organisation{exo7}
\contenu{
  \texte{Soit $ABC$ un triangle équilatéral direct, et $M$ un point. On note $A'$ (resp. $B'$ et $C'$) le symétrique orthogonal de $M$ par rapport à la droite $(BC)$ (resp. $(CA)$ et $(AB)$). Le but de l'exercice est de démontrer que $ABC$ et $A'B'C'$ ont le même centre de gravité.}
\begin{enumerate}
