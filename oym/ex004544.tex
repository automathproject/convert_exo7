...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$F_n(X) = \sum_{k=0}^{n-1}\frac{e^{2ik\pi/n}}{X+n(1-e^{2ik\pi/n})}$.}
  \item \reponse{$F_n(2x) - F_n(-2x) = \sum_{k=0}^{n-1}\frac{4xe^{2ik\pi/n}}{4x^2-n^2(1-e^{2ik\pi/n})^2}
  ...
  \item \reponse{$\sum_{k=1}^\infty\frac{2}{x^2+k^2\pi^2} = \frac{\coth(x)}x-\frac1{x^2}$
