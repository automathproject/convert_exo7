...
\contenu{
  \texte{}
  \question{Que vaut l'excentricité de l'hyperbole équilatère (une hyperbole est équilatère si et seulement
si ses asymptotes sont perpendiculaires)~?}
  \reponse{Soit $\mathcal{H}$ une hyperbole. Il existe un repère orthonormé dans lequel $\mathcal{H}$ admet
