\uuid{5923}
\titre{Exercice 5923}
\theme{Intégrale de Riemann, Applications}
\auteur{tumpach}
\date{2010/11/11}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Montrer que, si $f~:[a,b] \rightarrow \mathbb{R}$ est une fonction
...
\end{equation*}}
  \reponse{Soit $f~:[a,b] \rightarrow \mathbb{R}$ une fonction int\'egrable
au sens de Riemann. 
