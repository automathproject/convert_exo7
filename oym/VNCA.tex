...
\organisation{exo7}
\contenu{
  \texte{On consid\`ere les vecteurs
...
l'espace $\Rr^4$ de dimension $4$.}
  \item \reponse{Oui. Notons $F=\mbox{Vect}\{v_1,v_2\}$ et $G=\mbox{Vect}\{v_4, v_5\}$.
Pour montrer $F \oplus G = \Rr^4$ il faut montrer $F\cap G =\{ (0,0,0,0) \}$ et
$F+G=\Rr^4$.

  \begin{enumerate}}
  \item \reponse{Montrons $F\cap G =\{ (0,0,0,0 \}$. Soit $u \in F\cap G$,
...
Ainsi le seul vecteur de $F\cap G$ est le vecteur nul.}
  \item \reponse{Montrons $F+G=\Rr^4$.
