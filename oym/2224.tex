\uuid{2224}
\titre{Factorisation LU d'une matrice bande}
...
\contenu{
  \texte{}
  \question{Montrer que la factorisation LU pr\'eserve la structure des matrices bande au sens suivant : 
$$a_{ij}=0 \mbox{ pour } |i-j| \geq p \Rightarrow \left\{ \begin{array}{ll} 
l_{ij}=0 & \mbox{ pour } i-j \geq p\\ 
u_{ij}=0 & \mbox{ pour } j-i \geq p 
\end{array}\right.$$}
  \reponse{Montrons par r\'ecurrence que $A_n=U$ est une matrice bande.
