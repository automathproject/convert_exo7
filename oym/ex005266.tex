...
\contenu{
  \texte{}
  \question{Soit $A\in\mathcal{M}_{3,2}(\Rr)$ et $B\in\mathcal{M}_{2,3}(\Rr)$ telles que~:
...
Montrer l'existence d'au moins un couple $(A,B)$ vérifiant les conditions de l'énoncé puis calculer $BA$. (Indication. Calculer $(AB)^2$ et utiliser le rang.)}
  \reponse{Soit $(i,j)$ la base canonique de $\Rr^2$ et $(e_1,e_2,e_3)$ la base canonique de $\Rr^3$. On cherche $f\in\mathcal{L}(\Rr^2,\Rr^3)$ et $g\in\mathcal{L}(\Rr^3,\Rr^2)$ tels que
