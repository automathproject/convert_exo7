...
\exo7id{2420}
\titre{Exercice 2420}
\theme{Devoir maison : notion de topologie}
\auteur{drutu}
\date{2007/10/01}
\organisation{exo7}
\contenu{
  \texte{On appelle \textit{base} d'une topologie $\mathcal{T}$ un sous-ensemble
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Supposons que $\mathcal{B}$ est une base de $\mathcal{T}$, et soit $\mathcal{O}$ un
...
tel que $x\in B_{i_0}$.}
  \item \reponse{R\'eciproquement, si $\mathcal{O}$ est un ouvert arbitraire, pour tout point $x\in \mathcal{O}$ il
  existe un $B_x\in \mathcal{B}$ tel que $x\in B_x\subset \mathcal{O}$. Par
  cons\'equent $\mathcal{O}=\bigcup_{x\in \mathcal{O}}B_x$.}
  \item \reponse{Il suffit de montrer la propri\'et\'e \'enonc\'ee dans (1).
...
B\left( q, \frac{r}{2}\right)\subset \mathcal{O}$.}
  \item \reponse{Puisque $\mathcal{B}'\subset \mathcal{T}_n$, ce qu'il reste \`a d\'emontrer
...
On conclut que $\mathcal{B}'$ est une base de $\mathcal{T}_n$.}
  \item \reponse{Soit $]0,1[\in \mathcal{T}_1$. Il n'existe pas d'intervalle de la
forme $]-\infty ,a[\, ,\; a\in \R \, ,$ ou $ ]b, +\infty[\, ,\;
b\in \R \, ,$ contenu dans $]0,1[$. Donc $\mathcal{B}''$ n'est pas une
base pour $\mathcal{T}_1$.}
  \item \reponse{Supposons que $\mathcal{T}'\subset \mathcal{T}$. En particulier $\mathcal{B}'\subset
\mathcal{T}$.
