...
\contenu{
  \texte{}
  \question{On pose $P=a(X-x_1) ... (X-x_n)$ où les $x_i$ sont des complexes non nécessairement deux à deux distincts et $a$ est un complexe non nul.
