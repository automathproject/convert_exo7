...
\organisation{exo7}
\contenu{
  \texte{Soit $f$ continue et intégrable sur~$\R$. On considère l'équation
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Formule de Duhamel : $y(t) = - \int_{x=0}^t e^{t-x}f(x)\,d x + \lambda e^t$.
  ...
  \item \reponse{\begin{align*} \int_{t=a}^b|F(t)|\,d t
