...
\contenu{
  \texte{}
  \question{Soit $G$ un groupe d'ordre pair. Montrer qu'il existe un \'el\'ement $x\in
G$, $x \not= e$ tel que $x^2=e$.}
  \reponse{En groupant chaque \'el\'ement $x\in G$ avec son inverse $x^{-1}$, on obtient une
