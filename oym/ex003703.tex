\uuid{3703}
\titre{Conjugaison dans ${\cal O}(\R^3)$}
\theme{}
\auteur{quercia}
\date{2010/03/11}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Soient $f,g \in {\cal O}(\R^3)$ ayant même polynôme caractéristique.

Montrer qu'il existe $h \in {\cal O}(\R^3)$ tel que $f = h^{-1}\circ g \circ h$.

Si $f$ et $g$ sont positifs, a-t-on $h$ positif ?}
  \reponse{Pour $f,g \in {\cal O}^+(\R^3)$, $f$ et $g$ ont la même matrice
