\uuid{7160}
\titre{Isométries d'un triangle isocèle}
\theme{}
\auteur{megy}
\date{2017/05/13}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Soit $\mathcal T=ABC$ un triangle isocèle non équilatéral. Déterminer son groupe d'isométries ainsi qu'un isomorphisme entre ce groupe et un groupe classique.}
