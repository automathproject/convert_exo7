\exo7id{6950}
\titre{Lemme de Borel-Cantelli **}
\theme{}
\auteur{ruette}
\date{2013/01/24}
\organisation{exo7}
\contenu{
  \texte{Soit $(X_n)_{n\geq 1}$ une suite de variables aléatoires indépendantes de même
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{On pose $A_n(\alpha)=\{X_n>\alpha \ln n\}$
...
répond à la question 1.}
  \item \reponse{Pour tout $\epsilon>0$, on
