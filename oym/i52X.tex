...
\organisation{exo7}
\contenu{
  \texte{Soit $E$ un espace vectoriel norm\'e. On dit qu'une s\'erie $\sum u_k$ est normalement convergente
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $(x_n)$ une suite de Cauchy. 
