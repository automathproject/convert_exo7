...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Posons $y_1=x$, $y_2=x'=y_1'$, $y_3=x''=y_2'$. L'\'equation
...
\end{array}\right) = f(t,y_1,y_2,y_3).$$}
  \item \reponse{$f$ \'etant de classe $C^\infty$, elle est lipschitzienne
par rapport \`a la deuxi\`eme variable $(y_1,y_2,y_3)$ et donc le
th\'eor\`eme de Cauchy-Lipschitz permet de conclure.}
  \item \reponse{La d\'eriv\'ee de la fonction donn\'ee est nulle. Par cons\'equent,
