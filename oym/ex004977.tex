...
\contenu{
  \texte{}
  \question{Soient $D_1,D_2,D_3$, trois droites, et $\sigma_1,\sigma_2,\sigma_3$ les
...
parallèles.}
  \reponse{Soit $v = \sigma_1 \circ \sigma_2$. (vissage autour de la perp. commune à
$D_1$ et $D_2$)
