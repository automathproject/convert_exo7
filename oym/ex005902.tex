...
\contenu{
  \texte{}
  \question{Maximum du produit des distances d'un point $M$ intérieur à un triangle $ABC$ aux cotés de ce triangle.}
  \reponse{On pose $BC=a$, $CA=b$ et $AB=c$ et on note $\mathcal{A}$ l'aire du triangle $ABC$. Soit $M$ un point intérieur au triangle $ABC$. On note $I$, $J$ et $K$ les projetés orthogonaux de $M$ sur les droites $(BC)$, $(CA)$ et $(AB)$ respectivement. On pose $u=\text{aire de}\;MBC$, $v=\text{aire de}\;MCA$ et $w=\text{aire de}\;MAB$. On a
