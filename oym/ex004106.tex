...
\contenu{
  \texte{}
  \question{On considère l'équation différentielle à coefficients continus sur
...
le produit vaut constamment~un.}
  \reponse{$x$ et $1/x$ sont solution $ \Rightarrow $ $x'^2+qx^2=0$ donc une condition nécessaire
