...
\contenu{
  \texte{}
  \question{Soit $l>0$ un réel et $X=[0,l]\times [-1,1]$, et $\sim$ la relation d'équivalence la plus fine sur $X$ telle que $(0,y)\sim(l,-y)$ pour tout $y\in [-1,1]$.  Décrire le graphe et les classes d'équivalence de la relation. 
