\uuid{4126}
\titre{$y'' = F(x,y)$, $y(a) = \alpha$, $y(b) = \beta$}
\theme{}
\auteur{quercia}
\date{2010/03/11}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Soit $F : {[a,b]\times \R} \to \R$ de classe $\mathcal{C}^1$ telle que pour tout
...
$y'' = F(x,y)$ avec les conditions aux limites $y(a) = \alpha$, $y(b) = \beta$.}
  \reponse{Soient $y,z$ deux solutions distinctes. D'après Cauchy-Lipschitz,
