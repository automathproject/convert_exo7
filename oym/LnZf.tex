\uuid{LnZf}
\exo7id{3755}
\titre{Groupe engendré par les réflexions}
\theme{Exercices de Michel Quercia, Transformations orthogonales}
\auteur{quercia}
\date{2010/03/11}
\organisation{exo7}
\contenu{
  \texte{Soit $E$ un espace vectoriel hermitien et $G$ le sous-groupe
de~$U(E)$ engendré par les réflexions.}
\begin{enumerate}
  \item \question{On suppose ici $\dim E\ge 2$.
    Soient $u,v\in E$. Montrer qu'il existe une réflexion $\sigma$
    échangeant $u$ et~$v$ si et seulement si $\|u\| = \|v\|$ et $(u\mid v)\in\R$.}
  \item \question{Montrer que $G = \{f\in U(E)\ \text{ tq }\det(f)\in\{-1,1\}\}$.}
\end{enumerate}
\begin{enumerate}
  \item \reponse{Tout $f\in G$ vérifie $\det(f)\in\{-1,1\}$. Réciproquement,
