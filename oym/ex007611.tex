...
\end{enumerate}
\begin{enumerate}
  \item \reponse{On note $R$ le rayon de convergence de la série entière $\sum_{n\geq 1}a_nz^n$ et $r\in]0,R[$. 
...
Par conséquent, $\sum_{n\geq 1}\frac{a_n}{n!}z^n$ a un rayon de convergence infini.}
  \item \reponse{L'application $f-g$ est somme sur $\Delta_r$ connexe d'une série entière centrée en $0$ et s'annule sur l'ensemble non discret $]-R,R[$.
Par le principe des zéros isolés, $f=g$ sur $\Delta_r$.}
  \item \reponse{Soit $a\in\Rr$. Les deux applications $z\mapsto \sin(a+z)$ et $z\mapsto \sin(a)\cos (z)+\cos(a)\sin (z)$ sont développables en séries entières
