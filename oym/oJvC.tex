...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$\|A\|_2^2 =\rho (A^*A)=\max_i \lambda_i(A^*A) =\mu_1^2(A)$ la plus grande valeur singuli\`ere de $A$
...
$$\mbox{cond}_2(A)=\|A\|_2 \|A^{-1}\|_2=\mu_n(A)/\mu_1(A)$$}
  \item \reponse{Si $A$ est normale alors $\|A\|_2=\rho (A) $ rayon spectral. Donc
...
$$\mbox{cond}_2(A)=\max |\lambda_i(A)|/\min |\lambda_i(A)|$$}
  \item \reponse{cond$_2(QA)=\|QA\|_2 \|A^{-1}Q^*\|_2=\|A\|_2\|A^{-1}\|_2=$cond$_2(A)$.}
\end{enumerate}
}