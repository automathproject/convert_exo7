...
\end{enumerate}
\begin{enumerate}
  \item \reponse{{\it Calculons les valeurs propres de $A$ et voyons si l'endomorphisme $u$ est diagonalisable.} 
...
Ainsi, la matrice $A$ admet $1$ comme valeur propre triple. Elle n'est donc pas diagonalisable, sinon elle serait égale à $I=I_3$, la matrice identité.}
  \item \reponse{{\it Calculons $(A-I)^2$ et démontrons que $A^n=nA+(1-n)I$.}
