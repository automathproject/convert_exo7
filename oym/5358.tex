...
\contenu{
  \texte{}
  \question{Soit $\sigma$ une permutation de $\{1,...,n\}$ et $k$ le nombre d'orbites de $\sigma$. Montrer que $\varepsilon(\sigma)=(-1)^{n-k}$.}
  \reponse{Montrons d'abord par récurrence sur $l\geq 2$ que la signature d'un cycle de longueur $l$ est $(-1)^{l-1}$.
