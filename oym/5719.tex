...
\contenu{
  \texte{}
  \question{\label{ex:rou7bis}
Calculer $\int_{0}^{1}\frac{t-1}{\ln t}\;dt$ (en écrivant $\int_{0}^{x}\frac{t-1}{\ln t}\;dt=\int_{0}^{x}\frac{t}{\ln t}\;dt-\int_{0}^{x}\frac{1}{\ln t}\;dt$).}
  \reponse{La fonction $f~:~t\mapsto\frac{t-1}{\ln t}$ est continue sur $]0,1[$, prolongeable par continuité en $0$ et $1$ et donc est intégrable sur $]0,1[$.
