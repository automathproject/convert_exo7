...
\organisation{exo7}
\contenu{
  \texte{{\bf Questions préliminaires} :}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{[(a)] Soient  $E$ un espace vectoriel réel de dimension $n$ et  $u$ un endomorphisme de $E$. Soit $P\in\R[X]$ un polynôme. Soit $\lambda$ une valeur propre de $u$ et $\vec x$ un vecteur propre associé à $\lambda$. 
