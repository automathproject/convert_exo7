...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Calculons l'accroissement:
...
diff\'erentiable et sa diff\'erentielle est nulle: $$D^2f=0.$$}
  \item \reponse{Calculons $$f((x,y)+(h,k))-f(x,y)=f(x+h,y+k)-f(x,y)=
...
diff\'erentielle est $$D^2f(x,y)[(h,k),(u,v)]=f(u,k)+f(h,v).$$}
  \item \reponse{$$f(A+h)-f(A)=(A+h)^2-A^2=Ah+hA+h^2$$ avec $Ah+hA$
