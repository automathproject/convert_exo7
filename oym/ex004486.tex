...
\contenu{
  \texte{}
  \question{Soit $P(n)=\max\{p \text{ premier},\, p\mid n\}$. Montrer que $\sum_{n}\frac{1}{nP(n)}$ converge.}
  \reponse{Soit $(p_0,p_1,\dots)$ la suite croissante des nombres premiers
