...
\contenu{
  \texte{}
  \question{Soient $A$ la somme des chiffres de $4444^{4444}$ et $B$ la somme des chiffres de $A$. Trouver la somme des chiffres de $B$. (Commencer par majorer la somme des chiffres de $n=a_0+10a_1...+10^pa_p$.)}
  \reponse{Soit $n$ un entier naturel non nul. On note $\sigma(n)$ la somme de ses chiffres en base $10$ (voir l'exercice \ref{exo:suprou19}). Si $n=a_0+10a_1+...+10^ka_k$ où $k\in\Nn$, $0\leq a_i\leq9$ pour $0\leq i\leq k$ et $a_k\neq0$, alors
