...
l'exercice \ref{ex:burnol1.1}.}
  \reponse{Commen\c{c}ons donc par le contre-exemple en prenant $U=\Omega$, c'est \`a dire $U=\C \setminus ]-\infty, 0]$, et $f=\mathrm{Log}$. Il suffit alors de choisir $z_1=-1+i$ et $z_2=-1-i$ et d'appliquer l'exercice \ref{ex:burnol1.1}.
