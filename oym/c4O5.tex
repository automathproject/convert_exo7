...
\end{enumerate}
\begin{enumerate}
  \item \reponse{En faisant le changement de variable $x=e^t$ (donc $t = \ln x$) et en posant 
...
$$y(x)=\sqrt{x}\left(\lambda\cos(\frac{\sqrt{3}}{2}\ln x)+\mu\sin(\frac{\sqrt{3}}{2}\ln x)\right)$$}
  \item \reponse{Supposons que $f$ convienne: par hypothèse, $f$ est de classe $\mathcal{C}^1$, 
