...
\contenu{
  \texte{}
  \question{Soit $f~:~\Rr^2\rightarrow\Rr^2$ de classe $C^2$ dont la différentielle en tout point est une rotation. Montrer que $f$ est une rotation affine.}
  \reponse{Soit $(x,y)\in\Rr^2$. La matrice jacobienne de $f$ en $(x,y)$ s'écrit $\left(
\begin{array}{cc}
c(x,y)&-s(x,y)\\
s(x,y)&c(x,y)
\end{array}
