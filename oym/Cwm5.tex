...
\organisation{exo7}
\contenu{
  \texte{Equation du cône de sommet $S$ et de directrice $(\mathcal{C})$ dans les cas suivants :}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{On note $(\mathcal{S})$ le cône de sommet $S$ et de directrice $(\mathcal{C})$.
