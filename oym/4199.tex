\uuid{4199}
\titre{Plus court chemin, ENS Ulm-Lyon-Cachan MP$^*$ 2005}
...
\contenu{
  \texte{}
  \question{D{\'e}terminer le plus court chemin entre les p{\^o}les nord et sud d'une sph{\`e}re en dimension $3$.}
  \reponse{On param{\`e}tre le chemin en coordonn{\'e}ees sph{\'e}riques par $t\mapsto (\theta(t),\phi(t))$.
