...
\contenu{
  \texte{}
  \question{Soit $A=\left\{\frac{1}{n}+(-1)^n,\;n\in\Nn^*\right\}$. Déterminer $\mbox{sup }A$ et $\mbox{inf }A$.}
  \reponse{Posons pour $n$ entier naturel non nul $u_n=\frac{1}{n}+(-1)^n$ de sorte que $A=\{u_n,\;n\in\Nn^*\}=\left\{0,\frac{1}{2}+1,\frac{1}{3}-1,\frac{1}{4}+1,\frac{1}{5}-1,...\right\}$.
