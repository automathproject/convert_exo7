...
\contenu{
  \texte{}
  \question{Soit $(u_n)=\left(\frac{p_n}{q_n}\right)$ avec $p_n\in\Zz$ et $q_n\in\Nn^*$, une suite de rationnels convergeant vers un irrationnel $x$. Montrer que les suites $(|p_n|)$ et $(q_n)$ tendent vers $+\infty$ quand $n$ tend vers $+\infty$.}
  \reponse{Soit $x$ un irrationnel et $(\frac{p_n}{q_n})_{n\in\Nn}$ une suite de rationnels tendant vers $x$ ($p_n$ entier relatif et $q_n$ entier naturel non nul, la fraction $\frac{p_n}{q_n}$ n'étant pas nécessairement irréductible). Supposons que la suite $(q_n)_{n\in\Nn}$ ne tende pas vers $+\infty$. Donc~:
