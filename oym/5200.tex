...
\contenu{
  \texte{}
  \question{Déterminer un cercle tangent aux trois droites d'équations respectives $y=2x+1$, $y=2x+7$ et $y=-\frac{1}{2}x$.}
  \reponse{Notons $(D_1)$, $(D_2)$ et $(D_3)$ les droites d'équations respectives $y=2x+1$, $y=2x+7$ et $y=-\frac{1}{2}x$. Soit $\mathcal{C}$ un cercle.
