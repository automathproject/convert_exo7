...
\contenu{
  \texte{}
  \question{Soit $a > 1$. Montrer qu'il existe une suite r{\'e}elle born{\'e}e, $(x_n)$,
telle que : $\forall\ i\ne j,\ |x_i-x_j| \ge \frac 1{|i-j|^a}$.}
  \reponse{On construit un ensemble de type Cantor dont les trous ont pour
