...
$$\sum_{k=1}^{p}\frac{1}{\sin^2\frac{k\pi}{2p+1}}=\sum_{k=1}^{p}(1+\cotan^2\frac{k\pi}{2p+1})=p+\frac{p(2p-1)}{3}=\frac{2p(p+1)}{3}.$$}
  \item \reponse{Pour $n$ entier naturel non nul donné, on a
...
La suite $(u_n)$ est croissante et est majorée par $2$. Par suite, la suite $(u_n)$ converge vers un réel inférieur ou égal à $2$.}
  \item \reponse{Pour $x$ élément de $[0,\frac{\pi}{2}]$, posons $f(x)=x-\sin x$ et $g(x)=\tan x-x$.
...
Donc, $\forall x\in]0,\frac{\pi}{2}[,\;0<\sin x<x<\tan x$ et par passage à l'inverse $\forall x\in]0,\frac{\pi}{2}[,\;0<\cotan x<\frac{1}{x}<\frac{1}{\sin x}$.}
  \item \reponse{Pour $1\leq k\leq p$, $0<\frac{k\pi}{2p+1}<\frac{\pi}{2}$  et donc $0<\cotan\frac{k\pi}{2p+1}<\frac{2p+1}{k\pi}<\frac{1}{\sin\frac{k\pi}{2p+1}}$. Puis, $\cotan^2\frac{k\pi}{2p+1}<(\frac{(2p+1)^2}{\pi^2})\frac{1}{k^2}<\frac{1}{\sin\frac{k\pi}{2p+1}}$. En sommant ces inégalités, on obtient
