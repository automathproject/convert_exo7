...
\contenu{
  \texte{}
  \question{Soit $(E,\|\;\|)$ un espace vectoriel normé et $B=\{x\in E/\;\|x\| < 1\}$. Montrer que $\begin{array}[t]{cccc}
f~:&E&\rightarrow&B\\
 &x&\mapsto& \frac{x}{1+\|x\|}
\end{array}$ est un homéomorphisme.}
  \reponse{\textbullet~Pour tout $x\in E$, $\|f(x)\|= \frac{\|x\|}{1+\|x\|}< \frac{\|x\|+1}{\|x\|+1}=1$. Donc $f$ est bien une application de $E$ dans $B$.
