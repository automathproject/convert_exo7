...
\organisation{exo7}
\contenu{
  \texte{Montrer que les nombres suivants sont irrationnels.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soient $m$ et $n$ deux entiers naturels supérieurs à $2$.
...
\end{center}}
  \item \reponse{Supposons par l'absurde que $\pi$ soit rationnel. Il existe alors deux entiers naturels non nuls $p$ et $q$ tels que $\pi=\frac{p}{q}$.
...
\end{center}}
  \item \reponse{Montrons par récurrence que~:~$\forall n\in\Nn,\;e=\sum_{k=0}^{n}\frac{1}{k!}+\int_{0}^{1}\frac{(1-t)^n}{n!}e^t\;dt$.
...
\end{center}}
  \item \reponse{Une équation du troisième degré dont les solutions sont $\cos\frac{2\pi}{7}$, $\cos\frac{4\pi}{7}$ et $\cos\frac{6\pi}{7}$ est 
...
\end{center}}
  \item \reponse{On sait que $\sqrt{2}$, $\sqrt{3}$ et $\sqrt{5}$ sont irrationnels mais ceci n'impose rien à la somme $\sqrt{2}+\sqrt{3}+\sqrt{5}$.
