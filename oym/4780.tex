...
\contenu{
  \texte{}
  \question{Soit $E$ un evn de dimension finie et $C \subset E$ convexe et dense.
Montrer que $C=E$.}
  \reponse{On proc{\`e}de par r{\'e}currence sur~$n=\dim E$. Pour $n=1$, en confondant $E$ et $\R$,
