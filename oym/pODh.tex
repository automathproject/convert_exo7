...
\organisation{exo7}
\contenu{
  \texte{Soit $q$ un entier au moins {\'e}gal {\`a} $2$. Pour tout $n\in
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$u_{n+q} = \cos \left( \frac{2(n+q)\pi}{q} \right) = \cos \left(\frac{2n\pi}{q}+2\pi\right) = \cos \left(\frac{2n\pi}{q}\right) = u_n$.}
  \item \reponse{$u_{nq} = \cos \left(\frac{2nq\pi}{q}\right) = \cos \left({2n\pi}\right)= 1 = u_0$ et $u_{nq+1} = \cos \left(\frac{2(nq+1)\pi}{q}\right) = \cos \left(\frac{2\pi}{q}\right) = u_1$.
