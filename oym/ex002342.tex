...
\organisation{exo7}
\contenu{
  \texte{On va montrer que l'ensemble $D$ des r\'eels de la forme $p+q\sqrt 2$ o\`u $p$ et
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soient $d = p+q \sqrt 2$ et $d'=p'+q'\sqrt 2$ deux éléments de $D$.
Alors $d+d'=(p+p')+(q+q')\sqrt 2$ est un élément de $D$ et $dd'=
(pp'+2qq')+(pq'+p'q)\sqrt 2$ aussi.}
  \item \reponse{On a $u < 1$ donc $u^k$ tend vers $0$ quand $k$ tend vers $+\infty$.
