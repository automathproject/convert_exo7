...
\contenu{
  \texte{}
  \question{Montrer que $\forall x>0$, $\int_{0}^{+\infty} \frac{e^{-tx}}{1+t^2}\;dt=\int_{0}^{+\infty} \frac{\sin t}{t+x}\;dt$.}
  \reponse{\textbf{Existence de $F(x)=\int_{0}^{+\infty} \frac{e^{-tx}}{1+t^2}\;dt$.} Soit $x>0$. La fonction $t\mapsto \frac{e^{-tx}}{1+t^2}\;dt$ est continue sur $[0,+\infty[$ et est dominée par $ \frac{1}{t^2}$ quand $t$ tend vers $+\infty$. Donc la fonction $t\mapsto \frac{e^{-tx}}{1+t^2}\;dt$ est intégrable sur $[0,+\infty[$. On en déduit que
