\uuid{2225}
\titre{Factorisation d'une matrice sym\'etrique}
...
\contenu{
  \texte{}
  \question{Soit $A$ une matrice sym\'etrique inversible admettant une factorisation LU. Montrer que l'on peut \'ecrire $A$ sous la forme 
...
1&3&0&0 
\end{array}\right).$$}
  \reponse{Soit $LU$ la factorisation $LU$ de $A$. On va intercaler dans cette factorisation la matrice r\'eelle $\Lambda=$diag$(\sqrt{|u_{ii}|})$.
