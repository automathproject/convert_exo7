...
\exo7id{5102}
\titre{Exercice 5102}
\theme{Fonctions usuelles}
\auteur{rouget}
\date{2010/06/30}
\organisation{exo7}
\contenu{
  \texte{Construire le graphe des fonctions suivantes~:}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$f_1$ est définie et continue sur $\Rr$, dérivable sur $\Rr\setminus\left\{-2,\frac{1}{2}\right\}$. On précise dans
...
$$\includegraphics{../images/img005102-1}$$}
  \item \reponse{Soit $x\in\Rr$. $\ch x\geq1$ et donc $f_2(x)$ existe et $f_2(x)\geq0$. $f_2$ est donc définie sur $\Rr$. De
...
$$\includegraphics{../images/img005102-2}$$}
  \item \reponse{$f_3$ est définie et continue sur $\Rr$, dérivable sur $\Rr\setminus\{-1,1\}$.
...
$$\includegraphics{../images/img005102-3}$$}
  \item \reponse{$f_4$ est définie sur $\Rr\setminus\left(\frac{\pi}{2}+\pi\Zz\right)$, $2\pi$-périodique et paire. On étudie
...
$$\includegraphics{../images/img005102-4}$$}
  \item \reponse{Soit $x>0$. $x$ n'est pas nul donc $\frac{1}{x}$ existe puis $1+\frac{1}{x}>0$ et $f_6(x)$ existe.
...
$$\includegraphics{../images/img005102-5}$$}
  \item \reponse{\textbf{Domaine de définition de} $\bf{f_6.}$ Soit $x\in\Rr$.
