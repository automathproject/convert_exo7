...
\organisation{exo7}
\contenu{
  \texte{Soit $\gamma$ la constante d'Euler. Montrer que~\dots}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Intégrations par parties successives,\par
\begin{align*}
...
&= - \int_{t=0}^{+\infty} e^{-t}\ln t\,d t.\cr\end{align*}}
  \item \reponse{$ \int_{t=x}^{+\infty}\frac{e^{-t}}t\,d t = (t=-\ln(1-u)) =
