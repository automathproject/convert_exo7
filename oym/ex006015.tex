...
\organisation{exo7}
\contenu{
  \texte{Des machines fabriquent des plaques de tôle destinées à être
empilées.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{La probabilité pour que $X$ soit inférieur à 0.36mm est :
...
$P[0.25\leq X\leq 0.35]=2 F(0.5)-1= 0.383$, soit $38.3$\%.}
  \item \reponse{Pour $n = 20$, la loi de $Z=\sum X_{i}$ est une loi normale de paramètres: d'espérance $E(Z)=20 m = 6$
