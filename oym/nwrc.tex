...
\organisation{exo7}
\contenu{
  \texte{Soit $E = \mathcal{C}([0,1],\R)$ muni du produit scalaire défini par $(f\mid g) =  \int_0^1 fg$.
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{On a pour~$f,g\in E$~: $u\circ v(f) = g \Leftrightarrow g$ est $\mathcal{C}^2$,
$g(0)=g'(1)=0$ et $g''=-f$.
