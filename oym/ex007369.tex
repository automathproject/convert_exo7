...
\end{enumerate}
\begin{enumerate}
  \item \reponse{On peut affirmer que l'ordre de $a$ est un diviseur de $m$.}
  \item \reponse{Il s'agit de l'idéal $pgcd(18,28)\Z=252\Z$.}
  \item \reponse{$\Z/4\Z$ et $\Z/2\Z\times\Z/2\Z$ sont deux groupes d'ordre $4$, mais le second dont tous les éléments sont d'ordre 1 ou 2 n'est pas cyclique.}
  \item \reponse{Comme $(1,2)(1,3)(1,2)=(2,3)$, $(1,2)$ et $(1,3)$ ne commutent pas. Par conséquent, le groupe $\mathcal{S}_4$ n'est pas cyclique.}
\end{enumerate}
}