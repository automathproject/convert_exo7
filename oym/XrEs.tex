...
\organisation{exo7}
\contenu{
  \texte{Résoudre dans $\Rr$ les équations ou inéquations suivantes~:}
\begin{enumerate}
...
\end{align*}}
  \item \reponse{$\Argch3=\ln(3+\sqrt{3^2-1})=\ln(3+\sqrt{8})$ et
...
\end{align*}}
  \item \reponse{Pour $x\in]0,+\infty[\setminus\left\{\frac{1}{100},\frac{1}{10},1\right\}$,
