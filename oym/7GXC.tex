...
\exo7id{5966}
\titre{Exercice 5966}
\theme{Intersections des $L^p$ et convergences, Cas de la mesure de Lebesgue sur $\mathbb{R}
\auteur{tumpach}
\date{2010/11/11}
\organisation{exo7}
\contenu{
  \texte{Soit $\Omega = \mathbb{R}^{n}$ muni de la mesure de Lebesgue. Pour
...
\begin{enumerate}
  ...
  \item \reponse{La fonction $x\mapsto
\frac{1}{\left(1 + |x|^2 \right)^{\alpha}}$ appartient \`a
$L^{p}(\mathbb{R}^{n})$ pour $2\alpha p > n$.}
  \item \reponse{La fonction $x\mapsto \frac{1}{|x|^{\beta}} e^{-\frac{|x|^2}{2}}$
appartient \`a $L^{p}(\mathbb{R}^{n})$ pour $p\beta< n$.}
  \item \reponse{Soit $1\leq q < p \leq +\infty$. La fonction
$$
...
\end{itemize}}
  \item \reponse{\begin{itemize}}
  \item \reponse{Soit $1\leq q< p<+\infty$ et
...
$L^{p}(\mathbb{R}^{n})\cap L^{q}(\mathbb{R}^{n})$.}
  \item \reponse{Soit $r$ tel que $q< r<p$. Montrons que
$$
\|f\|_{r} \leq \|f\|_{p}^{\alpha}\|f\|_{q}^{1-\alpha}
$$
o\`u $\frac{1}{r} = \frac{\alpha}{p} + \frac{1-\alpha}{q}$,
...
\frac{1-\alpha}{q}$.}
  \item \reponse{Si $f_{n}$ converge vers $f$ dans
...
$L^{r}(\mathbb{R}^{n})$.
\end{itemize}}
  \item \reponse{Soit $f\in L^{p}([0, +\infty[)\cap L^{q}([0, +\infty[)$ et
