...
\contenu{
  \texte{}
  \question{Montrer que pour $n\in\Nn$, $E(\frac{1}{3}(n+2-E(\frac{n}{25})))=E(\frac{8n+24}{25})$.}
  \reponse{Soit $n\in\Nn$. La division euclidienne de $n$ par $25$ fournit un quotient entier $q$ et et un
