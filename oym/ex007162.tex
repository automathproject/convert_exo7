\uuid{7162}
\titre{Isométries d'un rectangle}
\theme{}
\auteur{megy}
\date{2017/05/13}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Soit $\mathcal C=ABCD$ un rectangle plein, non carré. Déterminer son groupe d'isométries, et préciser un isomorphisme entre ce groupe et un groupe usuel abstrait.}
  \reponse{Dans le rectangle, les points maximalement éloignés sont les sommets des diagonales. Comme une isométrie conserve les distances, on en déduit qu'une isométrie du rectangle doit envoyer une diagonale sur une autre, et donc soit permuter les sommets. Elle fixe donc le centre, qui est l'isobarycentre des sommets, et donc est une rotation ou une réflexion, car les translations et les réflexions glissées n'ont pas de points fixes.
