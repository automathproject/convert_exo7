...
\organisation{exo7}
\contenu{
  \texte{Soit $O$ un ouvert de $\Rr^3$, $f:O\to \Rr$ une application de classe $C^1$
et $(a,b,c)\in O$ tel que $f(a,b,c)=0$.}
\begin{enumerate}
  \item \question{Donner une condition suffisante pour qu'on puisse résoudre : et $x$ en
...
y=\chi(x,z)\Longleftrightarrow z=\psi(x,y).$$}
  \item \question{Si la condition donnée en 1. est satisfaite, démontrer que pour $(x,y,z)\in
