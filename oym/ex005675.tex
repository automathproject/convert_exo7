...
\contenu{
  \texte{}
  \question{Sur $E$ un $\Rr$-espace vectoriel. On donne trois endomorphismes $f$, $u$ et $v$ tels qu'il existe deux réels $\lambda$ et $\mu$ tels que pour $k\in\{1,2,3\}$, $f^k =\lambda^ku +\mu^kv$. Montrer que $f$ est diagonalisable.}
  \reponse{Trouvons un polynôme scindé à racines simples annulant $f$.
