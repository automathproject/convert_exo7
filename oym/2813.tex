...
\contenu{
  \texte{}
  \question{Soit $C$ un cercle de centre quelconque, parcouru dans le
...
\emph{Indication} pour $n=-1$: soit $w$ l'affixe du
 ...
 invoquer la fonction $\mathrm{Log}(z/w)$.}
  \reponse{Dans le cas o\`u $C$ n'encercle pas l'origine la fonction $z\mapsto z^n$ est holomorphe au voisinage du disque
