...
\contenu{
  \texte{}
  \question{Soit $\Phi$ l'application qui à deux matrices carrées réelles $A$ et $B$ de format $n$ associe $\text{Tr}({^t}A\times B)$. Montrer que $\Phi$ est un produit scalaire sur $\mathcal{M}_n(\Rr)$. Est ce que $\Phi$ est un produit scalaire sur $\mathcal{M}_n(\Cc)$ ?}
  \reponse{Soit $(A,B)\in(\mathcal{M}_n(\Rr))^2$. 
