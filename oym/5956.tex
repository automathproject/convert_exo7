\uuid{5956}
\titre{Exercice 5956}
\theme{Espaces $L^{p, Différentiabilité des normes $\|\cdot\|_{p}
\auteur{tumpach}
\date{2010/11/11}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Soient $f$ et $g$ deux fonctions de $L^{p}(\mu)$ avec
...
o\`u par convention $|f(x)|^{p-2}f(x) = 0$ lorsque $f=0$.}
  \reponse{Soient $f$ et $g$ deux fonctions de $L^{p}(\mu)$ avec
