...
\organisation{exo7}
\contenu{
  \texte{\emph{Cet exercice fournit une autre m\'ethode de calcul du volume
...
Donc $I_n=\frac{n-1}{n}\cdot I_{n-2}\;\;$.}
  \item \reponse{On a $I_0=\pi,\;I_1 = 2.$ Donc
$I_2=\frac{\pi}{2}, \;
...
.$$}
  \item \reponse{On a $\displaystyle\mathcal{V}_n =\int\limits_0^1
