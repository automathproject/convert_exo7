...
\organisation{exo7}
\contenu{
  \texte{Soit $n$ un entier naturel supérieur ou égal à $2$. Pour $k\in\Zz$, on pose $\omega_k=e^{2ik\pi/n}$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$\prod_{k=0}^{n-1}(1+\frac{2}{2-\omega_k})=\frac{\prod_{k=0}^{n-1}(4-\omega_k)}{\prod_{k=0}^{n-1}(2-\omega_k)}
