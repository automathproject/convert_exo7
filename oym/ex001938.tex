...
\organisation{exo7}
\contenu{
  \texte{Calculer les sommes des séries suivantes, en montrant leur convergence :}
\begin{enumerate}
  \item \question{$\sum_{n \ge 0} (n+1)3^{-n}$}
  \item \question{$\displaystyle \sum_{n \ge 0} \frac{n}{n^4+n^2+1}$}
  \item \question{$\displaystyle \sum_{n \ge 3} \frac{2n-1}{n^3-4n}$}
\end{enumerate}
\begin{enumerate}
  \item \reponse{Posons $S_n = \sum_{k=0}^{n} (k+1)3^{-k}$.
...
Remarque: On reconnaît la série géométrique dérivée première de raison $\frac{1}{3}$.}
  \item \reponse{Posons  $\displaystyle u_n = \frac{n}{n^4+n^2+1} $ et cherchons à la décomposer en éléments simples.
\begin{eqnarray*}
...
\]}
  \item \reponse{Décomposons $\displaystyle v_n=\frac{2n-1}{n^3-4n}$ en éléments simples.
Comme 
\[
