...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Si~$f$ est $\mathcal{C}^1$ $2\pi$-périodique alors $f'$ est continue,
  ...
  \item \reponse{Non (et ceci quelle que soit la norme) car le spectre de~$D$ n'est par borné.}
  \item \reponse{$\|f\|_2^2 = \sum_{k\in\Z^*}|c_k(f)|^2 \le \sum_{k\in\Z^*}|ikc_k(f)|^2 = \|f'\|^2$.}
  \item \reponse{Idem, $\|\kern-1.2pt|D^{-1}_{|E_n}\|\kern-1.2pt| = \frac1{n+1}$.}
\end{enumerate}
}