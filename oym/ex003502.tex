...
\contenu{
  \texte{}
  \question{Déterminer les valeurs propres de la matrice
$A = \begin{pmatrix} 1  &-1     &       &        &(0)     \cr
               -1 &2      &-1     &        &        \cr
                  &\ddots &\ddots &\ddots  &        \cr
                  &       &-1     &2       &-1      \cr
               (0)&       &       &-1      &1       \cr\end{pmatrix} \in \mathcal{M}_n(\R)$.}
  \reponse{Soit $P_n(x)$ le polynôme caractéristique de~$x$ et $Q_n(x)$ celui de la
