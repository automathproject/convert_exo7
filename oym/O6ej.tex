...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Un vecteur non nul $x$ est colinéaire à son image si et seulement si il existe $\lambda\in\Cc$ tel que $u(x)=\lambda x$. Les nombres $\lambda$ correspondants sont les complexes tels qu'il existe un vecteur $x\neq0$ dans $\mbox{Ker}(u-\lambda Id)$ ou encore tels que $A-\lambda I_4\notin\mathcal{GL}_4(\Cc)$.
...
\begin{itemize}}
  \item \reponse{[- Cas $\lambda=-1$.] Soit $(x,y,z,t)\in\Cc^4$.
...
\right)
.$$}
  \item \reponse{Les formules de changement de bases s'écrivent $A=PDP^{-1}$ avec $D=\mbox{diag}(-1,1,2,3)$.}
  \item \reponse{Soit $n\in\Nn^*$. Calculons $A^n$.
