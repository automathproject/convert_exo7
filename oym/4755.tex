...
\contenu{
  \texte{}
  \question{On note $E$ l'espace vectoriel des suites r{\'e}elles $(x_n)$ telles que la s{\'e}rie $\sum x_n^2$
...
telle que pour tout $x$ de $E$ on ait $(x\mid y^{s_k})\xrightarrow[k\to\infty]{}(x\mid z)$.}
  \reponse{On construit $(s_k)$ de proche en proche de sorte que pour tout~$n$ fix{\'e}
