...
\contenu{
  \texte{}
  \question{Calculer $I=\displaystyle\iint_{\frac{x^2}{a^2}+\frac{y^2}{b^2}\leqslant1}(x^2-y^2)\;dxdy$.}
  \reponse{On pose déjà $x=ua$ et $y=vb$ de sorte que $ \frac{D(u,v)}{D(x,y)}=ab$. On obtient
