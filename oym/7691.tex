...
\contenu{
  \texte{}
  \question{Calculer l'aire de l'ellipsoïde $\mathcal{E}$ d'équation $x^2+y^2+5z^2=1$.}
  \reponse{On paramètre $\mathcal{E}$ en coordonnées sphériques par $F(\theta,\varphi)=
