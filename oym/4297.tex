...
\contenu{
  \texte{}
  \question{Soit $f:\R \to \R$ continue par morceaux telle que $ \int_{t=-\infty}^{+\infty}|f(t)|\,d t$ converge.
...
$ \int_{t=-\infty}^{+\infty}f(t)\,d t$.}
  \reponse{$ \int_{t=a}^b F(t)\,d t =  \int_{u=a-1}^{a+1} \frac{u-(a-1)}2f(u)\,d u
