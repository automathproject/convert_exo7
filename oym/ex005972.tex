...
\end{enumerate}
\begin{enumerate}
  \item \reponse{On d\'{e}finit  la fonction B\^{e}ta  par $B(a,b):=\int_{0}^{1}s^{a-1}(1-s)^{b-1}ds$, montrons que \\
$$
B\left(1+\frac{d}{2},\frac{m}{2}\right) = 2\int_{0}^{1}\left(
1-r^{2}\right) ^{d/2}r^{m-1}dr
$$
...
\end{array}
\end{equation*}}
  \item \reponse{Par le changement de variables $t\rightarrow t^2 $ et $
