...
\organisation{exo7}
\contenu{
  \texte{Soient $E$ un espace vectoriel non nul de dimension finie et $f$ un endomorphisme de $E$.
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{$\Leftarrow$/ Si $f=0$, $f$ n'est pas injective (car $E\neq\{0\}$).
...
Puisque $F=\text{Ker}f$, on a $f\circ p=0$ et puisque $f$ n'est pas nul, $F$ est distinct de $E$ et donc $G$ n'est pas nul ($E$ étant de dimension finie) ou encore $p$ n'est pas nul. $f$ est donc diviseur de zéro à gauche.}
  \item \reponse{$\Leftarrow$/ Si $f=0$, $f$ n'est pas surjective.
