...
\organisation{exo7}
\contenu{
  \texte{Etudier les courbes dont une équation en repère orthonormé est :}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Pour $(x,y)\in\Rr^2$, posons $f(x,y) =2x^2+6xy+5y^2+4x+6y+1$  et $Q((x,y)) = 2x^2+6xy+5y^2$.
...
$$\includegraphics{../images/img005815-1}$$}
  \item \reponse{Pour $(x,y)\in\Rr^2$, posons $f(x,y) =x^2+2xy+y^2+3x-2y+1$ puis $Q((x,y)) = x^2+2xy+y^2 = (x+y)^2$. $Q$ est de rang $1$ et donc $(\Gamma)$ est du genre parabole c'est-à-dire soit une parabole, soit une réunion de deux droites parallèles éventuellement confondues, soit l'ensemble vide.
...
- La \emph{directrice} $(D)$ a pour équation $\frac{1}{\sqrt{2}}(-x+y)=-\frac{1}{4\sqrt{2}}$ et donc $y = x-\frac{1}{4}$.}
  \item \reponse{Pour $(x,y)\in\Rr^2$, posons $f(x,y) =2x^2-4xy-3x+3y+1$ puis $Q((x,y)) = 2x^2-4xy=0$.
...
$$\includegraphics{../images/img005815-3}$$}
  \item \reponse{Pour $(x,y)\in\Rr^2$, posons $Q(x,y)= -5x^2+6\sqrt{3}xy+y^2$. Le discriminant de $(\Gamma)$ vaut $-5 -27=-32< 0$.
...
$$\includegraphics{../images/img005815-4}$$}
  \item \reponse{L'équation proposée s'écrit $(2x+3y)^2- 2x+1 = 0$. Il s'agit d'une conique du genre parabole de direction asymptotique éventuelle $2x+3y = 0$.
...
$$\includegraphics{../images/img005815-5}$$}
  \item \reponse{$(\Gamma)$ est le point d'intersection des droites d'équations respectives $x-y+1 = 0$ et $x+y-1 = 0$ à savoir le point de coordonnées $(0,1)$.}
  \item \reponse{L'équation s'écrit $\left(x-\frac{3}{2}\right)^2 +\left(y-\frac{1}{2}\right)^2=\frac{1}{2}$. $(\Gamma)$ est le cercle de centre $\left(\frac{3}{2},\frac{1}{2}\right)$ et de rayon $\frac{1}{\sqrt{2}}$.}
  \item \reponse{On reconnait une équation du cercle de diamètre $[AB]$ où $A(0,2)$ et $B(1,3)$.}
  \item \reponse{Si on pose $X = x+2y-4$ et $Y = x-y-1$, l'équation s'écrit $XY = 3$ ce qui montre immédiatement que la courbe est une hyperbole dont les asymptotes sont les droites d'équations respectives $x+2y-4= 0$ et $x-y-1=0$ et donc de centre le point d'intersection de ces deux droites $\Omega(2,1)$. Ce changement de repère non orthonormé ne peut pas fournir davantage et si on veut les éléments métriques de l'hyperbole, il faut revenir aux méthodes de 3) ou 4).}
  \item \reponse{De nouveau, si on pose $X = 2x+y-1$ et $Y = x+y$ (ou même $Y=3(x+y)$) , l'équation s'écrit $X^2 = 3Y$. Le nouveau repère est quelconque mais on peut tout de même affirmer que la courbe est une parabole de direction asymptotique $2x+y=0$.
