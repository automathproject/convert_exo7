...
\contenu{
  \texte{}
  \question{Démontrer que $A_n$ est engendré par les cycles de longueur $3$ (pour $n\geq3$).}
  \reponse{Les éléments de $A_n$ sont les produits pairs de transpositions. Il suffit donc de vérifier qu'un produit de deux transpositions est un produit de cycles de longueur $3$.
