...
\exo7id{5530}
\titre{Exercice 5530}
\theme{Courbes en polaires}
\auteur{rouget}
\date{2010/07/15}
\organisation{exo7}
\contenu{
  \texte{Construire les courbes suivantes~:}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{(\textbf{Lemniscate de } \textsc{Bernoulli}.) Soit $\mathcal{C}$ la courbe d'équation polaire $r=\sqrt{\cos(2\theta)}$.
...
$$\includegraphics{../images/img005530-1}$$}
  \item \reponse{Soit $\mathcal{C}$ la courbe d'équation polaire $r=\sin\left(\frac{2\theta}{3}\right)$.
...
$$\includegraphics{../images/img005530-3}$$}
  \item \reponse{Soit $\mathcal{C}$ la courbe d'équation polaire $r=ae^{b\theta}$.
...
$$\includegraphics{../images/img005530-4}$$}
  \item \reponse{Soit $\mathcal{C}$ la courbe d'équation polaire $r=2\cos(\theta)+1$.
...
$$\includegraphics{../images/img005530-5}$$}
  \item \reponse{Soit $\mathcal{C}$ la courbe d'équation polaire $r=\tan\left(\frac{2\theta}{3}\right)$.
