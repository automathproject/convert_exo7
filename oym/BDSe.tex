...
\end{enumerate}
\begin{enumerate}
  \item \reponse{En notant $q$ l'exposant conjugu\'e de $p$ ($\frac{1}{p} +
\frac{1}{q} = 1$), on a
$$
\begin{array}{lcl}
...
\end{array}
$$}
  \item \reponse{On en d\'eduit que
$$
\begin{array}{lcl}
\|\varphi_n * f - f\|_{p}^{p} & \leq &
...
\end{array}
$$}
  \item \reponse{Soit $\delta>0$, on a
$$
\begin{array}{lcl}
...
\end{array}
$$}
  \item \reponse{Soit $\varepsilon>0$. Par continuit\'e des translations dans
