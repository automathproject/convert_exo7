\uuid{4836}
\titre{Ensemble compact de suites}
\theme{}
\auteur{quercia}
\date{2010/03/16}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Soit $E = {\cal B}(\N,\R) = \{ \text{suites } u = (u_n) \text{ born{\'e}es}\}$.
On munit $E$ de la norme :
$\|u\| = \sum_{n=0}^\infty \frac{|u_n|}{2^n}$.
Montrer que $A = \{u\in E \text{ tq } \forall\ n\in\N,\ 0\le u_n\le 1\}$
est compact.}
  \reponse{Soit $(u^n)$ une suite de suites {\'e}l{\'e}ments de $A$ : $u^n = (u^n_k)$.
