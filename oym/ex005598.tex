...
\contenu{
  \texte{}
  \question{Soient $E$ un $\Cc$-espace vectoriel de dimension finie et $f$ un endomorphisme de $E$. Montrer qu'il existe un projecteur $p$ et un automorphisme $g$ de $E$ tel que $f=g\circ p$.}
  \reponse{Deux cas particuliers se traitent immédiatement.
