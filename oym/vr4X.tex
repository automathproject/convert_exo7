...
\organisation{exo7}
\contenu{
  \texte{D\'eterminer si chacune des parties suivantes du plan
sont ouvertes ou
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{La partie $A_1$ est ouverte.
...
de la courbe $x^2y^2 = 1$.}
  \item \reponse{La partie $A_2$ est le demi-cercle de rayon 1 ayant l'origine pour
