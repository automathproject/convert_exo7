...
\organisation{exo7}
\contenu{
  \texte{Dans le cours nous avons d\'ej\`a montr\'e que le produit de polyn\^omes
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $f=\sum_{i=0}^{n}a_{i}x^{i}\in\Qq[x]$. Soit
  ...
  \item \reponse{Notons $\alpha=\frac{p}{q}$, avec $\pgcd(p,q)=1$ et $q>0$. Soit
    $g_{1}=\alpha g$. On a $qg=pg_{1}$, donc $qc(g)=pc(g_{1})$. On en
    déduit que $q|p$, et donc que $q=1$~:$\alpha\in\Zz$.}
  \item \reponse{Soit $g\in\Qq[x]$ tel que $f=dg$. Soit $g=\frac{p}{q}g_{0}$ la
  ...
  \item \reponse{$d=\pgcd_{\Qq}(f,g)=\frac{p}{q}d_{0}$. Alors $d_{0}$ est primitif et
  ...
  \item \reponse{Soit $d=\pgcd(c(f),c(g))$, $h=\pgcd(f,g)=c(h)h_{0}$,
    $h'=\pgcd(f_{0},g_{0})$.
