...
\end{enumerate}
\begin{enumerate}
  \item \reponse{On note $\mathcal{H}$ l'hyperbole considérée. On tourne de $\frac{\pi}{4}$. Pour cela, on pose $\left\{
\begin{array}{l}
x=\frac{1}{\sqrt{2}}(X-Y)\\
y=\frac{1}{\sqrt{2}}(X+Y)
\end{array}
...
%41x^2-24xy+34y^2-106x+92y+74=0}
  \item \reponse{Le discriminant de cette conique vaut $41\times34-12^2=1250>0$. Il s'agit donc d'une conique du genre ellipse.
On pose $\left\{
\begin{array}{l}
...
Foyers : $F\left(\frac{1}{5},-\frac{2}{5}\right)$ et $F'\left(\frac{9}{5},-\frac{8}{5}\right)$. Directrices : $4x-3y+3=0$ et $4x-3y+17=0$.}
  \item \reponse{$x^2+2xy+y^2=(x+y)^2$. On pose donc $\left\{
\begin{array}{l}
X=\frac{1}{\sqrt{2}}(x-y)\\
Y=\frac{1}{\sqrt{2}}(x+y)
\end{array}
...
Foyer : $F\left(-\frac{5}{8},\frac{3}{8}\right)$. Directrice : $x-y-\frac{1}{4}=0$.}
  \item \reponse{$\mathcal{C}$ est le point d'intersection des droites d'équation $x-y+1=0$ et $x+y-1=0$ c'est-à-dire le point de coordonnées $(0,1)$.}
  \item \reponse{$x^2+y^2-3x-y+3=\left(x-\frac{3}{2}\right)^2+\left(y-\frac{1}{2}\right)^2+\frac{1}{2}>0$ et donc $\mathcal{C}$ est vide.}
  \item \reponse{$x(x-1)+(y-2)(y-3)=0$ est une équation du cercle de diamètre $[AB]$ où $A(0,2)$ et $B(1,3)$.}
  \item \reponse{Si on pose $\left\{
\begin{array}{l}
X=x+y+1\\
Y=x-y+3
\end{array}
