...
\end{enumerate}
\begin{enumerate}
  \item \reponse{La démonstration la plus simple apparaîtra dans le chapitre suivant~:~le déterminant d'une matrice triangulaire est le produit de ses coefficients diagonaux. Cette matrice est inversible si et seulement si son déterminant est non nul ou encore si et seulement si aucun des coefficients diagonaux n'est nul.
