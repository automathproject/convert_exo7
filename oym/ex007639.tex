...
\organisation{exo7}
\contenu{
  \texte{On rappelle que le Laplacien $\Delta\varphi$ d'une fonction $\varphi~: U\to\Rr$ définie sur un ouvert $U$ de $\Rr^2$ est la fonction sur $U$ donnée par $\Delta\varphi (x,y)=\frac{\partial^2}{\partial x^2}\varphi (x,y)+\frac{\partial^2}{\partial y^2}\varphi(x,y)$.}
\begin{enumerate}
...
$$\Delta |f|^2=4|f'|^2.$$}
  \item \reponse{On applique la formule précédente à chaque $f_i$ pour obtenir
