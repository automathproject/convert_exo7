\uuid{5408}
\titre{*** Formule de \textsc{Taylor}-\textsc{Lagrange}}
\theme{}
\auteur{rouget}
\date{2010/07/06}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Soient $a$ et $b$ deux réels tels que $a<b$ et $n$ un entier naturel. Soit $f$ une fonction élément de $C^n([a,b],\Rr)\cap D^{n+1}(]a,b[,\Rr)$. Montrer qu'il existe $c\in]a,b[$ tel que 
