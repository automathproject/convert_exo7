...
\contenu{
  \texte{}
  \question{Trouver toutes les droites sécantes aux quatre droites $(D_1)$~$x-1=y=0$, $(D_2)$~:~$y-1=z=0$, $(D_3)$~:~$z-1=x=0$ et $(D_4)$~:~$x=y=-6z$.}
  \reponse{Notons $(\Delta)$ une éventuelle droite solution.
