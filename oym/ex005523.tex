\uuid{5523}
\titre{Quelques grands classiques}
\theme{}
\auteur{rouget}
\date{2010/07/15}
\organisation{exo7}
\contenu{
  \texte{\label{exo:routhe1}}
\begin{enumerate}
...
$$\includegraphics{../images/img005523-4}$$}
  \item \reponse{Soit $t\in\left]0,\frac{\pi}{2}\right[$. On a vu que la tangente $(T_t)$ en $M(t)$ est dirigée par le vecteur $(-\cos
