\uuid{6942}
\titre{Indépendance d'événements}
\theme{}
\auteur{ruette}
\date{2013/01/24}
\organisation{exo7}
\contenu{
  \texte{}
  \question{Soient $A$ et $B$ deux événements indépendants. Montrer que
$A\bot B^c$. En déduire que $A^c\bot B$ et $A^c\bot B^c$.}
  \reponse{$A=(A\cap B)\cup(A\cap B^c)$ et cette union est disjointe, donc
