...
\organisation{exo7}
\contenu{
  \texte{On considère l'équation $(E)~:~(z-1)^n-(z+1)^n=0$ où $n$ est un entier naturel supérieur ou
égal à $2$ donné.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $z\in\Cc$. Soient $M$, $A$ et $B$ les points d'affixes resectives $z$, $1$ et $-1$.
