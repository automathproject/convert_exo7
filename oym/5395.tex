...
\contenu{
  \texte{}
  \question{Soit $f$ croissante de $[a,b]$ dans lui-même. Montrer que $f$ a un point fixe.}
  \reponse{Soit $E=\{x\in[a,b]/\;f(x)\geq x\}$. $E$ est une partie non vide de $\Rr$ (car $a$ est dans $E$) et majorée (par $b$). Donc, $E$ admet une borne supèrieure $c$ vérifiant $a\leq c\leq b$.
