...
\contenu{
  \texte{}
  \question{Soit $f$ une fonction de classe $C^1$ sur $[a,b]$ telle que $f(a)=f(b)=0$ et soit $M=\mbox{sup}\{|f '(x)|,\;x\in[a,b]\}$. Montrer que $\left|\int_{a}^{b}f(x)\;dx\right|\leq M\frac{(b-a)^2}{4}$.}
  \reponse{Soit $F$ une primitive de $f$ sur $[a,b]$. $F$ est de classe $C^2$ sur le segment $[a,b]$ et l'inégalité de \textsc{Taylor}-\textsc{Lagrange} permet d'écrire
