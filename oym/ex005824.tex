...
\contenu{
  \texte{}
  \question{Equation cartésienne de la parabole $(\mathcal{P})$ tangente à $(Ox)$ en $(1,0)$ et à $(Oy)$ en $(0,2)$.}
  \reponse{On cherche une équation sous la forme $(ax+by)^2 + 2cx + 2dy + e = 0$ avec $a^2+b^2 = 1$  et $a > 0$.
