...
\contenu{
  \texte{}
  \question{Soit $P$ un polynôme de degré $3$ à coefficients réels. Montrer que la courbe d'équation
$P(x)=P(y)$ dans un certain repère orthonormé, est en général la réunion d'une droite et d'une ellipse d'excentricité
fixe.}
  \reponse{Notons $\mathcal{C}$ l'ensemble des points considérés. Pour $x$ réel, posons $P(x)=x^3+Ax^2+Bx+C$.
