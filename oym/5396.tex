...
\contenu{
  \texte{}
  \question{Soit $f$ croissante sur $[a,b]$ telle que $f([a,b])=[f(a),f(b)]$. Montrer que $f$ est continue sur $[a,b]$.}
  \reponse{Puisque $f$ est croissante sur $[a,b]$, on sait que $f$ admet en tout point $x_0$ de $]a,b[$ une limite à gauche et une limite à droite réelles vérifiant $f(x_0^-)\leq f(x_0)\leq f(x_0^+)$ puis une limite à droite en $a$ élément de $[f(a),+\infty[$ et une limite à gauche en $b$ élément de $]-\infty,f(b)]$.
