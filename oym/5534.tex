...
\contenu{
  \texte{}
  \question{Développée de la spirale logarithmique d'équation polaire $r=ae^{\theta}$ ($a>0$).}
  \reponse{\textbf{Développée.} $M(\theta)=O+ae^\theta\overrightarrow{u}_\theta$ puis 
