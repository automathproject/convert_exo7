...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Le fait que $(D)$ et $(D')$ soient sécantes équivaut à $ab'-a'b\neq0$.
...
Une équation cartésienne de $(\Delta)$ est donc $(5x+7y+1)+3(-3x+2y+1)=0$ ou encore $-4x+13y+4=0$.}
  \item \reponse{Soit $M(x,y)$ un point du plan.
