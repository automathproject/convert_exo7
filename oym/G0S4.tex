...
\organisation{exo7}
\contenu{
  \texte{On munit le plan affine euclidien $(P,<,>)$ d'un repère orthonormé
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Comme la somme des masses $2+1$ est non nulle, le barycentre est bien défini.
    L'abscisse de $G$ est $\frac{2\times (-2)+1\times 4}{2+1}=0$
    et l'ordonnée $\frac{2\times 1+1\times 4}{2+1}=2$.}
  \item \reponse{$2GA^ 2+GB^2=2((-2)^2+(1-2)^2)+(4^2+(4-2)^2)=30$.}
  \item \reponse{Soit $M$ un point du plan $P$.
    \begin{eqnarray*}
