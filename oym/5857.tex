...
\contenu{
  \texte{}
  \question{On munit $E=\mathcal{M}_n(\Rr)$ de la norme $N$ définie par $\forall A\in E$, $N(A)=\underset{1\leqslant i\leqslant n}{\text{Sup}}\left\{\sum_{j=1}^{n}|a_{i,j}|\right\}$ (on admet que $N$ est une norme sur $E$).
...
Soit $f$ l'application de $E$ dans $\Rr$ définie par $\forall A\in E$, $f(A)=\text{Tr}(A)$. Démontrer que l'application $f$ est continue sur $(E,N)$ et déterminer $|||f|||$.}
  \reponse{L'application $f$ est linéaire de $(E,N)$ dans $(\Rr,|\;|)$. Soit $A=(a_{i,j})_{1\leqslant i,j\leqslant n}\in E$.
