...
\contenu{
  \texte{}
  \question{Nature, construction et longueur de la courbe d'équation $\sqrt x + \sqrt y = 1$.}
  \reponse{$\sqrt x + \sqrt y = 1  \Rightarrow  2\sqrt{xy}=1-x-y \Rightarrow (x-y)^2=2(x+y)-1$.
