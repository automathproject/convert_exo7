\uuid{3872}
\titre{Plus grande fonction lipschitzienne minorant~$f$ (Ens Lyon MP$^*$ 2003)}
\theme{}
\auteur{quercia}
\date{2010/03/11}
\organisation{exo7}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Non. Si $\varphi$ est lipschitzienne alors $\varphi(x) = O(\|x\|)$
  ...
  \item \reponse{CNS~: $x \mapsto f(x)+k\|x\|$ est minorée.}
  \item \reponse{On pose $\varphi(x) = \sup\{g(x),\ g\ k$-lipschitzienne minorant $f\}$.
