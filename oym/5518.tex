...
\contenu{
  \texte{}
  \question{Soient $(P_1)~:~4x+4y-7z-1=0$ et $(P_2)~:~8x-4y+z+7=0$. Trouver une équation cartésienne des plans bissecteurs de $(P_1)$ et $(P_2)$.}
  \reponse{Soit $M(x,y,z)$ un point de l'espace. On a 
\begin{center}
