...
\organisation{exo7}
\contenu{
  \texte{Soit $\Omega$ un ouvert borné de $\R^2$ et ${u} : {\overline{\Omega}} \to {\R}$ continue sur 
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Si $u$ atteint son maximum en $(x,y)\in\Omega$ alors $d^2u(x,y)$ est
    négative, contradiction avec $\Delta u(x,y)>0$.}
  \item \reponse{Soit $u_p(x,y) = u(x,y) + (x^2+y^2)/p$~: $\Delta u_p = \Delta u + 2/p >0$
  ...
  \item \reponse{Soit $u_1(x,y) = u(x,y) + \alpha\ln(x^2+y^2)$ où $\alpha$ est
