...
\contenu{
  \texte{}
  \question{Soient $a$ et $b$ deux réels tels que $0<a<b$. On pose $u_0=a$ et $v_0=b$ puis, pour $n$ entier naturel donné, $u_{n+1}= \frac{u_n+v_n}{2}$ et $v_{n+1}=\sqrt{u_{n+1}v_n}$.
Montrer que les suites $(u_n)$ et $(v_n)$ sont adjacentes et que leur limite commune est égale à $\frac{b\sin(\Arccos(\frac{a}{b}))}{\Arccos(\frac{a}{b})}$.}
  \reponse{Posons $\alpha=\Arccos\frac{a}{b}$. $\alpha$ existe car $0<\frac{a}{b}<1$ et est élément de $\left]0,\frac{\pi}{2}\right[$. De plus, $a=b\cos\alpha$. Enfin, pour tout entier naturel $n$, $\frac{\alpha}{2^n}\in\left]0,\frac{\pi}{2}\right[$ et donc, $\cos\frac{\alpha}{2^n}>0$.
