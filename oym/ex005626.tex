...
$M(a)$ et $N(a)$ sont-elles semblables ?}
  \reponse{Si $M(a)$ et $N(a)$ sont semblables alors nécessairement $\text{Tr}(M(a))=\text{Tr}(N(a))$. Or, pour tout scalaire $a$, $\text{Tr}(M(a))=4-3a =\text{Tr}(N(a))$. La trace ne fournit aucun renseignement.
