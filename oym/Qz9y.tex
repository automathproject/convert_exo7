...
\exo7id{724}
\titre{Exercice 724}
\theme{Fonctions dérivables, Théorème de Rolle et accroissements finis}
\auteur{bodin}
\date{1998/09/01}
\organisation{exo7}
\contenu{
  \texte{Soient $x$ et $y$ r\'eels avec $0<x<y$.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{Soit $g(t) = \ln t$. Appliquons le th\'eor\`eme des accroissements finis sur $[x,y]$. Il existe $c \in ]x,y[$, 
...
Ce qui donne les in\'egalit\'es recherch\'ees.}
  \item \reponse{$f'(\alpha)= \frac{x-y}{\alpha x + (1-\alpha)y} - \ln x + \ln y$. Et $f''(\alpha) = -\frac{(x-y)^2}{(\alpha x + (1-\alpha)y)^2}$.
...
Cela prouve l'in\'egalit\'e demand\'ee.}
  \item \reponse{G\'eom\'etriquement nous avons prouv\'e que la fonction $\ln$
