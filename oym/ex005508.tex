...
\contenu{
  \texte{}
  \question{Dans $\Rr^3$, équation du plan $P$ parallèle à la droite $(Oy)$ et passant par $A(0,-1,2)$ et $B(-1,2,3)$.}
  \reponse{Puisque $P$ parallèle à la droite $(Oy)$, le vecteur $\overrightarrow{j}=(0,1,0)$ est dans $\overrightarrow{P}$. De même, le vecteur $\overrightarrow{AB}=(-1,3,1)$ est dans $\overrightarrow{P}$.
