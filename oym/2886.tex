...
\contenu{
  \texte{}
  \question{Soit $\alpha$ avec $|\alpha|<1$. On sait que
...
des points est l'origine).}
  \reponse{On a $\Phi_\alpha (0) =\alpha$ et $\Phi_\alpha (\alpha )=0$. Remarquons que $\Phi_\alpha \circ \Phi_\alpha $ fixe l'origine.
