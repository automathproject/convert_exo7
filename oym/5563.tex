...
Montrer que : $\left[(F\cup G\;\text{sous-espace de}\;E)\Leftrightarrow(F\subset G\;\text{ou}\;G\subset F)\right]$.}
  \reponse{$\Leftarrow)$ Si $F\subset G$ ou $G\subset F$ alors $F\cup G=G$ ou $F\cup G=F$. Dans tous les cas, $F\cup G$ est un sous-espace vectoriel.
