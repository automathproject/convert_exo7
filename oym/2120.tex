...
\contenu{
  \texte{}
  \question{Soit $G$ un groupe et $H,K$ deux sous-groupes de $G$.\smallskip
...
(b) Montrer qu'un groupe ne peut \^etre la r\'eunion de deux sous-groupes propres.}
  \reponse{(a) Supposons que $H \cup K$ soit un sous-groupe de $G$ et que $H$ ne soit pas inclus dans
