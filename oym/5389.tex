...
\contenu{
  \texte{}
  \question{Etudier en chaque point de $\Rr$ l'existence d'une limite à droite, à gauche, la continuité de la fonction $f$ définie par $f(x)=xE(\frac{1}{x})$ si $x\neq0$ et $1$ si $x=0$.}
  \reponse{Donnons tout d'abord une expression plus explicite de $f(x)$ pour chaque réel $x$.
