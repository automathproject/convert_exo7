\uuid{5670}
\titre{*** Décomposition de \textsc{Dunford}}
\theme{Réduction}
\auteur{rouget}
\date{2010/10/16}
\organisation{exo7}
...
Montrer qu'il existe un couple d'endomorphismes $(d,n)$ et un seul tel que $d$ est diagonalisable,  $n$ est nilpotent $n$ et $f = d+n$.}
  \reponse{Posons $\chi_f =\prod_{k=1}^{p}(\lambda_k-X)^{\alpha_k}$  où $\lambda_1$,..., $\lambda_p$ sont les valeurs propres deux à deux distinctes de $f$.
