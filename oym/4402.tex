...
\contenu{
  \texte{}
  \question{Soit $f\in\mathcal{C}([0,1],\R^+)$ telle que $ \int_0^1f = 1$. Pour $\psi\in\mathcal{C}([0,1],\R)$
...
Montrer que $\Lambda_n(\psi)\to\psi\Bigl( \int_{x=0}^1xf(x)\,d x\Bigr)$  lorsque $n\to\infty$.}
  \reponse{C'est manifestement vrai pour $\psi\equiv 1$ et aussi pour $\psi(t)=t$.
