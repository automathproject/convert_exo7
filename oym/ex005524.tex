...
\organisation{exo7}
\contenu{
  \texte{Construire les courbes de paramétrisations :}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{\textbf{Domaine d'étude.}
...
Dans la suite de cet exercice, je ne détaillerai que très peu ou pas du tout l'étude de la courbe.}
  \item \reponse{$$\includegraphics{../images/img005524-3}$$}
  \item \reponse{$$\includegraphics{../images/img005524-4}$$}
  \item \reponse{$\left\{\begin{array}{l}
x=\frac{2t}{1+t^2}\\
y=\frac{t+2}{1-t^2}
\end{array}\right.$

$$\includegraphics{../images/img005524-5}$$}
  \item \reponse{$$\includegraphics{../images/img005524-6}$$}
  \item \reponse{$\left\{\begin{array}{l}
x=\frac{t^3}{t^2-9}\\
y=\frac{t(t-2)}{t-3}
\end{array}\right.$
