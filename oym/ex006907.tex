...
\organisation{exo7}
\contenu{
  \texte{Un standard téléphonique reçoit en moyenne 2 appels par minute. Les appels sont répartis au hasard dans le temps.}
\begin{enumerate}
...
\end{enumerate}
\begin{enumerate}
  \item \reponse{C'est une loi de Poisson de paramètre $6$ : $P(X=n)=e^{-6}\frac{6^n}{n!}$.
La probabilité qu'il n'y ait aucun appel est $p(X=0)=e^{-6}\simeq 0,002$.}
  \item \reponse{Soit $Y$ la variable aléatoire ``Nombre d'appels reçus en 2 minutes''. 
