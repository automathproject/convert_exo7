...
\contenu{
  \texte{}
  \question{Soient $A$ et $B \in \mathcal{M}_n(\Rr)$ telles que $\forall X \in \mathcal{M}_n (\Rr)$,
$\text{tr} (AX) = \text{tr} (BX)$. Montrer que $A = B$.}
  \reponse{Notons $E_{ij}$ la matrice élémentaire (des zéros partout sauf le coefficient $1$ à la
