...
\end{enumerate}
\begin{enumerate}
  \item \reponse{\textbf{1ère solution}. Posons $f(x)=\Arccos x+\Arcsin x$ pour $x$ dans $[-1,1]$.
...
$[-\frac{\pi}{2},\frac{\pi}{2}])$.}
  \item \reponse{\textbf{1ère solution}. Pour $x$ réel non nul, posons $f(x)=\Arctan x+\Arctan\frac{1}{x}$. $f$ est
impaire.
...
$\left]0,\frac{\pi}{2}\right[)$.}
  \item \reponse{$\cos^2(\Arctan a)=\frac{1}{1+\tan^2(\Arctan a)}=\frac{1}{1+a^2}$. De plus , $\Arctan
...
\begin{itemize}}
  \item \reponse{[\textbf{1er cas.}] Si $ab<1$ alors $\cos(\Arctan a+\Arctan
